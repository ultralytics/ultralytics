...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/split.py#L13-L95">View on GitHub</a>
```python
def split_classify_dataset(source_dir: str | Path, train_ratio: float = 0.8) -> Path:
    """Split classification dataset into train and val directories in a new directory.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/split.py#L98-L134">View on GitHub</a>
```python
def autosplit(
    path: Path = DATASETS_DIR / "coco8/images",
    weights: tuple[float, float, float] = (0.9, 0.1, 0.0),
