...
!!! abstract "Summary"
    ...
    === "<span class="doc-kind doc-kind-class">Classes</span>"
        ...
        - [`SemanticSegmentationModel`](#ultralytics.nn.tasks.SemanticSegmentationModel)
        - [`PoseModel`](#ultralytics.nn.tasks.PoseModel)
        - [`DepthModel`](#ultralytics.nn.tasks.DepthModel)
        ...
        - [`_SafeLoad`](#ultralytics.nn.tasks._SafeLoad)
    ...
    === "<span class="doc-kind doc-kind-method">Methods</span>"
        ...
        - [`BaseModel._remap_cls_by_names`](#ultralytics.nn.tasks.BaseModel._remap_cls_by_names)
        ...
        - [`SemanticSegmentationModel.init_criterion`](#ultralytics.nn.tasks.SemanticSegmentationModel.init_criterion)
        - [`SemanticSegmentationModel._apply`](#ultralytics.nn.tasks.SemanticSegmentationModel._apply)
        - [`PoseModel.init_criterion`](#ultralytics.nn.tasks.PoseModel.init_criterion)
        - [`DepthModel.init_criterion`](#ultralytics.nn.tasks.DepthModel.init_criterion)
        ...
        - [`RTDETRDetectionModel._remap_cls_by_names`](#ultralytics.nn.tasks.RTDETRDetectionModel._remap_cls_by_names)
        ...
        - [`_SafeLoad.restricted`](#ultralytics.nn.tasks._SafeLoad.restricted)
        - [`_SafeLoad.loading`](#ultralytics.nn.tasks._SafeLoad.loading)
        - [`_SafeLoad.activation`](#ultralytics.nn.tasks._SafeLoad.activation)
        - [`_SafeLoad._build`](#ultralytics.nn.tasks._SafeLoad._build)

    === "<span class="doc-kind doc-kind-function">Functions</span>"

        - [`_initialize_yolo_model`](#ultralytics.nn.tasks._initialize_yolo_model)
...
| [`_remap_cls_by_names`](#ultralytics.nn.tasks.BaseModel._remap_cls_by_names) | Remap pretrained classification head rows to current class order by name. |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/tasks.py#L117-L418">View on GitHub</a>
```python
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/tasks.py#L292-L309">View on GitHub</a>
```python
def _apply(self, fn):
    """Apply a function to all tensors in the model, including Detect head attributes like stride and anchors.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/tasks.py#L202-L208">View on GitHub</a>
```python
def _predict_augment(self, x):
    """Perform augmentations on input image x and return augmented inference."""
    LOGGER.warning(
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/tasks.py#L175-L200">View on GitHub</a>
```python
def _predict_once(self, x, profile=False, embed=None):
    """Perform a forward pass through the network.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/tasks.py#L210-L234">View on GitHub</a>
```python
def _profile_one_layer(self, m, x, dt):
    """Profile the computation time and FLOPs of a single layer of the model on a given input.
...
### Method `ultralytics.nn.tasks.BaseModel._remap_cls_by_names` {#ultralytics.nn.tasks.BaseModel.\_remap\_cls\_by\_names}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/tasks.py#L340-L400">View on GitHub</a>
```python
def _remap_cls_by_names(self, csd: dict[str, torch.Tensor], src_model: torch.nn.Module, verbose: bool = True):
    """Remap pretrained classification head rows to current class order by name.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/tasks.py#L142-L157">View on GitHub</a>
```python
def forward(self, x, *args, **kwargs):
    """Perform forward pass of the model for either training or inference.
...
| `imgsz` | `int \| list` | Input image size used for FLOPs calculation. | `640` |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/tasks.py#L236-L268">View on GitHub</a>
```python
def fuse(self, verbose=True, imgsz=640):
    """Fuse Conv/ConvTranspose and BatchNorm layers, and reparameterize RepConv/RepVGGDW for improved efficiency.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/tasks.py#L282-L290">View on GitHub</a>
```python
def info(self, detailed=False, verbose=True, imgsz=640):
    """Print model information.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/tasks.py#L416-L418">View on GitHub</a>
```python
def init_criterion(self):
    """Initialize the loss criterion for the BaseModel."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/tasks.py#L270-L280">View on GitHub</a>
```python
def is_fused(self, thresh=10):
    """Check if the model has less than a certain threshold of normalization layers.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/tasks.py#L311-L338">View on GitHub</a>
```python
def load(self, weights, verbose=True):
    """Load weights into the model.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/tasks.py#L402-L414">View on GitHub</a>
```python
def loss(self, batch, preds=None):
    """Compute loss.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/tasks.py#L159-L173">View on GitHub</a>
```python
def predict(self, x, profile=False, augment=False, embed=None):
    """Perform a forward pass through the network.
...
```python
DetectionModel(cfg="yolo26n.yaml", ch=3, nc=None, verbose=True)
```
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/tasks.py#L440-L597">View on GitHub</a>
```python
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/tasks.py#L509-L511">View on GitHub</a>
```python
@property
def end2end(self):
    """Return whether the model uses end-to-end NMS-free detection."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/tasks.py#L577-L593">View on GitHub</a>
```python
def _clip_augmented(self, y):
    """Clip YOLO augmented inference tails.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/tasks.py#L556-L575">View on GitHub</a>
```python
@staticmethod
def _descale_pred(p, flips, scale, img_size, dim=1):
    """De-scale predictions following augmented inference (inverse operation).
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/tasks.py#L531-L553">View on GitHub</a>
```python
def _predict_augment(self, x):
    """Perform augmentations on input image x and return augmented inference and train outputs.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/tasks.py#L514-L516">View on GitHub</a>
```python
@end2end.setter
def end2end(self, value):
    """Override the end-to-end detection mode."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/tasks.py#L595-L597">View on GitHub</a>
```python
def init_criterion(self):
    """Initialize the loss criterion for the DetectionModel."""
...
| Name | Type | Description | Default |
| --- | --- | --- | --- |
| `**kwargs` | `Any` | Arbitrary keyword arguments representing attributes to set. | *required* |

<details>
<summary>Source code in <code>ultralytics/nn/tasks.py</code></summary>

<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/tasks.py#L518-L529">View on GitHub</a>
```python
def set_head_attr(self, **kwargs):
    """Set attributes of the model head (last layer).
...
```python
OBBModel(cfg="yolo26n-obb.yaml", ch=3, nc=None, verbose=True)
```
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/tasks.py#L600-L629">View on GitHub</a>
```python
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/tasks.py#L627-L629">View on GitHub</a>
```python
def init_criterion(self):
    """Initialize the loss criterion for the model."""
...
```python
SegmentationModel(cfg="yolo26n-seg.yaml", ch=3, nc=None, verbose=True)
```
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/tasks.py#L632-L661">View on GitHub</a>
```python
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/tasks.py#L659-L661">View on GitHub</a>
```python
def init_criterion(self):
    """Initialize the loss criterion for the SegmentationModel."""
...
## Class `ultralytics.nn.tasks.SemanticSegmentationModel` {#ultralytics.nn.tasks.SemanticSegmentationModel}

```python
SemanticSegmentationModel(cfg="yolo26n-sem.yaml", ch=3, nc=None, verbose=True)
```
...
This class implements a semantic segmentation model that produces per-pixel class predictions. Unlike SegmentationModel (instance segmentation), this does not produce bounding boxes.

**Args**

| Name | Type | Description | Default |
| --- | --- | --- | --- |
| `cfg` | `str \| dict` | Model configuration file path or dictionary. | `"yolo26n-sem.yaml"` |
| `ch` | `int` | Number of input channels. | `3` |
| `nc` | `int, optional` | Number of classes. | `None` |
| `verbose` | `bool` | Whether to display model information. | `True` |
...
| Name | Description |
| --- | --- |
| [`_apply`](#ultralytics.nn.tasks.SemanticSegmentationModel._apply) | Apply a function to all tensors in the model. |
| [`init_criterion`](#ultralytics.nn.tasks.SemanticSegmentationModel.init_criterion) | Initialize the loss criterion for semantic segmentation. |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/tasks.py#L664-L733">View on GitHub</a>
```python
...
### Method `ultralytics.nn.tasks.SemanticSegmentationModel._apply` {#ultralytics.nn.tasks.SemanticSegmentationModel.\_apply}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/tasks.py#L727-L733">View on GitHub</a>
```python
def _apply(self, fn):
    """Apply a function to all tensors in the model."""
    super()._apply(fn)
...
### Method `ultralytics.nn.tasks.SemanticSegmentationModel.init_criterion` {#ultralytics.nn.tasks.SemanticSegmentationModel.init\_criterion}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/tasks.py#L723-L725">View on GitHub</a>
```python
def init_criterion(self):
    """Initialize the loss criterion for semantic segmentation."""
...
```python
PoseModel(cfg="yolo26n-pose.yaml", ch=3, nc=None, data_kpt_shape=(None, None), verbose=True)
```
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/tasks.py#L736-L775">View on GitHub</a>
```python
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/tasks.py#L772-L775">View on GitHub</a>
```python
def init_criterion(self):
    """Initialize the loss criterion for the PoseModel."""
...
## Class `ultralytics.nn.tasks.DepthModel` {#ultralytics.nn.tasks.DepthModel}

```python
DepthModel(cfg="yolo26n-depth.yaml", ch=3, nc=None, verbose=True)
```
...
This class extends DetectionModel for monocular depth estimation, using YOLO backbone + FPN with a DPT-style dense depth decoder head. Follows the Depth Anything approach adapted to YOLO architecture.

**Methods**

| Name | Description |
| --- | --- |
| [`init_criterion`](#ultralytics.nn.tasks.DepthModel.init_criterion) | Initialize the depth loss criterion. |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/tasks.py#L778-L795">View on GitHub</a>
```python
...
### Method `ultralytics.nn.tasks.DepthModel.init_criterion` {#ultralytics.nn.tasks.DepthModel.init\_criterion}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/tasks.py#L793-L795">View on GitHub</a>
```python
def init_criterion(self):
    """Initialize the depth loss criterion."""
...
```python
ClassificationModel(cfg="yolo26n-cls.yaml", ch=3, nc=None, verbose=True)
```
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/tasks.py#L798-L887">View on GitHub</a>
```python
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/tasks.py#L834-L855">View on GitHub</a>
```python
def _from_yaml(self, cfg, ch, nc, verbose):
    """Set Ultralytics YOLO model configurations and define the model architecture.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/tasks.py#L885-L887">View on GitHub</a>
```python
def init_criterion(self):
    """Initialize the loss criterion for the ClassificationModel."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/tasks.py#L858-L883">View on GitHub</a>
```python
@staticmethod
def reshape_outputs(model, nc):
    """Update a TorchVision classification model to class count 'nc' if required.
...
| [`_remap_cls_by_names`](#ultralytics.nn.tasks.RTDETRDetectionModel._remap_cls_by_names) | Remap RT-DETR decoder cls-head rows by class name. |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/tasks.py#L890-L1072">View on GitHub</a>
```python
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/tasks.py#L974-L987">View on GitHub</a>
```python
def _apply(self, fn):
    """Apply a function to all tensors in the model, including decoder anchors and valid mask.
...
### Method `ultralytics.nn.tasks.RTDETRDetectionModel._remap_cls_by_names` {#ultralytics.nn.tasks.RTDETRDetectionModel.\_remap\_cls\_by\_names}
...
| --- | --- | --- | --- |
| `csd` | `dict` | Pretrained checkpoint state_dict (will be mutated). | *required* |
| `src_model` | `torch.nn.Module` | Pretrained module, used to read `.names`. | *required* |
| `verbose` | `bool` | Log mapping summary. | `True` |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/tasks.py#L924-L972">View on GitHub</a>
```python
def _remap_cls_by_names(self, csd: dict[str, torch.Tensor], src_model: torch.nn.Module, verbose: bool = True):
    """Remap RT-DETR decoder cls-head rows by class name.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/tasks.py#L989-L993">View on GitHub</a>
```python
def init_criterion(self):
    """Initialize the loss criterion for the RTDETRDetectionModel."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/tasks.py#L995-L1041">View on GitHub</a>
```python
def loss(self, batch, preds=None):
    """Compute the loss for the given batch of data.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/tasks.py#L1043-L1072">View on GitHub</a>
```python
def predict(self, x, profile=False, batch=None, augment=False, embed=None):
    """Perform a forward pass through the model.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/tasks.py#L1075-L1199">View on GitHub</a>
```python
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/tasks.py#L1123-L1144">View on GitHub</a>
```python
def get_text_pe(self, text, batch=80, cache_clip_model=True):
    """Get text positional embeddings using the CLIP model.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/tasks.py#L1187-L1199">View on GitHub</a>
```python
def loss(self, batch, preds=None):
    """Compute loss.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/tasks.py#L1146-L1185">View on GitHub</a>
```python
def predict(self, x, profile=False, txt_feats=None, augment=False, embed=None):
    """Perform a forward pass through the model.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/tasks.py#L1112-L1121">View on GitHub</a>
```python
def set_classes(self, text, batch=80, cache_clip_model=True):
    """Set classes in advance so that model could do offline-inference without clip model.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/tasks.py#L1202-L1452">View on GitHub</a>
```python
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/tasks.py#L1366-L1385">View on GitHub</a>
```python
def get_cls_pe(self, tpe, vpe):
    """Get class positional embeddings.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/tasks.py#L1242-L1277">View on GitHub</a>
```python
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/tasks.py#L1280-L1290">View on GitHub</a>
```python
@smart_inference_mode()
def get_visual_pe(self, img, visual):
    """Get visual positional embeddings.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/tasks.py#L1324-L1349">View on GitHub</a>
```python
def get_vocab(self, names):
    """Get fused vocabulary layer from the model.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/tasks.py#L1430-L1452">View on GitHub</a>
```python
def loss(self, batch, preds=None):
    """Compute loss.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/tasks.py#L1387-L1428">View on GitHub</a>
```python
def predict(self, x, profile=False, tpe=None, augment=False, embed=None, vpe=None, return_vpe=False):
    """Perform a forward pass through the model.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/tasks.py#L1351-L1364">View on GitHub</a>
```python
def set_classes(self, names, embeddings):
    """Set classes in advance so that model could do offline-inference without clip model.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/tasks.py#L1292-L1322">View on GitHub</a>
```python
def set_vocab(self, vocab, names):
    """Set vocabulary for the prompt-free model.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/tasks.py#L1455-L1499">View on GitHub</a>
```python
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/tasks.py#L1482-L1499">View on GitHub</a>
```python
def loss(self, batch, preds=None):
    """Compute loss.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/tasks.py#L1502-L1540">View on GitHub</a>
```python
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/tasks.py#L1524-L1540">View on GitHub</a>
```python
def forward(self, x, augment=False, profile=False):
    """Run ensemble forward pass and concatenate predictions from all models.
...
## Class `ultralytics.nn.tasks._SafeLoad` {#ultralytics.nn.tasks.\_SafeLoad}
...
Enabled per-process by the `ULTRALYTICS_SAFE_LOAD` env flag, or per-call by `torch_safe_load(..., safe_only=True)`. Default loading (flag off) is unchanged.

**Methods**

| Name | Description |
| --- | --- |
| [`_build`](#ultralytics.nn.tasks._SafeLoad._build) | Auto-discover `nn.Module` subclasses across `torch.nn` and the ultralytics model families, registered under |
| [`activation`](#ultralytics.nn.tasks._SafeLoad.activation) | Resolve a model-yaml `activation` spec to a `torch.nn` module instance without `eval()`. |
| [`loading`](#ultralytics.nn.tasks._SafeLoad.loading) | Load with `weights_only=True`: scope the allow-list to this load and mark the thread restricted, so a |
| [`restricted`](#ultralytics.nn.tasks._SafeLoad.restricted) | Whether model construction should use the no-eval, known-layer path (env flag or an in-progress load). |

<details>
<summary>Source code in <code>ultralytics/nn/tasks.py</code></summary>

<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/tasks.py#L1594-L1739">View on GitHub</a>
```python
class _SafeLoad:
    """Opt-in restricted checkpoint loading: reconstruct only known model classes (`weights_only=True` plus an
    allow-list) and build models without `eval()`.
...
### Method `ultralytics.nn.tasks._SafeLoad._build` {#ultralytics.nn.tasks.\_SafeLoad.\_build}
...
every namespace path they are reachable from (covering re-exports such as `block.RealNVP` as `head.RealNVP`), plus torchvision transforms and legacy aliases.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/tasks.py#L1659-L1739">View on GitHub</a>
```python
@classmethod
def _build(cls):
    """Auto-discover `nn.Module` subclasses across `torch.nn` and the ultralytics model families, registered under
...
### Method `ultralytics.nn.tasks._SafeLoad.activation` {#ultralytics.nn.tasks.\_SafeLoad.activation}
...
Accepts only the documented `[torch.]nn.<Class>(literal args)` shape (e.g. `nn.SiLU()`, `torch.nn.LeakyReLU(0.1)`) with literal arguments, and rejects anything else.

<details>
<summary>Source code in <code>ultralytics/nn/tasks.py</code></summary>

<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/tasks.py#L1629-L1656">View on GitHub</a>
```python
@staticmethod
def activation(act):
    """Resolve a model-yaml `activation` spec to a `torch.nn` module instance without `eval()`.
...
### Method `ultralytics.nn.tasks._SafeLoad.loading` {#ultralytics.nn.tasks.\_SafeLoad.loading}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/tasks.py#L1615-L1626">View on GitHub</a>
```python
@classmethod
...
### Method `ultralytics.nn.tasks._SafeLoad.restricted` {#ultralytics.nn.tasks.\_SafeLoad.restricted}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/tasks.py#L1609-L1611">View on GitHub</a>
```python
@classmethod
def restricted(cls):
    """Whether model construction should use the no-eval, known-layer path (env flag or an in-progress load)."""
...
## Function `ultralytics.nn.tasks._initialize_yolo_model` {#ultralytics.nn.tasks.\_initialize\_yolo\_model}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/tasks.py#L421-L437">View on GitHub</a>
```python
def _initialize_yolo_model(model, cfg, ch, nc, verbose):
    """Initialize common YOLO model attributes from a YAML config."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/tasks.py#L1547-L1591">View on GitHub</a>
```python
@contextlib.contextmanager
def temporary_modules(modules=None, attributes=None):
    """Context manager for temporarily adding or modifying modules in Python's module cache (`sys.modules`).
...
| `safe_only` | `bool, optional` | Load with `torch.load(weights_only=True)`, reconstructing only the known Ultralytics/torch model classes on the allow-list. Defaults to the `ULTRALYTICS_SAFE_LOAD` environment variable (off), so standard usage is unchanged; set the env to opt in. | `None` |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/tasks.py#L1742-L1884">View on GitHub</a>
```python
def torch_safe_load(weight, safe_only=None):
    """Attempt to load a PyTorch model with the torch.load() function. If a ModuleNotFoundError is raised, it catches
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/tasks.py#L1887-L1931">View on GitHub</a>
```python
def load_checkpoint(weight, device=None, inplace=True, fuse=False):
    """Load single model weights.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/tasks.py#L1934-L2136">View on GitHub</a>
```python
def parse_model(d, ch, verbose=True):
    """Parse a YOLO model.yaml dictionary into a PyTorch model.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/tasks.py#L2139-L2159">View on GitHub</a>
```python
def yaml_model_load(path):
    """Load a YOLO model from a YAML file.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/tasks.py#L2162-L2174">View on GitHub</a>
```python
def guess_model_scale(model_path):
    """Extract the size character n, s, m, l, or x of the model's scale from the model path.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/tasks.py#L2177-L2256">View on GitHub</a>
```python
def guess_model_task(model):
    """Guess the task of a PyTorch model from its architecture or configuration.
