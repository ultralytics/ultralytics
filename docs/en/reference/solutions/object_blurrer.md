...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/solutions/object_blurrer.py#L12-L91">View on GitHub</a>
```python
...
| Type | Description |
| --- | --- |
| `SolutionResults` | Object containing the processed image and number of tracked objects.<br>- plot_im (np.ndarray): The annotated output image with blurred objects.<br>- total_tracks (int): The total number of tracked objects in the frame. |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/solutions/object_blurrer.py#L49-L91">View on GitHub</a>
```python
def process(self, im0) -> SolutionResults:
    """Apply a blurring effect to detected objects in the input image.
