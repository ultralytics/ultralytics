...
!!! abstract "Summary"
    ...
    === "<span class="doc-kind doc-kind-class">Classes</span>"
        ...
        - [`FXModel`](#ultralytics.utils.export.imx.FXModel)
        - [`NMSWrapper`](#ultralytics.utils.export.imx.NMSWrapper)

    === "<span class="doc-kind doc-kind-method">Methods</span>"

        - [`FXModel.forward`](#ultralytics.utils.export.imx.FXModel.forward)
        - [`NMSWrapper.forward`](#ultralytics.utils.export.imx.NMSWrapper.forward)

    === "<span class="doc-kind doc-kind-function">Functions</span>"

        - [`_inference`](#ultralytics.utils.export.imx._inference)
        - [`pose_forward`](#ultralytics.utils.export.imx.pose_forward)
        - [`segment_forward`](#ultralytics.utils.export.imx.segment_forward)
        - [`torch2imx`](#ultralytics.utils.export.imx.torch2imx)


## Class `ultralytics.utils.export.imx.FXModel` {#ultralytics.utils.export.imx.FXModel}
...
| --- | --- | --- | --- |
| `model` | `nn.Module` | The original model to wrap for torch.fx compatibility. | *required* |
| `imgsz` | `tuple[int, int]` | The input image size (height, width). Default is (640, 640). | `(640, 640)` |
...
| Name | Description |
| --- | --- |
| [`forward`](#ultralytics.utils.export.imx.FXModel.forward) | Forward pass through the model. |

<details>
<summary>Source code in <code>ultralytics/utils/export/imx.py</code></summary>

<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/export/imx.py#L61-L117"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
...
### Method `ultralytics.utils.export.imx.FXModel.forward` {#ultralytics.utils.export.imx.FXModel.forward}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/export/imx.py#L86-L117"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def forward(self, x):
    """Forward pass through the model.
...
## Class `ultralytics.utils.export.imx.NMSWrapper` {#ultralytics.utils.export.imx.NMSWrapper}
...
| Name | Type | Description | Default |
| --- | --- | --- | --- |
| `model` | `torch.nn.Module` | Model instance. | *required* |
| `score_threshold` | `float` | Score threshold for non-maximum suppression. | `0.001` |
| `iou_threshold` | `float` | Intersection over union threshold for non-maximum suppression. | `0.7` |
| `max_detections` | `int` | The number of detections to return. | `300` |
| `task` | `str` | Task type, one of 'detect', 'pose', or 'segment'. | `"detect"` |

**Methods**

| Name | Description |
| --- | --- |
| [`forward`](#ultralytics.utils.export.imx.NMSWrapper.forward) | Forward pass with model inference and NMS post-processing. |

<details>
<summary>Source code in <code>ultralytics/utils/export/imx.py</code></summary>

<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/export/imx.py#L152-L201"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
...
### Method `ultralytics.utils.export.imx.NMSWrapper.forward` {#ultralytics.utils.export.imx.NMSWrapper.forward}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/export/imx.py#L179-L201"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def forward(self, images):
    """Forward pass with model inference and NMS post-processing."""
...
## Function `ultralytics.utils.export.imx._inference` {#ultralytics.utils.export.imx.\_inference}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/export/imx.py#L120-L123"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def _inference(self, x: dict[str, torch.Tensor]) -> tuple[torch.Tensor, torch.Tensor]:
    """Decode boxes and cls scores for imx object detection."""
...
## Function `ultralytics.utils.export.imx.pose_forward` {#ultralytics.utils.export.imx.pose\_forward}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/export/imx.py#L126-L140"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def pose_forward(self, x: list[torch.Tensor]) -> tuple[torch.Tensor, torch.Tensor, torch.Tensor]:
    """Forward pass for imx pose estimation, including keypoint decoding."""
...
## Function `ultralytics.utils.export.imx.segment_forward` {#ultralytics.utils.export.imx.segment\_forward}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/export/imx.py#L143-L149"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def segment_forward(self, x: list[torch.Tensor]) -> tuple[torch.Tensor, torch.Tensor, torch.Tensor, torch.Tensor]:
    """Forward pass for imx segmentation."""
...
## Function `ultralytics.utils.export.imx.torch2imx` {#ultralytics.utils.export.imx.torch2imx}
...
This function quantizes a YOLO model using Model Compression Toolkit (MCT) and exports it to IMX format compatible with Sony IMX500 edge devices. It supports both YOLOv8n and YOLO11n models for detection, segmentation, pose estimation, and classification tasks.

**Args**

| Name | Type | Description | Default |
| --- | --- | --- | --- |
| `model` | `torch.nn.Module` | The YOLO model to export. Must be YOLOv8n or YOLO11n. | *required* |
| `file` | `Path | str` | Output file path for the exported model. | *required* |
| `conf` | `float` | Confidence threshold for NMS post-processing. | *required* |
| `iou` | `float` | IoU threshold for NMS post-processing. | *required* |
| `max_det` | `int` | Maximum number of detections to return. | *required* |
| `metadata` | `dict | None, optional` | Metadata to embed in the ONNX model. Defaults to None. | `None` |
| `gptq` | `bool, optional` | Whether to use Gradient-Based Post Training Quantization. If False, uses standard Post<br>    Training Quantization. Defaults to False. | `False` |
| `dataset` | `optional` | Representative dataset for quantization calibration. Defaults to None. | `None` |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/export/imx.py#L204-L345"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def torch2imx(
    model: torch.nn.Module,
    file: Path | str,
