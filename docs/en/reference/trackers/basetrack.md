...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/trackers/basetrack.py#L7-L25">View on GitHub</a>
```python
class TrackState:
    """Enumeration class representing the possible states of an object being tracked.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/trackers/basetrack.py#L28-L102">View on GitHub</a>
```python
class BaseTrack:
    """Base class for object tracking, providing foundational attributes and methods.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/trackers/basetrack.py#L69-L71">View on GitHub</a>
```python
@property
def end_frame(self) -> int:
    """Return the ID of the most recent frame where the object was tracked."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/trackers/basetrack.py#L79-L81">View on GitHub</a>
```python
def activate(self, *args: Any) -> None:
    """Activate the track with provided arguments, initializing necessary attributes for tracking."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/trackers/basetrack.py#L91-L93">View on GitHub</a>
```python
def mark_lost(self) -> None:
    """Mark the track as lost by updating its state to TrackState.Lost."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/trackers/basetrack.py#L95-L97">View on GitHub</a>
```python
def mark_removed(self) -> None:
    """Mark the track as removed by setting its state to TrackState.Removed."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/trackers/basetrack.py#L74-L77">View on GitHub</a>
```python
@staticmethod
def next_id() -> int:
    """Increment and return the next unique global track ID for object tracking."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/trackers/basetrack.py#L83-L85">View on GitHub</a>
```python
def predict(self) -> None:
    """Predict the next state of the track based on the current state and tracking model."""
    raise NotImplementedError
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/trackers/basetrack.py#L100-L102">View on GitHub</a>
```python
@staticmethod
def reset_id() -> None:
    """Reset the global track ID counter to its initial value."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/trackers/basetrack.py#L87-L89">View on GitHub</a>
```python
def update(self, *args: Any, **kwargs: Any) -> None:
    """Update the track with new observations and data, modifying its state and attributes accordingly."""
    raise NotImplementedError
