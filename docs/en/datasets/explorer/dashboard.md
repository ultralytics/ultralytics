...
<p>
<img width="1710" alt="Explorer similarity search results showing similar images" src="https://cdn.jsdelivr.net/gh/ultralytics/assets@main/docs/explorer-dashboard-screenshot-3.avif">
</p>
