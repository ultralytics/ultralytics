...
def test_data_annotator():
    ...
    auto_annotate(ASSETS, det_model='yolov8n.pt', output_dir=TMP / 'auto_annotate_labels')
    auto_annotate(ASSETS, det_model='yolov8n-cls.pt', output_dir=TMP / 'auto_annotate_labels')
    auto_annotate(ASSETS, det_model='yolov8n-seg.pt', output_dir=TMP / 'auto_annotate_labels')
    auto_annotate(ASSETS, det_model='yolov8n-pose.pt', output_dir=TMP / 'auto_annotate_labels')
