...
class AutoBackend(nn.Module):
    ...
    def __init__(
        ...
        # NCNN
            ...
            if ARM64:
                # NCNN build is broken on ARM64 https://github.com/Tencent/ncnn/issues/6509
                raise SystemError("NCNN inference is not supported on ARM64 due to upstream build issues")
