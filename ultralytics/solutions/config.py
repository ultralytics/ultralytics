...
class SolutionConfig:
    ...
    Attributes:
        ...
        quantize (int | str | None): Inference precision for PyTorch and TorchScript models, e.g. 16 (FP16);
            other formats run at their own runtime precision. Replaces the deprecated half flag.
