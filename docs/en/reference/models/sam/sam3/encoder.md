...
!!! abstract "Summary"
    ...
    === "<span class="doc-kind doc-kind-class">Classes</span>"
        ...
        - [`TransformerEncoderLayer`](#ultralytics.models.sam.sam3.encoder.TransformerEncoderLayer)
        - [`TransformerEncoder`](#ultralytics.models.sam.sam3.encoder.TransformerEncoder)
        - [`TransformerEncoderFusion`](#ultralytics.models.sam.sam3.encoder.TransformerEncoderFusion)

    === "<span class="doc-kind doc-kind-method">Methods</span>"

        - [`TransformerEncoderLayer.forward_post`](#ultralytics.models.sam.sam3.encoder.TransformerEncoderLayer.forward_post)
        - [`TransformerEncoderLayer.forward_pre`](#ultralytics.models.sam.sam3.encoder.TransformerEncoderLayer.forward_pre)
        - [`TransformerEncoderLayer.forward`](#ultralytics.models.sam.sam3.encoder.TransformerEncoderLayer.forward)
        - [`TransformerEncoder._prepare_multilevel_features`](#ultralytics.models.sam.sam3.encoder.TransformerEncoder._prepare_multilevel_features)
        - [`TransformerEncoder.forward`](#ultralytics.models.sam.sam3.encoder.TransformerEncoder.forward)
        - [`TransformerEncoderFusion.forward`](#ultralytics.models.sam.sam3.encoder.TransformerEncoderFusion.forward)

    === "<span class="doc-kind doc-kind-function">Functions</span>"

        - [`pool_text_feat`](#ultralytics.models.sam.sam3.encoder.pool_text_feat)


## Class `ultralytics.models.sam.sam3.encoder.TransformerEncoderLayer` {#ultralytics.models.sam.sam3.encoder.TransformerEncoderLayer}
...
This layer was previously called TransformerDecoderLayer but was renamed to better reflect its role in the architecture. It processes input sequences through self-attention and then cross-attention with another input (typically image features).

The layer supports both pre-norm and post-norm configurations, as well as positional encoding at different stages of the attention mechanism.

**Args**

| Name | Type | Description | Default |
| --- | --- | --- | --- |
| `d_model` | `int` | Model dimension/hidden size | *required* |
| `dim_feedforward` | `int` | Dimension of the feedforward network | *required* |
| `dropout` | `float` | Dropout probability | *required* |
| `pos_enc_at_attn` | `bool` | Whether to add positional encodings at self-attention | *required* |
| `pos_enc_at_cross_attn_keys` | `bool` | Whether to add positional encodings to keys in cross-attention | *required* |
| `pos_enc_at_cross_attn_queries` | `bool` | Whether to add positional encodings to queries in cross-attention | *required* |
| `pre_norm` | `bool` | Whether to use pre-norm (True) or post-norm (False) architecture | *required* |
| `self_attention` | `nn.Module` | Self-attention module | `None` |
| `cross_attention` | `nn.Module` | Cross-attention module for attending to image features | `None` |

**Methods**

| Name | Description |
| --- | --- |
| [`forward`](#ultralytics.models.sam.sam3.encoder.TransformerEncoderLayer.forward) | Forward pass for the transformer encoder layer. |
| [`forward_post`](#ultralytics.models.sam.sam3.encoder.TransformerEncoderLayer.forward_post) | Forward pass for post-norm architecture. |
| [`forward_pre`](#ultralytics.models.sam.sam3.encoder.TransformerEncoderLayer.forward_pre) | Forward pass for pre-norm architecture. |

<details>
<summary>Source code in <code>ultralytics/models/sam/sam3/encoder.py</code></summary>

<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/sam3/encoder.py#L15-L234"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
...
### Method `ultralytics.models.sam.sam3.encoder.TransformerEncoderLayer.forward` {#ultralytics.models.sam.sam3.encoder.TransformerEncoderLayer.forward}
...
| Name | Type | Description | Default |
| --- | --- | --- | --- |
| `tgt` | `torch.Tensor` | Input tensor to be processed | *required* |
| `memory` | `torch.Tensor` | Memory tensor (e.g., image features) for cross-attention | *required* |
| `dac` | `bool` | Whether to use Divide-and-Conquer attention (only apply self-attention to first half) | `False` |
| `tgt_mask` | `torch.Tensor` | Mask for self-attention | `None` |
| `memory_mask` | `torch.Tensor` | Mask for cross-attention | `None` |
| `tgt_key_padding_mask` | `torch.Tensor` | Key padding mask for self-attention | `None` |
| `memory_key_padding_mask` | `torch.Tensor` | Key padding mask for cross-attention | `None` |
| `pos` | `torch.Tensor` | Positional encoding for memory | `None` |
| `query_pos` | `torch.Tensor` | Positional encoding for query | `None` |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/sam3/encoder.py#L193-L234"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def forward(
    self,
    tgt: torch.Tensor,
...
### Method `ultralytics.models.sam.sam3.encoder.TransformerEncoderLayer.forward_post` {#ultralytics.models.sam.sam3.encoder.TransformerEncoderLayer.forward\_post}
...
| --- | --- | --- | --- |
| `tgt` | `torch.Tensor` | Input tensor to be processed | *required* |
| `memory` | `torch.Tensor` | Memory tensor for cross-attention | *required* |
| `tgt_mask` | `torch.Tensor` | Mask for self-attention | `None` |
| `memory_mask` | `torch.Tensor` | Mask for cross-attention | `None` |
| `tgt_key_padding_mask` | `torch.Tensor` | Key padding mask for self-attention | `None` |
| `memory_key_padding_mask` | `torch.Tensor` | Key padding mask for cross-attention | `None` |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/sam3/encoder.py#L79-L134"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def forward_post(
    self,
    tgt: torch.Tensor,
...
### Method `ultralytics.models.sam.sam3.encoder.TransformerEncoderLayer.forward_pre` {#ultralytics.models.sam.sam3.encoder.TransformerEncoderLayer.forward\_pre}
...
| `tgt` | `torch.Tensor` | Input tensor to be processed | *required* |
| `memory` | `torch.Tensor` | Memory tensor for cross-attention | *required* |
| `dac` | `bool` | Whether to use Divide-and-Conquer attention | `False` |
| `tgt_mask` | `torch.Tensor` | Mask for self-attention | `None` |
| `memory_mask` | `torch.Tensor` | Mask for cross-attention | `None` |
| `tgt_key_padding_mask` | `torch.Tensor` | Key padding mask for self-attention | `None` |
| `memory_key_padding_mask` | `torch.Tensor` | Key padding mask for cross-attention | `None` |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/sam3/encoder.py#L136-L191"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def forward_pre(
    self,
    tgt: torch.Tensor,
...
## Class `ultralytics.models.sam.sam3.encoder.TransformerEncoder` {#ultralytics.models.sam.sam3.encoder.TransformerEncoder}
...
| Name | Type | Description | Default |
| --- | --- | --- | --- |
| `layer` | `nn.Module` | The encoder layer to be stacked multiple times | *required* |
| `num_layers` | `int` | Number of encoder layers to stack | *required* |
| `d_model` | `int` | Model dimension/hidden size | *required* |
| `num_feature_levels` | `int` | Number of feature levels to process | *required* |
| `frozen` | `bool` | Whether to freeze the parameters of this module | `False` |
| `use_act_checkpoint` | `bool` | Whether to use activation checkpointing during training | `False` |

**Methods**

| Name | Description |
| --- | --- |
| [`_prepare_multilevel_features`](#ultralytics.models.sam.sam3.encoder.TransformerEncoder._prepare_multilevel_features) | Prepare multi-level features for transformer encoder. |
| [`forward`](#ultralytics.models.sam.sam3.encoder.TransformerEncoder.forward) | Process multi-level features through the transformer encoder. |

<details>
<summary>Source code in <code>ultralytics/models/sam/sam3/encoder.py</code></summary>

<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/sam3/encoder.py#L237-L407"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
...
### Method `ultralytics.models.sam.sam3.encoder.TransformerEncoder._prepare_multilevel_features` {#ultralytics.models.sam.sam3.encoder.TransformerEncoder.\_prepare\_multilevel\_features}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/sam3/encoder.py#L284-L336"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def _prepare_multilevel_features(self, srcs, masks, pos_embeds):
    """Prepare multi-level features for transformer encoder."""
...
### Method `ultralytics.models.sam.sam3.encoder.TransformerEncoder.forward` {#ultralytics.models.sam.sam3.encoder.TransformerEncoder.forward}
...
| Name | Type | Description | Default |
| --- | --- | --- | --- |
| `src` | `list[torch.Tensor]` | List of multi-level features, each with shape (batch_size, channels, height, width) | *required* |
| `src_key_padding_masks` | `list[torch.Tensor] | None` | List of padding masks for each feature level, each with shape (batch_size, height,<br>    width) | `None` |
| `pos` | `list[torch.Tensor] | None` | List of positional embeddings for each feature level, each with shape (batch_size, channels, height,<br>    width) | `None` |
| `prompt` | `torch.Tensor` | Optional text/prompt features to attend to, with shape (seq_len, batch_size, d_model) | `None` |
| `prompt_key_padding_mask` | `torch.Tensor` | Optional padding mask for prompt, with shape (batch_size, seq_len) | `None` |
| `encoder_extra_kwargs` | `dict | None` | Optional additional arguments to pass to each encoder layer | `None` |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/sam3/encoder.py#L338-L407"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def forward(
    self,
    src: list[torch.Tensor],
...
## Class `ultralytics.models.sam.sam3.encoder.TransformerEncoderFusion` {#ultralytics.models.sam.sam3.encoder.TransformerEncoderFusion}
...
This encoder extends TransformerEncoder to handle both text and image features, with the ability to add pooled text features to image features for better cross-modal fusion. It supports torch.compile for performance optimization.
...
| `d_model` | `int` | Model dimension/hidden size | *required* |
| `num_feature_levels` | `int` | Number of feature levels to process | *required* |
| `add_pooled_text_to_img_feat` | `bool` | Whether to add pooled text features to image features | `True` |
| `pool_text_with_mask` | `bool` | Whether to use the mask when pooling text features | `False` |
| `compile_mode` | `str | None` | Mode for torch.compile, or None to disable compilation | `None` |
| `**kwargs` |  | Additional arguments to pass to the parent class | *required* |

**Methods**

| Name | Description |
| --- | --- |
| [`forward`](#ultralytics.models.sam.sam3.encoder.TransformerEncoderFusion.forward) | Forward pass for the transformer encoder with text-image fusion. |

<details>
<summary>Source code in <code>ultralytics/models/sam/sam3/encoder.py</code></summary>

<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/sam3/encoder.py#L410-L511"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
...
### Method `ultralytics.models.sam.sam3.encoder.TransformerEncoderFusion.forward` {#ultralytics.models.sam.sam3.encoder.TransformerEncoderFusion.forward}
...
| Name | Type | Description | Default |
| --- | --- | --- | --- |
| `src` | `list[torch.Tensor]` |  | *required* |
| `prompt` | `torch.Tensor` |  | *required* |
| `src_key_padding_mask` | `list[torch.Tensor] | None` |  | `None` |
| `src_pos` | `list[torch.Tensor] | None` |  | `None` |
| `prompt_key_padding_mask` | `torch.Tensor` |  | `None` |
| `feat_sizes` | `list[int] | None` |  | `None` |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/sam3/encoder.py#L453-L511"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def forward(
    self,
    src: list[torch.Tensor],
...
## Function `ultralytics.models.sam.sam3.encoder.pool_text_feat` {#ultralytics.models.sam.sam3.encoder.pool\_text\_feat}
...
| `pool_with_mask` |  |  | *required* |

<details>
<summary>Source code in <code>ultralytics/models/sam/sam3/encoder.py</code></summary>

<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/sam3/encoder.py#L514-L529"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def pool_text_feat(prompt, prompt_mask, pool_with_mask):
    """Mean-pool the prompt embeddings over the valid tokens only."""
