...
| `dynamic`   | `bool`            | `False`    | Allows dynamic input sizes, enhancing flexibility in handling varying image dimensions. With `nms=True`, only the batch axis stays dynamic; height/width are fixed at the traced `imgsz`.                                                                        |
