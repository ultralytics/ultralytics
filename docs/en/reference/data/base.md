...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/base.py#L23-L456">View on GitHub</a>
```python
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/base.py#L395-L397">View on GitHub</a>
```python
def __getitem__(self, index: int) -> dict[str, Any]:
    """Return transformed label information for given index."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/base.py#L419-L421">View on GitHub</a>
```python
def __len__(self) -> int:
    """Return the length of the labels list for the dataset."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/base.py#L427-L438">View on GitHub</a>
```python
def build_transforms(self, hyp: dict[str, Any] | None = None):
    """Users can customize augmentations here.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/base.py#L280-L294">View on GitHub</a>
```python
def cache_images(self) -> None:
    """Cache images to memory or disk for faster training."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/base.py#L296-L304">View on GitHub</a>
```python
def cache_images_to_disk(self, i: int) -> None:
    """Save an image as an *.npy file for faster loading."""
    f = self.npy_files[i]
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/base.py#L306-L339">View on GitHub</a>
```python
def check_cache_disk(self, safety_margin: float = 0.5) -> bool:
    """Check if there's enough disk space for caching images.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/base.py#L341-L368">View on GitHub</a>
```python
def check_cache_ram(self, safety_margin: float = 0.5) -> bool:
    """Check if there's enough RAM for caching images.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/base.py#L399-L417">View on GitHub</a>
```python
def get_image_and_label(self, index: int) -> dict[str, Any]:
    """Get and return label information from the dataset.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/base.py#L150-L185">View on GitHub</a>
```python
def get_img_files(self, img_path: str | list[str]) -> list[str]:
    """Read image files from the specified path.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/base.py#L440-L456">View on GitHub</a>
```python
def get_labels(self) -> list[dict[str, Any]]:
    """Users can customize their own format here.
...
| `resize_short` | `bool` | Whether to resize the shorter side to imgsz while maintaining aspect ratio. Overrides rect_mode when True. | `False` |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/base.py#L210-L278">View on GitHub</a>
```python
def load_image(
    self, i: int, rect_mode: bool = True, resize_short: bool = False
) -> tuple[np.ndarray, tuple[int, int], tuple[int, int]]:
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/base.py#L370-L393">View on GitHub</a>
```python
def set_rectangle(self) -> None:
    """Sort images by aspect ratio and set batch shapes for rectangular training."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/base.py#L187-L208">View on GitHub</a>
```python
def update_labels(self, include_class: list[int] | None) -> None:
    """Update labels to include only specified classes.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/base.py#L423-L425">View on GitHub</a>
```python
def update_labels_info(self, label: dict[str, Any]) -> dict[str, Any]:
    """Customize your label format here."""
    return label
