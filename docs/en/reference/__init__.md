...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/__init__.py#L35-L39">View on GitHub</a>
```python
def __getattr__(name: str):
    """Lazy-import model classes on first access."""
    if name in MODELS:
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/__init__.py#L42-L44">View on GitHub</a>
```python
def __dir__():
    """Extend dir() to include lazily available model names for IDE autocompletion."""
