...
| `_callbacks` | `dict, optional` | Dictionary of callback functions to be applied during training. | `None` |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/yolo/yoloe/train.py#L21-L100">View on GitHub</a>
```python
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/yolo/yoloe/train.py#L86-L100">View on GitHub</a>
```python
def build_dataset(self, img_path: str, mode: str = "train", batch: int | None = None):
    """Build YOLO Dataset.
...
| Name | Type | Description | Default |
| --- | --- | --- | --- |
| `cfg` | `dict \| str, optional` | Model configuration. Can be a dictionary containing a 'yaml_file' key, a direct path to a YAML file, or None to use default configuration. | `None` |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/yolo/yoloe/train.py#L50-L78">View on GitHub</a>
```python
def get_model(self, cfg=None, weights=None, verbose: bool = True):
    """Return a YOLOEModel initialized with the specified configuration and weights.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/yolo/yoloe/train.py#L80-L84">View on GitHub</a>
```python
def get_validator(self):
    """Return a YOLOEDetectValidator for YOLOE model validation."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/yolo/yoloe/train.py#L103-L155">View on GitHub</a>
```python
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/yolo/yoloe/train.py#L113-L155">View on GitHub</a>
```python
def get_model(self, cfg=None, weights=None, verbose: bool = True):
    """Return YOLOEModel initialized with specified config and weights.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/yolo/yoloe/train.py#L158-L207">View on GitHub</a>
```python
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/yolo/yoloe/train.py#L169-L183">View on GitHub</a>
```python
def build_dataset(self, img_path: list[str] | str, mode: str = "train", batch: int | None = None):
    """Build YOLO Dataset for training or validation.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/yolo/yoloe/train.py#L185-L207">View on GitHub</a>
```python
def generate_text_embeddings(self, texts: list[str], batch: int, cache_dir: Path):
    """Generate text embeddings for a list of text samples.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/yolo/yoloe/train.py#L210-L238">View on GitHub</a>
```python
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/yolo/yoloe/train.py#L222-L226">View on GitHub</a>
```python
def get_validator(self):
    """Return a DetectionValidator for YOLO model validation."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/yolo/yoloe/train.py#L228-L230">View on GitHub</a>
```python
def preprocess_batch(self, batch):
    """Preprocess a batch of images for YOLOE training, adjusting formatting and dimensions as needed."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/yolo/yoloe/train.py#L232-L238">View on GitHub</a>
```python
def set_text_embeddings(self, datasets, batch: int):
    """No-op override for prompt-free training that does not require text embeddings.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/yolo/yoloe/train.py#L241-L278">View on GitHub</a>
```python
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/yolo/yoloe/train.py#L271-L278">View on GitHub</a>
```python
def _close_dataloader_mosaic(self):
    """Close mosaic augmentation and add visual prompt loading to the training dataset."""
...
| Type | Description |
| --- | --- |
| `YOLOConcatDataset \| Dataset` | YOLO dataset configured for training or validation, with visual prompts for training mode. |

<details>
<summary>Source code in <code>ultralytics/models/yolo/yoloe/train.py</code></summary>

<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/yolo/yoloe/train.py#L251-L269">View on GitHub</a>
```python
def build_dataset(self, img_path: list[str] | str, mode: str = "train", batch: int | None = None):
    """Build YOLO Dataset for training or validation with visual prompts.
