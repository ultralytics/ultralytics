...
!!! abstract "Summary"
    ...
    === "<span class="doc-kind doc-kind-class">Classes</span>"
        ...
        - [`OpenVINOBackend`](#ultralytics.nn.backends.openvino.OpenVINOBackend)

    === "<span class="doc-kind doc-kind-method">Methods</span>"

        - [`OpenVINOBackend.load_model`](#ultralytics.nn.backends.openvino.OpenVINOBackend.load_model)
        - [`OpenVINOBackend.forward`](#ultralytics.nn.backends.openvino.OpenVINOBackend.forward)


## Class `ultralytics.nn.backends.openvino.OpenVINOBackend` {#ultralytics.nn.backends.openvino.OpenVINOBackend}
...
Loads and runs inference with Intel OpenVINO IR models (*_openvino_model/ directories). Supports automatic device selection, Intel-specific device targeting, and async inference for throughput optimization.

**Methods**

| Name | Description |
| --- | --- |
| [`forward`](#ultralytics.nn.backends.openvino.OpenVINOBackend.forward) | Run Intel OpenVINO inference with sync or async execution based on inference mode. |
| [`load_model`](#ultralytics.nn.backends.openvino.OpenVINOBackend.load_model) | Load an Intel OpenVINO IR model from a .xml/.bin file pair or model directory. |

<details>
<summary>Source code in <code>ultralytics/nn/backends/openvino.py</code></summary>

<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/backends/openvino.py#L16-L110">View on GitHub</a>
```python
...
### Method `ultralytics.nn.backends.openvino.OpenVINOBackend.forward` {#ultralytics.nn.backends.openvino.OpenVINOBackend.forward}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/backends/openvino.py#L78-L110">View on GitHub</a>
```python
def forward(self, im: torch.Tensor) -> list[np.ndarray]:
    """Run Intel OpenVINO inference with sync or async execution based on inference mode.
...
### Method `ultralytics.nn.backends.openvino.OpenVINOBackend.load_model` {#ultralytics.nn.backends.openvino.OpenVINOBackend.load\_model}
...
| Name | Type | Description | Default |
| --- | --- | --- | --- |
| `weight` | `str \| Path` | Path to the .xml file or directory containing OpenVINO model files. | *required* |

<details>
<summary>Source code in <code>ultralytics/nn/backends/openvino.py</code></summary>

<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/backends/openvino.py#L23-L76">View on GitHub</a>
```python
def load_model(self, weight: str | Path) -> None:
    """Load an Intel OpenVINO IR model from a .xml/.bin file pair or model directory.
