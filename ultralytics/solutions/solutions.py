...
class SolutionResults:
    ...
    Attributes:
        in_count (int, optional): The total in counts in a video stream.
        out_count (int, optional): The total out counts in a video stream.
        classwise_count (Dict[str, int], optional): A dictionary containing class-wise object counts.
        queue_count (int, optional): The count of objects in a queue or waiting area.
        workout_count (int, optional): The count of workout repetitions. (e.g. 10)
        workout_angle (float, optional): The angle calculated during a workout exercise (e.g., 55 degree).
        workout_stage (str, optional): The current stage of the workout (e.g., "up", "down").
