...
Treine o modelo YOLOv8n-cls no dataset MNIST160 por 100 épocas com tamanho de imagem 64. Para uma lista completa de arguments disponíveis, veja a página de [Configuração](/../usage/cfg.md).
...
Valid a acurácia do modelo YOLOv8n-cls treinado no dataset MNIST160. Não é necessário passar argumento, pois o `modelo` retém seus dados de treinamento e arguments como atributos do modelo.
...
!!! Example "Exemplo"
    ...
    === "Python"
        ...
        # Validar o modelo
        metrics = model.val()  # sem arguments necessários, dataset e configurações lembrados
