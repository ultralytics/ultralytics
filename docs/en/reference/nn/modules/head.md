...
!!! abstract "Summary"
    ...
    === "<span class="doc-kind doc-kind-class">Classes</span>"
        ...
        - [`Depth`](#ultralytics.nn.modules.head.Depth)
        ...
        - [`SemanticSegment`](#ultralytics.nn.modules.head.SemanticSegment)
    ...
    === "<span class="doc-kind doc-kind-method">Methods</span>"
        ...
        - [`Detect._grouped_topk`](#ultralytics.nn.modules.head.Detect._grouped_topk)
        - [`Detect.end2end`](#ultralytics.nn.modules.head.Detect.end2end)
        ...
        - [`Depth.forward`](#ultralytics.nn.modules.head.Depth.forward)
        ...
        - [`RTDETRDecoder.postprocess`](#ultralytics.nn.modules.head.RTDETRDecoder.postprocess)
        ...
        - [`SemanticSegment.forward`](#ultralytics.nn.modules.head.SemanticSegment.forward)


## Class `ultralytics.nn.modules.head.Detect` {#ultralytics.nn.modules.head.Detect}

```python
Detect(nc: int = 80, reg_max=16, end2end=False, ch: tuple = ())
```
...
| [`_grouped_topk`](#ultralytics.nn.modules.head.Detect._grouped_topk) | Select exact top-k values through smaller grouped selections. |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/modules/head.py#L37-L280">View on GitHub</a>
```python
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/modules/head.py#L140-L142">View on GitHub</a>
```python
@property
def one2many(self):
    """Returns the one-to-many head components, here for v3/v5/v8/v9/v11 backward compatibility."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/modules/head.py#L145-L147">View on GitHub</a>
```python
@property
def one2one(self):
    """Returns the one-to-one head components."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/modules/head.py#L150-L152">View on GitHub</a>
```python
@property
def end2end(self):
    """Checks if the model has one2one for v3/v5/v8/v9/v11 backward compatibility."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/modules/head.py#L199-L207">View on GitHub</a>
```python
def _get_decode_boxes(self, x: dict[str, torch.Tensor]) -> torch.Tensor:
    """Get decoded boxes based on anchors and strides."""
...
### Method `ultralytics.nn.modules.head.Detect._grouped_topk` {#ultralytics.nn.modules.head.Detect.\_grouped\_topk}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/modules/head.py#L90-L100">View on GitHub</a>
```python
@staticmethod
def _grouped_topk(x: torch.Tensor, k: int, groups: int = 8) -> tuple[torch.Tensor, torch.Tensor]:
    """Select exact top-k values through smaller grouped selections."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/modules/head.py#L186-L197">View on GitHub</a>
```python
def _inference(self, x: dict[str, torch.Tensor]) -> torch.Tensor:
    """Decode predicted bounding boxes and class probabilities based on multiple-level feature maps.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/modules/head.py#L209-L221">View on GitHub</a>
```python
def bias_init(self):
    """Initialize Detect() biases, WARNING: requires stride availability."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/modules/head.py#L223-L230">View on GitHub</a>
```python
def decode_bboxes(self, bboxes: torch.Tensor, anchors: torch.Tensor, xywh: bool = True) -> torch.Tensor:
    """Decode bounding boxes from predictions."""
    return dist2bbox(
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/modules/head.py#L155-L157">View on GitHub</a>
```python
@end2end.setter
def end2end(self, value):
    """Override the end-to-end detection mode."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/modules/head.py#L170-L184">View on GitHub</a>
```python
def forward(
    self, x: list[torch.Tensor]
) -> dict[str, torch.Tensor] | torch.Tensor | tuple[torch.Tensor, dict[str, torch.Tensor]]:
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/modules/head.py#L159-L168">View on GitHub</a>
```python
def forward_head(
    self, x: list[torch.Tensor], box_head: torch.nn.Module = None, cls_head: torch.nn.Module = None
) -> dict[str, torch.Tensor]:
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/modules/head.py#L278-L280">View on GitHub</a>
```python
def fuse(self) -> None:
    """Remove the one2many head for inference optimization."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/modules/head.py#L248-L276">View on GitHub</a>
```python
def get_topk_index(self, scores: torch.Tensor, max_det: int) -> tuple[torch.Tensor, torch.Tensor, torch.Tensor]:
    """Get top-k indices from scores.
...
| Name | Type | Description | Default |
| --- | --- | --- | --- |
| `preds` | `torch.Tensor` | Raw predictions with shape (batch_size, num_anchors, 4 + nc) with last dimension format [x1, y1, x2, y2, class_probs]. | *required* |

**Returns**

| Type | Description |
| --- | --- |
| `torch.Tensor` | Processed predictions with shape (batch_size, min(max_det, num_anchors), 6) and last dimension format [x1, y1, x2, y2, max_class_prob, class_index]. |

<details>
<summary>Source code in <code>ultralytics/nn/modules/head.py</code></summary>

<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/modules/head.py#L232-L246">View on GitHub</a>
```python
def postprocess(self, preds: torch.Tensor) -> torch.Tensor:
    """Post-processes YOLO model predictions.
...
```python
Segment(nc: int = 80, nm: int = 32, npr: int = 256, reg_max=16, end2end=False, ch: tuple = ())
```
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/modules/head.py#L283-L384">View on GitHub</a>
```python
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/modules/head.py#L326-L328">View on GitHub</a>
```python
@property
def one2many(self):
    """Returns the one-to-many head components, here for backward compatibility."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/modules/head.py#L331-L333">View on GitHub</a>
```python
@property
def one2one(self):
    """Returns the one-to-one head components."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/modules/head.py#L350-L353">View on GitHub</a>
```python
def _inference(self, x: dict[str, torch.Tensor]) -> torch.Tensor:
    """Decode predicted bounding boxes and class probabilities, concatenated with mask coefficients."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/modules/head.py#L335-L348">View on GitHub</a>
```python
def forward(self, x: list[torch.Tensor]) -> tuple | list[torch.Tensor] | dict[str, torch.Tensor]:
    """Return model outputs and mask coefficients if training, otherwise return outputs and mask coefficients."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/modules/head.py#L355-L363">View on GitHub</a>
```python
def forward_head(
    self, x: list[torch.Tensor], box_head: torch.nn.Module, cls_head: torch.nn.Module, mask_head: torch.nn.Module
) -> dict[str, torch.Tensor]:
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/modules/head.py#L382-L384">View on GitHub</a>
```python
def fuse(self) -> None:
    """Remove the one2many head for inference optimization."""
...
| Name | Type | Description | Default |
| --- | --- | --- | --- |
| `preds` | `torch.Tensor` | Raw predictions with shape (batch_size, num_anchors, 4 + nc + nm) with last dimension format [x1, y1, x2, y2, class_probs, mask_coefficient]. | *required* |

**Returns**

| Type | Description |
| --- | --- |
| `torch.Tensor` | Processed predictions with shape (batch_size, min(max_det, num_anchors), 6 + nm) and last dimension format [x1, y1, x2, y2, max_class_prob, class_index, mask_coefficient]. |

<details>
<summary>Source code in <code>ultralytics/nn/modules/head.py</code></summary>

<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/modules/head.py#L365-L380">View on GitHub</a>
```python
def postprocess(self, preds: torch.Tensor) -> torch.Tensor:
    """Post-process YOLO model predictions.
...
```python
Segment26(nc: int = 80, nm: int = 32, npr: int = 256, reg_max=16, end2end=False, ch: tuple = ())
```
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/modules/head.py#L387-L443">View on GitHub</a>
```python
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/modules/head.py#L422-L437">View on GitHub</a>
```python
def forward(self, x: list[torch.Tensor]) -> tuple | list[torch.Tensor] | dict[str, torch.Tensor]:
    """Return model outputs and mask coefficients if training, otherwise return outputs and mask coefficients."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/modules/head.py#L439-L443">View on GitHub</a>
```python
def fuse(self) -> None:
    """Remove the one2many head and extra part of proto module for inference optimization."""
    super().fuse()
...
```python
OBB(nc: int = 80, ne: int = 1, reg_max=16, end2end=False, ch: tuple = ())
```
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/modules/head.py#L446-L539">View on GitHub</a>
```python
class OBB(Detect):
    """YOLO OBB detection head for detection with rotation models.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/modules/head.py#L486-L488">View on GitHub</a>
```python
@property
def one2many(self):
    """Returns the one-to-many head components, here for backward compatibility."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/modules/head.py#L491-L493">View on GitHub</a>
```python
@property
def one2one(self):
    """Returns the one-to-one head components."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/modules/head.py#L495-L500">View on GitHub</a>
```python
def _inference(self, x: dict[str, torch.Tensor]) -> torch.Tensor:
    """Decode predicted bounding boxes and class probabilities, concatenated with rotation angles."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/modules/head.py#L516-L518">View on GitHub</a>
```python
def decode_bboxes(self, bboxes: torch.Tensor, anchors: torch.Tensor) -> torch.Tensor:
    """Decode rotated bounding boxes."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/modules/head.py#L502-L514">View on GitHub</a>
```python
def forward_head(
    self, x: list[torch.Tensor], box_head: torch.nn.Module, cls_head: torch.nn.Module, angle_head: torch.nn.Module
) -> dict[str, torch.Tensor]:
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/modules/head.py#L537-L539">View on GitHub</a>
```python
def fuse(self) -> None:
    """Remove the one2many head for inference optimization."""
    self.cv2 = self.cv3 = self.cv4 = None
...
| Type | Description |
| --- | --- |
| `torch.Tensor` | Processed predictions with shape (batch_size, min(max_det, num_anchors), 7) and last dimension format [x, y, w, h, max_class_prob, class_index, angle]. |

<details>
<summary>Source code in <code>ultralytics/nn/modules/head.py</code></summary>

<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/modules/head.py#L520-L535">View on GitHub</a>
```python
def postprocess(self, preds: torch.Tensor) -> torch.Tensor:
    """Post-process YOLO model predictions.
...
```python
OBB26(nc: int = 80, ne: int = 1, reg_max=16, end2end=False, ch: tuple = ())
```
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/modules/head.py#L542-L573">View on GitHub</a>
```python
class OBB26(OBB):
    """YOLO26 OBB detection head for detection with rotation models. This class extends the OBB head with modified angle
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/modules/head.py#L562-L573">View on GitHub</a>
```python
def forward_head(
    self, x: list[torch.Tensor], box_head: torch.nn.Module, cls_head: torch.nn.Module, angle_head: torch.nn.Module
) -> dict[str, torch.Tensor]:
...
```python
Pose(nc: int = 80, kpt_shape: tuple = (17, 3), reg_max=16, end2end=False, ch: tuple = ())
```
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/modules/head.py#L576-L678">View on GitHub</a>
```python
class Pose(Detect):
    """YOLO Pose head for keypoints models.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/modules/head.py#L617-L619">View on GitHub</a>
```python
@property
def one2many(self):
    """Returns the one-to-many head components, here for backward compatibility."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/modules/head.py#L622-L624">View on GitHub</a>
```python
@property
def one2one(self):
    """Returns the one-to-one head components."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/modules/head.py#L626-L629">View on GitHub</a>
```python
def _inference(self, x: dict[str, torch.Tensor]) -> torch.Tensor:
    """Decode predicted bounding boxes and class probabilities, concatenated with keypoints."""
    preds = super()._inference(x)
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/modules/head.py#L631-L639">View on GitHub</a>
```python
def forward_head(
    self, x: list[torch.Tensor], box_head: torch.nn.Module, cls_head: torch.nn.Module, pose_head: torch.nn.Module
) -> dict[str, torch.Tensor]:
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/modules/head.py#L658-L660">View on GitHub</a>
```python
def fuse(self) -> None:
    """Remove the one2many head for inference optimization."""
    self.cv2 = self.cv3 = self.cv4 = None
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/modules/head.py#L662-L678">View on GitHub</a>
```python
def kpts_decode(self, kpts: torch.Tensor) -> torch.Tensor:
    """Decode keypoints from predictions."""
...
| Name | Type | Description | Default |
| --- | --- | --- | --- |
| `preds` | `torch.Tensor` | Raw predictions with shape (batch_size, num_anchors, 4 + nc + nk) with last dimension format [x1, y1, x2, y2, class_probs, keypoints]. | *required* |

**Returns**

| Type | Description |
| --- | --- |
| `torch.Tensor` | Processed predictions with shape (batch_size, min(max_det, num_anchors), 6 + self.nk) and last dimension format [x1, y1, x2, y2, max_class_prob, class_index, keypoints]. |

<details>
<summary>Source code in <code>ultralytics/nn/modules/head.py</code></summary>

<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/modules/head.py#L641-L656">View on GitHub</a>
```python
def postprocess(self, preds: torch.Tensor) -> torch.Tensor:
    """Post-process YOLO model predictions.
...
```python
Pose26(nc: int = 80, kpt_shape: tuple = (17, 3), reg_max=16, end2end=False, ch: tuple = ())
```
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/modules/head.py#L681-L792">View on GitHub</a>
```python
class Pose26(Pose):
    """YOLO26 Pose head for keypoints models.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/modules/head.py#L728-L736">View on GitHub</a>
```python
@property
def one2many(self):
    """Returns the one-to-many head components, here for backward compatibility."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/modules/head.py#L739-L747">View on GitHub</a>
```python
@property
def one2one(self):
    """Returns the one-to-one head components."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/modules/head.py#L749-L768">View on GitHub</a>
```python
def forward_head(
    self,
    x: list[torch.Tensor],
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/modules/head.py#L770-L773">View on GitHub</a>
```python
def fuse(self) -> None:
    """Remove the one2many head for inference optimization."""
    super().fuse()
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/modules/head.py#L775-L792">View on GitHub</a>
```python
def kpts_decode(self, kpts: torch.Tensor) -> torch.Tensor:
    """Decode keypoints from predictions."""
    ndim = self.kpt_shape[1]
...
## Class `ultralytics.nn.modules.head.Depth` {#ultralytics.nn.modules.head.Depth}

```python
Depth(c_mid: int = 256, ch: tuple = ())
```
...
| Name | Description |
| --- | --- |
| [`forward`](#ultralytics.nn.modules.head.Depth.forward) | Fuse multi-scale features and predict depth. |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/modules/head.py#L795-L874">View on GitHub</a>
```python
...
### Method `ultralytics.nn.modules.head.Depth.forward` {#ultralytics.nn.modules.head.Depth.forward}
...
| Name | Type | Description | Default |
| --- | --- | --- | --- |
| `x` | `list[torch.Tensor]` | List of feature tensors [P3, P4, P5] from the backbone/neck. | *required* |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/modules/head.py#L843-L874">View on GitHub</a>
```python
def forward(self, x: list[torch.Tensor]) -> dict[str, torch.Tensor] | torch.Tensor:
    """Fuse multi-scale features and predict depth.
...
```python
Classify(c1: int, c2: int, k: int = 1, s: int = 1, p: int | None = None, g: int = 1)
```
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/modules/head.py#L877-L927">View on GitHub</a>
```python
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/modules/head.py#L919-L927">View on GitHub</a>
```python
def forward(self, x: list[torch.Tensor] | torch.Tensor) -> torch.Tensor | tuple:
    """Perform forward pass on input feature maps."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/modules/head.py#L930-L997">View on GitHub</a>
```python
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/modules/head.py#L991-L997">View on GitHub</a>
```python
def bias_init(self):
    """Initialize Detect() biases, WARNING: requires stride availability."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/modules/head.py#L976-L989">View on GitHub</a>
```python
def forward(self, x: list[torch.Tensor], text: torch.Tensor) -> dict[str, torch.Tensor] | tuple:
    """Concatenate and return predicted bounding boxes and class probabilities."""
...
```python
LRPCHead(vocab: nn.Module, pf: nn.Module, loc: nn.Module, enabled: bool = True)
```
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/modules/head.py#L1001-L1067">View on GitHub</a>
```python
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/modules/head.py#L1041-L1047">View on GitHub</a>
```python
@staticmethod
def conv2linear(conv: nn.Conv2d) -> nn.Linear:
    """Convert a 1x1 convolutional layer to a linear layer."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/modules/head.py#L1049-L1067">View on GitHub</a>
```python
def forward(self, cls_feat: torch.Tensor, loc_feat: torch.Tensor, conf: float) -> tuple[tuple, torch.Tensor]:
    """Process classification and localization features to generate detection proposals."""
    if self.enabled:
...
```python
YOLOEDetect(nc: int = 80, embed: int = 512, with_bn: bool = False, reg_max=16, end2end=False, ch: tuple = ())
```
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/modules/head.py#L1070-L1287">View on GitHub</a>
```python
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/modules/head.py#L1250-L1252">View on GitHub</a>
```python
@property
def one2many(self):
    """Returns the one-to-many head components, here for v3/v5/v8/v9/v11 backward compatibility."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/modules/head.py#L1255-L1257">View on GitHub</a>
```python
@property
def one2one(self):
    """Returns the one-to-one head components."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/modules/head.py#L1159-L1194">View on GitHub</a>
```python
def _fuse_tp(self, txt_feats: torch.Tensor, cls_head: torch.nn.Module, bn_head: torch.nn.Module) -> None:
    """Fuse text prompt embeddings with model weights for efficient inference."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/modules/head.py#L1242-L1247">View on GitHub</a>
```python
def _get_decode_boxes(self, x):
    """Decode predicted bounding boxes for inference."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/modules/head.py#L1273-L1287">View on GitHub</a>
```python
def bias_init(self):
    """Initialize Detect() biases, WARNING: requires stride availability."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/modules/head.py#L1209-L1213">View on GitHub</a>
```python
def forward(self, x: list[torch.Tensor]) -> torch.Tensor | tuple:
    """Process features with class prompt embeddings to generate detections."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/modules/head.py#L1259-L1271">View on GitHub</a>
```python
def forward_head(self, x, box_head, cls_head, contrastive_head):
    """Concatenates and returns predicted bounding boxes, class probabilities, and contrastive scores."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/modules/head.py#L1215-L1240">View on GitHub</a>
```python
def forward_lrpc(self, x: list[torch.Tensor]) -> torch.Tensor | tuple:
    """Process features with fused text embeddings to generate detections for prompt-free model."""
    boxes, scores, index = [], [], []
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/modules/head.py#L1141-L1157">View on GitHub</a>
```python
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/modules/head.py#L1196-L1198">View on GitHub</a>
```python
def get_tpe(self, tpe: torch.Tensor | None) -> torch.Tensor | None:
    """Get text prompt embeddings with normalization."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/modules/head.py#L1200-L1207">View on GitHub</a>
```python
def get_vpe(self, x: list[torch.Tensor], vpe: torch.Tensor) -> torch.Tensor:
    """Get visual prompt embeddings with spatial awareness."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/modules/head.py#L1290-L1450">View on GitHub</a>
```python
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/modules/head.py#L1347-L1349">View on GitHub</a>
```python
@property
def one2many(self):
    """Returns the one-to-many head components, here for v3/v5/v8/v9/v11 backward compatibility."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/modules/head.py#L1352-L1359">View on GitHub</a>
```python
@property
def one2one(self):
    """Returns the one-to-one head components."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/modules/head.py#L1406-L1409">View on GitHub</a>
```python
def _inference(self, x: dict[str, torch.Tensor]) -> torch.Tensor:
    """Decode predicted bounding boxes and class probabilities, concatenated with mask coefficients."""
    preds = super()._inference(x)
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/modules/head.py#L1391-L1404">View on GitHub</a>
```python
def forward(self, x: list[torch.Tensor]) -> tuple | list[torch.Tensor] | dict[str, torch.Tensor]:
    """Return model outputs and mask coefficients if training, otherwise return outputs and mask coefficients."""
    outputs = super().forward(x)
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/modules/head.py#L1411-L1424">View on GitHub</a>
```python
def forward_head(
    self,
    x: list[torch.Tensor],
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/modules/head.py#L1361-L1389">View on GitHub</a>
```python
def forward_lrpc(self, x: list[torch.Tensor]) -> torch.Tensor | tuple:
    """Process features with fused text embeddings to generate detections for prompt-free model."""
    boxes, scores, index = [], [], []
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/modules/head.py#L1443-L1450">View on GitHub</a>
```python
def fuse(self, txt_feats: torch.Tensor = None):
    """Fuse text features with model weights for efficient inference."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/modules/head.py#L1426-L1441">View on GitHub</a>
```python
def postprocess(self, preds: torch.Tensor) -> torch.Tensor:
    """Post-process YOLO model predictions.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/modules/head.py#L1453-L1513">View on GitHub</a>
```python
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/modules/head.py#L1499-L1513">View on GitHub</a>
```python
def forward(self, x: list[torch.Tensor]) -> tuple | list[torch.Tensor] | dict[str, torch.Tensor]:
    """Return model outputs and mask coefficients if training, otherwise return outputs and mask coefficients."""
...
| `act` | `nn.Module` | Activation function. | `None` |
...
| [`postprocess`](#ultralytics.nn.modules.head.RTDETRDecoder.postprocess) | Post-process predictions to select top-k detections. |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/modules/head.py#L1516-L1858">View on GitHub</a>
```python
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/modules/head.py#L1713-L1749">View on GitHub</a>
```python
@staticmethod
def _generate_anchors(
    shapes: list[list[int]],
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/modules/head.py#L1777-L1834">View on GitHub</a>
```python
def _get_decoder_input(
    self,
    feats: torch.Tensor,
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/modules/head.py#L1751-L1775">View on GitHub</a>
```python
def _get_encoder_input(self, x: list[torch.Tensor]) -> tuple[torch.Tensor, list[list[int]]]:
    """Process and return encoder inputs by getting projection features from input and concatenating them.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/modules/head.py#L1836-L1858">View on GitHub</a>
```python
def _reset_parameters(self):
    """Initialize or reset the parameters of the model's various components with predefined weights and biases."""
...
| Type | Description |
| --- | --- |
| `outputs (tuple \| torch.Tensor)` | During training, returns a tuple of bounding boxes, scores, and other metadata. During inference, returns a tensor of shape (bs, num_queries, 6) containing bounding boxes, confidence scores, and class labels. |

<details>
<summary>Source code in <code>ultralytics/nn/modules/head.py</code></summary>

<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/modules/head.py#L1642-L1692">View on GitHub</a>
```python
def forward(self, x: list[torch.Tensor], batch: dict | None = None) -> tuple | torch.Tensor:
    """Run the forward pass of the module, returning bounding box and classification scores for the input.
...
### Method `ultralytics.nn.modules.head.RTDETRDecoder.postprocess` {#ultralytics.nn.modules.head.RTDETRDecoder.postprocess}
...
| Type | Description |
| --- | --- |
| `torch.Tensor` | Processed predictions with shape (batch_size, num_queries, 6), limited to max_det during export, and last dimension format [cx, cy, w, h, max_class_prob, class_index]. |

<details>
<summary>Source code in <code>ultralytics/nn/modules/head.py</code></summary>

<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/modules/head.py#L1694-L1710">View on GitHub</a>
```python
def postprocess(self, boxes: torch.Tensor, scores: torch.Tensor) -> torch.Tensor:
    """Post-process predictions to select top-k detections.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/modules/head.py#L1861-L1910">View on GitHub</a>
```python
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/modules/head.py#L1908-L1910">View on GitHub</a>
```python
def fuse(self):
    """Remove the one2many head for inference optimization."""
    self.cv2 = self.cv3 = None
...
## Class `ultralytics.nn.modules.head.SemanticSegment` {#ultralytics.nn.modules.head.SemanticSegment}

```python
SemanticSegment(nc=19, ch=())
```
...
| Name | Description |
| --- | --- |
| [`forward`](#ultralytics.nn.modules.head.SemanticSegment.forward) | Forward pass: fuse multi-scale features and predict per-pixel classes. |

<details>
<summary>Source code in <code>ultralytics/nn/modules/head.py</code></summary>

<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/modules/head.py#L1913-L1978">View on GitHub</a>
```python
...
### Method `ultralytics.nn.modules.head.SemanticSegment.forward` {#ultralytics.nn.modules.head.SemanticSegment.forward}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/modules/head.py#L1951-L1978">View on GitHub</a>
```python
def forward(self, x):
    """Forward pass: fuse multi-scale features and predict per-pixel classes.
