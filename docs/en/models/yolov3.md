...
## Supported Tasks, Modes and Available Models
...
| ------------------ | -------------------- | -------------------------------------- | --------- | ---------- | -------- | ------ |
| YOLOv3             | [yolov3-sppu.pt][1]  | [Object Detection](../tasks/detect.md) | ✅        | ✅         | ✅       | ✅     |
| YOLOv3-Ultralytics | [yolov3-tinyu.pt][2] | [Object Detection](../tasks/detect.md) | ✅        | ✅         | ✅       | ✅     |
| YOLOv3u            | [yolov3u.pt][3]      | [Object Detection](../tasks/detect.md) | ✅        | ✅         | ✅       | ✅     |
...
[3]: https://github.com/ultralytics/assets/releases/download/v8.2.0/yolov3u.pt
