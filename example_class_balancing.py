...
This script demonstrates how to use the new class balancing capabilities
including pos_weight for BCEWithLogitsLoss and WeightedRandomSampler for DataLoader.
"""
...
def analyze_class_distribution():
    ...
    try:
        ...
        dataset = build_yolo_dataset(cfg, "coco8/images/train", batch=4, data={'train': 'coco8/images/train'}, mode="train")
