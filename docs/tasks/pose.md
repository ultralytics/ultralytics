...
| [CoreML MLModel](https://github.com/apple/coremltools)             | `mlmodel`         | `yolov8n-pose.mlmodel`         | ✅        |
| [CoreML MLProgram](https://github.com/apple/coremltools)           | `mlprogram`       | `yolov8n-pose.mlpackage`       | ✅        |
