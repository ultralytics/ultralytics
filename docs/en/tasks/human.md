...
keywords: YOLOv8, Ultralytics, human detection, attribute estimation, age estimation, gender estimation, weight estimation, height estimation, race estimation
---
...
Human detection and attribute estimation is a task that involves identifying humans in an image or video stream and estimating their attributes, such as age, gender, weight, height, and race.
