...
| `data`     | `str`            | `'coco8.yaml'` | Path to the [dataset](../datasets/index.md) YAML, essential for quantization; classification instead takes a dataset directory or a built-in dataset name.                                                                                                              |
