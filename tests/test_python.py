...
def test_data_annotator():
    ...
    auto_annotate(ASSETS, det_model=WEIGHTS_DIR / 'yolov8n.pt', output_dir=TMP / 'auto_annotate_labels')
    auto_annotate(ASSETS, det_model=WEIGHTS_DIR / 'yolov8n-cls.pt', output_dir=TMP / 'auto_annotate_labels')
    auto_annotate(ASSETS, det_model=WEIGHTS_DIR / 'yolov8n-seg.pt', output_dir=TMP / 'auto_annotate_labels')
    auto_annotate(ASSETS, det_model=WEIGHTS_DIR / 'yolov8n-pose.pt', output_dir=TMP / 'auto_annotate_labels')
