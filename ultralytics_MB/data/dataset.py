...
from ultralytics_MB.utils import LOCAL_RANK, NUM_THREADS, TQDM, colorstr, is_dir_writeable
from ultralytics_MB.utils.ops import resample_segments
...
class YOLODataset(BaseDataset):
    ...
    def __init__(self, *args, data=None, task="detect",dual_stream=False, **kwargs):
    ...
    def build_transforms(self, hyp=None):
        ...
        if self.augment:
            ...
            transforms = v8_transforms(self, self.imgsz, hyp, dual_stream=self.dual_stream)
        else:
