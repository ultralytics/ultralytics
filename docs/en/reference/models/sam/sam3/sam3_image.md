...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/sam3/sam3_image.py#L30-L344">View on GitHub</a>
```python
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/sam3/sam3_image.py#L99-L128">View on GitHub</a>
```python
def _encode_prompt(
    self,
    img_feats,
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/sam3/sam3_image.py#L166-L207">View on GitHub</a>
```python
def _run_decoder(
    self,
    pos_embed,
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/sam3/sam3_image.py#L130-L164">View on GitHub</a>
```python
def _run_encoder(
    self,
    img_feats,
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/sam3/sam3_image.py#L259-L285">View on GitHub</a>
```python
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/sam3/sam3_image.py#L209-L257">View on GitHub</a>
```python
def _update_scores_and_boxes(
    self,
    out,
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/sam3/sam3_image.py#L287-L335">View on GitHub</a>
```python
def forward_grounding(
    self, backbone_out: dict[str, torch.Tensor], text_ids: torch.Tensor, geometric_prompt: Prompt = None
):
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/sam3/sam3_image.py#L337-L340">View on GitHub</a>
```python
def set_classes(self, text: list[str]):
    """Set the text embeddings for the given class names."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/sam3/sam3_image.py#L342-L344">View on GitHub</a>
```python
def set_imgsz(self, imgsz: tuple[int, int]):
    """Set the image size for the model."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/sam3/sam3_image.py#L19-L27">View on GitHub</a>
```python
def _update_out(out, out_name, out_value, auxiliary=True, update_aux=True):
    """Helper function to update output dictionary with main and auxiliary outputs."""
