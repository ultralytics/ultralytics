...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/amg.py#L14-L40">View on GitHub</a>
```python
def is_box_near_crop_edge(
    boxes: torch.Tensor, crop_box: list[int], orig_box: list[int], atol: float = 20.0
) -> torch.Tensor:
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/amg.py#L43-L68">View on GitHub</a>
```python
def batch_iterator(batch_size: int, *args) -> Generator[list[Any]]:
    """Yield batches of data from input arguments with specified batch size for efficient processing.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/amg.py#L71-L97">View on GitHub</a>
```python
def calculate_stability_score(masks: torch.Tensor, mask_threshold: float, threshold_offset: float) -> torch.Tensor:
    """Compute the stability score for a batch of masks.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/amg.py#L100-L106">View on GitHub</a>
```python
def build_point_grid(n_per_side: int) -> np.ndarray:
    """Generate a 2D grid of evenly spaced points in the range [0,1]x[0,1] for image segmentation tasks."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/amg.py#L109-L111">View on GitHub</a>
```python
def build_all_layer_point_grids(n_per_side: int, n_layers: int, scale_per_layer: int) -> list[np.ndarray]:
    """Generate point grids for multiple crop layers with varying scales and densities."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/amg.py#L114-L162">View on GitHub</a>
```python
def generate_crop_boxes(
    im_size: tuple[int, ...], n_layers: int, overlap_ratio: float
) -> tuple[list[list[int]], list[int]]:
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/amg.py#L165-L172">View on GitHub</a>
```python
def uncrop_boxes_xyxy(boxes: torch.Tensor, crop_box: list[int]) -> torch.Tensor:
    """Uncrop bounding boxes by adding the crop box offset to their coordinates."""
    x0, y0, _, _ = crop_box
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/amg.py#L175-L182">View on GitHub</a>
```python
def uncrop_points(points: torch.Tensor, crop_box: list[int]) -> torch.Tensor:
    """Uncrop points by adding the crop box offset to their coordinates."""
    x0, y0, _, _ = crop_box
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/amg.py#L185-L193">View on GitHub</a>
```python
def uncrop_masks(masks: torch.Tensor, crop_box: list[int], orig_h: int, orig_w: int) -> torch.Tensor:
    """Uncrop masks by padding them to the original image size, handling coordinate transformations."""
...
| `mode` | `str` | Processing mode, either 'holes' to fill small holes or 'islands' to remove small disconnected regions. | *required* |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/amg.py#L196-L230">View on GitHub</a>
```python
def remove_small_regions(mask: np.ndarray, area_thresh: float, mode: str) -> tuple[np.ndarray, bool]:
    """Remove small disconnected regions or holes in a mask based on area threshold and mode.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/amg.py#L233-L275">View on GitHub</a>
```python
def batched_mask_to_box(masks: torch.Tensor) -> torch.Tensor:
    """Calculate bounding boxes in XYXY format around binary masks.
