...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/utils/loss.py#L17-L390">View on GitHub</a>
```python
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/utils/loss.py#L273-L299">View on GitHub</a>
```python
def _get_assigned_bboxes(
    self, pred_bboxes: torch.Tensor, gt_bboxes: torch.Tensor, match_indices: list[tuple]
) -> tuple[torch.Tensor, torch.Tensor]:
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/utils/loss.py#L258-L271">View on GitHub</a>
```python
@staticmethod
def _get_index(match_indices: list[tuple]) -> tuple[tuple[torch.Tensor, torch.Tensor], torch.Tensor]:
    """Extract batch indices, source indices, and destination indices from match indices.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/utils/loss.py#L301-L349">View on GitHub</a>
```python
def _get_loss(
    self,
    pred_bboxes: torch.Tensor,
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/utils/loss.py#L186-L255">View on GitHub</a>
```python
def _get_loss_aux(
    self,
    pred_bboxes: torch.Tensor,
...
| Type | Description |
| --- | --- |
| `dict[str, torch.Tensor]` | Dictionary containing:<br>- loss_bbox{postfix}: L1 loss between predicted and ground truth boxes, scaled by the bbox loss gain.<br>- loss_giou{postfix}: GIoU loss between predicted and ground truth boxes, scaled by the giou loss gain. |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/utils/loss.py#L121-L153">View on GitHub</a>
```python
def _get_loss_bbox(
    self, pred_bboxes: torch.Tensor, gt_bboxes: torch.Tensor, postfix: str = ""
) -> dict[str, torch.Tensor]:
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/utils/loss.py#L80-L119">View on GitHub</a>
```python
def _get_loss_class(
    self, pred_scores: torch.Tensor, targets: torch.Tensor, gt_scores: torch.Tensor, num_gts: int, postfix: str = ""
) -> dict[str, torch.Tensor]:
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/utils/loss.py#L351-L390">View on GitHub</a>
```python
def forward(
    self,
    pred_bboxes: torch.Tensor,
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/utils/loss.py#L393-L466">View on GitHub</a>
```python
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/utils/loss.py#L400-L438">View on GitHub</a>
```python
def forward(
    self,
    preds: tuple[torch.Tensor, torch.Tensor],
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/utils/loss.py#L441-L466">View on GitHub</a>
```python
@staticmethod
def get_dn_match_indices(
    dn_pos_idx: list[torch.Tensor], dn_num_group: int, gt_groups: list[int]
