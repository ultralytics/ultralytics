...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/build_sam3.py#L26-L69">View on GitHub</a>
```python
def _create_vision_backbone(compile_mode=None, enable_inst_interactivity=True) -> Sam3DualViTDetNeck:
    """Create SAM3 visual backbone with ViT and neck."""
    # Position encoding
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/build_sam3.py#L72-L132">View on GitHub</a>
```python
def _create_sam3_transformer() -> TransformerWrapper:
    """Create SAM3 detector encoder and decoder."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/build_sam3.py#L135-L255">View on GitHub</a>
```python
def build_sam3_image_model(checkpoint_path: str, enable_segmentation: bool = True, compile: bool = False):
    """Build SAM3 image model.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/build_sam3.py#L258-L348">View on GitHub</a>
```python
def build_interactive_sam3(checkpoint_path: str, compile=None, with_backbone=True) -> SAM3Model:
    """Build the SAM3 Tracker module for video tracking.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/build_sam3.py#L351-L382">View on GitHub</a>
```python
def _load_checkpoint(model, checkpoint, interactive=False):
    """Load SAM3 model checkpoint from file."""
