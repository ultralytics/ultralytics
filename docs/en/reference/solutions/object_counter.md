...
!!! abstract "Summary"
    ...
    === "<span class="doc-kind doc-kind-class">Classes</span>"
        ...
        - [`ObjectCounter`](#ultralytics.solutions.object_counter.ObjectCounter)

    === "<span class="doc-kind doc-kind-method">Methods</span>"

        - [`ObjectCounter.count_objects`](#ultralytics.solutions.object_counter.ObjectCounter.count_objects)
        - [`ObjectCounter.forget_tracks`](#ultralytics.solutions.object_counter.ObjectCounter.forget_tracks)
        - [`ObjectCounter.display_counts`](#ultralytics.solutions.object_counter.ObjectCounter.display_counts)
        - [`ObjectCounter.process`](#ultralytics.solutions.object_counter.ObjectCounter.process)


## Class `ultralytics.solutions.object_counter.ObjectCounter` {#ultralytics.solutions.object\_counter.ObjectCounter}
...
| Name | Description |
| --- | --- |
| [`count_objects`](#ultralytics.solutions.object_counter.ObjectCounter.count_objects) | Count objects within a polygonal or linear region based on their tracks. |
| [`display_counts`](#ultralytics.solutions.object_counter.ObjectCounter.display_counts) | Display object counts on the input image or frame. |
| [`forget_tracks`](#ultralytics.solutions.object_counter.ObjectCounter.forget_tracks) | Drop retired IDs from `counted_ids` so it doesn't grow across a 24/7 stream (see BaseSolution). |
| [`process`](#ultralytics.solutions.object_counter.ObjectCounter.process) | Process input data (frames or object tracks) and update object counts. |
...
<details>
<summary>Source code in <code>ultralytics/solutions/object_counter.py</code></summary>

<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/solutions/object_counter.py#L12-L205">View on GitHub</a>
```python
...
### Method `ultralytics.solutions.object_counter.ObjectCounter.count_objects` {#ultralytics.solutions.object\_counter.ObjectCounter.count\_objects}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/solutions/object_counter.py#L54-L125">View on GitHub</a>
```python
def count_objects(
    self,
    current_centroid: tuple[float, float],
...
### Method `ultralytics.solutions.object_counter.ObjectCounter.display_counts` {#ultralytics.solutions.object\_counter.ObjectCounter.display\_counts}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/solutions/object_counter.py#L132-L150">View on GitHub</a>
```python
def display_counts(self, plot_im) -> None:
    """Display object counts on the input image or frame.
...
### Method `ultralytics.solutions.object_counter.ObjectCounter.forget_tracks` {#ultralytics.solutions.object\_counter.ObjectCounter.forget\_tracks}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/solutions/object_counter.py#L127-L130">View on GitHub</a>
```python
def forget_tracks(self, track_ids: list[int]) -> None:
    """Drop retired IDs from `counted_ids` so it doesn't grow across a 24/7 stream (see BaseSolution)."""
...
### Method `ultralytics.solutions.object_counter.ObjectCounter.process` {#ultralytics.solutions.object\_counter.ObjectCounter.process}
...
| Type | Description |
| --- | --- |
| `SolutionResults` | Contains processed image `plot_im`, 'in_count' (int, count of objects entering the region), 'out_count' (int, count of objects exiting the region), 'classwise_count' (dict, per-class object count), and 'total_tracks' (int, total number of tracked objects). |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/solutions/object_counter.py#L152-L205">View on GitHub</a>
```python
def process(self, im0) -> SolutionResults:
    """Process input data (frames or object tracks) and update object counts.
