...
class YOLO(Model):
    ...
    def __init__(self, model: str | Path = "yolo26n.pt", task: str | None = None, verbose: bool = False):
        ...
        if head in {"DeimDecoder", "DeimSegmentDecoder", "DeimLayerNormDecoder", "DFineDecoder"}:
            ...
            if head_name in {"DeimDecoder", "DeimSegmentDecoder", "DeimLayerNormDecoder", "DFineDecoder"}:
                from ultralytics import RTDETRDEIM
