---
comments: true
description: Log YOLO11 training to Comet ML. Automatically track metrics, images, confusion matrices, and model checkpoints with Ultralytics' built-in Comet integration.
