...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/solutions/config.py#L12-L116">View on GitHub</a>
```python
@dataclass
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/solutions/config.py#L102-L116">View on GitHub</a>
```python
def update(self, **kwargs: Any):
    """Update configuration parameters with new values provided as keyword arguments."""
