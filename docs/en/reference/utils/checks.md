...
!!! abstract "Summary"
    ...
    === "<span class="doc-kind doc-kind-function">Functions</span>"
        ...
        - [`normalize_platform_uri`](#ultralytics.utils.checks.normalize_platform_uri)
        - [`resolve_platform_uri`](#ultralytics.utils.checks.resolve_platform_uri)
...
## Function `ultralytics.utils.checks.normalize_platform_uri` {#ultralytics.utils.checks.normalize\_platform\_uri}
...
| --- | --- | --- | --- |
| `uri` | `str \| Path` | Resource identifier, e.g. an Ultralytics Platform web URL ending in "/user/datasets/slug". | *required* |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/checks.py#L64-L74">View on GitHub</a>
```python
def normalize_platform_uri(uri):
    """Rewrite an Ultralytics Platform web URL to its ul:// URI so it can be loaded directly as data or model.
...
## Function `ultralytics.utils.checks.resolve_platform_uri` {#ultralytics.utils.checks.resolve\_platform\_uri}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/checks.py#L77-L167">View on GitHub</a>
```python
def resolve_platform_uri(uri, hard=True):
    """Resolve ul:// URIs to signed URLs by authenticating with Ultralytics Platform.
...
| Type | Description |
| --- | --- |
| `requirements (list[SimpleNamespace])` | List of parsed requirements as SimpleNamespace objects with `name` and `specifier` attributes. |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/checks.py#L170-L198">View on GitHub</a>
```python
def parse_requirements(file_path=ROOT.parent / "requirements.txt", package=""):
    """Parse a requirements.txt file, ignoring lines that start with '#' and any text after '#'.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/checks.py#L201-L207">View on GitHub</a>
```python
def get_distribution_name(import_name: str) -> str:
    """Get the pip distribution name for a given import name (e.g., 'cv2' -> 'opencv-python-headless')."""
...
Not PEP 440: pre-release/dev/post/local suffixes are dropped, so '1.0rc1', '1.0.post1', and '1.0+cu118' all compare equal to '1.0'. Use the `packaging` library where exact pre-release ordering matters.

**Args**

| Name | Type | Description | Default |
| --- | --- | --- | --- |
| `version` | `str` | Version string, i.e. '2.0.1+cpu', '4.13.0.92', or 'v2.1' | `"0.0.0"` |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/checks.py#L211-L228">View on GitHub</a>
```python
@functools.lru_cache
def parse_version(version="0.0.0") -> tuple:
    """Convert a version string to a tuple of integers from its release segments, ignoring prefixes and suffixes.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/checks.py#L231-L240">View on GitHub</a>
```python
def is_ascii(s) -> bool:
    """Check if a string is composed of only ASCII characters.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/checks.py#L243-L299">View on GitHub</a>
```python
def check_imgsz(imgsz, stride=32, min_dim=1, max_dim=2, floor=0):
    """Verify image size is a multiple of the given stride in each dimension. If the image size is not a multiple of the
    stride, update it to the nearest multiple of the stride that is greater than or equal to the given floor value.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/checks.py#L303-L308">View on GitHub</a>
```python
@functools.lru_cache
def check_uv():
    """Check if uv package manager is installed and can run successfully."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/checks.py#L312-L400">View on GitHub</a>
```python
@functools.lru_cache
def check_version(
    current: str = "0.0.0",
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/checks.py#L403-L420">View on GitHub</a>
```python
def check_latest_pypi_version(package_name="ultralytics"):
    """Return the latest version of a PyPI package without downloading or installing it.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/checks.py#L423-L442">View on GitHub</a>
```python
def check_pip_update_available():
    """Check if a new version of the ultralytics package is available on PyPI.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/checks.py#L447-L473">View on GitHub</a>
```python
@ThreadingLocked()
@functools.lru_cache
def check_font(font="Arial.ttf"):
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/checks.py#L476-L487">View on GitHub</a>
```python
def check_python(minimum: str = "3.8.0", hard: bool = True, verbose: bool = False) -> bool:
    """Check current python version against the required minimum version.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/checks.py#L491-L527">View on GitHub</a>
```python
@TryExcept()
def check_apt_requirements(requirements):
    """Check if apt packages are installed and install missing ones.
...
| Name | Type | Description | Default |
| --- | --- | --- | --- |
| `requirements` | `Path \| str \| list[str\|tuple] \| tuple[str]` | Path to a requirements.txt file, a single package requirement as a string, a list of package requirements as strings, or a list containing strings and tuples of interchangeable packages. | `ROOT.parent / "requirements.txt"` |
...
| `constrain` | `tuple \| list` | Extra version constraints always appended to the install command even if already satisfied, preventing the resolver from upgrading those packages during install. | `()` |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/checks.py#L531-L648">View on GitHub</a>
```python
@TryExcept()
def check_requirements(requirements=ROOT.parent / "requirements.txt", exclude=(), install=True, cmds="", constrain=()):
    """Check if installed dependencies meet Ultralytics YOLO models requirements and attempt to auto-update if needed.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/checks.py#L651-L657">View on GitHub</a>
```python
def check_executorch_requirements():
    """Check and install ExecuTorch requirements including platform-specific dependencies."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/checks.py#L660-L668">View on GitHub</a>
```python
def check_tensorrt(min_version: str = "7.0.0"):
    """Check and install TensorRT requirements including platform-specific dependencies.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/checks.py#L671-L704">View on GitHub</a>
```python
def check_torchvision():
    """Check the installed versions of PyTorch and Torchvision to ensure they're compatible.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/checks.py#L707-L720">View on GitHub</a>
```python
def check_suffix(file="yolo26n.pt", suffix=".pt", msg=""):
    """Check file(s) for acceptable suffix.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/checks.py#L723-L747">View on GitHub</a>
```python
def check_yolov5u_filename(file: str, verbose: bool = True) -> str:
    """Replace legacy YOLOv5 filenames with updated YOLOv5u filenames.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/checks.py#L750-L762">View on GitHub</a>
```python
def check_model_file_from_stem(model: str = "yolo11n") -> str | Path:
    """Return a model filename from a valid model stem.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/checks.py#L765-L822">View on GitHub</a>
```python
def check_file(file, suffix="", download=True, download_dir=".", hard=True):
    """Search/download file (if necessary), check suffix (if provided), and return path.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/checks.py#L825-L836">View on GitHub</a>
```python
def check_yaml(file, suffix=(".yaml", ".yml"), hard=True):
    """Search/download YAML file (if necessary) and return path, checking suffix.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/checks.py#L839-L852">View on GitHub</a>
```python
def check_is_path_safe(basedir: Path | str, path: Path | str) -> bool:
    """Check if the resolved path is under the intended directory to prevent path traversal.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/checks.py#L856-L877">View on GitHub</a>
```python
@functools.lru_cache
def check_imshow(warn=False):
    """Check if environment supports image displays.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/checks.py#L880-L913">View on GitHub</a>
```python
def check_yolo(verbose=True, device=""):
    """Print a human-readable YOLO software and hardware summary.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/checks.py#L916-L973">View on GitHub</a>
```python
def collect_system_info():
    """Collect and print relevant system information including OS, Python, RAM, CPU, and CUDA.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/checks.py#L976-L1045">View on GitHub</a>
```python
def check_amp(model):
    """Check the PyTorch Automatic Mixed Precision (AMP) functionality of a YOLO model.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/checks.py#L1048-L1073">View on GitHub</a>
```python
def check_multiple_install():
    """Check if there are multiple Ultralytics installations."""
    import sys
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/checks.py#L1076-L1099">View on GitHub</a>
```python
def print_args(args: dict | None = None, show_file=True, show_func=False):
    """Print function arguments (optional args dict).
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/checks.py#L1102-L1124">View on GitHub</a>
```python
def cuda_device_count() -> int:
    """Get the number of NVIDIA GPUs available in the environment.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/checks.py#L1127-L1133">View on GitHub</a>
```python
def cuda_is_available() -> bool:
    """Check if CUDA is available in the environment.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/checks.py#L1136-L1152">View on GitHub</a>
```python
def is_rockchip():
    """Check if the current environment is running on a Rockchip SoC.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/checks.py#L1155-L1172">View on GitHub</a>
```python
def is_intel():
    """Check if the system has Intel hardware (CPU or GPU).
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/checks.py#L1175-L1187">View on GitHub</a>
```python
def is_sudo_available() -> bool:
    """Check if the sudo command is available in the environment.
