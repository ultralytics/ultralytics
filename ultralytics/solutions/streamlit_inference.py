...
class LiveInference(BaseSolution):
    ...
    def web_ui(self):
        ...
        st.set_page_config(page_title="Ultralytics Streamlit App",  # Set html page configuration
    ...
    def sidebar(self):
        with st.sidebar:        # Add Ultralytics LOGO
            logo = "https://raw.githubusercontent.com/ultralytics/assets/main/logo/Ultralytics_Logotype_Original.svg"
            st.image(logo, width=250)

        st.sidebar.title("User Configuration")  # Add elements to vertical setting menu
        self.source = st.sidebar.selectbox("Video", ("webcam", "video"),)  # Add source selection dropdown
        self.enable_trk = st.sidebar.radio("Enable Tracking", ("Yes", "No"))
        self.conf = float(st.sidebar.slider("Confidence Threshold", 0.0, 1.0, 0.25, 0.01))
        self.iou = float(st.sidebar.slider("IoU Threshold", 0.0, 1.0, 0.45, 0.01))

        col1, col2 = st.columns(2)
        self.org_frame = col1.empty()
        self.ann_frame = col2.empty()
        self.fps_display = st.sidebar.empty()  # Placeholder for FPS display
    ...
    def configure(self):
        ...
        self.selected_model = st.sidebar.selectbox("Model", available_models)
...
if __name__ == "__main__":
    LiveInference.inference(model="yolo11n.pt")
