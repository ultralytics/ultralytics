...
class SolutionConfig:
    ...
    Attributes:
        ...
        quantize (int | str | None): Inference precision, e.g. 16 (FP16). Only PyTorch and TorchScript models compute
            in it; other formats use their artifact's and runtime's precision, though at 16 the input is FP16-rounded
            on the client and Triton also returns its outputs as FP16. Replaces the deprecated half flag.
