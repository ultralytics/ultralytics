...
!!! tip "Performance Preview"
    ...
    === "Detection (COCO)"
        ...
        | -----   | --------------------- | --------------------      | -------------------- | ------------------------------- | ------------------------------------ | ------------------ | ----------------- |
        | YOLO26n | 640                   | 40.1                      | 40.9                 | 38.90 ± 0.7                     | 1.7 ± 0.0                            | 2.4                | 5.4               |
    ...
    === "Segmentation (COCO)"
        ...
        |-------------|-----------------------|---------------------------|----------------------------|--------------------------------|-------------------------------------|--------------------|-------------------|
        | YOLO26n-seg | 640                   | 38.0                      | 31.6                       | 53.27 ± 0.52                    | 2.00 ± 0.01                         | 2.66               | 8.62              |
        | YOLO26s-seg | 640                   | 46.3                      | 38.2                       | 118.38 ± 0.94                   | 3.52 ± 0.04                         | 10.15              | 32.18             |
        | YOLO26m-seg | 640                   | 51.5                      | 42.3                       | 328.18 ± 2.39                   | 7.49 ± 0.09                         | 22.72              | 113.43            |
        | YOLO26l-seg | 640                   | 53.1                      | 43.6                       | 386.96 ± 3.73                   | 8.43 ± 0.12                         | 27.11              | 131.68            |
        | YOLO26x-seg | 640                   | 55.4                      | 45.4                       | 787.02 ± 6.78                   | 18.44 ± 0.06                        | 60.90              | 295.34            |
    ...
    === "Pose (COCO)"
        ...
        |--------------|-----------------------|---------------------------|-------------------------|--------------------------------|-------------------------------------|--------------------|-------------------|
        | YOLO26n-pose | 640                   | 55.2                      | 82.4                    | 40.33 ± 0.46                    | 1.82 ± 0.01                         | 2.66               | 6.71              |
        | YOLO26s-pose | 640                   | 62.2                      | 86.9                    | 85.32 ± 0.88                     | 2.92 ± 0.03                         | 9.96               | 23.95             |
        | YOLO26m-pose | 640                   | 67.3                      | 89.4                    | 218.00 ± 1.47                    | 5.62 ± 0.07                         | 21.21              | 77.84             |
        | YOLO26l-pose | 640                   | 69.5                      | 90.5                    | 275.41 ± 2.35                    | 7.29 ± 0.09                         | 25.60              | 96.08             |
        | YOLO26x-pose | 640                   | 71.2                      | 91.4                    | 565.42 ± 2.95                    | 13.86±0.24                          | 57.56              | 215.73            |
    ...
    === "OBB (DOTAv1)"
        ...
        |-------------|-----------------------|-------------------------|--------------------------------|-------------------------------------|--------------------|-------------------|
        | YOLO26n-obb | 1024                  | 78.9                    | 97.71 ± 0.90                   | 2.96 ± 0.02                         | 2.45               | 14.0              |
        | YOLO26s-obb | 1024                  | 79.8                    | 218.03 ± 1.43                  | 5.64 ± 0.07                         | 9.76               | 55.1              |
        | YOLO26m-obb | 1024                  | 80.7                    | 579.19 ± 3.79                  | 12.22 ± 0.25                        | 21.21              | 183.3             |
        | YOLO26l-obb | 1024                  | 81.4                    | 735.62 ± 3.12                  | 16.52 ± 0.21                        | 25.61              | 230.0             |
        | YOLO26x-obb | 1024                  | 82.1                    | 1485.74 ± 11.50                | 34.68 ± 0.96                        | 57.56              | 516.5             |
