...
!!! abstract "Summary"
    ...
    === "<span class="doc-kind doc-kind-method">Methods</span>"
        ...
        - [`PoseValidator.gather_stats`](#ultralytics.models.yolo.pose.val.PoseValidator.gather_stats)
...
```python
PoseValidator(dataloader=None, save_dir=None, args=None, _callbacks: dict | None = None)
```
...
| `_callbacks` | `dict, optional` | Dictionary of callback functions to be executed during validation. | `None` |
...
| [`gather_stats`](#ultralytics.models.yolo.pose.val.PoseValidator.gather_stats) | Gather stats from all GPUs. |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/yolo/pose/val.py#L16-L257">View on GitHub</a>
```python
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/yolo/pose/val.py#L139-L160">View on GitHub</a>
```python
def _prepare_batch(self, si: int, batch: dict[str, Any]) -> dict[str, Any]:
    """Prepare a batch for processing by converting keypoints to float and scaling to original dimensions.
...
| Name | Type | Description | Default |
| --- | --- | --- | --- |
| `preds` | `dict[str, torch.Tensor]` | Dictionary containing prediction data with keys 'cls' for class predictions and 'keypoints' for keypoint predictions. | *required* |
| `batch` | `dict[str, Any]` | Dictionary containing ground truth data with keys 'cls' for class labels, 'bboxes' for bounding boxes, and 'keypoints' for keypoint annotations. | *required* |

**Returns**

| Type | Description |
| --- | --- |
| `dict[str, np.ndarray]` | Dictionary containing the correct prediction matrix including 'tp_p' for pose true positives across 10 IoU levels. |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/yolo/pose/val.py#L162-L190">View on GitHub</a>
```python
def _process_batch(self, preds: dict[str, torch.Tensor], batch: dict[str, Any]) -> dict[str, np.ndarray]:
    """Return correct prediction matrix by computing Intersection over Union (IoU) between detections and ground
    truth.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/yolo/pose/val.py#L253-L257">View on GitHub</a>
```python
def eval_json(self, stats: dict[str, Any]) -> dict[str, Any]:
    """Evaluate object detection model using COCO JSON format."""
...
### Method `ultralytics.models.yolo.pose.val.PoseValidator.gather_stats` {#ultralytics.models.yolo.pose.val.PoseValidator.gather\_stats}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/yolo/pose/val.py#L192-L195">View on GitHub</a>
```python
def gather_stats(self) -> None:
    """Gather stats from all GPUs."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/yolo/pose/val.py#L79-L93">View on GitHub</a>
```python
def get_desc(self) -> str:
    """Return description of evaluation metrics in string format."""
    return ("%22s" + "%11s" * 10) % (
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/yolo/pose/val.py#L95-L110">View on GitHub</a>
```python
def init_metrics(self, model: torch.nn.Module) -> None:
    """Initialize evaluation metrics for YOLO pose validation.
...
| Name | Type | Description | Default |
| --- | --- | --- | --- |
| `preds` | `torch.Tensor` | Raw prediction tensor from the YOLO pose model containing bounding boxes, confidence scores, class predictions, and keypoint data. | *required* |

**Returns**

| Type | Description |
| --- | --- |
| `list[dict[str, torch.Tensor]]` | List of processed prediction dictionaries, each containing:<br>- 'bboxes': Bounding box coordinates<br>- 'conf': Confidence scores<br>- 'cls': Class predictions<br>- 'keypoints': Reshaped keypoint coordinates with shape (-1, *self.kpt_shape) |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/yolo/pose/val.py#L112-L137">View on GitHub</a>
```python
def postprocess(self, preds: torch.Tensor) -> list[dict[str, torch.Tensor]]:
    """Postprocess YOLO predictions to extract and reshape keypoints for pose estimation.
...
| Name | Type | Description | Default |
| --- | --- | --- | --- |
| `predn` | `dict[str, torch.Tensor]` | Prediction dictionary containing 'bboxes', 'conf', 'cls', and 'keypoints' tensors. | *required* |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/yolo/pose/val.py#L220-L239">View on GitHub</a>
```python
def pred_to_json(self, predn: dict[str, torch.Tensor], pbatch: dict[str, Any]) -> None:
    """Convert YOLO predictions to COCO JSON format.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/yolo/pose/val.py#L73-L77">View on GitHub</a>
```python
def preprocess(self, batch: dict[str, Any]) -> dict[str, Any]:
    """Preprocess batch by converting keypoints data to float and moving it to the device."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/yolo/pose/val.py#L197-L218">View on GitHub</a>
```python
def save_one_txt(self, predn: dict[str, torch.Tensor], save_conf: bool, shape: tuple[int, int], file: Path) -> None:
    """Save YOLO pose detections to a text file in normalized coordinates.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/yolo/pose/val.py#L241-L251">View on GitHub</a>
```python
def scale_preds(self, predn: dict[str, torch.Tensor], pbatch: dict[str, Any]) -> dict[str, torch.Tensor]:
    """Scales predictions to the original image size."""
    return {
