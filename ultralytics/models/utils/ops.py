...
class HungarianMatcher(nn.Module):
    ...
    Attributes:
        cost_gain (dict): Dictionary of cost coefficients for 'class', 'bbox', 'giou', 'mask', and 'dice' components.
    ...
    def __init__(self, cost_gain=None, use_fl=True, with_mask=False, num_sample_points=12544, alpha=0.25, gamma=2.0):
        ...
        Args:
            cost_gain (dict, optional): Dictionary of cost coefficients for different matching cost components.
...
def get_cdn_group(
    ...
    Args:
        batch (dict): Batch dictionary containing 'gt_cls' (torch.Tensor with shape (num_gts,)), 'gt_bboxes'
            (torch.Tensor with shape (num_gts, 4)), and 'gt_groups' (List[int]) indicating number of ground
            truths per image.
    ...
    Returns:
        ...
        dn_meta (dict | None): Meta information dictionary containing denoising parameters.
