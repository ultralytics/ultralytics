...
!!! abstract "Summary"
    ...
    === "<span class="doc-kind doc-kind-class">Classes</span>"
        ...
        - [`SemanticMask`](#ultralytics.engine.results.SemanticMask)
        - [`DepthMap`](#ultralytics.engine.results.DepthMap)
    ...
    === "<span class="doc-kind doc-kind-method">Methods</span>"
        ...
        - [`SemanticMask.__len__`](#ultralytics.engine.results.SemanticMask.__len__)
        - [`DepthMap.__len__`](#ultralytics.engine.results.DepthMap.__len__)
...
```python
BaseTensor(data: torch.Tensor | np.ndarray, orig_shape: tuple[int, int])
```
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/results.py#L22-L172">View on GitHub</a>
```python
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/results.py#L61-L73">View on GitHub</a>
```python
@property
def shape(self) -> tuple[int, ...]:
    """Return the shape of the underlying data tensor.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/results.py#L156-L172">View on GitHub</a>
```python
def __getitem__(self, idx):
    """Return a new BaseTensor instance containing the specified indexed elements of the data tensor.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/results.py#L142-L154">View on GitHub</a>
```python
def __len__(self) -> int:
    """Return the length of the underlying data tensor.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/results.py#L75-L90">View on GitHub</a>
```python
def cpu(self):
    """Return a copy of the tensor stored in CPU memory.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/results.py#L108-L123">View on GitHub</a>
```python
def cuda(self):
    """Move the tensor to GPU memory.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/results.py#L92-L106">View on GitHub</a>
```python
def numpy(self):
    """Return a copy of this object with its data converted to a NumPy array.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/results.py#L125-L140">View on GitHub</a>
```python
def to(self, *args, **kwargs):
    """Return a copy of the tensor with the specified device and dtype.
...
## Class `ultralytics.engine.results.SemanticMask` {#ultralytics.engine.results.SemanticMask}

```python
SemanticMask(data: torch.Tensor | np.ndarray, orig_shape: tuple[int, int])
```
...
| Name | Description |
| --- | --- |
| [`__len__`](#ultralytics.engine.results.SemanticMask.__len__) | Return one semantic segmentation result per image. |

<details>
<summary>Source code in <code>ultralytics/engine/results.py</code></summary>

<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/results.py#L175-L180">View on GitHub</a>
```python
...
### Method `ultralytics.engine.results.SemanticMask.__len__` {#ultralytics.engine.results.SemanticMask.\_\_len\_\_}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/results.py#L178-L180">View on GitHub</a>
```python
def __len__(self) -> int:
    """Return one semantic segmentation result per image."""
    return 1
...
## Class `ultralytics.engine.results.DepthMap` {#ultralytics.engine.results.DepthMap}

```python
DepthMap(data: torch.Tensor | np.ndarray, orig_shape: tuple[int, int])
```
...
| Name | Description |
| --- | --- |
| [`__len__`](#ultralytics.engine.results.DepthMap.__len__) | Return one depth map per image. |

<details>
<summary>Source code in <code>ultralytics/engine/results.py</code></summary>

<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/results.py#L183-L188">View on GitHub</a>
```python
...
### Method `ultralytics.engine.results.DepthMap.__len__` {#ultralytics.engine.results.DepthMap.\_\_len\_\_}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/results.py#L186-L188">View on GitHub</a>
```python
def __len__(self) -> int:
    """Return one depth map per image."""
    return 1
...
This class provides comprehensive functionality for handling inference results from various Ultralytics models, including detection, instance segmentation, semantic segmentation, classification, pose estimation, and oriented bounding box detection. It supports visualization, data export, and various coordinate transformations.
...
| `semantic_mask` | `torch.Tensor \| None` | A 2D tensor of class IDs for semantic segmentation results. | `None` |
| `depth` | `torch.Tensor \| None` | A 2D float tensor of per-pixel depth values (H, W). | `None` |
...
| [`__len__`](#ultralytics.engine.results.Results.__len__) | Return the number of results in the Results object. |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/results.py#L191-L910">View on GitHub</a>
```python
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/results.py#L291-L305">View on GitHub</a>
```python
def __getitem__(self, idx):
    """Return a Results object for a specific index of inference results.
...
| Type | Description |
| --- | --- |
| `int` | The number of results, determined by the length of the first non-empty attribute in (boxes, masks, probs, keypoints, obb, semantic_mask, or depth). Empty Results objects return 0. |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/results.py#L307-L323">View on GitHub</a>
```python
def __len__(self) -> int:
    """Return the number of results in the Results object.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/results.py#L371-L396">View on GitHub</a>
```python
def _apply(self, fn: str, *args, **kwargs):
    """Apply a function to all non-empty attributes and return a new Results object with modified attributes.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/results.py#L398-L412">View on GitHub</a>
```python
def cpu(self):
    """Return a copy of the Results object with all its tensors moved to CPU memory.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/results.py#L432-L444">View on GitHub</a>
```python
def cuda(self):
    """Move all tensors in the Results object to GPU memory.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/results.py#L464-L474">View on GitHub</a>
```python
def new(self):
    """Create a new Results object with the same image, path, names, and speed attributes.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/results.py#L414-L430">View on GitHub</a>
```python
def numpy(self):
    """Convert all tensors in the Results object to numpy arrays.
...
| `img` | `np.ndarray \| torch.Tensor \| None` | Image to plot on. Tensor images must be contiguous HWC BGR uint8. If None, uses the original image. | `None` |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/results.py#L476-L620">View on GitHub</a>
```python
def plot(
    self,
    conf: bool = True,
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/results.py#L640-L669">View on GitHub</a>
```python
def save(self, filename: str | None = None, *args, **kwargs) -> str:
    """Save annotated inference results image to file.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/results.py#L774-L813">View on GitHub</a>
```python
def save_crop(self, save_dir: str | Path, file_name: str | Path = Path("im.jpg")):
    """Save cropped detection images to specified directory.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/results.py#L708-L772">View on GitHub</a>
```python
def save_txt(self, txt_file: str | Path, save_conf: bool = False) -> str:
    """Save detection results to a text file.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/results.py#L622-L638">View on GitHub</a>
```python
def show(self, *args, **kwargs):
    """Display the image with annotated inference results.
...
| Type | Description |
| --- | --- |
| `list[dict[str, Any]]` | A list of dictionaries, each containing summarized information for a single detection or classification result. The structure of each dictionary varies based on the task type (classification or detection) and available information (boxes, masks, keypoints). |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/results.py#L815-L910">View on GitHub</a>
```python
def summary(self, normalize: bool = False, decimals: int = 5) -> list[dict[str, Any]]:
    """Convert inference results to a summarized dictionary with optional normalization for box coordinates.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/results.py#L446-L462">View on GitHub</a>
```python
def to(self, *args, **kwargs):
    """Move all tensors in the Results object to the specified device and dtype.
...
| `keypoints` | `torch.Tensor \| None` | A tensor of shape (N, K, 3) containing keypoints, where K=17 for persons. | `None` |
| `semantic_mask` | `torch.Tensor \| None` | A tensor of shape (H, W) containing class IDs for semantic segmentation. | `None` |
| `depth` | `torch.Tensor \| None` | A tensor of shape (H, W) containing per-pixel depth values. | `None` |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/results.py#L325-L369">View on GitHub</a>
```python
def update(
    self,
    boxes: torch.Tensor | None = None,
...
| Type | Description |
| --- | --- |
| `str` | A formatted string containing a summary of the results. For detection tasks, it includes the number of detections per class. For classification tasks, it includes the top 5 class probabilities. |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/results.py#L671-L706">View on GitHub</a>
```python
def verbose(self) -> str:
    """Return a log string for each task in the results, detailing detection and classification outcomes.
...
```python
Boxes(boxes: torch.Tensor | np.ndarray, orig_shape: tuple[int, int])
```
...
| Name | Type | Description | Default |
| --- | --- | --- | --- |
| `boxes` | `torch.Tensor \| np.ndarray` | A tensor or numpy array with detection boxes of shape (num_boxes, 6) or (num_boxes, 7). Columns should contain [x1, y1, x2, y2, (optional) track_id, confidence, class]. | *required* |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/results.py#L913-L1101">View on GitHub</a>
```python
...
| Type | Description |
| --- | --- |
| `torch.Tensor \| np.ndarray` | A tensor or numpy array of shape (n, 4) containing bounding box coordinates in [x1, y1, x2, y2] format, where n is the number of boxes. |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/results.py#L970-L983">View on GitHub</a>
```python
@property
def xyxy(self) -> torch.Tensor | np.ndarray:
    """Return bounding boxes in [x1, y1, x2, y2] format.
...
| Type | Description |
| --- | --- |
| `torch.Tensor \| np.ndarray` | A 1D tensor or array containing confidence scores for each detection, with shape (N,) where N is the number of detections. |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/results.py#L986-L999">View on GitHub</a>
```python
@property
def conf(self) -> torch.Tensor | np.ndarray:
    """Return the confidence scores for each detection box.
...
| Type | Description |
| --- | --- |
| `torch.Tensor \| np.ndarray` | A tensor or numpy array containing the class IDs for each detection box. The shape is (N,), where N is the number of boxes. |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/results.py#L1002-L1015">View on GitHub</a>
```python
@property
def cls(self) -> torch.Tensor | np.ndarray:
    """Return the class ID tensor representing category predictions for each bounding box.
...
| Type | Description |
| --- | --- |
| `torch.Tensor \| np.ndarray \| None` | A tensor or array containing tracking IDs for each box if tracking is enabled, otherwise None. Shape is (N,) where N is the number of boxes. |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/results.py#L1018-L1039">View on GitHub</a>
```python
@property
def id(self) -> torch.Tensor | np.ndarray | None:
    """Return the tracking IDs for each detection box if available.
...
| Type | Description |
| --- | --- |
| `torch.Tensor \| np.ndarray` | Boxes in [x_center, y_center, width, height] format, where x_center, y_center are the coordinates of the center point of the bounding box, width, height are the dimensions of the bounding box and the shape of the returned tensor is (N, 4), where N is the number of boxes. |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/results.py#L1042-L1056">View on GitHub</a>
```python
@cached_property
def xywh(self) -> torch.Tensor | np.ndarray:
    """Convert bounding boxes from [x1, y1, x2, y2] format to [x, y, width, height] format.
...
| Type | Description |
| --- | --- |
| `torch.Tensor \| np.ndarray` | Normalized bounding box coordinates with shape (N, 4), where N is the number of boxes. Each row contains [x1, y1, x2, y2] values normalized to [0, 1]. |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/results.py#L1059-L1078">View on GitHub</a>
```python
@cached_property
def xyxyn(self) -> torch.Tensor | np.ndarray:
    """Return normalized bounding box coordinates relative to the original image size.
...
| Type | Description |
| --- | --- |
| `torch.Tensor \| np.ndarray` | Normalized bounding boxes with shape (N, 4), where N is the number of boxes. Each row contains [x_center, y_center, width, height] values normalized to [0, 1] based on the original image dimensions. |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/results.py#L1081-L1101">View on GitHub</a>
```python
@cached_property
def xywhn(self) -> torch.Tensor | np.ndarray:
    """Return normalized bounding boxes in [x, y, width, height] format.
...
```python
Masks(masks: torch.Tensor | np.ndarray, orig_shape: tuple[int, int])
```
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/results.py#L1104-L1185">View on GitHub</a>
```python
...
| Type | Description |
| --- | --- |
| `list[np.ndarray]` | A list of numpy arrays, where each array contains the normalized xy-coordinates of a single segmentation mask. Each array has shape (N, 2), where N is the number of points in the mask contour. |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/results.py#L1142-L1162">View on GitHub</a>
```python
@cached_property
def xyn(self) -> list[np.ndarray]:
    """Return normalized xy-coordinates of the segmentation masks.
...
| Type | Description |
| --- | --- |
| `list[np.ndarray]` | A list of numpy arrays, where each array contains the [x, y] pixel coordinates for a single segmentation mask. Each array has shape (N, 2), where N is the number of points in the segment. |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/results.py#L1165-L1185">View on GitHub</a>
```python
@cached_property
def xy(self) -> list[np.ndarray]:
    """Return the [x, y] pixel coordinates for each segment in the mask tensor.
...
```python
Keypoints(keypoints: torch.Tensor | np.ndarray, orig_shape: tuple[int, int])
```
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/results.py#L1188-L1290">View on GitHub</a>
```python
...
| Type | Description |
| --- | --- |
| `torch.Tensor \| np.ndarray` | A tensor or array containing the x, y coordinates of keypoints with shape (N, K, 2), where N is the number of detections and K is the number of keypoints per detection. |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/results.py#L1236-L1254">View on GitHub</a>
```python
@cached_property
def xy(self) -> torch.Tensor | np.ndarray:
    """Return x, y coordinates of keypoints.
...
| Type | Description |
| --- | --- |
| `torch.Tensor \| np.ndarray` | A tensor or array of shape (N, K, 2) containing normalized keypoint coordinates, where N is the number of instances, K is the number of keypoints, and the last dimension contains [x, y] values in the range [0, 1]. |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/results.py#L1257-L1274">View on GitHub</a>
```python
@cached_property
def xyn(self) -> torch.Tensor | np.ndarray:
    """Return normalized coordinates (x, y) of keypoints relative to the original image size.
...
| Type | Description |
| --- | --- |
| `torch.Tensor \| np.ndarray \| None` | A tensor or array containing confidence scores for each keypoint if available, otherwise None. Shape is (num_detections, num_keypoints) for batched data or (num_keypoints,) for single detection. |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/results.py#L1277-L1290">View on GitHub</a>
```python
@cached_property
def conf(self) -> torch.Tensor | np.ndarray | None:
    """Return confidence values for each keypoint.
...
```python
Probs(probs: torch.Tensor | np.ndarray, orig_shape: tuple[int, int] | None = None)
```
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/results.py#L1293-L1403">View on GitHub</a>
```python
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/results.py#L1340-L1351">View on GitHub</a>
```python
@cached_property
def top1(self) -> int:
    """Return the index of the class with the highest probability.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/results.py#L1354-L1365">View on GitHub</a>
```python
@cached_property
def top5(self) -> list[int]:
    """Return the indices of the top 5 class probabilities.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/results.py#L1368-L1383">View on GitHub</a>
```python
@cached_property
def top1conf(self) -> torch.Tensor | np.ndarray:
    """Return the confidence score of the highest probability class.
...
| Type | Description |
| --- | --- |
| `torch.Tensor \| np.ndarray` | A tensor or array containing the confidence scores for the top 5 predicted classes, sorted in descending order of probability. |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/results.py#L1386-L1403">View on GitHub</a>
```python
@cached_property
def top5conf(self) -> torch.Tensor | np.ndarray:
    """Return confidence scores for the top 5 classification predictions.
...
```python
OBB(boxes: torch.Tensor | np.ndarray, orig_shape: tuple[int, int])
```
...
| Name | Type | Description | Default |
| --- | --- | --- | --- |
| `boxes` | `torch.Tensor \| np.ndarray` | A tensor or numpy array containing the detection boxes, with shape (num_boxes, 7) or (num_boxes, 8). The last two columns contain confidence and class values. If present, the third last column contains track IDs, and the fifth column contains rotation. | *required* |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/results.py#L1406-L1608">View on GitHub</a>
```python
...
| Type | Description |
| --- | --- |
| `torch.Tensor \| np.ndarray` | A tensor or numpy array containing the oriented bounding boxes with format [x_center, y_center, width, height, rotation]. The shape is (N, 5) where N is the number of boxes. |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/results.py#L1462-L1481">View on GitHub</a>
```python
@property
def xywhr(self) -> torch.Tensor | np.ndarray:
    """Return boxes in [x_center, y_center, width, height, rotation] format.
...
| Type | Description |
| --- | --- |
| `torch.Tensor \| np.ndarray` | A tensor or numpy array of shape (N,) containing confidence scores for N detections, where each score is in the range [0, 1]. |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/results.py#L1484-L1500">View on GitHub</a>
```python
@property
def conf(self) -> torch.Tensor | np.ndarray:
    """Return the confidence scores for Oriented Bounding Boxes (OBBs).
...
| Type | Description |
| --- | --- |
| `torch.Tensor \| np.ndarray` | A tensor or numpy array containing the class values for each oriented bounding box. The shape is (N,), where N is the number of boxes. |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/results.py#L1503-L1517">View on GitHub</a>
```python
@property
def cls(self) -> torch.Tensor | np.ndarray:
    """Return the class values of the oriented bounding boxes.
...
| Type | Description |
| --- | --- |
| `torch.Tensor \| np.ndarray \| None` | A tensor or numpy array containing the tracking IDs for each oriented bounding box. Returns None if tracking IDs are not available. |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/results.py#L1520-L1535">View on GitHub</a>
```python
@property
def id(self) -> torch.Tensor | np.ndarray | None:
    """Return the tracking IDs of the oriented bounding boxes (if available).
...
| Type | Description |
| --- | --- |
| `torch.Tensor \| np.ndarray` | Rotated bounding boxes in xyxyxyxy format with shape (N, 4, 2), where N is the number of boxes. The 4 points (x, y) are wound counter-clockwise as rendered, starting from the corner at +w/2, +h/2 in the box frame, so which image corner comes first follows the rotation. |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/results.py#L1538-L1552">View on GitHub</a>
```python
@cached_property
def xyxyxyxy(self) -> torch.Tensor | np.ndarray:
    """Convert OBB format to 8-point (xyxyxyxy) coordinate format for rotated bounding boxes.
...
| Type | Description |
| --- | --- |
| `torch.Tensor \| np.ndarray` | Normalized rotated bounding boxes in xyxyxyxy format with shape (N, 4, 2), where N is the number of boxes. Each box is represented by 4 points (x, y), normalized relative to the original image dimensions. |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/results.py#L1555-L1572">View on GitHub</a>
```python
@cached_property
def xyxyxyxyn(self) -> torch.Tensor | np.ndarray:
    """Convert rotated bounding boxes to normalized xyxyxyxy format.
...
| Type | Description |
| --- | --- |
| `torch.Tensor \| np.ndarray` | Axis-aligned bounding boxes in xyxy format with shape (N, 4), where N is the number of boxes. Each row contains [x1, y1, x2, y2] coordinates. |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/results.py#L1575-L1608">View on GitHub</a>
```python
@cached_property
def xyxy(self) -> torch.Tensor | np.ndarray:
    """Convert oriented bounding boxes (OBB) to axis-aligned bounding boxes in xyxy format.
