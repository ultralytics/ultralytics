...
from ultralytics.nn.tasks import SegmentationModel, ClassificationModel, attempt_load_one_weight
...
class DecathlonTrainer(BaseTrainer):
    ...
    def get_model(self, cfg=None, weights=None, verbose=True):
        ...
        number_classes = 1
        model = SegmentationModel(cfg, ch=3, nc=number_classes, verbose=verbose and RANK == -1) # arbitrarily take a model with 22 layers
    ...
    def validate(self):
        ...
        for i,t in enumerate(self.trainers):
            ...
            prefix = DecathlonTrainer.get_training_program()[i]['task']+"_"+DecathlonTrainer.get_training_program()[i]['data']
