...
class QueueManager(BaseSolution):
    ...
    def process_queue(self, im0):
        ...
        Returns:
            results (dict): Contains processed image `im0`, 'queue_count' (int, number of objects in the queue) and 'total_tracks' (int, total number of tracked objects).
        ...
        return SolutionResults(
            plot_im=plot_im, queue_count=self.counts, total_tracks=len(self.track_ids), verbose=self.verbose
        )
