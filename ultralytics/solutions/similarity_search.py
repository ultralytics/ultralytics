...
class VisualAISearch:
    """A semantic image search system that leverages OpenAI's CLIP for generating high-quality image and text
    embeddings and FAISS for fast similarity-based retrieval.
