...
HELP_MSG = """
    ...
    1. Install the ultralytics_MB package:
    ...
    2. Use the Python SDK:
        ...
        results = model("https://ultralytics_MB.com/images/bus.jpg")  # predict on an image
...
class IterableSimpleNamespace(SimpleNamespace):
    ...
    def __getattr__(self, attr):
        ...
        raise AttributeError(
            f"""
            '{name}' object has no attribute '{attr}'. This may be caused by a modified or out of date ultralytics_MB
            'default.yaml' file.\nPlease update your code with 'pip install -U ultralytics_MB' and if necessary replace
...
class ThreadingLocked:
    ...
    Example:
        ```python
        from ultralytics_MB.utils import ThreadingLocked
...
class SettingsManager(dict):
    ...
    def __init__(self, file=SETTINGS_YAML, version="0.0.4"):
        ...
        from ultralytics_MB.utils.checks import check_version
        from ultralytics_MB.utils.torch_utils import torch_distributed_zero_first
        ...
        self.help_msg = (
            ...
            "For help see https://docs.ultralytics_MB.com/quickstart/#ultralytics-settings."
        )
        ...
        with torch_distributed_zero_first(RANK):
            ...
            if not (correct_keys and correct_types and correct_version):
                LOGGER.warning(
                    ...
                    "with your settings or a recent ultralytics_MB package update. "
                    f"\nView settings with 'yolo settings' or at '{self.file}'"
                    "\nUpdate settings with 'yolo settings key=value', i.e. 'yolo settings runs_dir=path/to/dir'."
                )
                self.reset()
...
def deprecation_warn(arg, new_arg):
    ...
    LOGGER.warning(
        f"WARNING ⚠️ '{arg}' is deprecated and will be removed in 'ultralytics_MB {version}' in the future. "
...
from ultralytics_MB.utils.patches import imread, imshow, imwrite, torch_load, torch_save
