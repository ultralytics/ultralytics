...
!!! abstract "Summary"
    ...
    === "<span class="doc-kind doc-kind-function">Functions</span>"
        ...
        - [`torch2litert`](#ultralytics.utils.export.litert.torch2litert)


## Function `ultralytics.utils.export.litert.torch2litert` {#ultralytics.utils.export.litert.torch2litert}
...
<details>
<summary>Source code in <code>ultralytics/utils/export/litert.py</code></summary>

<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/export/litert.py#L15-L106">View on GitHub</a>
```python
def torch2litert(
    model: torch.nn.Module,
    im: torch.Tensor,
