...
| **[YOLO27](yolo27.md)**         | Detect                                                | Train, Val, Predict, Export | Query-based detection in the large and extra-large configs, with a YOLO26 CSP or UltraViT backbone and a DeimDecoder head, predicting boxes without NMS                                          |
