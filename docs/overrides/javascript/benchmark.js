        ...
        options: {
          ...
          scales: {
            x: {
              type: "linear",
              title: {
                display: true, text: "Latency T4 TensorRT10 FP16 (ms/img)", color: fg,
              },
              grid: { color: grid }, ticks: { color: fg }, min: 0, max: 18,
            },
            y: {
              title: { display: true, text: "COCO mAP 50-95", color: fg }, grid: { color: grid },
              ticks: { color: fg }, min: 36, max: 56,
            },
          },
        },
      },
