...
from ultralytics_4bands.utils import emojis
...
class HUBModelError(Exception):
    ...
    Note:
        The message is automatically processed through the 'emojis' function from the 'ultralytics_4bands.utils' package.
    """
