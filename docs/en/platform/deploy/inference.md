...
Both accept the same `multipart/form-data` body and return the same response shape. With the Python SDK, call
`client.models.predict(owner, project, model, body={"file": open("image.jpg", "rb"), "conf": 0.25})` for shared
