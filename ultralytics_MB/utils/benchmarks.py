...
Usage:
    from ultralytics_MB.utils.benchmarks import ProfileModels, benchmark
...
from ultralytics_MB.cfg import TASK2DATA, TASK2METRIC
from ultralytics_MB.engine.exporter import export_formats
from ultralytics_MB.utils import ASSETS, LINUX, LOGGER, MACOS, TQDM, WEIGHTS_DIR
from ultralytics_MB.utils.checks import check_requirements, check_yolo
from ultralytics_MB.utils.files import file_size
...
def benchmark(
    ...
    Example:
        ```python
        from ultralytics_MB.utils.benchmarks import benchmark
