...
```python
ClassificationPredictor(cfg=DEFAULT_CFG, overrides=None, _callbacks: dict | None = None)
```
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/yolo/classify/predict.py#L15-L90">View on GitHub</a>
```python
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/yolo/classify/predict.py#L72-L90">View on GitHub</a>
```python
def postprocess(self, preds, img, orig_imgs):
    """Process predictions to return Results objects with classification probabilities.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/yolo/classify/predict.py#L62-L70">View on GitHub</a>
```python
def preprocess(self, img):
    """Convert input images to model-compatible tensor format with appropriate normalization."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/yolo/classify/predict.py#L53-L60">View on GitHub</a>
```python
def setup_source(self, source):
    """Set up source and inference mode and classify transforms."""
