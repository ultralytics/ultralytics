...
from ultralytics.utils.checks import REMOTE_MODEL_PREFIXES, check_file, check_requirements, check_suffix, check_yaml
...
def load_checkpoint(weight, device=None, inplace=True, fuse=False):
    ...
    """
    if str(weight).lower().startswith(REMOTE_MODEL_PREFIXES):
