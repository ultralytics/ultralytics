...
def handle_yolo_convert(args: list[str]) -> None:
    ...
    This function processes YOLO convert CLI commands to convert datasets from NDJSON (Newline Delimited JSON)
    format to the standard YOLO dataset structure. It supports both local files and remote URLs.
