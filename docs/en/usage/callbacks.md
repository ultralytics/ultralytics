...
| `on_train_batch_end`        | Triggered at the end of each training batch, after the backward pass and optimizer step.                                                                                             |
...
| `on_fit_epoch_end`          | Triggered at the end of each fit epoch (train + val), **after** validation, model saving, and scheduler updates. Validation metrics and fitness are available. Also called during final evaluation of the best model. |
