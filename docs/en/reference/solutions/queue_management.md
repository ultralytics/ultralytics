...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/solutions/queue_management.py#L9-L93">View on GitHub</a>
```python
...
| Type | Description |
| --- | --- |
| `SolutionResults` | Contains processed image `plot_im`, 'queue_count' (int, number of objects in the queue) and 'total_tracks' (int, total number of tracked objects). |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/solutions/queue_management.py#L47-L93">View on GitHub</a>
```python
def process(self, im0) -> SolutionResults:
    """Process queue management for a single frame of video.
