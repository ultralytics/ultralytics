...
- [ExecuTorch](executorch.md) 🚀 NEW: Developed by [Meta](https://about.meta.com/), ExecuTorch is PyTorch's unified solution for deploying Ultralytics YOLO11 models on edge devices.
