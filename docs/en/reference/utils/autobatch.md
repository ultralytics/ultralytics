...
| `dataset_size` | `int, optional` | Total number of training images. If > 0, batch size will not exceed this value. | `0` |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/autobatch.py#L15-L47">View on GitHub</a>
```python
def check_train_batch_size(
    model: torch.nn.Module,
    imgsz: int = 640,
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/autobatch.py#L50-L131">View on GitHub</a>
```python
def autobatch(
    model: torch.nn.Module,
    imgsz: int = 640,
