...
!!! abstract "Summary"
    ...
    === "<span class="doc-kind doc-kind-class">Classes</span>"
        ...
        - [`Prompt`](#ultralytics.models.sam.sam3.geometry_encoders.Prompt)
        - [`SequenceGeometryEncoder`](#ultralytics.models.sam.sam3.geometry_encoders.SequenceGeometryEncoder)

    === "<span class="doc-kind doc-kind-method">Methods</span>"

        - [`Prompt.append_boxes`](#ultralytics.models.sam.sam3.geometry_encoders.Prompt.append_boxes)
        - [`SequenceGeometryEncoder._encode_points`](#ultralytics.models.sam.sam3.geometry_encoders.SequenceGeometryEncoder._encode_points)
        - [`SequenceGeometryEncoder._encode_boxes`](#ultralytics.models.sam.sam3.geometry_encoders.SequenceGeometryEncoder._encode_boxes)
        - [`SequenceGeometryEncoder.forward`](#ultralytics.models.sam.sam3.geometry_encoders.SequenceGeometryEncoder.forward)

    === "<span class="doc-kind doc-kind-function">Functions</span>"

        - [`is_right_padded`](#ultralytics.models.sam.sam3.geometry_encoders.is_right_padded)
        - [`concat_padded_sequences`](#ultralytics.models.sam.sam3.geometry_encoders.concat_padded_sequences)


## Class `ultralytics.models.sam.sam3.geometry_encoders.Prompt` {#ultralytics.models.sam.sam3.geometry\_encoders.Prompt}

```python
Prompt(box_embeddings=None, box_mask=None, box_labels=None)
```
...
| Name | Description |
| --- | --- |
| [`append_boxes`](#ultralytics.models.sam.sam3.geometry_encoders.Prompt.append_boxes) | Append box prompts to existing prompts. |

<details>
<summary>Source code in <code>ultralytics/models/sam/sam3/geometry_encoders.py</code></summary>

<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/sam3/geometry_encoders.py#L74-L175">View on GitHub</a>
```python
class Prompt:
    """Utility class to manipulate geometric prompts.
...
### Method `ultralytics.models.sam.sam3.geometry_encoders.Prompt.append_boxes` {#ultralytics.models.sam.sam3.geometry\_encoders.Prompt.append\_boxes}
...
| --- | --- | --- | --- |
| `boxes` | `torch.Tensor` | Tensor of shape (N_new_boxes, B, 4) with normalized box coordinates. | *required* |
| `labels` | `torch.Tensor \| None` | Optional tensor of shape (N_new_boxes, B) with positive/negative labels. | `None` |
| `mask` | `torch.Tensor \| None` | Optional tensor of shape (B, N_new_boxes) for attention mask. | `None` |

<details>
<summary>Source code in <code>ultralytics/models/sam/sam3/geometry_encoders.py</code></summary>

<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/sam3/geometry_encoders.py#L134-L175">View on GitHub</a>
```python
def append_boxes(self, boxes, labels=None, mask=None):
    """Append box prompts to existing prompts.
...
## Class `ultralytics.models.sam.sam3.geometry_encoders.SequenceGeometryEncoder` {#ultralytics.models.sam.sam3.geometry\_encoders.SequenceGeometryEncoder}
...
| Name | Description |
| --- | --- |
| [`_encode_boxes`](#ultralytics.models.sam.sam3.geometry_encoders.SequenceGeometryEncoder._encode_boxes) | Encode boxes using configured encoding methods. |
| [`_encode_points`](#ultralytics.models.sam.sam3.geometry_encoders.SequenceGeometryEncoder._encode_points) | Encode points (used when boxes are converted to corner points). |
| [`forward`](#ultralytics.models.sam.sam3.geometry_encoders.SequenceGeometryEncoder.forward) | Encode geometric box prompts. |

<details>
<summary>Source code in <code>ultralytics/models/sam/sam3/geometry_encoders.py</code></summary>

<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/sam3/geometry_encoders.py#L178-L417">View on GitHub</a>
```python
...
### Method `ultralytics.models.sam.sam3.geometry_encoders.SequenceGeometryEncoder._encode_boxes` {#ultralytics.models.sam.sam3.geometry\_encoders.SequenceGeometryEncoder.\_encode\_boxes}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/sam3/geometry_encoders.py#L275-L326">View on GitHub</a>
```python
def _encode_boxes(self, boxes, boxes_mask, boxes_labels, img_feats: torch.Tensor):
    """Encode boxes using configured encoding methods."""
    boxes_embed = None
...
### Method `ultralytics.models.sam.sam3.geometry_encoders.SequenceGeometryEncoder._encode_points` {#ultralytics.models.sam.sam3.geometry\_encoders.SequenceGeometryEncoder.\_encode\_points}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/sam3/geometry_encoders.py#L266-L273">View on GitHub</a>
```python
def _encode_points(self, points, points_mask, points_labels, img_feats):
    """Encode points (used when boxes are converted to corner points)."""
...
### Method `ultralytics.models.sam.sam3.geometry_encoders.SequenceGeometryEncoder.forward` {#ultralytics.models.sam.sam3.geometry\_encoders.SequenceGeometryEncoder.forward}
...
| `img_feats` | `list[torch.Tensor]` | List of image features from backbone. | *required* |
| `img_sizes` | `list[tuple[int, int]]` | List of (H, W) tuples for each feature level. | *required* |
| `img_pos_embeds` | `list[torch.Tensor] \| None` | Optional position embeddings for image features. | `None` |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/sam3/geometry_encoders.py#L328-L417">View on GitHub</a>
```python
def forward(self, geo_prompt: Prompt, img_feats, img_sizes, img_pos_embeds=None):
    """Encode geometric box prompts.
...
## Function `ultralytics.models.sam.sam3.geometry_encoders.is_right_padded` {#ultralytics.models.sam.sam3.geometry\_encoders.is\_right\_padded}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/sam3/geometry_encoders.py#L12-L16">View on GitHub</a>
```python
def is_right_padded(mask: torch.Tensor):
    """Given a padding mask (following pytorch convention, 1s for padded values), returns whether the padding is on the
    right or not.
...
## Function `ultralytics.models.sam.sam3.geometry_encoders.concat_padded_sequences` {#ultralytics.models.sam.sam3.geometry\_encoders.concat\_padded\_sequences}
...
| Name | Type | Description | Default |
| --- | --- | --- | --- |
| `seq1` | `torch.Tensor` | A tensor of shape (seq1_length, batch_size, hidden_size). | *required* |
| `mask1` | `torch.Tensor` | A tensor of shape (batch_size, seq1_length). | *required* |
| `seq2` | `torch.Tensor` | A tensor of shape (seq2_length, batch_size, hidden_size). | *required* |
| `mask2` | `torch.Tensor` | A tensor of shape (batch_size, seq2_length). | *required* |
| `return_index` | `bool` | If True, also return the index of the ids of the elements of seq2 in the concatenated sequence, which can be used to retrieve the elements of seq2. | `False` |

**Returns**

| Type | Description |
| --- | --- |
| `tuple` | (concatenated_sequence, concatenated_mask) if return_index is False, otherwise (concatenated_sequence, concatenated_mask, index). |

<details>
<summary>Source code in <code>ultralytics/models/sam/sam3/geometry_encoders.py</code></summary>

<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/sam3/geometry_encoders.py#L19-L71">View on GitHub</a>
```python
def concat_padded_sequences(seq1, mask1, seq2, mask2, return_index: bool = False):
    """Concatenate two right-padded sequences into a contiguous, right-padded sequence.
