...
class LoadDetections:
    ...
    Wraps all dataloaders, adding the ability to load saved detections for tracking.
    __next__() returns list of Results, in addition to expected paths, imgs, info
    ...
    Attributes:
        ...
        data_loader (LoadTensor | LoadStreams | LoadScreenshots | LoadImagesAndVideos | LoadPilAndNumpy): Initialized Data loader
