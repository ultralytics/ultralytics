...
!!! abstract "Summary"
    ...
    === "<span class="doc-kind doc-kind-function">Functions</span>"
        ...
        - [`check_train_batch_size`](#ultralytics.utils.autobatch.check_train_batch_size)
        - [`autobatch`](#ultralytics.utils.autobatch.autobatch)


## Function `ultralytics.utils.autobatch.check_train_batch_size` {#ultralytics.utils.autobatch.check\_train\_batch\_size}
...
| --- | --- | --- | --- |
| `model` | `torch.nn.Module` | YOLO model to check batch size for. | *required* |
| `imgsz` | `int, optional` | Image size used for training. | `640` |
| `amp` | `bool, optional` | Use automatic mixed precision if True. | `True` |
| `batch` | `int | float, optional` | Fraction of GPU memory to use. If -1, use default. | `-1` |
| `max_num_obj` | `int, optional` | The maximum number of objects from dataset. | `1` |
...
<details>
<summary>Source code in <code>ultralytics/utils/autobatch.py</code></summary>

<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/autobatch.py#L16-L42"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def check_train_batch_size(
    model: torch.nn.Module,
    imgsz: int = 640,
...
## Function `ultralytics.utils.autobatch.autobatch` {#ultralytics.utils.autobatch.autobatch}
...
| Name | Type | Description | Default |
| --- | --- | --- | --- |
| `model` | `torch.nn.Module` | YOLO model to compute batch size for. | *required* |
| `imgsz` | `int, optional` | The image size used as input for the YOLO model. | `640` |
| `fraction` | `float, optional` | The fraction of available CUDA memory to use. | `0.60` |
| `batch_size` | `int, optional` | The default batch size to use if an error is detected. | `DEFAULT_CFG.batch` |
| `max_num_obj` | `int, optional` | The maximum number of objects from dataset. | `1` |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/autobatch.py#L45-L119"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def autobatch(
    model: torch.nn.Module,
    imgsz: int = 640,
