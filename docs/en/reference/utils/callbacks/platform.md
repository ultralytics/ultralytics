...
!!! abstract "Summary"
    ...
    === "<span class="doc-kind doc-kind-function">Functions</span>"
        ...
        - [`_validation_payload`](#ultralytics.utils.callbacks.platform._validation_payload)
        - [`_sanitize_json_value`](#ultralytics.utils.callbacks.platform._sanitize_json_value)
        - [`_send`](#ultralytics.utils.callbacks.platform._send)
        - [`_handle_control_response`](#ultralytics.utils.callbacks.platform._handle_control_response)
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/callbacks/platform.py#L31-L35">View on GitHub</a>
```python
def slugify(text):
    """Convert text to URL-safe slug (e.g., 'My Project 1' -> 'my-project-1')."""
    if not text:
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/callbacks/platform.py#L38-L63">View on GitHub</a>
```python
def _interp_plot(plot, n=101):
    """Interpolate plot curve data to n points to reduce storage size."""
    import numpy as np
...
## Function `ultralytics.utils.callbacks.platform._validation_payload` {#ultralytics.utils.callbacks.platform.\_validation\_payload}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/callbacks/platform.py#L66-L82">View on GitHub</a>
```python
def _validation_payload(image_metrics, sample_limit=5_000, extremes_limit=100):
    """Return exact F1 extremes and an evenly ranked sample for correlation analysis."""
...
## Function `ultralytics.utils.callbacks.platform._sanitize_json_value` {#ultralytics.utils.callbacks.platform.\_sanitize\_json\_value}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/callbacks/platform.py#L85-L93">View on GitHub</a>
```python
def _sanitize_json_value(value):
    """Replace non-finite floats in payloads with None so requests JSON encoding succeeds."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/callbacks/platform.py#L96-L138">View on GitHub</a>
```python
def _send(event, data, project, name, model_id=None, retry=2, timeout=30):
    """Send event to Platform endpoint with retry logic."""
    if not _api_key:
...
## Function `ultralytics.utils.callbacks.platform._handle_control_response` {#ultralytics.utils.callbacks.platform.\_handle\_control\_response}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/callbacks/platform.py#L141-L152">View on GitHub</a>
```python
def _handle_control_response(trainer, ctx, response):
    """Apply centralized stop signals returned by Platform webhook responses.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/callbacks/platform.py#L155-L211">View on GitHub</a>
```python
def _upload_model(model_path, project, name, progress=False, retry=1, model_id=None, run_id=None):
    """Publish a model checkpoint to its configured Platform storage location."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/callbacks/platform.py#L214-L264">View on GitHub</a>
```python
def _get_environment_info():
    """Collect comprehensive environment info using existing ultralytics utilities."""
    import shutil
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/callbacks/platform.py#L267-L272">View on GitHub</a>
```python
def _get_project_name(trainer):
    """Get slugified project and name from trainer args."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/callbacks/platform.py#L275-L352">View on GitHub</a>
```python
def on_pretrain_routine_start(trainer):
    """Initialize Platform logging at training start."""
    global _api_key
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/callbacks/platform.py#L355-L360">View on GitHub</a>
```python
def on_pretrain_routine_end(trainer):
    """Apply pre-start cancellation after _setup_train resets trainer.stop."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/callbacks/platform.py#L363-L416">View on GitHub</a>
```python
def on_fit_epoch_end(trainer):
    """Log training and system metrics at epoch end."""
    ctx = getattr(trainer, "platform", None)
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/callbacks/platform.py#L419-L438">View on GitHub</a>
```python
def on_model_save(trainer):
    """Upload model checkpoint (rate limited to every 15 min)."""
    ctx = getattr(trainer, "platform", None)
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/callbacks/platform.py#L441-L514">View on GitHub</a>
```python
def on_train_end(trainer):
    """Log final training results and upload the best model to Platform."""
