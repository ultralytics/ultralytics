...
```python
FastSAM(model: str | Path = "FastSAM-x.pt")
```
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/fastsam/model.py#L14-L79">View on GitHub</a>
```python
class FastSAM(Model):
    """FastSAM model interface for Segment Anything tasks.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/fastsam/model.py#L77-L79">View on GitHub</a>
```python
@property
def task_map(self) -> dict[str, dict[str, Any]]:
    """Returns a dictionary mapping segment task to corresponding predictor and validator classes."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/fastsam/model.py#L45-L74">View on GitHub</a>
```python
def predict(
    self,
    source,
