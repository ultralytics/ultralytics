...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/rtdetr/train.py#L14-L90">View on GitHub</a>
```python
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/rtdetr/train.py#L62-L86">View on GitHub</a>
```python
def build_dataset(self, img_path: str, mode: str = "val", batch: int | None = None):
    """Build and return an RT-DETR dataset for training or validation.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/rtdetr/train.py#L44-L60">View on GitHub</a>
```python
def get_model(self, cfg: dict | None = None, weights: str | None = None, verbose: bool = True):
    """Initialize and return an RT-DETR model for object detection tasks.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/rtdetr/train.py#L88-L90">View on GitHub</a>
```python
def get_validator(self):
    """Return an RTDETRValidator suitable for RT-DETR model validation."""
