...
from ultralytics_4bands.nn.tasks import attempt_load_one_weight, guess_model_task, nn, yaml_model_load
from ultralytics_4bands.utils import ASSETS, DEFAULT_CFG_DICT, LOGGER, RANK, SETTINGS, callbacks, checks, emojis, yaml_load
...
class Model(nn.Module):
    ...
    def _get_hub_session(model: str):
        ...
        from ultralytics_4bands.hub.session import HUBTrainingSession
    ...
    def reset_weights(self) -> "Model":
        ...
        Returns:
            self (ultralytics_4bands.engine.model.Model): The instance of the class with reset weights.
    ...
    def load(self, weights: Union[str, Path] = "yolov8n.pt") -> "Model":
        ...
        Returns:
            self (ultralytics_4bands.engine.model.Model): The instance of the class with loaded weights.
    ...
    def names(self) -> list:
        ...
        using the 'check_class_names' function from the ultralytics_4bands.nn.autobackend module.
