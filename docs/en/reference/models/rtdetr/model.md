...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/rtdetr/model.py#L21-L63">View on GitHub</a>
```python
class RTDETR(Model):
    """Interface for Baidu's RT-DETR model, a Vision Transformer-based real-time object detector.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/rtdetr/model.py#L50-L63">View on GitHub</a>
```python
@property
def task_map(self) -> dict:
    """Return a task map for RT-DETR, associating tasks with corresponding Ultralytics classes.
