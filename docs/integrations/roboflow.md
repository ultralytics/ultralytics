...
![Roboflow Universe](https://media.roboflow.com/ultralytics/rf_universe.png)
...
![Roboflow Universe dataset](https://media.roboflow.com/ultralytics/rf_dataset.png)

For YOLOv8, select "YOLOv8" as the export format:

![Roboflow Universe dataset export](https://media.roboflow.com/ultralytics/rf_data_format.png)
...
![Create a Roboflow project](https://media.roboflow.com/ultralytics/rf_create_project.png)
...
![Annotating an image in Roboflow with SAM-powered label assist](https://media.roboflow.com/ultralytics/rf_annotate_interactive.png)
...
![Tags on an image](https://media.roboflow.com/ultralytics/rf_tags.png)
...
![Enabling Label Assist](https://media.roboflow.com/ultralytics/rf_label_assist.png)

When you open new images for annotation, Label Assist will trigger and recommend annotations.

![Label Assist recommending an annotation](https://media.roboflow.com/ultralytics/rf_label_assist.png)
...
![Searching for an image](https://media.roboflow.com/ultralytics/rf_dataset_management.png)

You can narrow your search to images with a particular tag using the "Tags" selector:

![Filter images by tag](https://media.roboflow.com/ultralytics/rf_filter_by_tag.png)
...
![Roboflow Health Check analysis](https://media.roboflow.com/ultralytics/rf_health_check.png)
...
![Running inference on an example image](https://media.roboflow.com/ultralytics/rf_test_project.png)
...
![Showcase image](https://media.roboflow.com/ultralytics/rf_showcase_1.png)
![Showcase image](https://media.roboflow.com/ultralytics/rf_showcase_2.png)
![Showcase image](https://media.roboflow.com/ultralytics/rf_showcase_3.png)