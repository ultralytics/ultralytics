---
comments: true
description: Run YOLO models on your Android device for real-time object detection with the Ultralytics Android App. Learn about model optimization and hardware delegates.
---
