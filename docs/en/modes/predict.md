...
| `box_color`  | `tuple` or `list of tuples` | BGR color(s) of the boxes. Defaults to Ultralytics palette if `None`.      | `None`        |
| `mask_color` | `tuple` or `list of tuples` | BGR color(s) of the masks. Defaults to Ultralytics palette if `None`.      | `None`        |
| `font_color` | `tuple`                     | BGR color of the font. Defaults to (255, 255, 255) if `None`.              | `None`        |
