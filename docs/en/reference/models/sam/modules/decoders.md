...
!!! abstract "Summary"
    ...
    === "<span class="doc-kind doc-kind-class">Classes</span>"
        ...
        - [`MaskDecoder`](#ultralytics.models.sam.modules.decoders.MaskDecoder)
        - [`SAM2MaskDecoder`](#ultralytics.models.sam.modules.decoders.SAM2MaskDecoder)

    === "<span class="doc-kind doc-kind-method">Methods</span>"

        - [`MaskDecoder.forward`](#ultralytics.models.sam.modules.decoders.MaskDecoder.forward)
        - [`MaskDecoder.predict_masks`](#ultralytics.models.sam.modules.decoders.MaskDecoder.predict_masks)
        - [`SAM2MaskDecoder.forward`](#ultralytics.models.sam.modules.decoders.SAM2MaskDecoder.forward)
        - [`SAM2MaskDecoder.predict_masks`](#ultralytics.models.sam.modules.decoders.SAM2MaskDecoder.predict_masks)
        - [`SAM2MaskDecoder._get_stability_scores`](#ultralytics.models.sam.modules.decoders.SAM2MaskDecoder._get_stability_scores)
        - [`SAM2MaskDecoder._dynamic_multimask_via_stability`](#ultralytics.models.sam.modules.decoders.SAM2MaskDecoder._dynamic_multimask_via_stability)


## Class `ultralytics.models.sam.modules.decoders.MaskDecoder` {#ultralytics.models.sam.modules.decoders.MaskDecoder}
...
| `transformer` | `nn.Module` | Transformer module used for mask prediction. | *required* |
| `num_multimask_outputs` | `int` | Number of masks to predict for disambiguating masks. | `3` |
| `activation` | `type[nn.Module]` | Type of activation to use when upscaling masks. | `nn.GELU` |
...
| Name | Description |
| --- | --- |
| [`forward`](#ultralytics.models.sam.modules.decoders.MaskDecoder.forward) | Predict masks given image and prompt embeddings. |
| [`predict_masks`](#ultralytics.models.sam.modules.decoders.MaskDecoder.predict_masks) | Predict masks and quality scores using image and prompt embeddings via transformer architecture. |
...
<details>
<summary>Source code in <code>ultralytics/models/sam/modules/decoders.py</code></summary>

<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/modules/decoders.py#L11-L163"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
...
### Method `ultralytics.models.sam.modules.decoders.MaskDecoder.forward` {#ultralytics.models.sam.modules.decoders.MaskDecoder.forward}
...
| Name | Type | Description | Default |
| --- | --- | --- | --- |
| `image_embeddings` | `torch.Tensor` | Embeddings from the image encoder. | *required* |
| `image_pe` | `torch.Tensor` | Positional encoding with the shape of image_embeddings. | *required* |
| `sparse_prompt_embeddings` | `torch.Tensor` | Embeddings of the points and boxes. | *required* |
| `dense_prompt_embeddings` | `torch.Tensor` | Embeddings of the mask inputs. | *required* |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/modules/decoders.py#L82-L124"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def forward(
    self,
    image_embeddings: torch.Tensor,
...
### Method `ultralytics.models.sam.modules.decoders.MaskDecoder.predict_masks` {#ultralytics.models.sam.modules.decoders.MaskDecoder.predict\_masks}
...
| Name | Type | Description | Default |
| --- | --- | --- | --- |
| `image_embeddings` | `torch.Tensor` |  | *required* |
| `image_pe` | `torch.Tensor` |  | *required* |
| `sparse_prompt_embeddings` | `torch.Tensor` |  | *required* |
| `dense_prompt_embeddings` | `torch.Tensor` |  | *required* |

<details>
<summary>Source code in <code>ultralytics/models/sam/modules/decoders.py</code></summary>

<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/modules/decoders.py#L126-L163"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def predict_masks(
    self,
    image_embeddings: torch.Tensor,
...
## Class `ultralytics.models.sam.modules.decoders.SAM2MaskDecoder` {#ultralytics.models.sam.modules.decoders.SAM2MaskDecoder}
...
| `transformer` | `nn.Module` | Transformer used to predict masks. | *required* |
...
| Name | Description |
| --- | --- |
| [`_dynamic_multimask_via_stability`](#ultralytics.models.sam.modules.decoders.SAM2MaskDecoder._dynamic_multimask_via_stability) | Dynamically select the most stable mask output based on stability scores and IoU predictions. |
| [`_get_stability_scores`](#ultralytics.models.sam.modules.decoders.SAM2MaskDecoder._get_stability_scores) | Compute mask stability scores based on IoU between upper and lower thresholds. |
| [`forward`](#ultralytics.models.sam.modules.decoders.SAM2MaskDecoder.forward) | Predict masks given image and prompt embeddings. |
| [`predict_masks`](#ultralytics.models.sam.modules.decoders.SAM2MaskDecoder.predict_masks) | Predict instance segmentation masks from image and prompt embeddings using a transformer. |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/modules/decoders.py#L166-L495"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
...
### Method `ultralytics.models.sam.modules.decoders.SAM2MaskDecoder._dynamic_multimask_via_stability` {#ultralytics.models.sam.modules.decoders.SAM2MaskDecoder.\_dynamic\_multimask\_via\_stability}
...
| Name | Type | Description | Default |
| --- | --- | --- | --- |
| `all_mask_logits` | `torch.Tensor` | Logits for all predicted masks, shape (B, N, H, W) where B is batch size, N<br>    is number of masks (typically 4), and H, W are mask dimensions. | *required* |
| `all_iou_scores` | `torch.Tensor` | Predicted IoU scores for all masks, shape (B, N). | *required* |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/modules/decoders.py#L443-L495"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def _dynamic_multimask_via_stability(self, all_mask_logits, all_iou_scores):
    """Dynamically select the most stable mask output based on stability scores and IoU predictions.
...
### Method `ultralytics.models.sam.modules.decoders.SAM2MaskDecoder._get_stability_scores` {#ultralytics.models.sam.modules.decoders.SAM2MaskDecoder.\_get\_stability\_scores}
...
| Name | Type | Description | Default |
| --- | --- | --- | --- |
| `mask_logits` |  |  | *required* |

<details>
<summary>Source code in <code>ultralytics/models/sam/modules/decoders.py</code></summary>

<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/modules/decoders.py#L436-L441"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def _get_stability_scores(self, mask_logits):
    """Compute mask stability scores based on IoU between upper and lower thresholds."""
...
### Method `ultralytics.models.sam.modules.decoders.SAM2MaskDecoder.forward` {#ultralytics.models.sam.modules.decoders.SAM2MaskDecoder.forward}
...
| Name | Type | Description | Default |
| --- | --- | --- | --- |
| `image_embeddings` | `torch.Tensor` | Embeddings from the image encoder with shape (B, C, H, W). | *required* |
| `image_pe` | `torch.Tensor` | Positional encoding with the shape of image_embeddings (B, C, H, W). | *required* |
| `sparse_prompt_embeddings` | `torch.Tensor` | Embeddings of the points and boxes with shape (B, N, C). | *required* |
| `dense_prompt_embeddings` | `torch.Tensor` | Embeddings of the mask inputs with shape (B, C, H, W). | *required* |
| `multimask_output` | `bool` | Whether to return multiple masks or a single mask. | *required* |
| `repeat_image` | `bool` | Flag to repeat the image embeddings. | *required* |
| `high_res_features` | `list[torch.Tensor] | None, optional` | Optional high-resolution features. | `None` |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/modules/decoders.py#L297-L363"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def forward(
    self,
    image_embeddings: torch.Tensor,
...
### Method `ultralytics.models.sam.modules.decoders.SAM2MaskDecoder.predict_masks` {#ultralytics.models.sam.modules.decoders.SAM2MaskDecoder.predict\_masks}
...
| `sparse_prompt_embeddings` | `torch.Tensor` |  | *required* |
| `dense_prompt_embeddings` | `torch.Tensor` |  | *required* |
| `repeat_image` | `bool` |  | *required* |
| `high_res_features` | `list[torch.Tensor] | None` |  | `None` |

<details>
<summary>Source code in <code>ultralytics/models/sam/modules/decoders.py</code></summary>

<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/modules/decoders.py#L365-L434"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def predict_masks(
    self,
    image_embeddings: torch.Tensor,
