...
- **[Core AI](../integrations/coreai.md)** (`coreai`): Apple's new `.aimodel` format for iOS 27 and macOS 27, scheduled across the CPU, GPU, and Apple Neural Engine; export needs macOS 26 or later on Apple silicon, or x86_64 Linux with glibc 2.34 or newer, with Python 3.11 to 3.14.
...
| Hailo             | INT8 HEF inference on Hailo NPUs                | Hailo-8/8L/10H/15H/15L, Raspberry Pi AI HAT+                                                           | Hailo Dataflow Compiler and HailoRT           | Cameras, robots, industrial edge systems    | Hailo DFC and HailoRT releases                 | On-device local inference                         | Hailo NPU                           |
| Huawei Ascend     | Higher throughput on the Ascend AI Core         | Atlas boards and OrangePi AIPro                                                                        | Huawei CANN ecosystem                         | Edge inference on Ascend NPUs               | CANN and ATC releases                          | On-device local inference                         | Ascend AI Core                      |
| Core AI           | Optimized for Apple silicon                     | iOS 27 and macOS 27; export on Apple silicon macOS 26+ or x86_64 Linux (glibc 2.34+), Python 3.11-3.14 | Apple framework; opt-in in iOS/Flutter SDKs   | On-device ML on next-gen Apple platforms    | Tied to Apple OS releases; currently beta      | On-device inference keeps data local              | Apple Neural Engine, GPU, and CPU   |
