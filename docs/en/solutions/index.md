...
!!! tip "Command Info"
    ...
    `Count`, `Action`, `Crop`, `Blur`, `Workout`, `Heatmap`, `Isegment`, `Visioneye`, `Speed`, `Queue`, `Analytics`, `Inference`, `Trackzone`
    ...
    **Syntax**
    ...
    - **SOLUTION_NAME** is one of: `['count', 'action', 'crop', 'blur', 'workout', 'heatmap', 'isegment', 'queue', 'speed', 'analytics', 'trackzone', 'inference', 'visioneye', 'region', 'security', 'parking']`.
