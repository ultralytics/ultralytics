...
!!! abstract "Summary"
    ...
    === "<span class="doc-kind doc-kind-class">Classes</span>"
        ...
        - [`SpeedEstimator`](#ultralytics.solutions.speed_estimation.SpeedEstimator)

    === "<span class="doc-kind doc-kind-method">Methods</span>"

        - [`SpeedEstimator.forget_tracks`](#ultralytics.solutions.speed_estimation.SpeedEstimator.forget_tracks)
        - [`SpeedEstimator.process`](#ultralytics.solutions.speed_estimation.SpeedEstimator.process)


## Class `ultralytics.solutions.speed_estimation.SpeedEstimator` {#ultralytics.solutions.speed\_estimation.SpeedEstimator}

```python
SpeedEstimator(**kwargs: Any)
```
...
| Name | Description |
| --- | --- |
| [`forget_tracks`](#ultralytics.solutions.speed_estimation.SpeedEstimator.forget_tracks) | Drop retired IDs from speed bookkeeping so it doesn't grow across a 24/7 stream (see BaseSolution). |
| [`process`](#ultralytics.solutions.speed_estimation.SpeedEstimator.process) | Process an input frame to estimate object speeds based on tracking data. |
...
<details>
<summary>Source code in <code>ultralytics/solutions/speed_estimation.py</code></summary>

<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/solutions/speed_estimation.py#L11-L123">View on GitHub</a>
```python
...
### Method `ultralytics.solutions.speed_estimation.SpeedEstimator.forget_tracks` {#ultralytics.solutions.speed\_estimation.SpeedEstimator.forget\_tracks}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/solutions/speed_estimation.py#L61-L68">View on GitHub</a>
```python
def forget_tracks(self, track_ids):
    """Drop retired IDs from speed bookkeeping so it doesn't grow across a 24/7 stream (see BaseSolution)."""
...
### Method `ultralytics.solutions.speed_estimation.SpeedEstimator.process` {#ultralytics.solutions.speed\_estimation.SpeedEstimator.process}
...
| Name | Type | Description | Default |
| --- | --- | --- | --- |
| `im0` | `np.ndarray` | Input image for processing with shape (H, W, C) in OpenCV BGR format. | *required* |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/solutions/speed_estimation.py#L70-L123">View on GitHub</a>
```python
def process(self, im0) -> SolutionResults:
    """Process an input frame to estimate object speeds based on tracking data.
