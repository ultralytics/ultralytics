...
def skip_class_mosaic(cls):
    ...
    @wraps(original_init)
    def __init__(self,*args,skip_class_idx:Optional[Tuple[int]]=(33,34),**kwargs):
...
def skip_class_hsv(cls):
    ...
    original_init=cls.__init__
    @wraps(original_init)
    def __init__(self,*args,skip_class_idx:Optional[Tuple[int]]=(6,7,8,9,10,17,18,33,34),**kwargs):
        self.skip_class=skip_class_idx
        original_init(self,*args,**kwargs)
