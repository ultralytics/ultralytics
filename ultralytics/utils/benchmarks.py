...
from ultralytics.utils import ARM64, ASSETS, LINUX, LOGGER, MACOS, TQDM, WEIGHTS_DIR, yaml_load, yaml_save
...
class RF100Benchmark:
    ...
    def fix_yaml(path):
        ...
        yaml_data = yaml_load(path)
        yaml_data["train"] = "train/images"
        yaml_data["val"] = "valid/images"
        yaml_save(path, yaml_data)
    ...
    def evaluate(self, yaml_path, val_log_file, eval_log_file, list_ind):
        ...
        """
        skip_symbols = ["🚀", "⚠️", "💡", "❌"]
        class_names = yaml_load(yaml_path)["names"]
