...
| [TensorRT]({{ integrations_path or "../integrations" }}/tensorrt.md) | `engine` | `{{ model_name or "yolo26n" }}.engine` | ✅ | `imgsz`, `quantize`, `dynamic`, `simplify`, `opset`, `workspace`, `nms`{{ tip1 }}, `batch`, `data`, `fraction`, `device`, `hw_compat` |
