...
- **LiteRT.js:** For web and Node.js apps, see the [LiteRT integration guide](https://docs.ultralytics.com/integrations/litert) and the [LiteRT.js web runtime](https://developers.google.com/edge/litert/web).
