...
with open(report_path, 'w') as f:
    ...
    f.write(f"输入视频: /workspace/ultralytics/videos/Homograph_Teset_FullScreen.mp4\n")
    f.write(f"Homography: /workspace/ultralytics/calibration/Homograph_Teset_FullScreen_homography.json\n")
    f.write(f"结果目录: /workspace/ultralytics/results/20260113_204922_yolo_first_method_a\n\n")
