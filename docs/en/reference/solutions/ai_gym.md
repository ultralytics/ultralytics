...
!!! abstract "Summary"
    ...
    === "<span class="doc-kind doc-kind-method">Methods</span>"
        ...
        - [`AIGym.forget_tracks`](#ultralytics.solutions.ai_gym.AIGym.forget_tracks)
...
| Name | Description |
| --- | --- |
| [`forget_tracks`](#ultralytics.solutions.ai_gym.AIGym.forget_tracks) | Drop retired IDs from workout state so it doesn't grow across a 24/7 stream (see BaseSolution). |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/solutions/ai_gym.py#L9-L119">View on GitHub</a>
```python
...
### Method `ultralytics.solutions.ai_gym.AIGym.forget_tracks` {#ultralytics.solutions.ai\_gym.AIGym.forget\_tracks}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/solutions/ai_gym.py#L49-L53">View on GitHub</a>
```python
def forget_tracks(self, track_ids):
    """Drop retired IDs from workout state so it doesn't grow across a 24/7 stream (see BaseSolution)."""
...
| Type | Description |
| --- | --- |
| `SolutionResults` | Contains processed image `plot_im`, 'workout_count' (list[int] of completed reps, one entry per currently tracked individual), 'workout_stage' (list[str] of current stages), 'workout_angle' (list[float] of current angles), and 'total_tracks' (int, total number of tracked individuals). All per-track lists are aligned with the currently visible tracks so that ``len(results.workout_count) == results.total_tracks``. |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/solutions/ai_gym.py#L55-L119">View on GitHub</a>
```python
def process(self, im0) -> SolutionResults:
    """Monitor workouts using Ultralytics YOLO Pose Model.
