...
!!! abstract "Summary"
    ...
    === "<span class="doc-kind doc-kind-class">Classes</span>"
        ...
        - [`MemoryAttentionLayer`](#ultralytics.models.sam.modules.memory_attention.MemoryAttentionLayer)
        - [`MemoryAttention`](#ultralytics.models.sam.modules.memory_attention.MemoryAttention)

    === "<span class="doc-kind doc-kind-method">Methods</span>"

        - [`MemoryAttentionLayer._forward_sa`](#ultralytics.models.sam.modules.memory_attention.MemoryAttentionLayer._forward_sa)
        - [`MemoryAttentionLayer._forward_ca`](#ultralytics.models.sam.modules.memory_attention.MemoryAttentionLayer._forward_ca)
        - [`MemoryAttentionLayer.forward`](#ultralytics.models.sam.modules.memory_attention.MemoryAttentionLayer.forward)
        - [`MemoryAttention.forward`](#ultralytics.models.sam.modules.memory_attention.MemoryAttention.forward)


## Class `ultralytics.models.sam.modules.memory_attention.MemoryAttentionLayer` {#ultralytics.models.sam.modules.memory\_attention.MemoryAttentionLayer}
...
| --- | --- | --- | --- |
| `d_model` | `int` | Dimensionality of the model. | `256` |
| `dim_feedforward` | `int` | Dimensionality of the feedforward network. | `2048` |
| `dropout` | `float` | Dropout rate for regularization. | `0.1` |
| `pos_enc_at_attn` | `bool` | Whether to add positional encoding at attention. | `False` |
| `pos_enc_at_cross_attn_keys` | `bool` | Whether to add positional encoding to cross-attention keys. | `True` |
| `pos_enc_at_cross_attn_queries` | `bool` | Whether to add positional encoding to cross-attention queries. | `False` |
| `self_attn` | `nn.Module | None` | Custom self-attention module. If None, a default RoPEAttention is used. | `None` |
| `cross_attn` | `nn.Module | None` | Custom cross-attention module. If None, a default RoPEAttention is used. | `None` |
...
| Name | Description |
| --- | --- |
| [`_forward_ca`](#ultralytics.models.sam.modules.memory_attention.MemoryAttentionLayer._forward_ca) | Perform cross-attention between target and memory tensors using RoPEAttention mechanism. |
| [`_forward_sa`](#ultralytics.models.sam.modules.memory_attention.MemoryAttentionLayer._forward_sa) | Perform self-attention on input tensor using positional encoding and RoPE attention mechanism. |
| [`forward`](#ultralytics.models.sam.modules.memory_attention.MemoryAttentionLayer.forward) | Process input tensors through self-attention, cross-attention, and feedforward network layers. |
...
<details>
<summary>Source code in <code>ultralytics/models/sam/modules/memory_attention.py</code></summary>

<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/modules/memory_attention.py#L13-L168"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
...
### Method `ultralytics.models.sam.modules.memory_attention.MemoryAttentionLayer._forward_ca` {#ultralytics.models.sam.modules.memory\_attention.MemoryAttentionLayer.\_forward\_ca}
...
| `memory` | `torch.Tensor` |  | *required* |
| `query_pos` | `torch.Tensor | None` |  | *required* |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/modules/memory_attention.py#L117-L140"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def _forward_ca(
    self,
    tgt: torch.Tensor,
...
### Method `ultralytics.models.sam.modules.memory_attention.MemoryAttentionLayer._forward_sa` {#ultralytics.models.sam.modules.memory\_attention.MemoryAttentionLayer.\_forward\_sa}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/modules/memory_attention.py#L109-L115"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def _forward_sa(self, tgt: torch.Tensor, query_pos: torch.Tensor | None) -> torch.Tensor:
    """Perform self-attention on input tensor using positional encoding and RoPE attention mechanism."""
    tgt2 = self.norm1(tgt)
...
### Method `ultralytics.models.sam.modules.memory_attention.MemoryAttentionLayer.forward` {#ultralytics.models.sam.modules.memory\_attention.MemoryAttentionLayer.forward}
...
| Name | Type | Description | Default |
| --- | --- | --- | --- |
| `tgt` | `torch.Tensor` | Target tensor for self-attention with shape (N, L, D). | *required* |
| `memory` | `torch.Tensor` | Memory tensor for cross-attention with shape (N, S, D). | *required* |
| `pos` | `torch.Tensor | None` | Positional encoding for memory tensor. | `None` |
| `query_pos` | `torch.Tensor | None` | Positional encoding for target tensor. | `None` |
| `num_k_exclude_rope` | `int` | Number of keys to exclude from rotary position embedding. | `0` |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/modules/memory_attention.py#L142-L168"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def forward(
    self,
    tgt: torch.Tensor,
...
## Class `ultralytics.models.sam.modules.memory_attention.MemoryAttention` {#ultralytics.models.sam.modules.memory\_attention.MemoryAttention}

```python
MemoryAttention(self, d_model: int, pos_enc_at_input: bool, layer: nn.Module, num_layers: int, batch_first: bool = True)
```
...
| Name | Type | Description | Default |
| --- | --- | --- | --- |
| `d_model` | `int` | The dimension of the model's hidden state. | *required* |
| `pos_enc_at_input` | `bool` | Whether to apply positional encoding at the input. | *required* |
| `layer` | `nn.Module` | The attention layer to be used in the module. | *required* |
| `num_layers` | `int` | The number of attention layers. | *required* |
| `batch_first` | `bool` | Whether the input tensors are in batch-first format. | `True` |
...
| Name | Description |
| --- | --- |
| [`forward`](#ultralytics.models.sam.modules.memory_attention.MemoryAttention.forward) | Process inputs through attention layers, applying self and cross-attention with positional encoding. |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/modules/memory_attention.py#L171-L298"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
...
### Method `ultralytics.models.sam.modules.memory_attention.MemoryAttention.forward` {#ultralytics.models.sam.modules.memory\_attention.MemoryAttention.forward}
...
| Name | Type | Description | Default |
| --- | --- | --- | --- |
| `curr` | `torch.Tensor` | Self-attention input tensor, representing the current state. | *required* |
| `memory` | `torch.Tensor` | Cross-attention input tensor, representing memory information. | *required* |
| `curr_pos` | `torch.Tensor | None` | Positional encoding for self-attention inputs. | `None` |
| `memory_pos` | `torch.Tensor | None` | Positional encoding for cross-attention inputs. | `None` |
| `num_obj_ptr_tokens` | `int` | Number of object pointer tokens to exclude from rotary position embedding. | `0` |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/modules/memory_attention.py#L229-L298"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def forward(
    self,
    curr: torch.Tensor,  # self-attention inputs
