...
!!! abstract "Summary"
    ...
    === "<span class="doc-kind doc-kind-class">Classes</span>"
        ...
        - [`ExportWrapper`](#ultralytics.engine.exporter.ExportWrapper)
        - [`QNNModel`](#ultralytics.engine.exporter.QNNModel)
        - [`ClassMapModel`](#ultralytics.engine.exporter.ClassMapModel)
    ...
    === "<span class="doc-kind doc-kind-method">Methods</span>"
        ...
        - [`Exporter.export_litert`](#ultralytics.engine.exporter.Exporter.export_litert)
        ...
        - [`Exporter.export_ascend`](#ultralytics.engine.exporter.Exporter.export_ascend)
        - [`Exporter.export_imx`](#ultralytics.engine.exporter.Exporter.export_imx)
        - [`Exporter.export_deepx`](#ultralytics.engine.exporter.Exporter.export_deepx)
        - [`Exporter.export_qnn`](#ultralytics.engine.exporter.Exporter.export_qnn)
        - [`Exporter.export_hailo`](#ultralytics.engine.exporter.Exporter.export_hailo)
        ...
        - [`ExportWrapper.__getattr__`](#ultralytics.engine.exporter.ExportWrapper.__getattr__)
        - [`QNNModel.forward`](#ultralytics.engine.exporter.QNNModel.forward)
        - [`ClassMapModel.forward`](#ultralytics.engine.exporter.ClassMapModel.forward)
...
```python
Exporter(cfg=DEFAULT_CFG, overrides=None, _callbacks: dict | None = None)
```
...
| [`_transform_fn`](#ultralytics.engine.exporter.Exporter._transform_fn) | Quantization preprocessing transform for INT8 calibration (Axelera, OpenVINO, ONNX, QNN). |
| [`add_callback`](#ultralytics.engine.exporter.Exporter.add_callback) | Append the given callback to the specified event. |
| [`export_ascend`](#ultralytics.engine.exporter.Exporter.export_ascend) | Export YOLO model to Huawei Ascend offline model (.om) format. |
...
| [`export_deepx`](#ultralytics.engine.exporter.Exporter.export_deepx) | Export YOLO model to DEEPX format. |
...
| [`export_hailo`](#ultralytics.engine.exporter.Exporter.export_hailo) | Export a YOLO model to Hailo Executable Format (HEF). |
| [`export_imx`](#ultralytics.engine.exporter.Exporter.export_imx) | Export YOLO model to IMX format. |
| [`export_litert`](#ultralytics.engine.exporter.Exporter.export_litert) | Export YOLO model to LiteRT format using litert_torch with optional INT8 quantization. |
...
| [`export_qnn`](#ultralytics.engine.exporter.Exporter.export_qnn) | Export YOLO model to a Qualcomm QNN context binary using ONNX Runtime QNN. |
| [`export_rknn`](#ultralytics.engine.exporter.Exporter.export_rknn) | Export YOLO model to RKNN format with optional INT8 quantization. |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/exporter.py#L496-L1767">View on GitHub</a>
```python
class Exporter:
    """A class for exporting YOLO models to various formats.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/exporter.py#L559-L970">View on GitHub</a>
```python
def __call__(self, model=None) -> str:
    """Export a model and return the final exported path as a string.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/exporter.py#L1745-L1750">View on GitHub</a>
```python
def _add_tflite_metadata(self, file):
    """Add metadata to *.tflite models per https://ai.google.dev/edge/litert/models/metadata."""
    import zipfile
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/exporter.py#L1753-L1758">View on GitHub</a>
```python
@staticmethod
def _transform_fn(data_item) -> np.ndarray:
    """Quantization preprocessing transform for INT8 calibration (Axelera, OpenVINO, ONNX, QNN)."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/exporter.py#L1760-L1762">View on GitHub</a>
```python
def add_callback(self, event: str, callback):
    """Append the given callback to the specified event."""
...
### Method `ultralytics.engine.exporter.Exporter.export_ascend` {#ultralytics.engine.exporter.Exporter.export\_ascend}

```python
def export_ascend(self, prefix=colorstr("Ascend:"))
```
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/exporter.py#L1515-L1532">View on GitHub</a>
```python
@try_export
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/exporter.py#L1434-L1452">View on GitHub</a>
```python
@try_export
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/exporter.py#L1276-L1354">View on GitHub</a>
```python
@try_export
...
### Method `ultralytics.engine.exporter.Exporter.export_deepx` {#ultralytics.engine.exporter.Exporter.export\_deepx}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/exporter.py#L1559-L1572">View on GitHub</a>
```python
@try_export
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/exporter.py#L1469-L1475">View on GitHub</a>
```python
@try_export
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/exporter.py#L1357-L1379">View on GitHub</a>
```python
@try_export
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/exporter.py#L1455-L1466">View on GitHub</a>
```python
@try_export
...
### Method `ultralytics.engine.exporter.Exporter.export_hailo` {#ultralytics.engine.exporter.Exporter.export\_hailo}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/exporter.py#L1598-L1743">View on GitHub</a>
```python
@try_export
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/exporter.py#L1535-L1556">View on GitHub</a>
```python
@try_export
...
### Method `ultralytics.engine.exporter.Exporter.export_litert` {#ultralytics.engine.exporter.Exporter.export\_litert}
...
Supports ``quantize=8`` (static INT8, int8 weights + int8 activations, requires calibration ``data``), ``quantize='w8a16'`` (static, int8 weights + int16 activations, requires calibration ``data``) and ``quantize='w8a32'`` (dynamic/weight-only INT8, int8 weights + FP32 activations, no calibration needed).

<details>
<summary>Source code in <code>ultralytics/engine/exporter.py</code></summary>

<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/exporter.py#L1225-L1245">View on GitHub</a>
```python
@try_export
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/exporter.py#L1248-L1258">View on GitHub</a>
```python
@try_export
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/exporter.py#L1261-L1273">View on GitHub</a>
```python
@try_export
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/exporter.py#L1026-L1155">View on GitHub</a>
```python
@try_export
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/exporter.py#L1158-L1209">View on GitHub</a>
```python
@try_export
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/exporter.py#L1212-L1222">View on GitHub</a>
```python
@try_export
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/exporter.py#L1427-L1431">View on GitHub</a>
```python
@try_export
...
### Method `ultralytics.engine.exporter.Exporter.export_qnn` {#ultralytics.engine.exporter.Exporter.export\_qnn}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/exporter.py#L1575-L1595">View on GitHub</a>
```python
@try_export
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/exporter.py#L1478-L1512">View on GitHub</a>
```python
@try_export
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/exporter.py#L1382-L1424">View on GitHub</a>
```python
@try_export
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/exporter.py#L1013-L1023">View on GitHub</a>
```python
@try_export
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/exporter.py#L972-L1010">View on GitHub</a>
```python
def get_int8_calibration_dataloader(self, prefix=""):
    """Build and return a dataloader for calibration of INT8 models."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/exporter.py#L1764-L1767">View on GitHub</a>
```python
def run_callbacks(self, event: str):
    """Execute all callbacks for a given event."""
...
## Class `ultralytics.engine.exporter.ExportWrapper` {#ultralytics.engine.exporter.ExportWrapper}
...
Subclasses adapt a fused YOLO model's inference I/O for a specific deployment contract (layout, output reduction) while the exporter keeps interacting with the wrapper as if it were the model itself.

**Methods**

| Name | Description |
| --- | --- |
| [`__getattr__`](#ultralytics.engine.exporter.ExportWrapper.__getattr__) | Forward attribute lookups (model, names, stride, yaml, args, ...) to the wrapped model. |

<details>
<summary>Source code in <code>ultralytics/engine/exporter.py</code></summary>

<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/exporter.py#L1770-L1790">View on GitHub</a>
```python
...
### Method `ultralytics.engine.exporter.ExportWrapper.__getattr__` {#ultralytics.engine.exporter.ExportWrapper.\_\_getattr\_\_}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/exporter.py#L1785-L1790">View on GitHub</a>
```python
def __getattr__(self, name):
    """Forward attribute lookups (model, names, stride, yaml, args, ...) to the wrapped model."""
    try:
...
## Class `ultralytics.engine.exporter.QNNModel` {#ultralytics.engine.exporter.QNNModel}
...
Traced by the standard ONNX export (`export_qnn` swaps it in with a channel-last dummy input). The graph takes `[N, H, W, C]` images - the Hexagon HTP's native layout and what camera pipelines produce - so ONNX Runtime's layout transformer folds the wrapper's Transpose into the NPU partition during context generation, and neither the NPU (boundary transpose) nor the consuming app (CPU-side permute) pays a per-inference layout cost.
...
| Name | Description |
| --- | --- |
| [`forward`](#ultralytics.engine.exporter.QNNModel.forward) | Run inference on channel-last `[N, H, W, C]` input normalized to [0, 1]. |

<details>
<summary>Source code in <code>ultralytics/engine/exporter.py</code></summary>

<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/exporter.py#L1793-L1807">View on GitHub</a>
```python
...
### Method `ultralytics.engine.exporter.QNNModel.forward` {#ultralytics.engine.exporter.QNNModel.forward}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/exporter.py#L1805-L1807">View on GitHub</a>
```python
def forward(self, x):
    """Run inference on channel-last `[N, H, W, C]` input normalized to [0, 1]."""
...
## Class `ultralytics.engine.exporter.ClassMapModel` {#ultralytics.engine.exporter.ClassMapModel}
...
Applied to QNN, Core ML and Ascend semantic exports, where the argmax runs on the NPU: deployment consumers want per-pixel class indices, and shipping float logits instead forces a dequantize + argmax over large tensors (~8M values at the standard 640px mobile input) on the consumer's CPU every frame - measured as both slow and highly variable on mobile NPUs. The argmax cannot live in the model's own forward because it is non-differentiable (training needs logits), so it is attached here at export time, mirroring how `NMSModel` adds suppression only for export.
...
| Name | Description |
| --- | --- |
| [`forward`](#ultralytics.engine.exporter.ClassMapModel.forward) | Run the wrapped model and return a `[N, H, W]` integer class map instead of float logits. |

<details>
<summary>Source code in <code>ultralytics/engine/exporter.py</code></summary>

<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/exporter.py#L1810-L1837">View on GitHub</a>
```python
...
### Method `ultralytics.engine.exporter.ClassMapModel.forward` {#ultralytics.engine.exporter.ClassMapModel.forward}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/exporter.py#L1832-L1837">View on GitHub</a>
```python
def forward(self, x):
    """Run the wrapped model and return a `[N, H, W]` integer class map instead of float logits."""
    y = self._model(x)
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/exporter.py#L1840-L1927">View on GitHub</a>
```python
...
| Type | Description |
| --- | --- |
| `torch.Tensor \| tuple` | Tensor of shape (B, max_det, 4 + 2 + extra_shape) where B is the batch size, or a tuple of (detections, proto) for segmentation models. |

<details>
<summary>Source code in <code>ultralytics/engine/exporter.py</code></summary>

<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/exporter.py#L1856-L1927">View on GitHub</a>
```python
def forward(self, x):
    """Perform inference with NMS post-processing. Supports Detect, Segment, OBB and Pose.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/exporter.py#L143-L265">View on GitHub</a>
```python
def export_formats():
    """Return a dictionary of Ultralytics YOLO export formats."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/exporter.py#L435-L470">View on GitHub</a>
```python
def validate_args(format, passed_args, valid_args):
    """Validate arguments based on the export format.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/exporter.py#L473-L493">View on GitHub</a>
```python
def try_export(inner_func):
    """YOLO export decorator, i.e. @try_export."""
