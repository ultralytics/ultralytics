    ...
    def track(
        ...
        **kwargs: Any,
        ...
        Args:
            ...
            persist (bool): If True, persists trackers between different calls to this method. Passing False on a
                later call resets the trackers, e.g. when starting a new video.
