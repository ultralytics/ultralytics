...
!!! abstract "Summary"
    ...
    === "<span class="doc-kind doc-kind-function">Functions</span>"
        ...
        - [`_arch`](#ultralytics.utils.events._arch)
        - [`on_train_end`](#ultralytics.utils.events.on_train_end)
        - [`on_val_start`](#ultralytics.utils.events.on_val_start)
        - [`on_predict_end`](#ultralytics.utils.events.on_predict_end)
        - [`on_export_start`](#ultralytics.utils.events.on_export_start)
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/events.py#L49-L202">View on GitHub</a>
```python
class Events:
    """Collect and send anonymous usage analytics with rate-limiting.
...
| `run` | `BasePredictor \| BaseTrainer, optional` | The completed run, read for the mode's result fields. | `None` |

<details>
<summary>Source code in <code>ultralytics/utils/events.py</code></summary>

<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/events.py#L95-L202">View on GitHub</a>
```python
def __call__(self, cfg, device=None, run=None) -> None:
    """Queue an event and flush the queue asynchronously when the rate limit elapses.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/events.py#L26-L33">View on GitHub</a>
```python
def _post(url: str, data: dict, timeout: float = 5.0) -> None:
    """Send a one-shot JSON POST request."""
    try:
...
## Function `ultralytics.utils.events._arch` {#ultralytics.utils.events.\_arch}
...
The config travels inside a checkpoint, so fine-tuned models report the architecture they descend from however many generations back.

<details>
<summary>Source code in <code>ultralytics/utils/events.py</code></summary>

<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/events.py#L36-L46">View on GitHub</a>
```python
def _arch(model):
    """Return the architecture a model is built from, i.e. 'yolo11n-seg', or None if it cannot be determined.
...
## Function `ultralytics.utils.events.on_train_end` {#ultralytics.utils.events.on\_train\_end}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/events.py#L208-L210">View on GitHub</a>
```python
def on_train_end(trainer):
    """Record an anonymous training event after final metrics are available."""
...
## Function `ultralytics.utils.events.on_val_start` {#ultralytics.utils.events.on\_val\_start}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/events.py#L213-L219">View on GitHub</a>
```python
def on_val_start(validator):
    """Record an anonymous standalone validation event.
...
## Function `ultralytics.utils.events.on_predict_end` {#ultralytics.utils.events.on\_predict\_end}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/events.py#L222-L224">View on GitHub</a>
```python
def on_predict_end(predictor):
    """Record an anonymous prediction event after per-image speeds are available."""
...
## Function `ultralytics.utils.events.on_export_start` {#ultralytics.utils.events.on\_export\_start}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/events.py#L227-L229">View on GitHub</a>
```python
def on_export_start(exporter):
    """Record an anonymous export event."""
