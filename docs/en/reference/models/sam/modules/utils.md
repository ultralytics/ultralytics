...
!!! abstract "Summary"
    ...
    === "<span class="doc-kind doc-kind-function">Functions</span>"
        ...
        - [`select_closest_cond_frames`](#ultralytics.models.sam.modules.utils.select_closest_cond_frames)
        - [`get_1d_sine_pe`](#ultralytics.models.sam.modules.utils.get_1d_sine_pe)
        - [`init_t_xy`](#ultralytics.models.sam.modules.utils.init_t_xy)
        - [`compute_axial_cis`](#ultralytics.models.sam.modules.utils.compute_axial_cis)
        - [`reshape_for_broadcast`](#ultralytics.models.sam.modules.utils.reshape_for_broadcast)
        - [`apply_rotary_enc`](#ultralytics.models.sam.modules.utils.apply_rotary_enc)
        - [`window_partition`](#ultralytics.models.sam.modules.utils.window_partition)
        - [`window_unpartition`](#ultralytics.models.sam.modules.utils.window_unpartition)
        - [`get_rel_pos`](#ultralytics.models.sam.modules.utils.get_rel_pos)
        - [`add_decomposed_rel_pos`](#ultralytics.models.sam.modules.utils.add_decomposed_rel_pos)
        - [`get_abs_pos`](#ultralytics.models.sam.modules.utils.get_abs_pos)
        - [`concat_rel_pos`](#ultralytics.models.sam.modules.utils.concat_rel_pos)


## Function `ultralytics.models.sam.modules.utils.select_closest_cond_frames` {#ultralytics.models.sam.modules.utils.select\_closest\_cond\_frames}
...
| --- | --- | --- | --- |
| `frame_idx` | `int` | Current frame index. | *required* |
| `cond_frame_outputs` | `dict[int, Any]` | Dictionary of conditioning frame outputs keyed by frame indices. | *required* |
| `max_cond_frame_num` | `int` | Maximum number of conditioning frames to select. | *required* |
...
<details>
<summary>Source code in <code>ultralytics/models/sam/modules/utils.py</code></summary>

<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/modules/utils.py#L12-L61"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def select_closest_cond_frames(frame_idx: int, cond_frame_outputs: dict[int, Any], max_cond_frame_num: int):
    """Select the closest conditioning frames to a given frame index.
...
## Function `ultralytics.models.sam.modules.utils.get_1d_sine_pe` {#ultralytics.models.sam.modules.utils.get\_1d\_sine\_pe}
...
| Name | Type | Description | Default |
| --- | --- | --- | --- |
| `pos_inds` | `torch.Tensor` | Position indices for which to generate embeddings. | *required* |
| `dim` | `int` | Dimension of the positional embeddings. Should be an even number. | *required* |
| `temperature` | `float, optional` | Scaling factor for the frequency of the sinusoidal functions. | `10000` |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/modules/utils.py#L64-L87"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def get_1d_sine_pe(pos_inds: torch.Tensor, dim: int, temperature: float = 10000):
    """Generate 1D sinusoidal positional embeddings for given positions and dimensions.
...
## Function `ultralytics.models.sam.modules.utils.init_t_xy` {#ultralytics.models.sam.modules.utils.init\_t\_xy}
...
| Name | Type | Description | Default |
| --- | --- | --- | --- |
| `end_x` | `int` | Width of the grid (number of columns). | *required* |
| `end_y` | `int` | Height of the grid (number of rows). | *required* |
| `scale` | `float` | Scaling factor to apply to the coordinates. | `1.0` |
| `offset` | `int` | Offset to add to the coordinates. | `0` |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/modules/utils.py#L90-L116"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def init_t_xy(end_x: int, end_y: int, scale: float = 1.0, offset: int = 0):
    """Initialize 1D and 2D coordinate tensors for a grid of specified dimensions.
...
## Function `ultralytics.models.sam.modules.utils.compute_axial_cis` {#ultralytics.models.sam.modules.utils.compute\_axial\_cis}
...
| Name | Type | Description | Default |
| --- | --- | --- | --- |
| `dim` | `int` | Dimension of the positional encoding. | *required* |
| `end_x` | `int` | Width of the 2D grid. | *required* |
| `end_y` | `int` | Height of the 2D grid. | *required* |
| `theta` | `float, optional` | Scaling factor for frequency computation. | `10000.0` |
| `scale_pos` | `float, optional` | Scaling factor for position coordinates. | `1.0` |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/modules/utils.py#L119-L149"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def compute_axial_cis(dim: int, end_x: int, end_y: int, theta: float = 10000.0, scale_pos: float = 1.0):
    """Compute axial complex exponential positional encodings for 2D spatial positions in a grid.
...
## Function `ultralytics.models.sam.modules.utils.reshape_for_broadcast` {#ultralytics.models.sam.modules.utils.reshape\_for\_broadcast}
...
| Name | Type | Description | Default |
| --- | --- | --- | --- |
| `freqs_cis` | `torch.Tensor` | Frequency tensor with shape matching the last two dimensions of x. | *required* |
| `x` | `torch.Tensor` | Input tensor to broadcast with. | *required* |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/modules/utils.py#L152-L172"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def reshape_for_broadcast(freqs_cis: torch.Tensor, x: torch.Tensor):
    """Reshape frequency tensor for broadcasting with input tensor.
...
## Function `ultralytics.models.sam.modules.utils.apply_rotary_enc` {#ultralytics.models.sam.modules.utils.apply\_rotary\_enc}
...
| Name | Type | Description | Default |
| --- | --- | --- | --- |
| `xq` | `torch.Tensor` | Query tensor to encode with positional information. | *required* |
| `xk` | `torch.Tensor` | Key tensor to encode with positional information. | *required* |
| `freqs_cis` | `torch.Tensor` | Complex-valued frequency components for rotary encoding with shape matching the last<br>    two dimensions of xq. | *required* |
| `repeat_freqs_k` | `bool, optional` | Whether to repeat frequency components along sequence length dimension to match<br>    key sequence length. | `False` |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/modules/utils.py#L175-L222"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
...
## Function `ultralytics.models.sam.modules.utils.window_partition` {#ultralytics.models.sam.modules.utils.window\_partition}
...
| Name | Type | Description | Default |
| --- | --- | --- | --- |
| `x` | `torch.Tensor` | Input tensor with shape (B, H, W, C). | *required* |
| `window_size` | `int` | Size of each window. | *required* |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/modules/utils.py#L225-L252"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def window_partition(x: torch.Tensor, window_size: int):
    """Partition input tensor into non-overlapping windows with padding if needed.
...
## Function `ultralytics.models.sam.modules.utils.window_unpartition` {#ultralytics.models.sam.modules.utils.window\_unpartition}
...
| Name | Type | Description | Default |
| --- | --- | --- | --- |
| `windows` | `torch.Tensor` | Input tensor of windowed sequences with shape (B * num_windows, window_size,<br>    window_size, C), where B is the batch size, num_windows is the number of windows, window_size is the size of<br>    each window, and C is the number of channels. | *required* |
| `window_size` | `int` | Size of each window. | *required* |
| `pad_hw` | `tuple[int, int]` | Padded height and width (Hp, Wp) of the input before windowing. | *required* |
| `hw` | `tuple[int, int]` | Original height and width (H, W) of the input before padding and windowing. | *required* |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/modules/utils.py#L255-L289"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def window_unpartition(windows: torch.Tensor, window_size: int, pad_hw: tuple[int, int], hw: tuple[int, int]):
    """Unpartition windowed sequences into original sequences and remove padding.
...
## Function `ultralytics.models.sam.modules.utils.get_rel_pos` {#ultralytics.models.sam.modules.utils.get\_rel\_pos}
...
| Name | Type | Description | Default |
| --- | --- | --- | --- |
| `q_size` | `int` | Size of the query. | *required* |
| `k_size` | `int` | Size of the key. | *required* |
| `rel_pos` | `torch.Tensor` | Relative position embeddings with shape (L, C), where L is the maximum relative distance<br>    and C is the embedding dimension. | *required* |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/modules/utils.py#L292-L329"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def get_rel_pos(q_size: int, k_size: int, rel_pos: torch.Tensor) -> torch.Tensor:
    """Extract relative positional embeddings based on query and key sizes.
...
## Function `ultralytics.models.sam.modules.utils.add_decomposed_rel_pos` {#ultralytics.models.sam.modules.utils.add\_decomposed\_rel\_pos}
...
| Name | Type | Description | Default |
| --- | --- | --- | --- |
| `attn` | `torch.Tensor` | Attention map with shape (B, q_h * q_w, k_h * k_w). | *required* |
| `q` | `torch.Tensor` | Query tensor in the attention layer with shape (B, q_h * q_w, C). | *required* |
| `rel_pos_h` | `torch.Tensor` | Relative position embeddings for height axis with shape (Lh, C). | *required* |
| `rel_pos_w` | `torch.Tensor` | Relative position embeddings for width axis with shape (Lw, C). | *required* |
| `q_size` | `tuple[int, int]` | Spatial sequence size of query q as (q_h, q_w). | *required* |
| `k_size` | `tuple[int, int]` | Spatial sequence size of key k as (k_h, k_w). | *required* |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/modules/utils.py#L332-L386"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def add_decomposed_rel_pos(
    attn: torch.Tensor,
    q: torch.Tensor,
...
## Function `ultralytics.models.sam.modules.utils.get_abs_pos` {#ultralytics.models.sam.modules.utils.get\_abs\_pos}
...
| Name | Type | Description | Default |
| --- | --- | --- | --- |
| `abs_pos` | `torch.Tensor` | Absolute positional embeddings with shape (1, num_position, C). | *required* |
| `has_cls_token` | `bool` | If true, has 1 embedding in abs_pos for cls token. | *required* |
| `hw` | `tuple[int, int]` | Size of input image tokens. | *required* |
| `retain_cls_token` | `bool` | Whether to retain the cls_token. | `False` |
| `tiling` | `bool` | Whether to tile the embeddings, *instead* of interpolation (a la abs_win). | `False` |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/modules/utils.py#L389-L451"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def get_abs_pos(
    abs_pos: torch.Tensor,
    has_cls_token: bool,
...
## Function `ultralytics.models.sam.modules.utils.concat_rel_pos` {#ultralytics.models.sam.modules.utils.concat\_rel\_pos}
...
| Name | Type | Description | Default |
| --- | --- | --- | --- |
| `q` | `torch.Tensor` | Query tensor with shape (B, L_q, C). | *required* |
| `k` | `torch.Tensor` | Key tensor with shape (B, L_k, C). | *required* |
| `q_hw` | `tuple[int, int]` | Spatial size of query tensors as (height, width). | *required* |
| `k_hw` | `tuple[int, int]` | Spatial size of key tensors as (height, width). | *required* |
| `rel_pos_h` | `torch.Tensor` | Relative positional embeddings for the height axis. | *required* |
| `rel_pos_w` | `torch.Tensor` | Relative positional embeddings for the width axis. | *required* |
| `rescale` | `bool` | Whether to rescale for use with SDPA, which would scale by the wrong factor due to the concat. | `False` |
| `relative_coords` | `torch.Tensor | None` | Precomputed relative coords index tensor. | `None` |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/modules/utils.py#L454-L512"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def concat_rel_pos(
    q: torch.Tensor,
    k: torch.Tensor,
