...
```python
WorkingDirectory(new_dir: str | Path)
```
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/files.py#L15-L53">View on GitHub</a>
```python
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/files.py#L47-L49">View on GitHub</a>
```python
def __enter__(self):
    """Change the current working directory to the specified directory upon entering the context."""
    os.chdir(self.dir)
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/files.py#L51-L53">View on GitHub</a>
```python
def __exit__(self, exc_type, exc_val, exc_tb):
    """Restore the original working directory when exiting the context."""
    os.chdir(self.cwd)
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/files.py#L57-L103">View on GitHub</a>
```python
@contextmanager
def spaces_in_path(path: str | Path):
    """Context manager to handle paths with spaces in their names.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/files.py#L106-L153">View on GitHub</a>
```python
def increment_path(path: str | Path, exist_ok: bool = False, sep: str = "-", mkdir: bool = False) -> Path:
    """Increment a file or directory path, i.e., runs/exp --> runs/exp{sep}2, runs/exp{sep}3, ... etc.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/files.py#L156-L159">View on GitHub</a>
```python
def file_age(path: str | Path = __file__) -> int:
    """Return days since the last modification of the specified file."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/files.py#L162-L165">View on GitHub</a>
```python
def file_date(path: str | Path = __file__) -> str:
    """Return the file modification date in 'YYYY-M-D' format."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/files.py#L168-L177">View on GitHub</a>
```python
def file_size(path: str | Path) -> float:
    """Return the size of a file or directory in mebibytes (MiB)."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/files.py#L180-L183">View on GitHub</a>
```python
def get_latest_run(search_dir: str = ".") -> str:
    """Return the path to the most recent 'last.pt' file in the specified directory for resuming training."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/files.py#L186-L222">View on GitHub</a>
```python
def update_models(model_names: tuple = ("yolo26n.pt",), source_dir: Path = Path("."), update_names: bool = False):
    """Update and re-save specified YOLO models in an 'updated_models' subdirectory.
