...
!!! abstract "Summary"
    ...
    === "<span class="doc-kind doc-kind-function">Functions</span>"
        ...
        - [`slugify`](#ultralytics.utils.callbacks.platform.slugify)
        - [`resolve_platform_uri`](#ultralytics.utils.callbacks.platform.resolve_platform_uri)
        - [`_interp_plot`](#ultralytics.utils.callbacks.platform._interp_plot)
        - [`_send`](#ultralytics.utils.callbacks.platform._send)
        - [`_send_async`](#ultralytics.utils.callbacks.platform._send_async)
        - [`_upload_model`](#ultralytics.utils.callbacks.platform._upload_model)
        - [`_upload_model_async`](#ultralytics.utils.callbacks.platform._upload_model_async)
        - [`_get_environment_info`](#ultralytics.utils.callbacks.platform._get_environment_info)
        - [`_get_project_name`](#ultralytics.utils.callbacks.platform._get_project_name)
        - [`on_pretrain_routine_start`](#ultralytics.utils.callbacks.platform.on_pretrain_routine_start)
        - [`on_pretrain_routine_end`](#ultralytics.utils.callbacks.platform.on_pretrain_routine_end)
        - [`on_fit_epoch_end`](#ultralytics.utils.callbacks.platform.on_fit_epoch_end)
        - [`on_model_save`](#ultralytics.utils.callbacks.platform.on_model_save)
        - [`on_train_end`](#ultralytics.utils.callbacks.platform.on_train_end)


## Function `ultralytics.utils.callbacks.platform.slugify` {#ultralytics.utils.callbacks.platform.slugify}
...
<details>
<summary>Source code in <code>ultralytics/utils/callbacks/platform.py</code></summary>

<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/callbacks/platform.py#L21-L25"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def slugify(text):
    """Convert text to URL-safe slug (e.g., 'My Project 1' -> 'my-project-1')."""
    if not text:
...
## Function `ultralytics.utils.callbacks.platform.resolve_platform_uri` {#ultralytics.utils.callbacks.platform.resolve\_platform\_uri}
...
| `hard` | `bool` | Whether to raise an error if resolution fails. | `True` |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/callbacks/platform.py#L45-L120"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def resolve_platform_uri(uri, hard=True):
    """Resolve ul:// URIs to signed URLs by authenticating with Ultralytics Platform.
...
## Function `ultralytics.utils.callbacks.platform._interp_plot` {#ultralytics.utils.callbacks.platform.\_interp\_plot}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/callbacks/platform.py#L123-L148"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def _interp_plot(plot, n=101):
    """Interpolate plot curve data to n points to reduce storage size."""
    import numpy as np
...
## Function `ultralytics.utils.callbacks.platform._send` {#ultralytics.utils.callbacks.platform.\_send}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/callbacks/platform.py#L151-L175"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def _send(event, data, project, name, model_id=None, retry=2):
    """Send event to Platform endpoint with retry logic."""
...
## Function `ultralytics.utils.callbacks.platform._send_async` {#ultralytics.utils.callbacks.platform.\_send\_async}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/callbacks/platform.py#L178-L180"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def _send_async(event, data, project, name, model_id=None):
    """Send event asynchronously using bounded thread pool."""
...
## Function `ultralytics.utils.callbacks.platform._upload_model` {#ultralytics.utils.callbacks.platform.\_upload\_model}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/callbacks/platform.py#L183-L213"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def _upload_model(model_path, project, name, progress=False, retry=1):
    """Upload model checkpoint to Platform via signed URL."""
...
## Function `ultralytics.utils.callbacks.platform._upload_model_async` {#ultralytics.utils.callbacks.platform.\_upload\_model\_async}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/callbacks/platform.py#L216-L218"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def _upload_model_async(model_path, project, name):
    """Upload model asynchronously using bounded thread pool."""
...
## Function `ultralytics.utils.callbacks.platform._get_environment_info` {#ultralytics.utils.callbacks.platform.\_get\_environment\_info}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/callbacks/platform.py#L221-L269"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def _get_environment_info():
    """Collect comprehensive environment info using existing ultralytics utilities."""
    import shutil
...
## Function `ultralytics.utils.callbacks.platform._get_project_name` {#ultralytics.utils.callbacks.platform.\_get\_project\_name}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/callbacks/platform.py#L272-L277"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def _get_project_name(trainer):
    """Get slugified project and name from trainer args."""
...
## Function `ultralytics.utils.callbacks.platform.on_pretrain_routine_start` {#ultralytics.utils.callbacks.platform.on\_pretrain\_routine\_start}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/callbacks/platform.py#L280-L335"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def on_pretrain_routine_start(trainer):
    """Initialize Platform logging at training start."""
...
## Function `ultralytics.utils.callbacks.platform.on_pretrain_routine_end` {#ultralytics.utils.callbacks.platform.on\_pretrain\_routine\_end}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/callbacks/platform.py#L338-L342"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def on_pretrain_routine_end(trainer):
    """Apply pre-start cancellation after _setup_train resets trainer.stop."""
...
## Function `ultralytics.utils.callbacks.platform.on_fit_epoch_end` {#ultralytics.utils.callbacks.platform.on\_fit\_epoch\_end}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/callbacks/platform.py#L345-L396"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def on_fit_epoch_end(trainer):
    """Log training and system metrics at epoch end."""
    if RANK not in {-1, 0} or not trainer.args.project:
...
## Function `ultralytics.utils.callbacks.platform.on_model_save` {#ultralytics.utils.callbacks.platform.on\_model\_save}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/callbacks/platform.py#L399-L414"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def on_model_save(trainer):
    """Upload model checkpoint (rate limited to every 15 min)."""
    if RANK not in {-1, 0} or not trainer.args.project:
...
## Function `ultralytics.utils.callbacks.platform.on_train_end` {#ultralytics.utils.callbacks.platform.on\_train\_end}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/callbacks/platform.py#L417-L474"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def on_train_end(trainer):
    """Log final results, upload best model, and send validation plot data."""
    if RANK not in {-1, 0} or not trainer.args.project:
