...
| [`latest-cuda12`](https://hub.docker.com/r/ultralytics/ultralytics/tags?name=latest-cuda12)                   | Alias of `latest`, pinning the CUDA 12 build explicitly                                                                              | [`Dockerfile`](https://github.com/ultralytics/ultralytics/blob/main/docker/Dockerfile)                                 |
| [`latest-cuda13`](https://hub.docker.com/r/ultralytics/ultralytics/tags?name=latest-cuda13)                   | Linux AMD64 with CUDA 13 for newer GPUs such as NVIDIA Blackwell Ultra                                                               | [`Dockerfile`](https://github.com/ultralytics/ultralytics/blob/main/docker/Dockerfile)                                 |
