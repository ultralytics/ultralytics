...
Integration with the YOLOv5 training script is now active. Every training run from this point on is captured by the ClearML [experiment manager](https://docs.ultralytics.com/integrations/clearml/).
...
For a deeper integration walkthrough across Ultralytics models, see the [ClearML integration guide](https://docs.ultralytics.com/integrations/clearml/) and explore other [MLOps workflows](https://www.ultralytics.com/blog/exploring-yolov8-ml-experiment-tracking-integrations) with additional experiment tracking tools.
