...
```python
FastSAMPredictor(cfg=DEFAULT_CFG, overrides=None, _callbacks: dict | None = None)
```
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/fastsam/predict.py#L17-L174">View on GitHub</a>
```python
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/fastsam/predict.py#L153-L170">View on GitHub</a>
```python
def _clip_inference(self, images, texts):
    """Perform CLIP inference to calculate similarity between images and text prompts.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/fastsam/predict.py#L50-L75">View on GitHub</a>
```python
def postprocess(self, preds, img, orig_imgs):
    """Apply postprocessing to FastSAM predictions and handle prompts.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/fastsam/predict.py#L77-L151">View on GitHub</a>
```python
def prompt(self, results, bboxes=None, points=None, labels=None, texts=None):
    """Perform image segmentation inference based on cues like bounding boxes, points, and text prompts.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/fastsam/predict.py#L172-L174">View on GitHub</a>
```python
def set_prompts(self, prompts):
    """Set prompts to be used during inference."""
