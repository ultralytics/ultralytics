...
- [Medical-pills](medical-pills.md): A dataset featuring images of medicinal pills, annotated for applications such as pharmaceutical quality assurance, pill sorting, and regulatory compliance.
