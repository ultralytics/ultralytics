...
!!! abstract "Summary"
    ...
    === "<span class="doc-kind doc-kind-class">Classes</span>"
        ...
        - [`TensorFlowBackend`](#ultralytics.nn.backends.tensorflow.TensorFlowBackend)

    === "<span class="doc-kind doc-kind-method">Methods</span>"

        - [`TensorFlowBackend.load_model`](#ultralytics.nn.backends.tensorflow.TensorFlowBackend.load_model)
        - [`TensorFlowBackend.forward`](#ultralytics.nn.backends.tensorflow.TensorFlowBackend.forward)


## Class `ultralytics.nn.backends.tensorflow.TensorFlowBackend` {#ultralytics.nn.backends.tensorflow.TensorFlowBackend}

```python
TensorFlowBackend(weight: str | Path, device: torch.device, fp16: bool = False, format: str = "saved_model")
```
...
| --- | --- | --- | --- |
| `weight` | `str \| Path` | Path to the SavedModel directory, .pb file, or Edge TPU .tflite file. | *required* |
| `device` | `torch.device` | Device to run inference on. | *required* |
| `fp16` | `bool` | Whether to use FP16 half-precision inference. | `False` |
| `format` | `str` | Model format, one of "saved_model", "pb", or "edgetpu". | `"saved_model"` |

**Methods**

| Name | Description |
| --- | --- |
| [`forward`](#ultralytics.nn.backends.tensorflow.TensorFlowBackend.forward) | Run Google TensorFlow inference with format-specific execution and output post-processing. |
| [`load_model`](#ultralytics.nn.backends.tensorflow.TensorFlowBackend.load_model) | Load a Google TensorFlow model in SavedModel, GraphDef, or Edge TPU format. |

<details>
<summary>Source code in <code>ultralytics/nn/backends/tensorflow.py</code></summary>

<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/backends/tensorflow.py#L16-L175">View on GitHub</a>
```python
...
### Method `ultralytics.nn.backends.tensorflow.TensorFlowBackend.forward` {#ultralytics.nn.backends.tensorflow.TensorFlowBackend.forward}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/backends/tensorflow.py#L108-L175">View on GitHub</a>
```python
def forward(self, im: torch.Tensor) -> list[np.ndarray]:
    """Run Google TensorFlow inference with format-specific execution and output post-processing.
...
### Method `ultralytics.nn.backends.tensorflow.TensorFlowBackend.load_model` {#ultralytics.nn.backends.tensorflow.TensorFlowBackend.load\_model}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/backends/tensorflow.py#L36-L106">View on GitHub</a>
```python
def load_model(self, weight: str | Path) -> None:
    """Load a Google TensorFlow model in SavedModel, GraphDef, or Edge TPU format.
