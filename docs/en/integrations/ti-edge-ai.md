...
Compiling and deploying Neural Network models on Texas Instruments MPU devices requires compiling models with the [TI Deep Learning (TIDL) Edge AI tools](https://github.com/TexasInstruments/edgeai-tidl-tools). For more details on TIDL model
