...
tflite_name = ["yolov8_saved_model/yolov8_float32.tflite", 
               "yolov8-seg_saved_model/yolov8-seg_float32.tflite", 
               "yolov5-p6_saved_model/yolov5-p6_float32.tflite"]
int8_tflite_name = ["yolov8_saved_model/yolov8_full_integer_quant.tflite", 
