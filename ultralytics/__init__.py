...
MODELS = ("YOLO", "YOLODeim", "YOLOWorld", "YOLOE", "NAS", "SAM", "FastSAM", "RTDETR", "RTDETRDEIM", "RTDETRDEIMv2")
...
if TYPE_CHECKING:
    ...
    from ultralytics.models import YOLO, YOLODeim, YOLOWorld, YOLOE, NAS, SAM, FastSAM, RTDETR, RTDETRDEIM, RTDETRDEIMv2  # noqa
