...
This is known as **end-to-end [object detection](https://www.ultralytics.com/glossary/object-detection)**, and it is enabled by default in every YOLO26 model. The result is a simpler deployment pipeline and lower latency — YOLO26n runs up to **43% faster than YOLO11n** on CPU ONNX inference (Intel Xeon CPU @ 2.00 GHz).
