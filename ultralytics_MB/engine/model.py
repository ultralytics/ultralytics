...
from ultralytics_MB.hub import HUB_WEB_ROOT
from ultralytics_MB.nn.tasks import attempt_load_one_weight, guess_model_task, nn, yaml_model_load
...
class Model(nn.Module):
    ...
    def __call__(
        ...
        **kwargs,
        ...
        Returns:
            (List[ultralytics_MB.engine.results.Results]): A list of prediction results, each encapsulated in a
                Results object.

        Examples:
            >>> model = YOLO('yolov8n.pt')
            >>> results = model('https://ultralytics_MB.com/images/bus.jpg')
            >>> for r in results:
    ...
    def _get_hub_session(model: str):
        ...
        from ultralytics_MB.hub.session import HUBTrainingSession
    ...
    def reset_weights(self) -> "Model":
        ...
        Returns:
            self (ultralytics_MB.engine.model.Model): The instance of the class with reset weights.
    ...
    def load(self, weights: Union[str, Path] = "yolov8n.pt") -> "Model":
        ...
        Returns:
            self (ultralytics_MB.engine.model.Model): The instance of the class with loaded weights.
    ...
    def embed(self, source=None, stream=False, **kwargs):
        ...
        Examples:
            >>> model = YOLO('yolov8n.pt')
            >>> image = 'https://ultralytics_MB.com/images/bus.jpg'
    ...
    def track(
        ...
        **kwargs,
        ...
        Returns:
            (List[ultralytics_MB.engine.results.Results]): A list of tracking results, each a Results object.
        ...
        if not hasattr(self.predictor, "trackers"):
            from ultralytics_MB.trackers import register_tracker
    ...
    def val(self, validator=None, **kwargs):
        ...
        Args:
            validator (ultralytics_MB.engine.validator.BaseValidator | None): An instance of a custom validator class for
                validating the model.
            **kwargs (Any): Arbitrary keyword arguments for customizing the validation process.

        Returns:
            (ultralytics_MB.utils.metrics.DetMetrics): Validation metrics obtained from the validation process.
    ...
    def benchmark(self, **kwargs):
        ...
        It uses the 'benchmark' function from the ultralytics_MB.utils.benchmarks module. The benchmarking is
    ...
    def tune(self, use_ray=False, iterations=10, *args, **kwargs):
        ...
        When Ray Tune is enabled, it leverages the 'run_ray_tune' function from the ultralytics_MB.utils.tuner module.
        ...
        self._check_is_pytorch_model()
        if use_ray:
            from ultralytics_MB.utils.tuner import run_ray_tune
