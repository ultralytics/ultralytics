...
| --- | --- | --- | --- |
| `scalars` | `dict` | Dictionary of scalar values to log to TensorBoard. Keys are scalar names and values are the corresponding scalar values. | *required* |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/callbacks/tensorboard.py#L24-L39">View on GitHub</a>
```python
def _log_scalars(scalars: dict, step: int = 0) -> None:
    """Log scalar values to TensorBoard.
...
| Name | Type | Description | Default |
| --- | --- | --- | --- |
| `trainer` | `ultralytics.engine.trainer.BaseTrainer` | The trainer object containing the model to visualize. Must have attributes model and args with imgsz. | *required* |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/callbacks/tensorboard.py#L43-L86">View on GitHub</a>
```python
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/callbacks/tensorboard.py#L89-L97">View on GitHub</a>
```python
def on_pretrain_routine_start(trainer) -> None:
    """Initialize TensorBoard logging with SummaryWriter."""
    if SummaryWriter:
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/callbacks/tensorboard.py#L100-L103">View on GitHub</a>
```python
def on_train_start(trainer) -> None:
    """Log TensorBoard graph."""
    if WRITER:
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/callbacks/tensorboard.py#L106-L109">View on GitHub</a>
```python
def on_train_epoch_end(trainer) -> None:
    """Log scalar statistics at the end of a training epoch."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/callbacks/tensorboard.py#L112-L114">View on GitHub</a>
```python
def on_fit_epoch_end(trainer) -> None:
    """Log epoch metrics at end of training epoch."""
