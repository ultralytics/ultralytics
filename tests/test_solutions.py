...
@pytest.mark.parametrize(
    ...
    [
        (
            ...
            False,
            "demo_video",
            {"region": REGION, "model": MODEL, "show": SHOW, "imgsz": 160},
        ),
        (
            "ObjectCounter",
            solutions.ObjectCounter,
            False,
            "demo_video",
            {"region": HORIZONTAL_LINE, "model": MODEL, "show": SHOW, "imgsz": 160},
        ),
        (
            ...
            False,
            "vertical_video",
            {"region": VERTICAL_LINE, "model": MODEL, "show": SHOW, "imgsz": 160},
        ),
        (
            ...
            False,
            "demo_video",
            {"region": REGION, "model": "yolo26n-obb.pt", "show": SHOW, "imgsz": 160},
        ),
        (
            "Heatmap",
            solutions.Heatmap,
            False,
            "demo_video",
            {"colormap": cv2.COLORMAP_PARULA, "model": MODEL, "show": SHOW, "region": None, "imgsz": 160},
        ),
        (
            "HeatmapWithRegion",
            solutions.Heatmap,
            False,
            "demo_video",
            {"colormap": cv2.COLORMAP_PARULA, "region": REGION, "model": MODEL, "show": SHOW, "imgsz": 160},
        ),
        (
            "SpeedEstimator",
        ...
        (
            ...
            True,
            "demo_video",
            {"analytics_type": "line", "model": MODEL, "show": SHOW, "figsize": (6.4, 3.2), "imgsz": 160},
        ),
        (
            "PieAnalytics",
            solutions.Analytics,
            True,
            "demo_video",
            {"analytics_type": "pie", "model": MODEL, "show": SHOW, "figsize": (6.4, 3.2), "imgsz": 160},
        ),
        (
            "BarAnalytics",
            solutions.Analytics,
            True,
            "demo_video",
            {"analytics_type": "bar", "model": MODEL, "show": SHOW, "figsize": (6.4, 3.2), "imgsz": 160},
        ),
        (
            "AreaAnalytics",
            solutions.Analytics,
            True,
            "demo_video",
            {"analytics_type": "area", "model": MODEL, "show": SHOW, "figsize": (6.4, 3.2), "imgsz": 160},
        ),
        (
            "TrackZone",
            solutions.TrackZone,
        ...
        (
            ...
            False,
            "crop_video",
            {"temp_crop_dir": "cropped-detections", "model": MODEL, "show": SHOW, "imgsz": 160},
        ),
        (
            "ObjectBlurrer",
            ...
            False,
            "demo_video",
            {"blur_ratio": 0.02, "model": MODEL, "show": SHOW, "imgsz": 160},
        ),
        (
            ...
            False,
            "demo_video",
            {"model": "yolo26n-seg.pt", "show": SHOW, "imgsz": 160},
        ),
        ("VisionEye", solutions.VisionEye, False, "demo_video", {"model": MODEL, "show": SHOW, "imgsz": 160}),
        (
            "RegionCounter",
        ...
        ("AIGym", solutions.AIGym, False, "pose_video", {"kpts": [6, 8, 10], "show": SHOW, "imgsz": 160}),
        (
            "ParkingManager",
            solutions.ParkingManagement,
            False,
            "parking_video",
            {"model": "parking_model", "show": SHOW, "json_file": "parking_areas", "imgsz": 160},
        ),
        (
            "StreamlitInference",
            solutions.Inference,
            ...
            {"imgsz": 160},  # streamlit application accepts arguments
        ),
    ],
)
