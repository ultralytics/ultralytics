...
class DetectionTrainer(BaseTrainer):
    ...
    def build_dataset(self, img_path, mode="train", batch=None):
        ...
        return build_yolo_dataset(self.args, img_path, batch, self.data, mode=mode, rect=mode == "val", stride=gs, override_label_transforms=self.override_label_transforms)
