...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/sam3/decoder.py#L22-L177">View on GitHub</a>
```python
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/sam3/decoder.py#L137-L177">View on GitHub</a>
```python
def _apply_self_attention(self, tgt, tgt_query_pos, dac, dac_use_selfatt_ln, presence_token, self_attn_mask):
    """Apply self-attention with optional DAC splitting."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/sam3/decoder.py#L73-L135">View on GitHub</a>
```python
def forward(
    self,
    # for tgt
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/sam3/decoder.py#L66-L71">View on GitHub</a>
```python
def forward_ffn(self, tgt):
    """Feedforward network forward pass."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/sam3/decoder.py#L62-L64">View on GitHub</a>
```python
@staticmethod
def with_pos_embed(tensor, pos):
    """Add positional embedding to the tensor."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/sam3/decoder.py#L180-L547">View on GitHub</a>
```python
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/sam3/decoder.py#L309-L313">View on GitHub</a>
```python
@staticmethod
def _get_coords(H, W, device, dtype):
    """Get normalized coordinates for height and width."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/sam3/decoder.py#L315-L375">View on GitHub</a>
```python
def _get_rpb_matrix(self, reference_boxes, feat_size):
    """Get the relative position bias (RPB) matrix for box-relative position bias."""
    H, W = feat_size
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/sam3/decoder.py#L377-L547">View on GitHub</a>
```python
def forward(
    self,
    tgt,
