...
class ObjectCounter(BaseSolution):
    ...
    def __init__(self, **kwargs):
        ...
        self.show_in = kwargs.get("show_in", True)  # flag to display objects moving *into* the defined region
        self.show_out = kwargs.get("show_out", True)  # flag to display objects moving *out of* the defined region
