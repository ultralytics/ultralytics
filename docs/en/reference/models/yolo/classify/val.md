...
```python
ClassificationValidator(dataloader=None, save_dir=None, args=None, _callbacks: dict | None = None)
```
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/yolo/classify/val.py#L18-L216">View on GitHub</a>
```python
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/yolo/classify/val.py#L149-L151">View on GitHub</a>
```python
def build_dataset(self, img_path: str) -> ClassificationDataset:
    """Create a ClassificationDataset instance for validation."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/yolo/classify/val.py#L105-L125">View on GitHub</a>
```python
def finalize_metrics(self) -> None:
    """Finalize metrics including confusion matrix and processing speed.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/yolo/classify/val.py#L136-L147">View on GitHub</a>
```python
def gather_stats(self) -> None:
    """Gather stats from all GPUs."""
    if RANK == 0:
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/yolo/classify/val.py#L153-L164">View on GitHub</a>
```python
def get_dataloader(self, dataset_path: Path | str, batch_size: int) -> torch.utils.data.DataLoader:
    """Build and return a data loader for classification validation.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/yolo/classify/val.py#L71-L73">View on GitHub</a>
```python
def get_desc(self) -> str:
    """Return a formatted string summarizing classification metrics."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/yolo/classify/val.py#L131-L134">View on GitHub</a>
```python
def get_stats(self) -> dict[str, float]:
    """Calculate and return a dictionary of metrics by processing targets and predictions."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/yolo/classify/val.py#L75-L81">View on GitHub</a>
```python
def init_metrics(self, model: torch.nn.Module) -> None:
    """Initialize confusion matrix, class names, and tracking containers for predictions and targets."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/yolo/classify/val.py#L191-L216">View on GitHub</a>
```python
def plot_predictions(self, batch: dict[str, Any], preds: torch.Tensor, ni: int) -> None:
    """Plot images with their predicted class labels and save the visualization.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/yolo/classify/val.py#L171-L189">View on GitHub</a>
```python
def plot_val_samples(self, batch: dict[str, Any], ni: int) -> None:
    """Plot validation image samples with their ground truth labels.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/yolo/classify/val.py#L127-L129">View on GitHub</a>
```python
def postprocess(self, preds: torch.Tensor | list[torch.Tensor] | tuple[torch.Tensor]) -> torch.Tensor:
    """Extract the primary prediction from model output if it's in a list or tuple format."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/yolo/classify/val.py#L83-L88">View on GitHub</a>
```python
def preprocess(self, batch: dict[str, Any]) -> dict[str, Any]:
    """Preprocess input batch by moving data to device and converting to appropriate dtype."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/yolo/classify/val.py#L166-L169">View on GitHub</a>
```python
def print_results(self) -> None:
    """Print evaluation metrics for the classification model."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/yolo/classify/val.py#L90-L103">View on GitHub</a>
```python
def update_metrics(self, preds: torch.Tensor, batch: dict[str, Any]) -> None:
    """Update running metrics with model predictions and batch targets.
