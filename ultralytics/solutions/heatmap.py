...
class Heatmap(ObjectCounter):
    ...
    def generate_heatmap(self, im0):
        ...
        Returns:
            results (dict): Contains processed image `im0`, 'in_count' (int, count of objects entering the region),
        ...
        if self.verbose:  # Log the total tracks, in-count, out-count and classwise count (if counting enabled)
            self.LOGGER.info(
