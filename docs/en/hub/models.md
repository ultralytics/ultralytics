...
![Ultralytics HUB screenshot of the Models page with an arrow pointing to the Models button in the sidebar and one to the Train Model button](./images/models/hub_train_model_2.jpg)

??? tip "Tip"

    You can train a model directly from the [Home](https://hub.ultralytics.com/home) page.

    ![Ultralytics HUB screenshot of the Home page with an arrow pointing to the Train Model card](./images/models/hub_train_model_1.jpg)
...
![Ultralytics HUB screenshot of the Train Model dialog with an arrow pointing to a dataset and one to the Continue button](./images/models/hub_train_model_3.jpg)

??? tip "Tip"

    You can skip this step if you train a model directly from the Dataset page.

    ![Ultralytics HUB screenshot of the Dataset page with an arrow pointing to the Train Model button](./images/datasets/hub_upload_dataset_9.jpg)
...
![Ultralytics HUB screenshot of the Train Model dialog with arrows pointing to the project dropdown, model name and Continue button](./images/models/hub_train_model_4.jpg)
...
??? note "Note"
    ...
    ![Ultralytics HUB screenshot of the Project page with an arrow pointing to the Train Model button](./images/projects/hub_create_project_5.jpg)
...
![Ultralytics HUB screenshot of the Train Model dialog with an arrow pointing to the Advanced Model Configuration accordion](./images/models/hub_train_model_5.jpg)
...
![Ultralytics HUB screenshot of the Train Model dialog with an arrow pointing to the Custom tab](./images/models/hub_train_model_6.jpg)
...
??? note "Note"
    ...
    ![Ultralytics HUB screenshot of the Model page with an arrow pointing to the Start Training card](./images/cloud-training/hub_cloud_training_2.jpg)
...
![Ultralytics HUB screenshot of the Train Model dialog with arrows pointing to instructions](./images/models/hub_train_model_8.jpg)

When the training starts, you can click **Done** and monitor the training progress on the Model page.

![Ultralytics HUB screenshot of the Train Model dialog with an arrow pointing to the Done button](./images/models/hub_train_model_9.jpg)

![Ultralytics HUB screenshot of the Model page of a model that is currently training](./images/models/hub_train_model_10.jpg)
...
![Ultralytics HUB screenshot of the Train Model dialog with arrows pointing to instructions](./images/models/hub_train_model_12.jpg)
...
![Ultralytics HUB screenshot of the Train Model dialog with an arrow pointing to the Done button](./images/models/hub_train_model_13.jpg)

![Ultralytics HUB screenshot of the Model page of a model that is currently training](./images/models/hub_train_model_14.jpg)

!!! note "Note"

    In case the training stops and a checkpoint was saved, you can resume training your model from the Model page.

    ![Ultralytics HUB screenshot of the Model page with an arrow pointing to the Resume Training card](./images/models/hub_train_model_15.jpg)
...
![Ultralytics HUB screenshot of the Model page of a trained model](./images/models/hub_analyze_model_1.jpg)

To access all model metrics, click on the **Charts** tab.

![Ultralytics HUB screenshot of the Preview tab inside the Model page with an arrow pointing to the Charts tab](./images/models/hub_analyze_model_2.jpg)

??? tip "Tip"

    Each chart can be enlarged for better visualization.

    ![Ultralytics HUB screenshot of the Train tab inside the Model page with an arrow pointing to the expand icon of one of the charts](./images/models/hub_analyze_model_3.jpg)

    ![Ultralytics HUB screenshot of the Train tab inside the Model page with one of the charts expanded](./images/models/hub_analyze_model_4.jpg)

    Furthermore, to properly analyze the data, you can utilize the zoom feature.

    ![Ultralytics HUB screenshot of the Train tab inside the Model page with one of the charts expanded and zoomed](./images/models/hub_analyze_model_5.jpg)
...
![Ultralytics HUB screenshot of the Preview tab inside the Model page with an arrow pointing to Charts tab and one to the Test card](./images/models/hub_preview_model_1.jpg)

!!! note "Note"

    You can also use your camera to take a picture and run inference on it directly.

    ![Ultralytics HUB screenshot of the Preview tab inside the Model page with an arrow pointing to Camera tab inside the Test card](./images/models/hub_preview_model_2.jpg)
...
![Ultralytics HUB screenshot of the Deploy tab inside the Model page with arrow pointing to the Real-Time Preview card](./images/models/hub_preview_model_3.jpg)
...
![Ultralytics HUB screenshot of the Deploy tab inside the Model page with an arrow pointing to the Export card and all formats exported](./images/models/hub_deploy_model_1.jpg)
...
??? tip "Tip"
    ...
    ![Ultralytics HUB screenshot of the Deploy tab inside the Model page with an arrow pointing to the Advanced option of one of the formats](./images/models/hub_deploy_model_2.jpg)
...
![Ultralytics HUB screenshot of the Model page with an arrow pointing to the Share option](./images/models/hub_share_model_1.jpg)
...
??? tip "Tip"
    ...
    ![Ultralytics HUB screenshot of the Models page with an arrow pointing to the Share option of one of the models](./images/models/hub_share_model_2.jpg)

Set the general access to "Unlisted" and click **Save**.

![Ultralytics HUB screenshot of the Share Model dialog with an arrow pointing to the dropdown and one to the Save button](./images/models/hub_share_model_3.jpg)
...
??? tip "Tip"
    ...
    ![Ultralytics HUB screenshot of the Share Model dialog with an arrow pointing to the model's link](./images/models/hub_share_model_4.jpg)
...
![Ultralytics HUB screenshot of the Model page with an arrow pointing to the Edit option](./images/models/hub_edit_model_1.jpg)
...
??? tip "Tip"
    ...
    ![Ultralytics HUB screenshot of the Models page with an arrow pointing to the Edit option of one of the models](./images/models/hub_edit_model_2.jpg)

Apply the desired modifications to your model and then confirm the changes by clicking **Save**.

![Ultralytics HUB screenshot of the Update Model dialog with an arrow pointing to the Save button](./images/models/hub_edit_model_3.jpg)
...
![Ultralytics HUB screenshot of the Model page with an arrow pointing to the Delete option](./images/models/hub_delete_model_1.jpg)
...
??? tip "Tip"
    ...
    ![Ultralytics HUB screenshot of the Models page with an arrow pointing to the Delete option of one of the models](./images/models/hub_delete_model_2.jpg)

!!! note "Note"

    If you change your mind, you can restore the model from the [Trash](https://hub.ultralytics.com/trash) page.

    ![Ultralytics HUB screenshot of the Trash page with an arrow pointing to the Restore option of one of the models](./images/models/hub_delete_model_3.jpg)
