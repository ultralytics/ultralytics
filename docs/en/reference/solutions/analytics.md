...
!!! abstract "Summary"
    ...
    === "<span class="doc-kind doc-kind-class">Classes</span>"
        ...
        - [`Analytics`](#ultralytics.solutions.analytics.Analytics)

    === "<span class="doc-kind doc-kind-method">Methods</span>"

        - [`Analytics.process`](#ultralytics.solutions.analytics.Analytics.process)
        - [`Analytics.update_graph`](#ultralytics.solutions.analytics.Analytics.update_graph)


## Class `ultralytics.solutions.analytics.Analytics` {#ultralytics.solutions.analytics.Analytics}

```python
Analytics(**kwargs: Any)
```
...
| Name | Description |
| --- | --- |
| [`process`](#ultralytics.solutions.analytics.Analytics.process) | Process image data and run object tracking to update analytics charts. |
| [`update_graph`](#ultralytics.solutions.analytics.Analytics.update_graph) | Update the graph with new data for single or multiple classes. |
...
<details>
<summary>Source code in <code>ultralytics/solutions/analytics.py</code></summary>

<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/solutions/analytics.py#L15-L264">View on GitHub</a>
```python
...
### Method `ultralytics.solutions.analytics.Analytics.process` {#ultralytics.solutions.analytics.Analytics.process}
...
| `frame_number` | `int` | Video frame number for plotting the data. | *required* |

**Returns**

| Type | Description |
| --- | --- |
| `SolutionResults` | Contains processed image `plot_im`, 'total_tracks' (int, total number of tracked objects) and 'classwise_count' (dict, per-class object count). |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/solutions/analytics.py#L95-L136">View on GitHub</a>
```python
def process(self, im0: np.ndarray, frame_number: int) -> SolutionResults:
    """Process image data and run object tracking to update analytics charts.
...
### Method `ultralytics.solutions.analytics.Analytics.update_graph` {#ultralytics.solutions.analytics.Analytics.update\_graph}
...
| `count_dict` | `dict[str, int], optional` | Dictionary with class names as keys and counts as values for multiple classes. If None, updates a single line graph. | `None` |
| `plot` | `str` | Type of the plot. Options are 'line', 'bar', 'pie', or 'area'. | `"line"` |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/solutions/analytics.py#L138-L264">View on GitHub</a>
```python
def update_graph(
