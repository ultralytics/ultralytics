...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/converter.py#L23-L122"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def coco91_to_coco80_class() -> list[int]:
    """Convert 91-index COCO class IDs to 80-index COCO class IDs.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/converter.py#L125-L226"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def coco80_to_coco91_class() -> list[int]:
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/converter.py#L229-L344"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def convert_coco(
    labels_dir: str = "../coco/annotations/",
    save_dir: str = "coco_converted/",
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/converter.py#L347-L419"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def convert_segment_masks_to_yolo_seg(masks_dir: str, output_dir: str, classes: int):
    """Convert a dataset of segmentation mask images to the YOLO segmentation format.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/converter.py#L422-L511"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def convert_dota_to_yolo_obb(dota_root_path: str):
    """Convert DOTA dataset annotations to YOLO OBB (Oriented Bounding Box) format.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/converter.py#L514-L526"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def min_index(arr1: np.ndarray, arr2: np.ndarray):
    """Find a pair of indexes with the shortest distance between two arrays of 2D points.
...
| Name | Type | Description | Default |
| --- | --- | --- | --- |
| `segments` | `list[list]` | Original segmentations in COCO's JSON file. Each element is a list of coordinates, like<br>    [segmentation1, segmentation2,...]. | *required* |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/converter.py#L529-L577"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def merge_multi_segment(segments: list[list]):
    """Merge multiple segments into one list by connecting the coordinates with the minimum distance between each
    segment.
...
| `save_dir` | `str | Path, optional` | Path to save the generated labels, labels will be saved into `labels-segment`<br>    in the same directory level of `im_dir` if save_dir is None. | `None` |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/converter.py#L580-L641"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def yolo_bbox2segment(im_dir: str | Path, save_dir: str | Path | None = None, sam_model: str = "sam_b.pt", device=None):
    """Convert existing object detection dataset (bounding boxes) to segmentation dataset in YOLO format.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/converter.py#L644-L696"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def create_synthetic_coco_dataset():
    """Create a synthetic COCO dataset with random images based on filenames from label lists.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/converter.py#L699-L747"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def convert_to_multispectral(path: str | Path, n_channels: int = 10, replace: bool = False, zip: bool = False):
    """Convert RGB images to multispectral images by interpolating across wavelength bands.
...
| `output_path` | `str | Path | None, optional` | Directory where the converted YOLO dataset will be saved. If None,<br>    uses the DATASETS_DIR directory. Defaults to None. | `None` |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/converter.py#L750-L898"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
async def convert_ndjson_to_yolo(ndjson_path: str | Path, output_path: str | Path | None = None) -> Path:
    """Convert NDJSON dataset format to Ultralytics YOLO dataset structure.
