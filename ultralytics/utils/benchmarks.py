...
def benchmark(
    ...
    **kwargs,
    ...
    Args:
        ...
        quantize (int | str | None): Export precision where the format supports it: 16 (FP16), 8 (INT8), or None/32
            (FP32). Each format then runs inference at its own runtime precision.
