...
| :----------------------------------------------------------------------------------------------------------------------------------------------: | :-----------------------------------------------------------------------------------------------------------------------------------------: | :-------------------------------------------------------------------------------------------------------------------------------------------------: |
| <img src="https://cdn.ul.run/i/9fbbd723bae594447ebecb1ca2be49f7.avif" alt="Original image without augmentation"/> | <img src="https://cdn.ul.run/i/8206af761dc359036f46085558ae50c0.avif" alt="Copy-paste augmentation enabled"/> | <img src="https://cdn.jsdelivr.net/gh/ultralytics/assets@main/docs/augmentation_copy_paste_demo.avif" alt="Copy-paste augmentation animated demo"/> |
