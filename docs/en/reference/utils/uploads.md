...
```python
_ProgressReader(file_path, pbar)
```
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/uploads.py#L13-L34">View on GitHub</a>
```python
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/uploads.py#L28-L30">View on GitHub</a>
```python
def __len__(self):
    """Return file size for Content-Length header."""
    return self._size
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/uploads.py#L32-L34">View on GitHub</a>
```python
def close(self):
    """Close the file."""
    self.file.close()
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/uploads.py#L21-L26">View on GitHub</a>
```python
def read(self, size=-1):
    """Read data and update progress bar."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/uploads.py#L37-L115">View on GitHub</a>
```python
def safe_upload(
    file: str | Path,
    url: str,
