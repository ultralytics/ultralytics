...
!!! abstract "Summary"
    ...
    === "<span class="doc-kind doc-kind-function">Functions</span>"
        ...
        - [`_sanitize_tune_value`](#ultralytics.utils.tuner._sanitize_tune_value)
        - [`_get_ray_search_alg_kind`](#ultralytics.utils.tuner._get_ray_search_alg_kind)
        - [`_validate_ax_search_space`](#ultralytics.utils.tuner._validate_ax_search_space)
        - [`_create_ax_search`](#ultralytics.utils.tuner._create_ax_search)
        - [`_convert_bohb_search_space`](#ultralytics.utils.tuner._convert_bohb_search_space)
        - [`_create_bohb_search`](#ultralytics.utils.tuner._create_bohb_search)
        - [`_create_nevergrad_search`](#ultralytics.utils.tuner._create_nevergrad_search)
        - [`_convert_zoopt_search_space`](#ultralytics.utils.tuner._convert_zoopt_search_space)
        - [`_create_zoopt_search`](#ultralytics.utils.tuner._create_zoopt_search)
        - [`_resolve_ray_search_alg`](#ultralytics.utils.tuner._resolve_ray_search_alg)
        - [`run_ray_tune`](#ultralytics.utils.tuner.run_ray_tune)


## Function `ultralytics.utils.tuner._sanitize_tune_value` {#ultralytics.utils.tuner.\_sanitize\_tune\_value}
...
| --- | --- | --- | --- |
| `value` | `dict` | The value to convert. Can be a dict, list, tuple, NumPy scalar, or NumPy array. | *required* |
...
<details>
<summary>Source code in <code>ultralytics/utils/tuner.py</code></summary>

<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/tuner.py#L23-L42">View on GitHub</a>
```python
def _sanitize_tune_value(value: dict):
    """Convert NumPy-backed Tune values into native Python types for YAML serialization.
...
## Function `ultralytics.utils.tuner._get_ray_search_alg_kind` {#ultralytics.utils.tuner.\_get\_ray\_search\_alg\_kind}
...
| Name | Type | Description | Default |
| --- | --- | --- | --- |
| `search_alg` | `str \| ray.tune.search.Searcher` | The search algorithm to identify. Can be None, a string, or a Ray Tune searcher object. | *required* |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/tuner.py#L45-L69">View on GitHub</a>
```python
def _get_ray_search_alg_kind(search_alg):
    """Return the normalized Ray Tune search algorithm kind for known searcher objects.
...
## Function `ultralytics.utils.tuner._validate_ax_search_space` {#ultralytics.utils.tuner.\_validate\_ax\_search\_space}
...
| Name | Type | Description | Default |
| --- | --- | --- | --- |
| `space` | `dict` | The hyperparameter search space to validate. | *required* |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/tuner.py#L72-L88">View on GitHub</a>
```python
def _validate_ax_search_space(space):
    """Validate that a Tune search space can be consumed by Ax.
...
## Function `ultralytics.utils.tuner._create_ax_search` {#ultralytics.utils.tuner.\_create\_ax\_search}
...
| Name | Type | Description | Default |
| --- | --- | --- | --- |
| `space` | `dict` | The hyperparameter search space. | *required* |
| `task` | `str` | The task type (e.g., 'detect', 'segment', 'classify'). | *required* |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/tuner.py#L91-L115">View on GitHub</a>
```python
def _create_ax_search(space, task):
    """Create an Ax searcher with an initialized experiment.
...
## Function `ultralytics.utils.tuner._convert_bohb_search_space` {#ultralytics.utils.tuner.\_convert\_bohb\_search\_space}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/tuner.py#L118-L172">View on GitHub</a>
```python
def _convert_bohb_search_space(space):
    """Convert a Tune search space into BOHB-compatible ConfigSpace and fixed-only Tune param_space.
...
## Function `ultralytics.utils.tuner._create_bohb_search` {#ultralytics.utils.tuner.\_create\_bohb\_search}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/tuner.py#L175-L192">View on GitHub</a>
```python
def _create_bohb_search(space, task):
    """Create a BOHB searcher using a ConfigSpace definition compatible with current ConfigSpace versions.
...
## Function `ultralytics.utils.tuner._create_nevergrad_search` {#ultralytics.utils.tuner.\_create\_nevergrad\_search}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/tuner.py#L195-L212">View on GitHub</a>
```python
def _create_nevergrad_search(task):
    """Create a Nevergrad searcher with a default optimizer.
...
## Function `ultralytics.utils.tuner._convert_zoopt_search_space` {#ultralytics.utils.tuner.\_convert\_zoopt\_search\_space}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/tuner.py#L215-L237">View on GitHub</a>
```python
def _convert_zoopt_search_space(space):
    """Convert a Tune search space into ZOOpt-compatible dimensions and fixed-only Tune param_space.
...
## Function `ultralytics.utils.tuner._create_zoopt_search` {#ultralytics.utils.tuner.\_create\_zoopt\_search}
...
| `space` | `dict` | The hyperparameter search space. | *required* |
| `task` | `str` | The task type (e.g., 'detect', 'segment', 'classify'). | *required* |
| `iterations` | `int` | The maximum number of trials (budget) for ZOOpt. | *required* |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/tuner.py#L240-L260">View on GitHub</a>
```python
def _create_zoopt_search(space, task, iterations):
    """Create a ZOOpt searcher with required budget and converted search space.
...
## Function `ultralytics.utils.tuner._resolve_ray_search_alg` {#ultralytics.utils.tuner.\_resolve\_ray\_search\_alg}
...
| Name | Type | Description | Default |
| --- | --- | --- | --- |
| `search_alg` | `str \| object \| None` | The search algorithm to use. Can be a string name, a pre-instantiated Ray Tune searcher object, or None for default behavior. | *required* |
| `task` | `str` | The task type (e.g., 'detect', 'segment', 'classify'). | *required* |
| `space` | `dict` | The hyperparameter search space. | *required* |
| `iterations` | `int` | The maximum number of trials to run. | *required* |

**Returns**

| Type | Description |
| --- | --- |
| `tuple` | A tuple containing (resolved_search_alg, tuner_param_space, resolved_search_alg_kind).<br>- resolved_search_alg: The configured searcher or None.<br>- tuner_param_space: The normalized parameter space for the tuner.<br>- resolved_search_alg_kind: The normalized algorithm name or None. |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/tuner.py#L263-L331">View on GitHub</a>
```python
def _resolve_ray_search_alg(search_alg, task, space, iterations):
    """Resolve search algorithms and normalize Tune param_space for known Ray Tune searchers.
...
## Function `ultralytics.utils.tuner.run_ray_tune` {#ultralytics.utils.tuner.run\_ray\_tune}
...
| Name | Type | Description | Default |
| --- | --- | --- | --- |
| `model` | `YOLO` | Model to run the tuner on. | *required* |
| `space` | `dict, optional` | The hyperparameter search space. If not provided, uses default space. | `None` |
...
| `iterations` | `int, optional` | The maximum number of trials to run. | `10` |
| `search_alg` | `str \| ray.tune.search.Searcher \| ray.tune.search.SearchAlgorithm, optional` | Search algorithm to use. Strings are resolved to supported Ray Tune searchers. Pre-instantiated objects are reused, and known searchers with special Tune param_space requirements are normalized automatically. | `None` |
| `**train_args` | `Any` | Additional arguments to pass to the `train()` method. | *required* |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/tuner.py#L334-L515">View on GitHub</a>
```python
def run_ray_tune(
    model,
    space: dict | None = None,
