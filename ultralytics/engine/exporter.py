...
def export_formats():
    ...
    x = [
        ...
        ["DEEPX", "deepx", "_deepx_model", False, False, ["data", "quantize", "opset", "simplify", "optimize"], "isolated-deepx"],
        ["Qualcomm QNN", "qnn", "_qnn.onnx", False, False, ["batch", "name", "quantize", "opset", "simplify", "fraction", "data"], "base"],
