...
!!! abstract "Summary"
    ...
    === "<span class="doc-kind doc-kind-method">Methods</span>"
        ...
        - [`YOLOE._prompt_embedding_model`](#ultralytics.models.yolo.model.YOLOE._prompt_embedding_model)
        - [`YOLOE.save_prompt_embeddings`](#ultralytics.models.yolo.model.YOLOE.save_prompt_embeddings)
        - [`YOLOE.load_prompt_embeddings`](#ultralytics.models.yolo.model.YOLOE.load_prompt_embeddings)
...
| `task` | `str, optional` | YOLO task specification, i.e. 'detect', 'segment', 'classify', 'pose', 'obb'. Defaults to auto-detection based on model. | `None` |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/yolo/model.py#L31-L136">View on GitHub</a>
```python
class YOLO(Model):
    """YOLO (You Only Look Once) object detection model.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/yolo/model.py#L91-L136">View on GitHub</a>
```python
@property
def task_map(self) -> dict[str, dict[str, Any]]:
    """Map head to model, trainer, validator, and predictor classes."""
...
```python
YOLOWorld(model: str | Path = "yolov8s-world.pt", verbose: bool = False)
```
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/yolo/model.py#L139-L207">View on GitHub</a>
```python
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/yolo/model.py#L181-L190">View on GitHub</a>
```python
@property
def task_map(self) -> dict[str, dict[str, Any]]:
    """Map head to model, trainer, validator, and predictor classes."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/yolo/model.py#L192-L207">View on GitHub</a>
```python
def set_classes(self, classes: list[str]) -> None:
    """Set the model's class names for detection.
...
```python
YOLOE(model: str | Path = "yoloe-11s-seg.pt", task: str | None = None, verbose: bool = False)
```
...
| [`_prompt_embedding_model`](#ultralytics.models.yolo.model.YOLOE._prompt_embedding_model) | Return the checkpoint identifier used to bind prompt embeddings to this model. |
...
| [`get_vocab`](#ultralytics.models.yolo.model.YOLOE.get_vocab) | Get the vocabulary for the given class names, which become the model's classes as the head is fused. |
| [`load_prompt_embeddings`](#ultralytics.models.yolo.model.YOLOE.load_prompt_embeddings) | Load prompt embeddings and class names from a model-bound NPZ file. |
| [`predict`](#ultralytics.models.yolo.model.YOLOE.predict) | Run prediction on images, videos, directories, streams, etc. |
| [`save_prompt_embeddings`](#ultralytics.models.yolo.model.YOLOE.save_prompt_embeddings) | Save the current prompt embeddings and class names to an NPZ file. |
| [`set_classes`](#ultralytics.models.yolo.model.YOLOE.set_classes) | Set the model's class names and embeddings for detection. |
| [`set_vocab`](#ultralytics.models.yolo.model.YOLOE.set_vocab) | Re-parameterize the model into a prompt-free one over the given class names. |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/yolo/model.py#L210-L552">View on GitHub</a>
```python
class YOLOE(Model):
    """YOLOE object detection and segmentation model.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/yolo/model.py#L259-L274">View on GitHub</a>
```python
@property
def task_map(self) -> dict[str, dict[str, Any]]:
    """Map head to model, trainer, validator, and predictor classes."""
...
### Method `ultralytics.models.yolo.model.YOLOE._prompt_embedding_model` {#ultralytics.models.yolo.model.YOLOE.\_prompt\_embedding\_model}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/yolo/model.py#L352-L357">View on GitHub</a>
```python
def _prompt_embedding_model(self) -> str:
    """Return the checkpoint identifier used to bind prompt embeddings to this model."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/yolo/model.py#L276-L279">View on GitHub</a>
```python
def get_text_pe(self, texts):
    """Get text positional embeddings for the given texts."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/yolo/model.py#L281-L301">View on GitHub</a>
```python
def get_visual_pe(self, img, visual):
    """Get visual positional embeddings for the given image and visual features.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/yolo/model.py#L326-L330">View on GitHub</a>
```python
def get_vocab(self, names):
    """Get the vocabulary for the given class names, which become the model's classes as the head is fused."""
    assert isinstance(self.model, YOLOEModel)
...
### Method `ultralytics.models.yolo.model.YOLOE.load_prompt_embeddings` {#ultralytics.models.yolo.model.YOLOE.load\_prompt\_embeddings}
...
| Name | Type | Description | Default |
| --- | --- | --- | --- |
| `file` | `str \| Path` | Source NPZ file path created by :meth:`save_prompt_embeddings`. | *required* |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/yolo/model.py#L390-L420">View on GitHub</a>
```python
def load_prompt_embeddings(self, file: str | Path) -> None:
    """Load prompt embeddings and class names from a model-bound NPZ file.
...
| Name | Type | Description | Default |
| --- | --- | --- | --- |
| `source` | `str \| int \| PIL.Image \| np.ndarray, optional` | Source for prediction. Accepts image paths, directory paths, URL/YouTube streams, PIL images, numpy arrays, or webcam indices. | `None` |
...
| `visual_prompts` | `dict[str, np.ndarray \| list[np.ndarray]]` | Dictionary containing visual prompts for the model. Must include 'bboxes' and 'cls' keys when non-empty, holding either flat arrays or one array per image for an explicit list, tuple, or 4-D tensor source with no refer_image. | `None` |
| `refer_image` | `str \| PIL.Image \| np.ndarray, optional` | Reference image for visual prompts. | `None` |
| `predictor` | `callable` | Custom predictor class for visual prompt predictions. Defaults to YOLOEVPDetectPredictor. | `yolo.yoloe.YOLOEVPDetectPredictor` |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/yolo/model.py#L448-L552">View on GitHub</a>
```python
def predict(
    self,
    source=None,
...
### Method `ultralytics.models.yolo.model.YOLOE.save_prompt_embeddings` {#ultralytics.models.yolo.model.YOLOE.save\_prompt\_embeddings}
...
| Name | Type | Description | Default |
| --- | --- | --- | --- |
| `file` | `str \| Path` | Destination NPZ file path. | *required* |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/yolo/model.py#L359-L388">View on GitHub</a>
```python
def save_prompt_embeddings(self, file: str | Path) -> Path:
    """Save the current prompt embeddings and class names to an NPZ file.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/yolo/model.py#L332-L350">View on GitHub</a>
```python
def set_classes(self, classes: list[str], embeddings: torch.Tensor | None = None) -> None:
    """Set the model's class names and embeddings for detection.
...
The vocabulary is the fused classification layer `get_vocab` returns for the same names, not the names themselves. The model must be an instance of YOLOEModel.

**Args**

| Name | Type | Description | Default |
| --- | --- | --- | --- |
| `vocab` | `torch.nn.ModuleList` | Fused classification layers returned by `get_vocab` for `names`. | *required* |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/yolo/model.py#L303-L324">View on GitHub</a>
```python
def set_vocab(self, vocab: torch.nn.ModuleList, names: list[str]) -> None:
    """Re-parameterize the model into a prompt-free one over the given class names.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/yolo/model.py#L422-L446">View on GitHub</a>
```python
def val(
    self,
    validator=None,
