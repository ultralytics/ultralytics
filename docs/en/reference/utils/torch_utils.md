...
!!! abstract "Summary"
    ...
    === "<span class="doc-kind doc-kind-function">Functions</span>"
        ...
        - [`get_torch_device_backend`](#ultralytics.utils.torch_utils.get_torch_device_backend)
        ...
        - [`parse_device`](#ultralytics.utils.torch_utils.parse_device)
        ...
        - [`_attention_ops`](#ultralytics.utils.torch_utils._attention_ops)
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/torch_utils.py#L706-L777">View on GitHub</a>
```python
class ModelEMA:
    """Updated Exponential Moving Average (EMA) implementation.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/torch_utils.py#L744-L766">View on GitHub</a>
```python
def update(self, model):
    """Update EMA parameters.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/torch_utils.py#L768-L777">View on GitHub</a>
```python
def update_attr(self, model, include=(), exclude=("process_group", "reducer")):
    """Copy attributes from model to EMA, with options to include/exclude certain attributes.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/torch_utils.py#L985-L1033">View on GitHub</a>
```python
class EarlyStopping:
    """Early stopping class that stops training when a specified number of epochs have passed without improvement.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/torch_utils.py#L1006-L1033">View on GitHub</a>
```python
def __call__(self, epoch, fitness):
    """Check whether to stop training.
...
## Function `ultralytics.utils.torch_utils.get_torch_device_backend` {#ultralytics.utils.torch\_utils.get\_torch\_device\_backend}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/torch_utils.py#L65-L68">View on GitHub</a>
```python
def get_torch_device_backend(device: torch.device | str):
    """Return the PyTorch module that owns the selected device backend."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/torch_utils.py#L72-L81">View on GitHub</a>
```python
@contextmanager
def torch_distributed_zero_first(local_rank: int):
    """Ensure all processes in distributed training wait for the local master (rank 0) to complete a task first."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/torch_utils.py#L84-L96">View on GitHub</a>
```python
def smart_inference_mode(mode=True):
    """Apply or disable torch inference mode while supporting the minimum torch version."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/torch_utils.py#L99-L130">View on GitHub</a>
```python
def autocast(enabled: bool, device: str = "cuda"):
    """Get the appropriate autocast context manager based on PyTorch version and AMP setting.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/torch_utils.py#L134-L136">View on GitHub</a>
```python
@functools.lru_cache
def get_cpu_info():
    """Return a string with system CPU information, i.e. 'Apple M2'."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/torch_utils.py#L140-L143">View on GitHub</a>
```python
@functools.lru_cache
def get_gpu_info(index):
    """Return a string with system GPU information, i.e. 'Tesla T4, 15102MiB'."""
...
## Function `ultralytics.utils.torch_utils.parse_device` {#ultralytics.utils.torch\_utils.parse\_device}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/torch_utils.py#L146-L209">View on GitHub</a>
```python
def parse_device(device: str | int | list | tuple | torch.device = "") -> str:
    """Parse a device request of any form into a canonical device string.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/torch_utils.py#L212-L331">View on GitHub</a>
```python
def select_device(device="", newline=False, verbose=True):
    """Select the appropriate PyTorch device based on the provided arguments.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/torch_utils.py#L334-L340">View on GitHub</a>
```python
def time_sync(device: torch.device | None = None):
    """Return PyTorch-accurate time."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/torch_utils.py#L343-L376">View on GitHub</a>
```python
def fuse_conv_and_bn(conv, bn):
    """Fuse Conv2d and BatchNorm2d layers for inference optimization.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/torch_utils.py#L379-L416">View on GitHub</a>
```python
def fuse_deconv_and_bn(deconv, bn):
    """Fuse ConvTranspose2d and BatchNorm2d layers for inference optimization.
...
| Type | Description |
| --- | --- |
| `tuple` | Tuple containing:<br>- n_l (int): Number of layers.<br>- n_p (int): Number of parameters.<br>- n_g (int): Number of gradients.<br>- flops (float): GFLOPs. |

<details>
<summary>Source code in <code>ultralytics/utils/torch_utils.py</code></summary>

<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/torch_utils.py#L419-L461">View on GitHub</a>
```python
def model_info(model, detailed=False, verbose=True, imgsz=640):
    """Print and return detailed model information layer by layer.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/torch_utils.py#L464-L466">View on GitHub</a>
```python
def get_num_params(model):
    """Return the total number of parameters in a YOLO model."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/torch_utils.py#L469-L471">View on GitHub</a>
```python
def get_num_gradients(model):
    """Return the total number of parameters with gradients in a YOLO model."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/torch_utils.py#L474-L504">View on GitHub</a>
```python
def model_info_for_loggers(trainer):
    """Return model info dict with useful model information.
...
## Function `ultralytics.utils.torch_utils._attention_ops` {#ultralytics.utils.torch\_utils.\_attention\_ops}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/torch_utils.py#L507-L518">View on GitHub</a>
```python
def _attention_ops(m, x, y):
    """Count the query-key and attention-value matmuls of an attention block for THOP.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/torch_utils.py#L521-L560">View on GitHub</a>
```python
def get_flops(model, imgsz=640):
    """Calculate FLOPs (floating point operations) for a model in GFLOPs.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/torch_utils.py#L563-L573">View on GitHub</a>
```python
def initialize_weights(model):
    """Initialize model weights, biases, and module settings to default values."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/torch_utils.py#L576-L595">View on GitHub</a>
```python
def scale_img(img, ratio=1.0, same_shape=False, gs=32):
    """Scale and pad an image tensor, optionally maintaining aspect ratio and padding to gs multiple.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/torch_utils.py#L598-L611">View on GitHub</a>
```python
def copy_attr(a, b, include=(), exclude=()):
    """Copy attributes from object 'b' to object 'a', with options to include/exclude certain attributes.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/torch_utils.py#L614-L625">View on GitHub</a>
```python
def intersect_dicts(da, db, exclude=()):
    """Return a dictionary of intersecting keys with matching shapes, excluding 'exclude' keys, using da values.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/torch_utils.py#L628-L637">View on GitHub</a>
```python
def is_parallel(model):
    """Return True if model is of type DP or DDP.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/torch_utils.py#L640-L656">View on GitHub</a>
```python
def unwrap_model(m: nn.Module) -> nn.Module:
    """Unwrap compiled and parallel models to get the base model.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/torch_utils.py#L659-L670">View on GitHub</a>
```python
def one_cycle(y1=0.0, y2=1.0, steps=100):
    """Return a lambda function for sinusoidal ramp from y1 to y2 https://arxiv.org/pdf/1812.01187.pdf.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/torch_utils.py#L673-L695">View on GitHub</a>
```python
def init_seeds(seed=0, deterministic=False):
    """Initialize random number generator (RNG) seeds https://pytorch.org/docs/stable/notes/randomness.html.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/torch_utils.py#L698-L703">View on GitHub</a>
```python
def unset_deterministic():
    """Unset all the configurations applied for deterministic training."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/torch_utils.py#L780-L845">View on GitHub</a>
```python
def strip_optimizer(f: str | Path = "best.pt", s: str = "", updates: dict[str, Any] | None = None) -> dict[str, Any]:
    """Strip optimizer from 'f' to finalize training, optionally save as 's'.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/torch_utils.py#L848-L862">View on GitHub</a>
```python
def convert_optimizer_state_dict_to_fp16(state_dict):
    """Convert the state_dict of a given optimizer to FP16, focusing on the 'state' key for tensor conversions.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/torch_utils.py#L866-L890">View on GitHub</a>
```python
@contextmanager
def cuda_memory_usage(device=None):
    """Monitor and manage accelerator memory usage.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/torch_utils.py#L893-L982">View on GitHub</a>
```python
def profile_ops(input, ops, n=10, device=None, max_num_obj=0):
    """Ultralytics speed, memory and FLOPs profiler.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/torch_utils.py#L1036-L1121">View on GitHub</a>
```python
def attempt_compile(
    model: torch.nn.Module,
    device: torch.device,
