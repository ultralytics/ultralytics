...
!!! abstract "Summary"
    ...
    === "<span class="doc-kind doc-kind-function">Functions</span>"
        ...
        - [`tf_wrapper`](#ultralytics.utils.export.tensorflow.tf_wrapper)
        - [`_tf_decode_boxes`](#ultralytics.utils.export.tensorflow._tf_decode_boxes)
        - [`_tf_kpts_decode`](#ultralytics.utils.export.tensorflow._tf_kpts_decode)
        - [`onnx2saved_model`](#ultralytics.utils.export.tensorflow.onnx2saved_model)
        - [`keras2pb`](#ultralytics.utils.export.tensorflow.keras2pb)
        - [`tflite2edgetpu`](#ultralytics.utils.export.tensorflow.tflite2edgetpu)
        - [`pb2tfjs`](#ultralytics.utils.export.tensorflow.pb2tfjs)
        - [`gd_outputs`](#ultralytics.utils.export.tensorflow.gd_outputs)


## Function `ultralytics.utils.export.tensorflow.tf_wrapper` {#ultralytics.utils.export.tensorflow.tf\_wrapper}
...
<details>
<summary>Source code in <code>ultralytics/utils/export/tensorflow.py</code></summary>

<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/export/tensorflow.py#L18-L28"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def tf_wrapper(model: torch.nn.Module) -> torch.nn.Module:
    """A wrapper for TensorFlow export compatibility (TF-specific handling is now in head modules)."""
...
## Function `ultralytics.utils.export.tensorflow._tf_decode_boxes` {#ultralytics.utils.export.tensorflow.\_tf\_decode\_boxes}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/export/tensorflow.py#L31-L42"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def _tf_decode_boxes(self, x: dict[str, torch.Tensor]) -> torch.Tensor:
    """Decode bounding boxes for TensorFlow export."""
...
## Function `ultralytics.utils.export.tensorflow._tf_kpts_decode` {#ultralytics.utils.export.tensorflow.\_tf\_kpts\_decode}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/export/tensorflow.py#L45-L57"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def _tf_kpts_decode(self, kpts: torch.Tensor, is_pose26: bool = False) -> torch.Tensor:
    """Decode keypoints for TensorFlow export."""
...
## Function `ultralytics.utils.export.tensorflow.onnx2saved_model` {#ultralytics.utils.export.tensorflow.onnx2saved\_model}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/export/tensorflow.py#L60-L133"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def onnx2saved_model(
    onnx_file: str,
    output_dir: Path,
...
## Function `ultralytics.utils.export.tensorflow.keras2pb` {#ultralytics.utils.export.tensorflow.keras2pb}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/export/tensorflow.py#L136-L155"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def keras2pb(keras_model, file: Path, prefix=""):
    """Convert a Keras model to TensorFlow GraphDef (.pb) format.
...
## Function `ultralytics.utils.export.tensorflow.tflite2edgetpu` {#ultralytics.utils.export.tensorflow.tflite2edgetpu}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/export/tensorflow.py#L158-L182"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def tflite2edgetpu(tflite_file: str | Path, output_dir: str | Path, prefix: str = ""):
    """Convert a TensorFlow Lite model to Edge TPU format using the Edge TPU compiler.
...
## Function `ultralytics.utils.export.tensorflow.pb2tfjs` {#ultralytics.utils.export.tensorflow.pb2tfjs}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/export/tensorflow.py#L185-L222"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def pb2tfjs(pb_file: str, output_dir: str, half: bool = False, int8: bool = False, prefix: str = ""):
    """Convert a TensorFlow GraphDef (.pb) model to TensorFlow.js format.
...
## Function `ultralytics.utils.export.tensorflow.gd_outputs` {#ultralytics.utils.export.tensorflow.gd\_outputs}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/export/tensorflow.py#L225-L231"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def gd_outputs(gd):
    """Return TensorFlow GraphDef model output node names."""
