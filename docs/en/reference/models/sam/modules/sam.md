...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/modules/sam.py#L25-L88">View on GitHub</a>
```python
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/modules/sam.py#L82-L88">View on GitHub</a>
```python
def set_imgsz(self, imgsz):
    """Set image size to make model compatible with different image sizes."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/modules/sam.py#L91-L1022">View on GitHub</a>
```python
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/modules/sam.py#L346-L348">View on GitHub</a>
```python
@property
def device(self):
    """Return the device on which the model's parameters are stored."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/modules/sam.py#L989-L1004">View on GitHub</a>
```python
@staticmethod
def _apply_non_overlapping_constraints(pred_masks):
    """Apply non-overlapping constraints to masks, keeping the highest scoring object per location."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/modules/sam.py#L357-L402">View on GitHub</a>
```python
def _build_sam_heads(self):
    """Build SAM-style prompt encoder and mask decoder for image segmentation tasks."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/modules/sam.py#L894-L917">View on GitHub</a>
```python
def _encode_memory_in_output(
    self,
    current_vision_feats,
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/modules/sam.py#L793-L834">View on GitHub</a>
```python
def _encode_new_memory(
    self,
    current_vision_feats,
...
| `point_inputs` | `dict[str, torch.Tensor] \| None` | Dictionary containing point prompts with keys 'point_coords' (Tensor of shape (B, P, 2) with float32 dtype, containing absolute pixel-unit coordinates in (x, y) format for P input points) and 'point_labels' (Tensor of shape (B, P) with int32 dtype, where 1 means positive clicks, 0 means negative clicks, and -1 means padding). | `None` |
| `mask_inputs` | `torch.Tensor \| None` | Mask of shape (B, 1, H*16, W*16), float or bool, with the same spatial size as the image. | `None` |
| `high_res_features` | `list[torch.Tensor] \| None` | List of two feature maps with shapes (B, C, 4*H, 4*W) and (B, C, 2*H, 2*W) respectively, used as high-resolution feature maps for SAM decoder. | `None` |
| `multimask_output` | `bool` | If True, output 3 candidate masks and their IoU estimates; if False, output only 1 mask and its IoU estimate. | `False` |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/modules/sam.py#L404-L550">View on GitHub</a>
```python
def _forward_sam_heads(
    self,
    backbone_features,
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/modules/sam.py#L609-L627">View on GitHub</a>
```python
def _prepare_backbone_features(self, backbone_out, batch=1):
    """Prepare and flatten visual features from the image backbone output for further processing."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/modules/sam.py#L629-L791">View on GitHub</a>
```python
def _prepare_memory_conditioned_features(
    self,
    frame_idx,
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/modules/sam.py#L836-L892">View on GitHub</a>
```python
def _track_step(
    self,
    frame_idx,
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/modules/sam.py#L552-L597">View on GitHub</a>
```python
def _use_mask_as_output(self, mask_inputs, backbone_features=None, high_res_features=None):
    """Process mask inputs directly as output, bypassing SAM encoder/decoder."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/modules/sam.py#L979-L986">View on GitHub</a>
```python
def _use_multimask(self, is_init_cond_frame, point_inputs):
    """Determine whether to use multiple mask outputs in the SAM head based on configuration and inputs."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/modules/sam.py#L350-L355">View on GitHub</a>
```python
def forward(self, *args, **kwargs):
    """Process image and prompt inputs to generate object masks and scores in video sequences."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/modules/sam.py#L599-L607">View on GitHub</a>
```python
def forward_image(self, img_batch: torch.Tensor):
    """Process image batch through encoder to extract multi-level features for SAM model."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/modules/sam.py#L1006-L1008">View on GitHub</a>
```python
def set_binarize(self, binarize=False):
    """Set binarize for VideoPredictor."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/modules/sam.py#L1010-L1022">View on GitHub</a>
```python
def set_imgsz(self, imgsz):
    """Set image size to make model compatible with different image sizes."""
    if hasattr(self.image_encoder, "set_imgsz"):
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/modules/sam.py#L919-L977">View on GitHub</a>
```python
def track_step(
    self,
    frame_idx,
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/modules/sam.py#L1025-L1159">View on GitHub</a>
```python
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/modules/sam.py#L1150-L1159">View on GitHub</a>
```python
def _suppress_object_pw_area_shrinkage(self, pred_masks):
    """This function suppresses masks that shrink in area after applying pixelwise non-overlapping constraints. Note
    that the final output can still be overlapping.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/modules/sam.py#L1139-L1148">View on GitHub</a>
```python
@staticmethod
def _suppress_shrinked_masks(pred_masks, new_pred_masks, shrink_threshold=0.3):
    """Suppress masks that shrink in area after applying pixelwise non-overlapping constraints."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/modules/sam.py#L1123-L1131">View on GitHub</a>
```python
def forward_image(self, img_batch: torch.Tensor):
    """Process image batch through encoder to extract multi-level features for SAM model."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/modules/sam.py#L1133-L1136">View on GitHub</a>
```python
def set_imgsz(self, imgsz: tuple[int, int]):
    """Set the image size for the model and mask downsampler."""
