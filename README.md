...
- **delta1<sup>val</sup>** is the percentage of pixels within the 1.25× threshold on the NYU Depth V2 validation set. <br>Reproduce with `yolo depth val data=nyu-depth.yaml device=0 imgsz=518`
