...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/solutions/heatmap.py#L15-L130">View on GitHub</a>
```python
...
| Name | Type | Description | Default |
| --- | --- | --- | --- |
| `box` | `torch.Tensor` | Bounding box coordinates [x0, y0, x1, y1] or (4, 2) OBB corner points. | *required* |

<details>
<summary>Source code in <code>ultralytics/solutions/heatmap.py</code></summary>

<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/solutions/heatmap.py#L54-L75">View on GitHub</a>
```python
def heatmap_effect(self, box: torch.Tensor) -> None:
    """Efficiently calculate heatmap area and effect location for applying colormap.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/solutions/heatmap.py#L77-L130">View on GitHub</a>
```python
def process(self, im0: np.ndarray) -> SolutionResults:
    """Generate heatmap for each frame using Ultralytics tracking.
