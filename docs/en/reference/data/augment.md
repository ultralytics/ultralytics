...
!!! abstract "Summary"
    ...
    === "<span class="doc-kind doc-kind-method">Methods</span>"
        ...
        - [`BaseMixTransform._mix_transform`](#ultralytics.data.augment.BaseMixTransform._mix_transform)
        ...
        - [`Mosaic._mix_transform`](#ultralytics.data.augment.Mosaic._mix_transform)
        - [`Mosaic._mosaic3`](#ultralytics.data.augment.Mosaic._mosaic3)
        - [`Mosaic._mosaic4`](#ultralytics.data.augment.Mosaic._mosaic4)
        - [`Mosaic._mosaic9`](#ultralytics.data.augment.Mosaic._mosaic9)
        ...
        - [`MixUp._mix_transform`](#ultralytics.data.augment.MixUp._mix_transform)
        - [`CutMix._rand_bbox`](#ultralytics.data.augment.CutMix._rand_bbox)
        - [`CutMix._mix_transform`](#ultralytics.data.augment.CutMix._mix_transform)
        - [`RandomPerspective.affine_transform`](#ultralytics.data.augment.RandomPerspective.affine_transform)
        ...
        - [`RandomPerspective.__call__`](#ultralytics.data.augment.RandomPerspective.__call__)
        - [`RandomPerspective.box_candidates`](#ultralytics.data.augment.RandomPerspective.box_candidates)
        - [`RandomHSV.__call__`](#ultralytics.data.augment.RandomHSV.__call__)
        - [`RandomFlip.__call__`](#ultralytics.data.augment.RandomFlip.__call__)
        ...
        - [`CopyPaste._mix_transform`](#ultralytics.data.augment.CopyPaste._mix_transform)
        - [`CopyPaste.__call__`](#ultralytics.data.augment.CopyPaste.__call__)
        - [`CopyPaste._transform`](#ultralytics.data.augment.CopyPaste._transform)
        - [`Albumentations.__call__`](#ultralytics.data.augment.Albumentations.__call__)
        - [`Format.__call__`](#ultralytics.data.augment.Format.__call__)
        ...
        - [`LoadVisualPrompt.__call__`](#ultralytics.data.augment.LoadVisualPrompt.__call__)
        - [`LoadVisualPrompt.get_visuals`](#ultralytics.data.augment.LoadVisualPrompt.get_visuals)
        - [`RandomLoadText.__call__`](#ultralytics.data.augment.RandomLoadText.__call__)
...
| Name | Description |
| --- | --- |
| [`__call__`](#ultralytics.data.augment.BaseTransform.__call__) | Apply all label transformations to an image, instances, and semantic masks. |
| [`apply_image`](#ultralytics.data.augment.BaseTransform.apply_image) | Apply image transformations to labels. |
| [`apply_instances`](#ultralytics.data.augment.BaseTransform.apply_instances) | Apply transformations to object instances in labels. |
| [`apply_semantic`](#ultralytics.data.augment.BaseTransform.apply_semantic) | Apply semantic segmentation transformations to an image. |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/augment.py#L28-L136"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
class BaseTransform:
    """Base class for image transformations in the Ultralytics library.
...
| --- | --- | --- | --- |
| `labels` | `dict` | A dictionary containing image data and annotations. Expected keys include 'img' for the image<br>    data, and 'instances' for object instances. | *required* |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/augment.py#L115-L136"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def __call__(self, labels):
    """Apply all label transformations to an image, instances, and semantic masks.
...
| Name | Type | Description | Default |
| --- | --- | --- | --- |
| `labels` | `Any` | The input labels to be transformed. The exact type and structure of labels may vary depending<br>    on the specific implementation. | *required* |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/augment.py#L54-L74"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def apply_image(self, labels):
    """Apply image transformations to labels.
...
| Name | Type | Description | Default |
| --- | --- | --- | --- |
| `labels` | `dict` | A dictionary containing label information, including object instances. | *required* |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/augment.py#L76-L94"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def apply_instances(self, labels):
    """Apply transformations to object instances in labels.
...
| Name | Type | Description | Default |
| --- | --- | --- | --- |
| `labels` | `Any` | The input labels or semantic segmentation mask to be transformed. | *required* |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/augment.py#L96-L113"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def apply_semantic(self, labels):
    """Apply semantic segmentation transformations to an image.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/augment.py#L139-L294"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
class Compose:
    """A class for composing multiple image transformations.
...
| Name | Type | Description | Default |
| --- | --- | --- | --- |
| `data` | `Any` | The input data to be transformed. This can be of any type, depending on the transformations in<br>    the list. | *required* |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/augment.py#L169-L188"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def __call__(self, data):
    """Apply a series of transformations to input data.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/augment.py#L217-L236"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def __getitem__(self, index: list | int) -> Compose:
    """Retrieve a specific transform or a set of transforms using indexing.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/augment.py#L279-L294"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def __repr__(self):
    """Return a string representation of the Compose object.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/augment.py#L238-L262"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def __setitem__(self, index: list | int, value: list | int) -> None:
    """Set one or more transforms in the composition using indexing.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/augment.py#L190-L200"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def append(self, transform):
    """Append a new transform to the existing list of transforms.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/augment.py#L202-L215"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def insert(self, index, transform):
    """Insert a new transform at a specified index in the existing list of transforms.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/augment.py#L264-L277"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def tolist(self):
    """Convert the list of transforms to a standard Python list.
...
| [`_mix_transform`](#ultralytics.data.augment.BaseMixTransform._mix_transform) | Apply CutMix, MixUp or Mosaic augmentation to the label dictionary. |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/augment.py#L297-L455"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/augment.py#L341-L378"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def __call__(self, labels: dict[str, Any]) -> dict[str, Any]:
    """Apply pre-processing transforms and cutmix/mixup/mosaic transforms to labels data.
...
### Method `ultralytics.data.augment.BaseMixTransform._mix_transform` {#ultralytics.data.augment.BaseMixTransform.\_mix\_transform}
...
| Name | Type | Description | Default |
| --- | --- | --- | --- |
| `labels` | `dict[str, Any]` | A dictionary containing image and label data. Expected to have a 'mix_labels' key<br>    with a list of additional image and label data for mixing. | *required* |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/augment.py#L380-L398"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def _mix_transform(self, labels: dict[str, Any]):
    """Apply CutMix, MixUp or Mosaic augmentation to the label dictionary.
...
| Name | Type | Description | Default |
| --- | --- | --- | --- |
| `labels` | `dict[str, Any]` | A dictionary containing label information, including 'texts' and 'cls' fields, and<br>    optionally a 'mix_labels' field with additional label dictionaries. | *required* |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/augment.py#L414-L455"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
@staticmethod
def _update_label_text(labels: dict[str, Any]) -> dict[str, Any]:
    """Update label text and class IDs for mixed labels in image augmentation.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/augment.py#L400-L411"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def get_indexes(self):
    """Get a random index for mosaic augmentation.
...
| [`_mix_transform`](#ultralytics.data.augment.Mosaic._mix_transform) | Apply mosaic augmentation to the input image and labels. |
| [`_mosaic3`](#ultralytics.data.augment.Mosaic._mosaic3) | Create a 1x3 image mosaic by combining three images. |
| [`_mosaic4`](#ultralytics.data.augment.Mosaic._mosaic4) | Create a 2x2 image mosaic from four input images. |
| [`_mosaic9`](#ultralytics.data.augment.Mosaic._mosaic9) | Create a 3x3 image mosaic from the input image and eight additional images. |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/augment.py#L458-L817"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/augment.py#L769-L817"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def _cat_labels(self, mosaic_labels: list[dict[str, Any]]) -> dict[str, Any]:
    """Concatenate and process labels for mosaic augmentation.
...
### Method `ultralytics.data.augment.Mosaic._mix_transform` {#ultralytics.data.augment.Mosaic.\_mix\_transform}
...
| Name | Type | Description | Default |
| --- | --- | --- | --- |
| `labels` | `dict[str, Any]` | A dictionary containing image data and annotations. Expected keys include:<br>    - 'rect_shape': Should be None as rect and mosaic are mutually exclusive.<br>    - 'mix_labels': A list of dictionaries containing data for other images to be used in the mosaic. | *required* |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/augment.py#L527-L553"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def _mix_transform(self, labels: dict[str, Any]) -> dict[str, Any]:
    """Apply mosaic augmentation to the input image and labels.
...
### Method `ultralytics.data.augment.Mosaic._mosaic3` {#ultralytics.data.augment.Mosaic.\_mosaic3}
...
| Name | Type | Description | Default |
| --- | --- | --- | --- |
| `labels` | `dict[str, Any]` | A dictionary containing image and label information for the main (center) image.<br>    Must include 'img' key with the image array, and 'mix_labels' key with a list of two dictionaries<br>    containing information for the side images. | *required* |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/augment.py#L555-L611"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def _mosaic3(self, labels: dict[str, Any]) -> dict[str, Any]:
    """Create a 1x3 image mosaic by combining three images.
...
### Method `ultralytics.data.augment.Mosaic._mosaic4` {#ultralytics.data.augment.Mosaic.\_mosaic4}
...
| Name | Type | Description | Default |
| --- | --- | --- | --- |
| `labels` | `dict[str, Any]` | A dictionary containing image data and labels for the base image (index 0) and<br>    three additional images (indices 1-3) in the 'mix_labels' key. | *required* |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/augment.py#L613-L669"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def _mosaic4(self, labels: dict[str, Any]) -> dict[str, Any]:
    """Create a 2x2 image mosaic from four input images.
...
### Method `ultralytics.data.augment.Mosaic._mosaic9` {#ultralytics.data.augment.Mosaic.\_mosaic9}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/augment.py#L671-L741"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def _mosaic9(self, labels: dict[str, Any]) -> dict[str, Any]:
    """Create a 3x3 image mosaic from the input image and eight additional images.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/augment.py#L744-L767"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
@staticmethod
def _update_labels(labels, padw: int, padh: int) -> dict[str, Any]:
    """Update label coordinates with padding values.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/augment.py#L507-L525"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def get_indexes(self):
    """Return a list of random indexes from the dataset for mosaic augmentation.
...
| Name | Description |
| --- | --- |
| [`_mix_transform`](#ultralytics.data.augment.MixUp._mix_transform) | Apply MixUp augmentation to the input labels. |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/augment.py#L820-L875"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
...
### Method `ultralytics.data.augment.MixUp._mix_transform` {#ultralytics.data.augment.MixUp.\_mix\_transform}
...
| Name | Type | Description | Default |
| --- | --- | --- | --- |
| `labels` | `dict[str, Any]` | A dictionary containing the original image and label information. | *required* |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/augment.py#L854-L875"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def _mix_transform(self, labels: dict[str, Any]) -> dict[str, Any]:
    """Apply MixUp augmentation to the input labels.
...
| Name | Description |
| --- | --- |
| [`_mix_transform`](#ultralytics.data.augment.CutMix._mix_transform) | Apply CutMix augmentation to the input labels. |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/augment.py#L878-L989"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
...
### Method `ultralytics.data.augment.CutMix._mix_transform` {#ultralytics.data.augment.CutMix.\_mix\_transform}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/augment.py#L945-L989"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def _mix_transform(self, labels: dict[str, Any]) -> dict[str, Any]:
    """Apply CutMix augmentation to the input labels.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/augment.py#L916-L943"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def _rand_bbox(self, width: int, height: int) -> tuple[int, int, int, int]:
    """Generate random bounding box coordinates for the cut region.
...
| `border` | `tuple[int, int]` | Tuple specifying mosaic border (y, x). | `(0, 0)` |
| `pre_transform` | `Callable | None` | Function/transform to apply to the image before starting the random<br>    transformation. | `None` |
...
| Name | Description |
| --- | --- |
| [`__call__`](#ultralytics.data.augment.RandomPerspective.__call__) | Apply random perspective and affine transformations to an image and its associated labels. |
| [`affine_transform`](#ultralytics.data.augment.RandomPerspective.affine_transform) | Apply a sequence of affine transformations centered around the image center. |
...
| [`apply_segments`](#ultralytics.data.augment.RandomPerspective.apply_segments) | Apply affine transformations to segments and generate new bounding boxes. |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/augment.py#L992-L1346"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
...
### Method `ultralytics.data.augment.RandomPerspective.__call__` {#ultralytics.data.augment.RandomPerspective.\_\_call\_\_}
...
| Name | Type | Description | Default |
| --- | --- | --- | --- |
| `labels` | `dict[str, Any]` | A dictionary containing image data and annotations. | *required* |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/augment.py#L1225-L1302"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def __call__(self, labels: dict[str, Any]) -> dict[str, Any]:
    """Apply random perspective and affine transformations to an image and its associated labels.
...
### Method `ultralytics.data.augment.RandomPerspective.affine_transform` {#ultralytics.data.augment.RandomPerspective.affine\_transform}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/augment.py#L1058-L1120"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def affine_transform(self, img: np.ndarray, border: tuple[int, int]) -> tuple[np.ndarray, np.ndarray, float]:
    """Apply a sequence of affine transformations centered around the image center.
...
| Name | Type | Description | Default |
| --- | --- | --- | --- |
| `bboxes` | `np.ndarray` | Bounding boxes in xyxy format with shape (N, 4), where N is the number of bounding<br>    boxes. | *required* |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/augment.py#L1122-L1154"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def apply_bboxes(self, bboxes: np.ndarray, M: np.ndarray) -> np.ndarray:
    """Apply affine transformation to bounding boxes.
...
| Name | Type | Description | Default |
| --- | --- | --- | --- |
| `keypoints` | `np.ndarray` | Array of keypoints with shape (N, K, 3), where N is the number of instances, K is<br>    the number of keypoints per instance, and 3 represents (x, y, visibility). | *required* |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/augment.py#L1192-L1223"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def apply_keypoints(self, keypoints: np.ndarray, M: np.ndarray) -> np.ndarray:
    """Apply affine transformation to keypoints.
...
| Name | Type | Description | Default |
| --- | --- | --- | --- |
| `segments` | `np.ndarray` | Input segments with shape (N, M, 2), where N is the number of segments and M is the<br>    number of points in each segment. | *required* |
| `M` | `np.ndarray` | Affine transformation matrix with shape (3, 3). | *required* |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/augment.py#L1156-L1190"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def apply_segments(self, segments: np.ndarray, M: np.ndarray) -> tuple[np.ndarray, np.ndarray]:
    """Apply affine transformations to segments and generate new bounding boxes.
...
| Name | Type | Description | Default |
| --- | --- | --- | --- |
| `box1` | `np.ndarray` | Original boxes before augmentation, shape (4, N) where N is the number of boxes. Format<br>    is [x1, y1, x2, y2] in absolute coordinates. | *required* |
| `box2` | `np.ndarray` | Augmented boxes after transformation, shape (4, N). Format is [x1, y1, x2, y2] in<br>    absolute coordinates. | *required* |
| `wh_thr` | `int` | Width and height threshold in pixels. Boxes smaller than this in either dimension are<br>    rejected. | `2` |
| `ar_thr` | `int` | Aspect ratio threshold. Boxes with an aspect ratio greater than this value are rejected. | `100` |
| `area_thr` | `float` | Area ratio threshold. Boxes with an area ratio (new/old) less than this value are<br>    rejected. | `0.1` |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/augment.py#L1305-L1346"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
@staticmethod
def box_candidates(
    box1: np.ndarray,
...
| Name | Description |
| --- | --- |
| [`__call__`](#ultralytics.data.augment.RandomHSV.__call__) | Apply random HSV augmentation to an image within predefined limits. |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/augment.py#L1349-L1422"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
class RandomHSV:
    """Randomly adjust the Hue, Saturation, and Value (HSV) channels of an image.
...
### Method `ultralytics.data.augment.RandomHSV.__call__` {#ultralytics.data.augment.RandomHSV.\_\_call\_\_}
...
| Name | Type | Description | Default |
| --- | --- | --- | --- |
| `labels` | `dict[str, Any]` | A dictionary containing image data and metadata. Must include an 'img' key with the<br>    image as a numpy array. | *required* |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/augment.py#L1386-L1422"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def __call__(self, labels: dict[str, Any]) -> dict[str, Any]:
    """Apply random HSV augmentation to an image within predefined limits.
...
| Name | Description |
| --- | --- |
| [`__call__`](#ultralytics.data.augment.RandomFlip.__call__) | Apply random flip to an image and update any instances like bounding boxes or keypoints accordingly. |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/augment.py#L1425-L1509"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
class RandomFlip:
    """Apply a random horizontal or vertical flip to an image with a given probability.
...
### Method `ultralytics.data.augment.RandomFlip.__call__` {#ultralytics.data.augment.RandomFlip.\_\_call\_\_}
...
| Name | Type | Description | Default |
| --- | --- | --- | --- |
| `labels` | `dict[str, Any]` | A dictionary containing the following keys:<br>    - 'img' (np.ndarray): The image to be flipped.<br>    - 'instances' (ultralytics.utils.instance.Instances): Object containing boxes and optionally keypoints. | *required* |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/augment.py#L1467-L1509"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def __call__(self, labels: dict[str, Any]) -> dict[str, Any]:
    """Apply random flip to an image and update any instances like bounding boxes or keypoints accordingly.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/augment.py#L1512-L1676"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
class LetterBox:
    """Resize image and padding for detection, instance segmentation, pose.
...
| Name | Type | Description | Default |
| --- | --- | --- | --- |
| `labels` | `dict[str, Any] | None` | A dictionary containing image data and associated labels, or empty dict if<br>    None. | `None` |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/augment.py#L1571-L1647"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def __call__(self, labels: dict[str, Any] | None = None, image: np.ndarray = None) -> dict[str, Any] | np.ndarray:
    """Resize and pad an image for object detection, instance segmentation, or pose estimation tasks.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/augment.py#L1650-L1676"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
@staticmethod
def _update_labels(labels: dict[str, Any], ratio: tuple[float, float], padw: float, padh: float) -> dict[str, Any]:
    """Update labels after applying letterboxing to an image.
...
| [`_mix_transform`](#ultralytics.data.augment.CopyPaste._mix_transform) | Apply Copy-Paste augmentation to combine objects from another image into the current image. |
| [`_transform`](#ultralytics.data.augment.CopyPaste._transform) | Apply Copy-Paste augmentation to combine objects from another image into the current image. |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/augment.py#L1679-L1775"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/augment.py#L1713-L1738"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def __call__(self, labels: dict[str, Any]) -> dict[str, Any]:
    """Apply Copy-Paste augmentation to an image and its labels."""
...
### Method `ultralytics.data.augment.CopyPaste._mix_transform` {#ultralytics.data.augment.CopyPaste.\_mix\_transform}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/augment.py#L1708-L1711"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def _mix_transform(self, labels: dict[str, Any]) -> dict[str, Any]:
    """Apply Copy-Paste augmentation to combine objects from another image into the current image."""
    labels2 = labels["mix_labels"][0]
...
### Method `ultralytics.data.augment.CopyPaste._transform` {#ultralytics.data.augment.CopyPaste.\_transform}
...
| Name | Type | Description | Default |
| --- | --- | --- | --- |
| `labels1` | `dict[str, Any]` |  | *required* |
| `labels2` | `dict[str, Any]` |  | `{}` |

<details>
<summary>Source code in <code>ultralytics/data/augment.py</code></summary>

<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/augment.py#L1740-L1775"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def _transform(self, labels1: dict[str, Any], labels2: dict[str, Any] = {}) -> dict[str, Any]:
    """Apply Copy-Paste augmentation to combine objects from another image into the current image."""
    im = labels1["img"]
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/augment.py#L1778-L1954"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
...
| Name | Type | Description | Default |
| --- | --- | --- | --- |
| `labels` | `dict[str, Any]` | A dictionary containing image data and annotations. Expected keys are:<br>    - 'img': np.ndarray representing the image<br>    - 'cls': np.ndarray of class labels<br>    - 'instances': object containing bounding boxes and other instance information | *required* |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/augment.py#L1901-L1954"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def __call__(self, labels: dict[str, Any]) -> dict[str, Any]:
    """Apply Albumentations transformations to input labels.
...
| Name | Description |
| --- | --- |
| [`__call__`](#ultralytics.data.augment.Format.__call__) | Format image annotations for object detection, instance segmentation, and pose estimation tasks. |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/augment.py#L1957-L2167"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
class Format:
    """A class for formatting image annotations for object detection, instance segmentation, and pose estimation tasks.
...
### Method `ultralytics.data.augment.Format.__call__` {#ultralytics.data.augment.Format.\_\_call\_\_}
...
| Name | Type | Description | Default |
| --- | --- | --- | --- |
| `labels` | `dict[str, Any]` | A dictionary containing image and annotation data with the following keys:<br>    - 'img': The input image as a numpy array.<br>    - 'cls': Class labels for instances.<br>    - 'instances': An Instances object containing bounding boxes, segments, and keypoints. | *required* |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/augment.py#L2024-L2105"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def __call__(self, labels: dict[str, Any]) -> dict[str, Any]:
    """Format image annotations for object detection, instance segmentation, and pose estimation tasks.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/augment.py#L2107-L2135"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def _format_img(self, img: np.ndarray) -> torch.Tensor:
    """Format an image for YOLO from a Numpy array to a PyTorch tensor.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/augment.py#L2137-L2167"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def _format_segments(
    self, instances: Instances, cls: np.ndarray, w: int, h: int
) -> tuple[np.ndarray, Instances, np.ndarray]:
...
| Name | Description |
| --- | --- |
| [`__call__`](#ultralytics.data.augment.LoadVisualPrompt.__call__) | Process labels to create visual prompts. |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/augment.py#L2170-L2263"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
...
### Method `ultralytics.data.augment.LoadVisualPrompt.__call__` {#ultralytics.data.augment.LoadVisualPrompt.\_\_call\_\_}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/augment.py#L2199-L2217"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def __call__(self, labels: dict[str, Any]) -> dict[str, Any]:
    """Process labels to create visual prompts.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/augment.py#L2219-L2263"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def get_visuals(
    self,
    category: int | np.ndarray | torch.Tensor,
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/augment.py#L2182-L2197"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
@staticmethod
def make_mask(boxes: torch.Tensor, h: int, w: int) -> torch.Tensor:
    """Create binary masks from bounding boxes.
...
| Name | Type | Description | Default |
| --- | --- | --- | --- |
| `prompt_format` | `str` | Format string for the prompt. The format string should contain a single pair of curly<br>    braces {} where the text will be inserted. | `"{}"` |
| `neg_samples` | `tuple[int, int]` | A range to randomly sample negative texts. The first integer specifies the<br>    minimum number of negative samples, and the second integer specifies the maximum. | `(80, 80)` |
| `max_samples` | `int` | The maximum number of different text samples in one image. | `80` |
| `padding` | `bool` | Whether to pad texts to max_samples. If True, the number of texts will always be equal to<br>    max_samples. | `False` |
...
| Name | Description |
| --- | --- |
| [`__call__`](#ultralytics.data.augment.RandomLoadText.__call__) | Randomly sample positive and negative texts and update class indices accordingly. |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/augment.py#L2266-L2383"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
...
### Method `ultralytics.data.augment.RandomLoadText.__call__` {#ultralytics.data.augment.RandomLoadText.\_\_call\_\_}
...
| Name | Type | Description | Default |
| --- | --- | --- | --- |
| `labels` | `dict[str, Any]` | A dictionary containing image labels and metadata. Must include 'texts' and 'cls'<br>    keys. | *required* |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/augment.py#L2320-L2383"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def __call__(self, labels: dict[str, Any]) -> dict[str, Any]:
    """Randomly sample positive and negative texts and update class indices accordingly.
...
| Name | Type | Description | Default |
| --- | --- | --- | --- |
| `size` | `int | tuple[int, int]` | Target size for the letterboxed image. If an int, a square image of (size,<br>    size) is created. If a tuple, it should be (height, width). | `(640, 640)` |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/augment.py#L2614-L2685"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/augment.py#L2654-L2685"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def __call__(self, im: np.ndarray) -> np.ndarray:
    """Resize and pad an image using the letterbox method.
...
| Name | Type | Description | Default |
| --- | --- | --- | --- |
| `size` | `int | tuple[int, int]` | The desired output size of the crop. If size is an int, a square crop (size,<br>    size) is made. If size is a sequence like (h, w), it is used as the output size. | `(640, 640)` |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/augment.py#L2689-L2746"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
class CenterCrop:
    """Apply center cropping to images for classification tasks.
...
| Name | Type | Description | Default |
| --- | --- | --- | --- |
| `im` | `np.ndarray | PIL.Image.Image` | The input image as a numpy array of shape (H, W, C) or a PIL Image<br>    object. | *required* |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/augment.py#L2723-L2746"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def __call__(self, im: Image.Image | np.ndarray) -> np.ndarray:
    """Apply center cropping to an input image.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/augment.py#L2750-L2810"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
class ToTensor:
    """Convert an image from a numpy array to a PyTorch tensor.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/augment.py#L2786-L2810"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def __call__(self, im: np.ndarray) -> torch.Tensor:
    """Transform an image from a numpy array to a PyTorch tensor.
...
| `hyp` | `IterableSimpleNamespace` | A namespace of hyperparameters controlling various aspects of the<br>    transformations. | *required* |
| `stretch` | `bool` | If True, applies stretching to the image. If False, uses LetterBox resizing. | `False` |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/augment.py#L2386-L2457"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def v8_transforms(dataset, imgsz: int, hyp: IterableSimpleNamespace, stretch: bool = False):
    """Apply a series of image transformations for training.
...
| Name | Type | Description | Default |
| --- | --- | --- | --- |
| `size` | `tuple[int, int] | int` | The target size for the transformed image. If an int, it defines the shortest<br>    edge. If a tuple, it defines (height, width). | `224` |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/augment.py#L2461-L2507"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def classify_transforms(
    size: tuple[int, int] | int = 224,
    mean: tuple[float, float, float] = DEFAULT_MEAN,
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/augment.py#L2511-L2610"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def classify_augmentations(
    size: int = 224,
    mean: tuple[float, float, float] = DEFAULT_MEAN,
