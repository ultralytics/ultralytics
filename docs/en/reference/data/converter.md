...
!!! abstract "Summary"
    ...
    === "<span class="doc-kind doc-kind-function">Functions</span>"
        ...
        - [`coco91_to_coco80_class`](#ultralytics.data.converter.coco91_to_coco80_class)
        - [`coco80_to_coco91_class`](#ultralytics.data.converter.coco80_to_coco91_class)
        - [`convert_coco`](#ultralytics.data.converter.convert_coco)
        - [`convert_segment_masks_to_yolo_seg`](#ultralytics.data.converter.convert_segment_masks_to_yolo_seg)
        - [`convert_dota_to_yolo_obb`](#ultralytics.data.converter.convert_dota_to_yolo_obb)
        - [`min_index`](#ultralytics.data.converter.min_index)
        - [`merge_multi_segment`](#ultralytics.data.converter.merge_multi_segment)
        - [`yolo_bbox2segment`](#ultralytics.data.converter.yolo_bbox2segment)
        - [`create_synthetic_coco_dataset`](#ultralytics.data.converter.create_synthetic_coco_dataset)
        - [`convert_to_multispectral`](#ultralytics.data.converter.convert_to_multispectral)
        - [`_infer_ndjson_kpt_shape`](#ultralytics.data.converter._infer_ndjson_kpt_shape)
        - [`convert_ndjson_to_yolo`](#ultralytics.data.converter.convert_ndjson_to_yolo)
        - [`_convert_ndjson_to_yolo`](#ultralytics.data.converter._convert_ndjson_to_yolo)


## Function `ultralytics.data.converter.coco91_to_coco80_class` {#ultralytics.data.converter.coco91\_to\_coco80\_class}
...
| Type | Description |
| --- | --- |
| `list[int \| None]` | A list of 91 elements where the index represents the 91-index class ID and the value is the corresponding 80-index class ID, or None if there is no mapping. |

<details>
<summary>Source code in <code>ultralytics/data/converter.py</code></summary>

<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/converter.py#L25-L124">View on GitHub</a>
```python
def coco91_to_coco80_class() -> list[int]:
    """Convert 91-index COCO class IDs to 80-index COCO class IDs.
...
## Function `ultralytics.data.converter.coco80_to_coco91_class` {#ultralytics.data.converter.coco80\_to\_coco91\_class}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/converter.py#L127-L228">View on GitHub</a>
```python
def coco80_to_coco91_class() -> list[int]:
...
## Function `ultralytics.data.converter.convert_coco` {#ultralytics.data.converter.convert\_coco}
...
| --- | --- | --- | --- |
| `labels_dir` | `str, optional` | Path to directory containing COCO dataset annotation files. | `"../coco/annotations/"` |
| `save_dir` | `str, optional` | Path to directory to save results to. | `"coco_converted/"` |
| `use_segments` | `bool, optional` | Whether to include segmentation masks in the output. | `False` |
| `use_keypoints` | `bool, optional` | Whether to include keypoint annotations in the output. | `False` |
| `cls91to80` | `bool, optional` | Whether to map 91 COCO class IDs to the corresponding 80 COCO class IDs. | `True` |
| `lvis` | `bool, optional` | Whether to convert data in lvis dataset way. | `False` |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/converter.py#L231-L368">View on GitHub</a>
```python
def convert_coco(
    labels_dir: str = "../coco/annotations/",
    save_dir: str = "coco_converted/",
...
## Function `ultralytics.data.converter.convert_segment_masks_to_yolo_seg` {#ultralytics.data.converter.convert\_segment\_masks\_to\_yolo\_seg}
...
| `classes` | `int` | Total number of classes in the dataset, e.g., 80 for COCO. | *required* |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/converter.py#L371-L445">View on GitHub</a>
```python
def convert_segment_masks_to_yolo_seg(masks_dir: str, output_dir: str, classes: int):
    """Convert a dataset of segmentation mask images to the YOLO segmentation format.
...
## Function `ultralytics.data.converter.convert_dota_to_yolo_obb` {#ultralytics.data.converter.convert\_dota\_to\_yolo\_obb}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/converter.py#L448-L537">View on GitHub</a>
```python
def convert_dota_to_yolo_obb(dota_root_path: str):
    """Convert DOTA dataset annotations to YOLO OBB (Oriented Bounding Box) format.
...
## Function `ultralytics.data.converter.min_index` {#ultralytics.data.converter.min\_index}
...
| Name | Type | Description | Default |
| --- | --- | --- | --- |
| `arr1` | `np.ndarray` | A NumPy array of shape (N, 2) representing N 2D points. | *required* |
| `arr2` | `np.ndarray` | A NumPy array of shape (M, 2) representing M 2D points. | *required* |

**Returns**

| Type | Description |
| --- | --- |
| `tuple[int, int]` | A tuple (idx1, idx2) where idx1 is the index in arr1 and idx2 is the index in arr2 of the pair with the shortest distance. |

<details>
<summary>Source code in <code>ultralytics/data/converter.py</code></summary>

<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/converter.py#L540-L552">View on GitHub</a>
```python
def min_index(arr1: np.ndarray, arr2: np.ndarray):
    """Find a pair of indexes with the shortest distance between two arrays of 2D points.
...
## Function `ultralytics.data.converter.merge_multi_segment` {#ultralytics.data.converter.merge\_multi\_segment}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/converter.py#L555-L603">View on GitHub</a>
```python
def merge_multi_segment(segments: list[list]):
    """Merge multiple segments into one list by connecting the coordinates with the minimum distance between each
    segment.
...
## Function `ultralytics.data.converter.yolo_bbox2segment` {#ultralytics.data.converter.yolo\_bbox2segment}
...
| `save_dir` | `str \| Path, optional` | Path to save the generated labels, labels will be saved into `labels-segment` in the same directory level of `im_dir` if save_dir is None. | `None` |
| `sam_model` | `str` | Segmentation model to use for intermediate segmentation data. | `"sam_b.pt"` |
| `device` | `int \| str, optional` | The specific device to run SAM models. | `None` |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/converter.py#L606-L667">View on GitHub</a>
```python
def yolo_bbox2segment(im_dir: str | Path, save_dir: str | Path | None = None, sam_model: str = "sam_b.pt", device=None):
    """Convert existing object detection dataset (bounding boxes) to segmentation dataset in YOLO format.
...
## Function `ultralytics.data.converter.create_synthetic_coco_dataset` {#ultralytics.data.converter.create\_synthetic\_coco\_dataset}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/converter.py#L670-L722">View on GitHub</a>
```python
def create_synthetic_coco_dataset():
    """Create a synthetic COCO dataset with random images based on filenames from label lists.
...
## Function `ultralytics.data.converter.convert_to_multispectral` {#ultralytics.data.converter.convert\_to\_multispectral}
...
This function takes RGB images and interpolates them to create multispectral images with a specified number of channels. It can process either a single image or a directory of images.

**Args**

| Name | Type | Description | Default |
| --- | --- | --- | --- |
| `path` | `str \| Path` | Path to an image file or directory containing images to convert. | *required* |
| `n_channels` | `int` | Number of spectral channels to generate in the output image. | `10` |
| `replace` | `bool` | Whether to replace the original image file with the converted one. | `False` |
| `zip` | `bool` | Whether to zip the converted images into a zip file. | `False` |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/converter.py#L725-L775">View on GitHub</a>
```python
def convert_to_multispectral(path: str | Path, n_channels: int = 10, replace: bool = False, zip: bool = False):
    """Convert RGB images to multispectral images by interpolating across wavelength bands.
...
## Function `ultralytics.data.converter._infer_ndjson_kpt_shape` {#ultralytics.data.converter.\_infer\_ndjson\_kpt\_shape}
...
Scans up to 50 pose annotations across image records. Annotation format is [classId, cx, cy, w, h, kp1_x, kp1_y, kp1_vis, ...] so keypoint values start at index 5.

Tries dims=3 first (x, y, visibility) with visibility validation ({0, 1, 2}), then falls back to dims=2 (x, y only) when values are unambiguously not divisible by 3.

**Args**

| Name | Type | Description | Default |
| --- | --- | --- | --- |
| `image_records` | `list` |  | *required* |

<details>
<summary>Source code in <code>ultralytics/data/converter.py</code></summary>

<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/converter.py#L778-L813">View on GitHub</a>
```python
def _infer_ndjson_kpt_shape(image_records: list) -> list:
    """Infer kpt_shape [num_keypoints, dims] from NDJSON pose annotations.
...
## Function `ultralytics.data.converter.convert_ndjson_to_yolo` {#ultralytics.data.converter.convert\_ndjson\_to\_yolo}
...
| Name | Type | Description | Default |
| --- | --- | --- | --- |
| `ndjson_path` | `str \| Path` | Path to the input NDJSON file containing dataset information. | *required* |
| `output_path` | `str \| Path \| None, optional` | Directory where the converted YOLO dataset will be saved. If None, uses the DATASETS_DIR directory. Defaults to None. | `None` |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/converter.py#L816-L874">View on GitHub</a>
```python
async def convert_ndjson_to_yolo(ndjson_path: str | Path, output_path: str | Path | None = None) -> Path:
    """Convert NDJSON dataset format to Ultralytics YOLO dataset structure.
...
## Function `ultralytics.data.converter._convert_ndjson_to_yolo` {#ultralytics.data.converter.\_convert\_ndjson\_to\_yolo}
...
| Name | Type | Description | Default |
| --- | --- | --- | --- |
| `ndjson_path` | `Path` |  | *required* |
| `output_path` | `Path` |  | *required* |

<details>
<summary>Source code in <code>ultralytics/data/converter.py</code></summary>

<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/converter.py#L877-L1111">View on GitHub</a>
```python
async def _convert_ndjson_to_yolo(ndjson_path: Path, output_path: Path) -> Path:
    """Convert a resolved NDJSON source while its conversion lock is held."""
