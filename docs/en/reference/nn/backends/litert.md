...
!!! abstract "Summary"
    ...
    === "<span class="doc-kind doc-kind-class">Classes</span>"
        ...
        - [`LiteRTBackend`](#ultralytics.nn.backends.litert.LiteRTBackend)

    === "<span class="doc-kind doc-kind-method">Methods</span>"

        - [`LiteRTBackend.load_model`](#ultralytics.nn.backends.litert.LiteRTBackend.load_model)
        - [`LiteRTBackend.forward`](#ultralytics.nn.backends.litert.LiteRTBackend.forward)


## Class `ultralytics.nn.backends.litert.LiteRTBackend` {#ultralytics.nn.backends.litert.LiteRTBackend}
...
| Name | Description |
| --- | --- |
| [`forward`](#ultralytics.nn.backends.litert.LiteRTBackend.forward) | Run inference using the LiteRT interpreter. |
| [`load_model`](#ultralytics.nn.backends.litert.LiteRTBackend.load_model) | Load a LiteRT model from a .tflite file. |

<details>
<summary>Source code in <code>ultralytics/nn/backends/litert.py</code></summary>

<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/backends/litert.py#L16-L113">View on GitHub</a>
```python
...
### Method `ultralytics.nn.backends.litert.LiteRTBackend.forward` {#ultralytics.nn.backends.litert.LiteRTBackend.forward}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/backends/litert.py#L50-L113">View on GitHub</a>
```python
def forward(self, im: torch.Tensor) -> list[np.ndarray]:
    """Run inference using the LiteRT interpreter.
...
### Method `ultralytics.nn.backends.litert.LiteRTBackend.load_model` {#ultralytics.nn.backends.litert.LiteRTBackend.load\_model}
...
| Name | Type | Description | Default |
| --- | --- | --- | --- |
| `weight` | `str \| Path` | Path to the .tflite model file (metadata embedded as a metadata.json entry). | *required* |

<details>
<summary>Source code in <code>ultralytics/nn/backends/litert.py</code></summary>

<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/backends/litert.py#L25-L48">View on GitHub</a>
```python
def load_model(self, weight: str | Path) -> None:
    """Load a LiteRT model from a .tflite file.
