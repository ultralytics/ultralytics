...
class YOLODataset(BaseDataset):
    ...
    def __init__(self,
        ...
        self.data = data
        assert not ((self.use_segments and self.use_keypoints) or (
        ...
        super().__init__(img_path, imgsz, cache, augment, hyp, prefix, rect, batch_size, stride, pad, single_cls, classes)
