---
comments: true
description: Export Ultralytics YOLO26 to ONNX, TensorRT, CoreML, TFLite, and more. Deployment-ready guide with CLI and Python examples for every major format.
keywords: YOLO26, export, ONNX, TensorRT, CoreML, TFLite, model deployment, Ultralytics, edge inference
canonical: https://docs.ultralytics.com/models/yolo26/tutorials/model-export/
---
...
<script type="application/ld+json">
{
  ...
  "@type": "TechArticle",
  "headline": "Export YOLO26 to ONNX, TensorRT, CoreML, and More",
  "description": "Export Ultralytics YOLO26 to ONNX, TensorRT, CoreML, TFLite, and more. Deployment-ready guide with CLI and Python examples for every major format.",
  "url": "https://docs.ultralytics.com/models/yolo26/tutorials/model-export/",
  ...
  "mainEntityOfPage": "https://docs.ultralytics.com/models/yolo26/tutorials/model-export/"
}
</script>

# Export YOLO26 to ONNX, TensorRT, CoreML, and More

<!-- NOTE FOR MURAT: Please verify the full list of export formats supported by YOLO26's end-to-end NMS-free architecture (some formats may require updated opset versions or have known limitations with the E2E head). Add measured inference speed benchmarks per format on representative hardware (e.g. RTX 4090 for TensorRT, iPhone 15 for CoreML, Raspberry Pi 5 for TFLite). Confirm the `imgsz`, `half`, and `dynamic` flags work as expected for YOLO26. Add screenshots of successful export terminal output if available. -->

Once you have a trained [Ultralytics YOLO26](../../../models/yolo26.md) model, the next step is deploying it. Exporting converts the PyTorch `.pt` checkpoint into a self-contained format optimised for your target hardware or runtime. YOLO26 supports all standard Ultralytics export targets, including cloud, edge, and mobile deployments.
...
# TensorRT inference
yolo predict model=yolo26n.engine source=image.jpg
```
