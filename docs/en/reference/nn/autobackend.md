...
| Name | Description |
| --- | --- |
| [`_model_type`](#ultralytics.nn.autobackend.AutoBackend._model_type) | Take a path to a model file and return the model type. |
| [`forward`](#ultralytics.nn.autobackend.AutoBackend.forward) | Run inference on an AutoBackend model. |
| [`from_numpy`](#ultralytics.nn.autobackend.AutoBackend.from_numpy) | Convert a NumPy array to a torch tensor on the model device. |
| [`warmup`](#ultralytics.nn.autobackend.AutoBackend.warmup) | Warm up the model by running forward pass(es) with a dummy input. |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/autobackend.py#L87-L980"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/autobackend.py#L950-L980"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
@staticmethod
def _model_type(p: str = "path/to/model.pt") -> list[bool]:
    """Take a path to a model file and return the model type.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/autobackend.py#L689-L921"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def forward(
    self,
    im: torch.Tensor,
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/autobackend.py#L923-L932"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def from_numpy(self, x: np.ndarray | torch.Tensor) -> torch.Tensor:
    """Convert a NumPy array to a torch tensor on the model device.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/autobackend.py#L934-L947"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def warmup(self, imgsz: tuple[int, int, int, int] = (1, 3, 640, 640)) -> None:
    """Warm up the model by running forward pass(es) with a dummy input.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/autobackend.py#L41-L67"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def check_class_names(names: list | dict) -> dict[int, str]:
    """Check class names and convert to dict format if needed.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/autobackend.py#L70-L84"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def default_class_names(data: str | Path | None = None) -> dict[int, str]:
    """Load class names from a YAML file or return numerical class names.
