...
def torch2ethos(
    ...
    # Shared_Sram is validated for YOLO exports; it permits system DRAM, unlike the U65/U85 default
    # Sram_Only which requires the whole model to fit in on-chip SRAM.
