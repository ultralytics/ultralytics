...
!!! Example "Exemplo do SAMPredictor"
    ...
    Segmentar tudo com arguments adicionais.
    ...
    === "Segmentar tudo"
        ...
        # Segmentar com arguments adicionais
        results = predictor(source="ultralytics/assets/zidane.jpg", crop_n_layers=1, points_stride=64)
        ```

- Mais arguments adicionais para `Segmentar tudo` consulte a [Referência do `Predictor/generate`](../../../reference/models/sam/predict.md).
...
A função `auto_annotate` recebe o caminho para suas imagens, com arguments opcionais para especificar os modelos de detecção pré-treinados e de segmentação SAM, o dispositivo onde executar os modelos e o diretório de saída para salvar os resultados anotados.
