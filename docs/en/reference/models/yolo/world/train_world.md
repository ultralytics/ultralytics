...
```python
WorldTrainerFromScratch(cfg=DEFAULT_CFG, overrides=None, _callbacks: dict | None = None)
```
...
| `_callbacks` | `dict, optional` | Dictionary of callback functions to run during different stages of training. | `None` |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/yolo/world/train_world.py#L15-L196">View on GitHub</a>
```python
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/yolo/world/train_world.py#L72-L104">View on GitHub</a>
```python
def build_dataset(self, img_path, mode="train", batch=None):
    """Build YOLO Dataset for training or validation.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/yolo/world/train_world.py#L107-L121">View on GitHub</a>
```python
@staticmethod
def check_data_config(data: dict | str | Path) -> dict:
    """Check and load the data configuration from a YAML file or dictionary.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/yolo/world/train_world.py#L185-L196">View on GitHub</a>
```python
def final_eval(self):
    """Perform final evaluation and validation for the YOLO-World model.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/yolo/world/train_world.py#L123-L180">View on GitHub</a>
```python
def get_dataset(self):
    """Get train and validation paths from data dictionary.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/yolo/world/train_world.py#L182-L183">View on GitHub</a>
```python
def plot_training_labels(self):
    """Skip label plotting for YOLO-World training."""
```
