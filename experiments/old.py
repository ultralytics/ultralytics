...
# --------------------------------------#
# plot_training_samples causes a need for .detach(), but I cannot find the best place to do this.
...
perturbed_data = fgsm_attack(batch['img'], 0.1, data_grad)
