...
class ObjectBlurrer(BaseSolution):
    ...
    def __init__(self, **kwargs):
        ...
        Attributes:
            ...
            iou (float): Intersection over Union threshold for detections, derived from the configuration.
            conf (float): Confidence threshold for detections, with a default of 0.25.
        """
