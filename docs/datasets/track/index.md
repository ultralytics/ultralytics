---
comments: true
description: Learn how to train a tracker for multi-object tracking using YOLO and explore some of the popular tracking datasets. Try it now with Ultralytics!
---
