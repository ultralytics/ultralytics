...
!!! abstract "Summary"
    ...
    === "<span class="doc-kind doc-kind-class">Classes</span>"
        ...
        - [`TTSTrack`](#ultralytics.trackers.track_tracker.TTSTrack)
        - [`TRACKTRACK`](#ultralytics.trackers.track_tracker.TRACKTRACK)

    === "<span class="doc-kind doc-kind-method">Methods</span>"

        - [`TTSTrack.update_features`](#ultralytics.trackers.track_tracker.TTSTrack.update_features)
        - [`TTSTrack.get_history_box`](#ultralytics.trackers.track_tracker.TTSTrack.get_history_box)
        - [`TTSTrack.activate`](#ultralytics.trackers.track_tracker.TTSTrack.activate)
        - [`TTSTrack.re_activate`](#ultralytics.trackers.track_tracker.TTSTrack.re_activate)
        - [`TTSTrack.update`](#ultralytics.trackers.track_tracker.TTSTrack.update)
        - [`TTSTrack.__repr__`](#ultralytics.trackers.track_tracker.TTSTrack.__repr__)
        - [`TRACKTRACK.setup_predictor`](#ultralytics.trackers.track_tracker.TRACKTRACK.setup_predictor)
        - [`TRACKTRACK.compute_frame_extras`](#ultralytics.trackers.track_tracker.TRACKTRACK.compute_frame_extras)
        - [`TRACKTRACK._cost_matrix`](#ultralytics.trackers.track_tracker.TRACKTRACK._cost_matrix)
        - [`TRACKTRACK._apply_gmc`](#ultralytics.trackers.track_tracker.TRACKTRACK._apply_gmc)
        - [`TRACKTRACK.update`](#ultralytics.trackers.track_tracker.TRACKTRACK.update)
        - [`TRACKTRACK.reset`](#ultralytics.trackers.track_tracker.TRACKTRACK.reset)

    === "<span class="doc-kind doc-kind-function">Functions</span>"

        - [`_hmiou_distance`](#ultralytics.trackers.track_tracker._hmiou_distance)
        - [`_angle_distance`](#ultralytics.trackers.track_tracker._angle_distance)
        - [`_confidence_distance`](#ultralytics.trackers.track_tracker._confidence_distance)
        - [`_iterative_associate`](#ultralytics.trackers.track_tracker._iterative_associate)
        - [`_track_aware_nms`](#ultralytics.trackers.track_tracker._track_aware_nms)
        - [`attach_raw_preds_hook`](#ultralytics.trackers.track_tracker.attach_raw_preds_hook)
        - [`compute_dets_del`](#ultralytics.trackers.track_tracker.compute_dets_del)
        - [`_cosine_distance`](#ultralytics.trackers.track_tracker._cosine_distance)


## Class `ultralytics.trackers.track_tracker.TTSTrack` {#ultralytics.trackers.track\_tracker.TTSTrack}

```python
TTSTrack(xywh: np.ndarray, score: float, cls: Any, feat: np.ndarray | None = None)
```
...
Extends `BOTrack` (XYWH Kalman state and EMA ReID smoothing), adding corner-velocity motion, score history, and score-adaptive feature smoothing.

**Args**

| Name | Type | Description | Default |
| --- | --- | --- | --- |
| `xywh` | `np.ndarray` | `(x, y, w, h, idx)` or `(x, y, w, h, angle, idx)`, center-based with detection index. | *required* |
| `score` | `float` | Detection confidence. | *required* |
| `cls` | `Any` | Class label. | *required* |
| `feat` | `np.ndarray \| None` | Optional ReID feature vector. | `None` |
...
| Name | Description |
| --- | --- |
| [`__repr__`](#ultralytics.trackers.track_tracker.TTSTrack.__repr__) | Short string representation of the track. |
| [`activate`](#ultralytics.trackers.track_tracker.TTSTrack.activate) | Initialize Kalman state and promote to New state. |
| [`get_history_box`](#ultralytics.trackers.track_tracker.TTSTrack.get_history_box) | Return the box from `dt` frames back, or the most recent box, or the current box. |
| [`re_activate`](#ultralytics.trackers.track_tracker.TTSTrack.re_activate) | Rebind a lost track to a fresh detection via NSA-Kalman. |
| [`update`](#ultralytics.trackers.track_tracker.TTSTrack.update) | Update a matched track with a new detection; promote to Tracked after min_track_len. |
| [`update_features`](#ultralytics.trackers.track_tracker.TTSTrack.update_features) | Normalize `feat` and blend it into `smooth_feat` via score-adaptive EMA. |
...
<details>
<summary>Source code in <code>ultralytics/trackers/track_tracker.py</code></summary>

<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/trackers/track_tracker.py#L212-L333">View on GitHub</a>
```python
...
### Method `ultralytics.trackers.track_tracker.TTSTrack.__repr__` {#ultralytics.trackers.track\_tracker.TTSTrack.\_\_repr\_\_}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/trackers/track_tracker.py#L331-L333">View on GitHub</a>
```python
def __repr__(self) -> str:
    """Short string representation of the track."""
...
### Method `ultralytics.trackers.track_tracker.TTSTrack.activate` {#ultralytics.trackers.track\_tracker.TTSTrack.activate}
...
| Name | Type | Description | Default |
| --- | --- | --- | --- |
| `kalman_filter` | `KalmanFilterXYWH` |  | *required* |
| `frame_id` | `int` |  | *required* |

<details>
<summary>Source code in <code>ultralytics/trackers/track_tracker.py</code></summary>

<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/trackers/track_tracker.py#L273-L283">View on GitHub</a>
```python
def activate(self, kalman_filter: KalmanFilterXYWH, frame_id: int) -> None:
    """Initialize Kalman state and promote to New state."""
...
### Method `ultralytics.trackers.track_tracker.TTSTrack.get_history_box` {#ultralytics.trackers.track\_tracker.TTSTrack.get\_history\_box}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/trackers/track_tracker.py#L263-L271">View on GitHub</a>
```python
def get_history_box(self, frame_id: int, dt: int) -> np.ndarray:
    """Return the box from `dt` frames back, or the most recent box, or the current box."""
    target = frame_id - dt
...
### Method `ultralytics.trackers.track_tracker.TTSTrack.re_activate` {#ultralytics.trackers.track\_tracker.TTSTrack.re\_activate}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/trackers/track_tracker.py#L285-L301">View on GitHub</a>
```python
def re_activate(self, new_track, frame_id: int, new_id: bool = False) -> None:
    """Rebind a lost track to a fresh detection via NSA-Kalman."""
...
### Method `ultralytics.trackers.track_tracker.TTSTrack.update` {#ultralytics.trackers.track\_tracker.TTSTrack.update}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/trackers/track_tracker.py#L303-L329">View on GitHub</a>
```python
def update(self, new_track, frame_id: int) -> None:
    """Update a matched track with a new detection; promote to Tracked after min_track_len."""
    self.frame_id = frame_id
...
### Method `ultralytics.trackers.track_tracker.TTSTrack.update_features` {#ultralytics.trackers.track\_tracker.TTSTrack.update\_features}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/trackers/track_tracker.py#L256-L261">View on GitHub</a>
```python
def update_features(self, feat: np.ndarray) -> None:
    """Normalize `feat` and blend it into `smooth_feat` via score-adaptive EMA."""
...
## Class `ultralytics.trackers.track_tracker.TRACKTRACK` {#ultralytics.trackers.track\_tracker.TRACKTRACK}
...
Detections are partitioned into high, low, and deleted (loose-NMS recovered) sets, then matched against the union of tracked and lost tracks using a multi-cue cost (HMIoU + cosine ReID + confidence + angle distance) solved with iterative assignment. Unmatched still-Lost tracks may optionally be re-associated against leftover detections in a relaxed second pass, and surviving leftover detections spawn new tracks via track-aware NMS.

**Args**

| Name | Type | Description | Default |
| --- | --- | --- | --- |
| `args` | `Any` | Parsed tracker configuration. All knobs are read with `getattr(..., default)` so legacy YAMLs missing recently added keys still load. | *required* |
...
| Name | Description |
| --- | --- |
| [`_apply_gmc`](#ultralytics.trackers.track_tracker.TRACKTRACK._apply_gmc) | Warp `pools` in place by the current GMC affine. |
| [`_cost_matrix`](#ultralytics.trackers.track_tracker.TRACKTRACK._cost_matrix) | Return the multi-cue cost matrix (HMIoU + ReID + confidence + angle), gated by IoU support. |
| [`compute_frame_extras`](#ultralytics.trackers.track_tracker.TRACKTRACK.compute_frame_extras) | Return per-batch ``(xywh, conf, cls)`` tuples for detections dropped by tight NMS. |
| [`reset`](#ultralytics.trackers.track_tracker.TRACKTRACK.reset) | Clear all tracker state including GMC warp history and the global ID counter. |
| [`setup_predictor`](#ultralytics.trackers.track_tracker.TRACKTRACK.setup_predictor) | Attach the raw-predictions hook for Track-Aware Initialization (detect/obb only). |
| [`update`](#ultralytics.trackers.track_tracker.TRACKTRACK.update) | Advance the tracker by one frame and return an `(N, 8)` array of `[x1, y1, x2, y2, id, score, cls, idx]`. |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/trackers/track_tracker.py#L336-L577">View on GitHub</a>
```python
class TRACKTRACK:
    """Multi-object tracker implementing Track-Perspective Association and Track-Aware Initialization.
...
### Method `ultralytics.trackers.track_tracker.TRACKTRACK._apply_gmc` {#ultralytics.trackers.track\_tracker.TRACKTRACK.\_apply\_gmc}
...
| `detections` | `list` |  | *required* |
| `pools` | `list[list[TTSTrack]]` |  | *required* |

<details>
<summary>Source code in <code>ultralytics/trackers/track_tracker.py</code></summary>

<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/trackers/track_tracker.py#L437-L445">View on GitHub</a>
```python
def _apply_gmc(self, img: np.ndarray, detections: list, pools: list[list[TTSTrack]]) -> None:
    """Warp `pools` in place by the current GMC affine."""
    try:
...
### Method `ultralytics.trackers.track_tracker.TRACKTRACK._cost_matrix` {#ultralytics.trackers.track\_tracker.TRACKTRACK.\_cost\_matrix}
...
| Name | Type | Description | Default |
| --- | --- | --- | --- |
| `tracks` | `list[TTSTrack]` |  | *required* |
| `dets` | `list[TTSTrack]` |  | *required* |

<details>
<summary>Source code in <code>ultralytics/trackers/track_tracker.py</code></summary>

<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/trackers/track_tracker.py#L418-L435">View on GitHub</a>
```python
def _cost_matrix(self, tracks: list[TTSTrack], dets: list[TTSTrack]) -> np.ndarray:
    """Return the multi-cue cost matrix (HMIoU + ReID + confidence + angle), gated by IoU support."""
...
### Method `ultralytics.trackers.track_tracker.TRACKTRACK.compute_frame_extras` {#ultralytics.trackers.track\_tracker.TRACKTRACK.compute\_frame\_extras}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/trackers/track_tracker.py#L414-L416">View on GitHub</a>
```python
@classmethod
def compute_frame_extras(cls, predictor):
    """Return per-batch ``(xywh, conf, cls)`` tuples for detections dropped by tight NMS."""
...
### Method `ultralytics.trackers.track_tracker.TRACKTRACK.reset` {#ultralytics.trackers.track\_tracker.TRACKTRACK.reset}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/trackers/track_tracker.py#L569-L577">View on GitHub</a>
```python
def reset(self) -> None:
    """Clear all tracker state including GMC warp history and the global ID counter."""
...
### Method `ultralytics.trackers.track_tracker.TRACKTRACK.setup_predictor` {#ultralytics.trackers.track\_tracker.TRACKTRACK.setup\_predictor}
...
Recovered (loose-NMS) detections are box-only and have no row in the post-NMS Results, so on segment/pose tasks they cannot carry mask/keypoint data and would mis-index downstream; skip recovery (and its per-frame overhead) for those tasks.

<details>
<summary>Source code in <code>ultralytics/trackers/track_tracker.py</code></summary>

<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/trackers/track_tracker.py#L403-L411">View on GitHub</a>
```python
@classmethod
def setup_predictor(cls, predictor):
    """Attach the raw-predictions hook for Track-Aware Initialization (detect/obb only).
...
### Method `ultralytics.trackers.track_tracker.TRACKTRACK.update` {#ultralytics.trackers.track\_tracker.TRACKTRACK.update}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/trackers/track_tracker.py#L447-L567">View on GitHub</a>
```python
def update(self, results, img: np.ndarray | None = None, dets_del=None, **kwargs) -> np.ndarray:
    """Advance the tracker by one frame and return an `(N, 8)` array of `[x1, y1, x2, y2, id, score, cls, idx]`."""
    self.frame_id += 1
...
## Function `ultralytics.trackers.track_tracker._hmiou_distance` {#ultralytics.trackers.track\_tracker.\_hmiou\_distance}
...
| Name | Type | Description | Default |
| --- | --- | --- | --- |
| `tracks_a` | `list[TTSTrack]` |  | *required* |
| `tracks_b` | `list[TTSTrack]` |  | *required* |

<details>
<summary>Source code in <code>ultralytics/trackers/track_tracker.py</code></summary>

<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/trackers/track_tracker.py#L30-L41">View on GitHub</a>
```python
def _hmiou_distance(tracks_a: list[TTSTrack], tracks_b: list[TTSTrack]) -> tuple[np.ndarray, np.ndarray]:
    """Return (iou_sim, 1 - HMIoU) where HMIoU = HIoU * IoU and HIoU is vertical-overlap / vertical-union."""
...
## Function `ultralytics.trackers.track_tracker._angle_distance` {#ultralytics.trackers.track\_tracker.\_angle\_distance}
...
| `dets` | `list[TTSTrack]` |  | *required* |
| `frame_id` | `int` |  | *required* |
| `pairs` | `tuple[np.ndarray, np.ndarray]` |  | *required* |
| `delta_t` | `int` |  | `3` |

<details>
<summary>Source code in <code>ultralytics/trackers/track_tracker.py</code></summary>

<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/trackers/track_tracker.py#L44-L63">View on GitHub</a>
```python
def _angle_distance(
    tracks: list[TTSTrack], dets: list[TTSTrack], frame_id: int, pairs: tuple[np.ndarray, np.ndarray], delta_t: int = 3
) -> np.ndarray:
...
## Function `ultralytics.trackers.track_tracker._confidence_distance` {#ultralytics.trackers.track\_tracker.\_confidence\_distance}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/trackers/track_tracker.py#L66-L74">View on GitHub</a>
```python
def _confidence_distance(tracks: list[TTSTrack], dets: list[TTSTrack]) -> np.ndarray:
    """Absolute difference between each track's projected score and each detection's confidence."""
...
## Function `ultralytics.trackers.track_tracker._iterative_associate` {#ultralytics.trackers.track\_tracker.\_iterative\_associate}
...
| Name | Type | Description | Default |
| --- | --- | --- | --- |
| `cost` | `np.ndarray` |  | *required* |
| `match_thr` | `float` |  | *required* |
| `reduce_step` | `float` |  | `0.05` |

<details>
<summary>Source code in <code>ultralytics/trackers/track_tracker.py</code></summary>

<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/trackers/track_tracker.py#L77-L104">View on GitHub</a>
```python
def _iterative_associate(cost: np.ndarray, match_thr: float, reduce_step: float = 0.05) -> tuple[list]:
    """Greedy mutually-nearest matching with a threshold that shrinks each iteration.
...
## Function `ultralytics.trackers.track_tracker._track_aware_nms` {#ultralytics.trackers.track\_tracker.\_track\_aware\_nms}
...
| `tracks` | `list[TTSTrack]` |  | *required* |
| `dets` | `list[TTSTrack]` |  | *required* |
| `tai_thr` | `float` |  | *required* |
| `new_track_thresh` | `float` |  | *required* |

<details>
<summary>Source code in <code>ultralytics/trackers/track_tracker.py</code></summary>

<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/trackers/track_tracker.py#L107-L133">View on GitHub</a>
```python
def _track_aware_nms(
    tracks: list[TTSTrack], dets: list[TTSTrack], tai_thr: float, new_track_thresh: float
) -> list[bool]:
...
## Function `ultralytics.trackers.track_tracker.attach_raw_preds_hook` {#ultralytics.trackers.track\_tracker.attach\_raw\_preds\_hook}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/trackers/track_tracker.py#L136-L152">View on GitHub</a>
```python
def attach_raw_preds_hook(predictor) -> None:
    """Wrap `predictor.postprocess` to capture raw pre-NMS predictions and inputs (idempotent)."""
...
## Function `ultralytics.trackers.track_tracker.compute_dets_del` {#ultralytics.trackers.track\_tracker.compute\_dets\_del}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/trackers/track_tracker.py#L155-L189">View on GitHub</a>
```python
def compute_dets_del(predictor) -> list | None:
    """Return per-batch `(xywh, conf, cls)` tuples for detections the tight NMS dropped, or None if unavailable."""
...
## Function `ultralytics.trackers.track_tracker._cosine_distance` {#ultralytics.trackers.track\_tracker.\_cosine\_distance}
...
A NaN entry signals "no appearance evidence for this pair" so the caller falls back to motion rather than treating a missing/occlusion-suppressed embedding as maximally dissimilar (which would penalize true matches).
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/trackers/track_tracker.py#L192-L209">View on GitHub</a>
```python
def _cosine_distance(tracks: list[TTSTrack], dets: list[TTSTrack]) -> np.ndarray:
    """Cosine distance in `[0, 1]` between track and detection embeddings; NaN where either side has no feature.
