...
!!! Example "Heatmaps using Ultralytics YOLOv8 Example"
    ...
    === "Heatmap"
        ...
        # Init heatmap
        heatmap_obj = solutions.Heatmap(colormap=cv2.COLORMAP_PARULA, show=True, model="yolov8n.pt")
    ...
    === "Line Counting"
        ...
        # Init heatmap
        heatmap_obj = solutions.Heatmap(colormap=cv2.COLORMAP_PARULA, show=True, model="yolov8n.pt", reg_pts=line_points)
    ...
    === "Polygon Counting"
        ...
        # Init heatmap
        heatmap_obj = solutions.Heatmap(colormap=cv2.COLORMAP_PARULA, show=True, model="yolov8n.pt", reg_pts=region_points)
    ...
    === "Specific Classes"
        ...
        heatmap_obj = solutions.Heatmap(
            colormap=cv2.COLORMAP_PARULA, show=True, model="yolov8n.pt", reg_pts=region_points, classes=[0, 2]
        )
...
cap = cv2.VideoCapture("path/to/video/file.mp4")
heatmap_obj = solutions.Heatmap(colormap=cv2.COLORMAP_PARULA, show=True, names=model.names)
