...
from ultralytics.nn.tasks import ClassificationModel, DetectionModel, RTDETRDetectionModel, SegmentationModel, WorldModel
...
class Exporter:
    ...
    def __call__(self, model=None) -> str:
        ...
        if self.args.nms:
            ...
            if getattr(model, "end2end", False) or isinstance(model, RTDETRDetectionModel):
