...
- **Copy-paste** (`copy_paste`, `copy_paste_mode`): Paste extra object instances into segmentation images, mirrored from the same image or copied from another sample.
