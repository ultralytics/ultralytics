...
- [D-Robotics RDK](drobotics-rdk.md): Export Ultralytics YOLO detection models to the D-Robotics RDK `.bin` format with the `hb_mapper` compiler for INT8 inference on RDK BPU hardware.
