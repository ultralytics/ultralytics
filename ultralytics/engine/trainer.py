    ...
    def _do_train(self, world_size=1):
        ...
        while True:
            ...
            for i, batch in pbar:
                ...
                # Log
                mem = f"{torch.cuda.memory_reserved() / 1E9 if torch.cuda.is_available() else torch.mps.driver_allocated_memory() / 1E9 if MACOS and self.device.type == 'mps' else 0:.3g}G"  # (GB)
