...
from ultralytics.utils import ASSETS, WEIGHTS_DIR, checks, LINUX, ARM64
...
@pytest.mark.skipif(PYTHON_VERSION <= "3.8.0" and LINUX and ARM64, reason="MobileSAM with CLIP is not supported in Python <= 3.8 and aarch64 Linux")
def test_fastsam(
