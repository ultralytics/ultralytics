...
- [COCO12-Formats](coco12-formats.md): A test dataset with 12 images covering all supported image formats (AVIF, BMP, DNG, HEIC, JPEG, JPG, MPO, PFM, PNG, TIF, TIFF, WebP) for validating image loading pipelines.
