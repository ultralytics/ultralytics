...
- **Neural Engine speed**: YOLO26n detection runs end-to-end in **3.8 ms** on an iPhone 17 Pro (see the table below) — comfortably past 60 FPS camera real-time with headroom for the rest of your app.
