...
!!! abstract "Summary"
    ...
    === "<span class="doc-kind doc-kind-class">Classes</span>"
        ...
        - [`TorchNMS`](#ultralytics.utils.nms.TorchNMS)

    === "<span class="doc-kind doc-kind-method">Methods</span>"

        - [`TorchNMS.fast_nms`](#ultralytics.utils.nms.TorchNMS.fast_nms)
        - [`TorchNMS.nms`](#ultralytics.utils.nms.TorchNMS.nms)
        - [`TorchNMS.batched_nms`](#ultralytics.utils.nms.TorchNMS.batched_nms)

    === "<span class="doc-kind doc-kind-function">Functions</span>"

        - [`non_max_suppression`](#ultralytics.utils.nms.non_max_suppression)


## Class `ultralytics.utils.nms.TorchNMS` {#ultralytics.utils.nms.TorchNMS}
...
This class provides static methods for performing non-maximum suppression (NMS) operations on bounding boxes, including standard NMS, fast NMS, and batched NMS for multi-class scenarios.

**Methods**

| Name | Description |
| --- | --- |
| [`batched_nms`](#ultralytics.utils.nms.TorchNMS.batched_nms) | Batched NMS for class-aware suppression. |
| [`fast_nms`](#ultralytics.utils.nms.TorchNMS.fast_nms) | Fast-NMS implementation from https://arxiv.org/pdf/1904.02689 using upper triangular matrix operations. |
| [`nms`](#ultralytics.utils.nms.TorchNMS.nms) | Optimized NMS with early termination that matches torchvision behavior exactly. |
...
<details>
<summary>Source code in <code>ultralytics/utils/nms.py</code></summary>

<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/nms.py#L169-L338"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
class TorchNMS:
```
</details>
...
### Method `ultralytics.utils.nms.TorchNMS.batched_nms` {#ultralytics.utils.nms.TorchNMS.batched\_nms}
...
| `scores` | `torch.Tensor` | Confidence scores with shape (N,). | *required* |
| `idxs` | `torch.Tensor` | Class indices with shape (N,). | *required* |
| `iou_threshold` | `float` | IoU threshold for suppression. | *required* |
| `use_fast_nms` | `bool` | Whether to use the Fast-NMS implementation. | `False` |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/nms.py#L300-L338"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
@staticmethod
def batched_nms(
    boxes: torch.Tensor,
...
### Method `ultralytics.utils.nms.TorchNMS.fast_nms` {#ultralytics.utils.nms.TorchNMS.fast\_nms}
...
| `iou_func` | `callable` | Function to compute IoU between boxes. | `box_iou` |
| `exit_early` | `bool` | Whether to exit early if there are no boxes. | `True` |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/nms.py#L188-L237"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
@staticmethod
def fast_nms(
    boxes: torch.Tensor,
...
### Method `ultralytics.utils.nms.TorchNMS.nms` {#ultralytics.utils.nms.TorchNMS.nms}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/nms.py#L240-L297"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
@staticmethod
def nms(boxes: torch.Tensor, scores: torch.Tensor, iou_threshold: float) -> torch.Tensor:
    """Optimized NMS with early termination that matches torchvision behavior exactly.
...
## Function `ultralytics.utils.nms.non_max_suppression` {#ultralytics.utils.nms.non\_max\_suppression}
...
| Name | Type | Description | Default |
| --- | --- | --- | --- |
| `prediction` | `torch.Tensor` | Predictions with shape (batch_size, num_classes + 4 + num_masks, num_boxes)<br>    containing boxes, classes, and optional masks. | *required* |
...
| `classes` | `list[int], optional` | List of class indices to consider. If None, all classes are considered. | `None` |
...
| `max_nms` | `int` | Maximum number of boxes for NMS. | `30000` |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/nms.py#L13-L166"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def non_max_suppression(
    prediction,
    conf_thres: float = 0.25,
