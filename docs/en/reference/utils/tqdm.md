...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/tqdm.py#L20-L387">View on GitHub</a>
```python
class TQDM:
    """Lightweight zero-dependency progress bar for Ultralytics.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/tqdm.py#L358-L363">View on GitHub</a>
```python
def __del__(self) -> None:
    """Destructor to ensure cleanup."""
    try:
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/tqdm.py#L338-L340">View on GitHub</a>
```python
def __enter__(self) -> Self:
    """Enter context manager."""
    return self
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/tqdm.py#L342-L344">View on GitHub</a>
```python
def __exit__(self, *args: object) -> None:
    """Exit context manager and close progress bar."""
    self.close()
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/tqdm.py#L346-L356">View on GitHub</a>
```python
def __iter__(self) -> Any:
    """Iterate over the wrapped iterable with progress updates."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/tqdm.py#L213-L290">View on GitHub</a>
```python
def _display(self, final: bool = False) -> None:
    """Display progress bar."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/tqdm.py#L173-L182">View on GitHub</a>
```python
def _format_num(self, num: float) -> str:
    """Format number with optional unit scaling."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/tqdm.py#L158-L171">View on GitHub</a>
```python
def _format_rate(self, rate: float) -> str:
    """Format rate with units, switching between it/s and s/it for readability."""
    if rate <= 0:
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/tqdm.py#L185-L193">View on GitHub</a>
```python
@staticmethod
def _format_time(seconds: float) -> str:
    """Format time duration."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/tqdm.py#L195-L205">View on GitHub</a>
```python
def _generate_bar(self, width: int = 12) -> str:
    """Generate progress bar."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/tqdm.py#L207-L211">View on GitHub</a>
```python
def _should_update(self, dt: float, dn: int) -> bool:
    """Check if display should update."""
    if self.noninteractive:
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/tqdm.py#L370-L377">View on GitHub</a>
```python
def clear(self) -> None:
    """Clear progress bar."""
    if not self.disable:
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/tqdm.py#L311-L336">View on GitHub</a>
```python
def close(self) -> None:
    """Close progress bar."""
    if self.closed:
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/tqdm.py#L365-L368">View on GitHub</a>
```python
def refresh(self) -> None:
    """Refresh display."""
    if not self.disable:
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/tqdm.py#L298-L302">View on GitHub</a>
```python
def set_description(self, desc: str | None) -> None:
    """Set description."""
    self.desc = desc or ""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/tqdm.py#L304-L309">View on GitHub</a>
```python
def set_postfix(self, **kwargs: Any) -> None:
    """Set postfix (appends to description)."""
    if kwargs:
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/tqdm.py#L292-L296">View on GitHub</a>
```python
def update(self, n: int = 1) -> None:
    """Update progress by n steps."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/tqdm.py#L380-L387">View on GitHub</a>
```python
@staticmethod
def write(s: str, file: IO[str] | None = None, end: str = "\n") -> None:
    """Static method to write without breaking progress bar."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/tqdm.py#L15-L17">View on GitHub</a>
```python
@lru_cache(maxsize=1)
def is_noninteractive_console() -> bool:
    """Check for known non-interactive console environments."""
