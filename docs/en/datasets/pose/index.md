...
!!! example "Image paths as a `*.txt` file"
    ...
    === "train.txt"
        ...
        ```text
        ./images/im0.jpg # ./ resolves next to train.txt -> datasets/coco8-pose/images/im0.jpg
