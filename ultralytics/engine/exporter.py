...
from ultralytics.nn.modules import C2f, Detect, RTDETRDecoder, MultiTask
from ultralytics.nn.tasks import DetectionModel, SegmentationModel, WorldModel, MultiTaskModel
