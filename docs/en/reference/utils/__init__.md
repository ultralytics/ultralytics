...
!!! abstract "Summary"
    ...
    === "<span class="doc-kind doc-kind-function">Functions</span>"
        ...
        - [`env_bool`](#ultralytics.utils.__init__.env_bool)
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/__init__.py#L187-L263">View on GitHub</a>
```python
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/__init__.py#L222-L251">View on GitHub</a>
```python
def to_csv(self, normalize=False, decimals=5):
    """Export results or metrics to CSV string format.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/__init__.py#L208-L220">View on GitHub</a>
```python
def to_df(self, normalize=False, decimals=5):
    """Create a Polars DataFrame from the prediction results summary or validation metrics.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/__init__.py#L253-L263">View on GitHub</a>
```python
def to_json(self, normalize=False, decimals=5):
    """Export results to JSON format.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/__init__.py#L266-L312">View on GitHub</a>
```python
class SimpleClass:
    """A simple base class for creating objects with string representations of their attributes.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/__init__.py#L309-L312">View on GitHub</a>
```python
def __getattr__(self, attr):
    """Provide a custom attribute access error message with helpful information."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/__init__.py#L305-L307">View on GitHub</a>
```python
def __repr__(self):
    """Return a machine-readable string representation of the object."""
    return self.__str__()
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/__init__.py#L291-L303">View on GitHub</a>
```python
def __str__(self):
    """Return a human-readable string representation of the object."""
    attr = []
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/__init__.py#L315-L371">View on GitHub</a>
```python
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/__init__.py#L357-L367">View on GitHub</a>
```python
def __getattr__(self, attr):
    """Provide a custom attribute access error message with helpful information."""
    name = self.__class__.__name__
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/__init__.py#L349-L351">View on GitHub</a>
```python
def __iter__(self):
    """Return an iterator of key-value pairs from the namespace's attributes."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/__init__.py#L353-L355">View on GitHub</a>
```python
def __str__(self):
    """Return a human-readable string representation of the object."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/__init__.py#L369-L371">View on GitHub</a>
```python
def get(self, key, default=None):
    """Return the value of the specified key if it exists; otherwise, return the default value."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/__init__.py#L526-L556">View on GitHub</a>
```python
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/__init__.py#L546-L556">View on GitHub</a>
```python
def __call__(self, f):
    """Run thread-safe execution of function or method."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/__init__.py#L559-L698">View on GitHub</a>
```python
class YAML:
    """YAML utility class for efficient file operations with automatic C-implementation detection.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/__init__.py#L589-L593">View on GitHub</a>
```python
@classmethod
def _get_instance(cls):
    """Initialize singleton instance on first use."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/__init__.py#L638-L681">View on GitHub</a>
```python
@classmethod
def load(cls, file="data.yaml", append_filename=False):
    """Load YAML file to Python object with robust error handling.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/__init__.py#L684-L698">View on GitHub</a>
```python
@classmethod
def print(cls, yaml_file):
    """Pretty print YAML file or object to console.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/__init__.py#L609-L635">View on GitHub</a>
```python
@classmethod
def save(cls, file="data.yaml", data=None, header=""):
    """Save Python object as YAML file.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/__init__.py#L1075-L1110">View on GitHub</a>
```python
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/__init__.py#L1103-L1104">View on GitHub</a>
```python
def __enter__(self):
    """Execute when entering TryExcept context, initialize instance."""
```
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/__init__.py#L1106-L1110">View on GitHub</a>
```python
def __exit__(self, exc_type, value, traceback):
    """Define behavior when exiting a 'with' block, print error message if necessary."""
...
```python
Retry(times=3, delay=2, verbose=True)
```
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/__init__.py#L1113-L1156">View on GitHub</a>
```python
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/__init__.py#L1139-L1156">View on GitHub</a>
```python
def __call__(self, func):
    """Decorator implementation for Retry with exponential backoff."""
...
```python
JSONDict(file_path: str | Path = "data.json")
```
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/__init__.py#L1264-L1354">View on GitHub</a>
```python
class JSONDict(dict):
    """A dictionary-like class that provides JSON persistence for its contents.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/__init__.py#L1333-L1337">View on GitHub</a>
```python
def __delitem__(self, key):
    """Remove an item and update the persistent storage."""
    with self.lock:
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/__init__.py#L1327-L1331">View on GitHub</a>
```python
def __setitem__(self, key, value):
    """Store a key-value pair and persist to disk."""
    with self.lock:
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/__init__.py#L1339-L1342">View on GitHub</a>
```python
def __str__(self):
    """Return a pretty-printed JSON string representation of the dictionary."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/__init__.py#L1321-L1325">View on GitHub</a>
```python
@staticmethod
def _json_default(obj):
    """Handle JSON serialization of Path objects."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/__init__.py#L1299-L1309">View on GitHub</a>
```python
def _load(self):
    """Load the data from the JSON file into the dictionary."""
    try:
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/__init__.py#L1311-L1318">View on GitHub</a>
```python
def _save(self):
    """Save the current state of the dictionary to the JSON file."""
    try:
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/__init__.py#L1350-L1354">View on GitHub</a>
```python
def clear(self):
    """Clear all entries and update the persistent storage."""
    with self.lock:
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/__init__.py#L1344-L1348">View on GitHub</a>
```python
def update(self, *args, **kwargs):
    """Update the dictionary and persist changes."""
    with self.lock:
...
```python
SettingsManager(file=SETTINGS_FILE, version="0.0.7")
```
...
| [`_validate_settings`](#ultralytics.utils.__init__.SettingsManager._validate_settings) | Validate settings and migrate valid values to the current schema. |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/__init__.py#L1357-L1483">View on GitHub</a>
```python
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/__init__.py#L1461-L1463">View on GitHub</a>
```python
def __setitem__(self, key, value):
    """Update one key: value pair."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/__init__.py#L1431-L1459">View on GitHub</a>
```python
def _validate_settings(self):
    """Validate settings and migrate valid values to the current schema."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/__init__.py#L1480-L1483">View on GitHub</a>
```python
def reset(self):
    """Reset the settings to default and save them."""
    self.clear()
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/__init__.py#L1465-L1478">View on GitHub</a>
```python
def update(self, *args, **kwargs):
    """Update settings, validating keys and types."""
    for arg in args:
...
## Function `ultralytics.utils.env_bool` {#ultralytics.utils.\_\_init\_\_.env\_bool}
...
Accepts "1", "true", "yes", "on", "y", "t" (case-insensitive, whitespace-trimmed) as True; any other set value is False. The default is returned only when the variable is unset, not when it is set to an empty string.
...
| `default` | `bool` | Value returned when the variable is unset. | `False` |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/__init__.py#L34-L52">View on GitHub</a>
```python
def env_bool(name: str, default: bool = False) -> bool:
    """Parse a boolean environment variable, accepting common truthy strings.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/__init__.py#L374-L441">View on GitHub</a>
```python
def plt_settings(rcparams=None, backend="Agg"):
    """Decorator to temporarily set rc parameters and the backend for a plotting function.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/__init__.py#L444-L513">View on GitHub</a>
```python
def set_logging(name="LOGGING_NAME", verbose=True):
    """Set up logging with UTF-8 encoding and configurable verbosity.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/__init__.py#L521-L523">View on GitHub</a>
```python
def emojis(string=""):
    """Return platform-dependent emoji-safe version of string."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/__init__.py#L707-L713">View on GitHub</a>
```python
def read_device_model() -> str:
    """Read the device model information from the system.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/__init__.py#L716-L726">View on GitHub</a>
```python
def is_ubuntu() -> bool:
    """Check if the OS is Ubuntu.
...
| Name | Type | Description | Default |
| --- | --- | --- | --- |
| `codenames` | `list[str] \| None \| str` | Specific Debian codename to check for (e.g., 'buster', 'bullseye'). If None, only checks for Debian. | `None` |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/__init__.py#L729-L752">View on GitHub</a>
```python
def is_debian(codenames: list[str] | str | None = None) -> list[bool] | bool:
    """Check if the OS is Debian.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/__init__.py#L755-L761">View on GitHub</a>
```python
def is_colab():
    """Check if the current script is running inside a Google Colab notebook.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/__init__.py#L764-L770">View on GitHub</a>
```python
def is_kaggle():
    """Check if the current script is running inside a Kaggle kernel.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/__init__.py#L773-L783">View on GitHub</a>
```python
def is_jupyter():
    """Check if the current script is running inside a Jupyter Notebook.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/__init__.py#L786-L792">View on GitHub</a>
```python
def is_runpod():
    """Check if the current script is running inside a RunPod container.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/__init__.py#L795-L804">View on GitHub</a>
```python
def is_docker() -> bool:
    """Determine if the script is running inside a Docker container.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/__init__.py#L807-L813">View on GitHub</a>
```python
def is_raspberrypi() -> bool:
    """Determine if the Python environment is running on a Raspberry Pi.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/__init__.py#L817-L834">View on GitHub</a>
```python
@lru_cache(maxsize=3)
def is_jetson(jetpack=None) -> bool:
    """Determine if the Python environment is running on an NVIDIA Jetson device.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/__init__.py#L837-L847">View on GitHub</a>
```python
def is_dgx() -> bool:
    """Check if the current script is running inside a DGX (NVIDIA Data Center GPU), DGX-Ready or DGX Spark system.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/__init__.py#L850-L865">View on GitHub</a>
```python
def is_online() -> bool:
    """Fast online check using DNS (v4/v6) resolution (Cloudflare + Google).
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/__init__.py#L868-L883">View on GitHub</a>
```python
def is_pip_package(filepath: str = __name__) -> bool:
    """Determine if the file at the given filepath is part of a pip package.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/__init__.py#L886-L895">View on GitHub</a>
```python
def is_dir_writeable(dir_path: str | Path) -> bool:
    """Check if a directory is writable.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/__init__.py#L898-L904">View on GitHub</a>
```python
def is_pytest_running():
    """Determine whether pytest is currently running or not.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/__init__.py#L907-L913">View on GitHub</a>
```python
def is_github_action_running() -> bool:
    """Determine if the current environment is a GitHub Actions runner.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/__init__.py#L916-L926">View on GitHub</a>
```python
def get_default_args(func):
    """Return a dictionary of default arguments for a function.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/__init__.py#L929-L940">View on GitHub</a>
```python
def get_ubuntu_version():
    """Retrieve the Ubuntu version if the OS is Ubuntu.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/__init__.py#L943-L983">View on GitHub</a>
```python
def get_user_config_dir(sub_dir="Ultralytics"):
    """Return a writable config dir, preferring YOLO_CONFIG_DIR and being OS-aware.
...
| Name | Type | Description | Default |
| --- | --- | --- | --- |
| `*input` | `str \| Path` | A sequence of strings where the first n-1 strings are color and style arguments, and the last string is the one to be colored. | *required* |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/__init__.py#L1003-L1055">View on GitHub</a>
```python
def colorstr(*input):
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/__init__.py#L1058-L1072">View on GitHub</a>
```python
def remove_colorstr(input_string):
    """Remove ANSI escape codes from a string, effectively un-coloring it.
...
| Type | Description |
| --- | --- |
| `callable` | A wrapper function that either returns a thread or the direct function result. The thread is non-daemon so interpreter shutdown joins it before module teardown, avoiding teardown races. |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/__init__.py#L1159-L1193">View on GitHub</a>
```python
def threaded(func):
    """Multi-thread a target function by default and return the thread or function result.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/__init__.py#L1196-L1261">View on GitHub</a>
```python
def set_sentry():
    """Initialize the Sentry SDK for error tracking and reporting.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/__init__.py#L1486-L1491">View on GitHub</a>
```python
def deprecation_warn(arg, new_arg=None):
    """Issue a deprecation warning when a deprecated argument is used, suggesting an updated argument."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/__init__.py#L1494-L1497">View on GitHub</a>
```python
def clean_url(url):
    """Strip auth from URL, i.e. `https://example.com/path/file.txt?auth` -> `https://example.com/path/file.txt`."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/__init__.py#L1500-L1502">View on GitHub</a>
```python
def url2file(url):
    """Convert URL to filename, i.e. `https://example.com/path/file.txt?auth` -> `file.txt`."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/__init__.py#L1505-L1511">View on GitHub</a>
```python
def vscode_msg(ext="ultralytics.ultralytics-snippets") -> str:
    """Display a message to install Ultralytics-Snippets for VS Code if not already installed."""
