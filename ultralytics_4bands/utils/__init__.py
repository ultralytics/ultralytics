...
LOGGING_NAME = "ultralytics_4bands"
MACOS, LINUX, WINDOWS = (platform.system() == x for x in ["Darwin", "Linux", "Windows"])  # environment booleans
ARM64 = platform.machine() in ("arm64", "aarch64")  # ARM64 booleans
HELP_MSG = """
    Usage examples for running YOLOv8:

    1. Install the ultralytics_4bands package:
...
class IterableSimpleNamespace(SimpleNamespace):
    ...
    def __getattr__(self, attr):
        ...
        raise AttributeError(
            f"""
            '{name}' object has no attribute '{attr}'. This may be caused by a modified or out of date ultralytics_4bands
            'default.yaml' file.\nPlease update your code with 'pip install -U ultralytics_4bands' and if necessary replace
...
class ThreadingLocked:
    ...
    Example:
        ```python
        from ultralytics_4bands.utils import ThreadingLocked
...
class SettingsManager(dict):
    ...
    def __init__(self, file=SETTINGS_YAML, version="0.0.4"):
        ...
        from ultralytics_4bands.utils.torch_utils import torch_distributed_zero_first
        ...
        with torch_distributed_zero_first(RANK):
            ...
            if not (correct_keys and correct_types and correct_version):
                LOGGER.warning(
                    ...
                    "with your settings or a recent ultralytics_4bands package update. "
...
def deprecation_warn(arg, new_arg, version=None):
    ...
    LOGGER.warning(
        f"WARNING ⚠️ '{arg}' is deprecated and will be removed in 'ultralytics_4bands {version}' in the future. "
