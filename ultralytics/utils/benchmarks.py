...
from ultralytics.utils import ASSETS, LINUX, MACOS, ARM64, WINDOWS, LOGGER, TQDM, WEIGHTS_DIR, IS_RASPBERRYPI, IS_JETSON
...
def benchmark(
    ...
    for i, (name, format, suffix, cpu, gpu) in export_formats().iterrows():  # index, (name, format, suffix, CPU, GPU)
        ...
        try:
            # Checks
            if i == 9:  # Edge TPU
                assert not (IS_RASPBERRYPI or IS_JETSON or MACOS or WINDOWS), "Edge TPU export only supported on Linux"
