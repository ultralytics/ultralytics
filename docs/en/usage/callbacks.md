...
Each of these objects supports distinct callbacks, making it easier to customize and control the behavior at each stage of the ML pipeline. For more details, you can refer to the [Reference section](../reference/index.md).
