...
!!! abstract "Summary"
    ...
    === "<span class="doc-kind doc-kind-class">Classes</span>"
        ...
        - [`GCPRegions`](#ultralytics.hub.google.__init__.GCPRegions)

    === "<span class="doc-kind doc-kind-method">Methods</span>"

        - [`GCPRegions.tier1`](#ultralytics.hub.google.__init__.GCPRegions.tier1)
        - [`GCPRegions.tier2`](#ultralytics.hub.google.__init__.GCPRegions.tier2)
        - [`GCPRegions._ping_region`](#ultralytics.hub.google.__init__.GCPRegions._ping_region)
        - [`GCPRegions.lowest_latency`](#ultralytics.hub.google.__init__.GCPRegions.lowest_latency)


## Class `ultralytics.hub.google.GCPRegions` {#ultralytics.hub.google.\_\_init\_\_.GCPRegions}
...
| Name | Description |
| --- | --- |
| [`_ping_region`](#ultralytics.hub.google.__init__.GCPRegions._ping_region) | Ping a specified GCP region and measure network latency statistics. |
| [`lowest_latency`](#ultralytics.hub.google.__init__.GCPRegions.lowest_latency) | Determine the GCP regions with the lowest latency based on ping tests. |
| [`tier1`](#ultralytics.hub.google.__init__.GCPRegions.tier1) | Return a list of GCP regions classified as tier 1 based on predefined criteria. |
| [`tier2`](#ultralytics.hub.google.__init__.GCPRegions.tier2) | Return a list of GCP regions classified as tier 2 based on predefined criteria. |
...
<details>
<summary>Source code in <code>ultralytics/hub/google/__init__.py</code></summary>

<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/hub/google/__init__.py#L10-L168"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
class GCPRegions:
    """A class for managing and analyzing Google Cloud Platform (GCP) regions.
...
### Method `ultralytics.hub.google.GCPRegions._ping_region` {#ultralytics.hub.google.\_\_init\_\_.GCPRegions.\_ping\_region}
...
| --- | --- | --- | --- |
| `region` | `str` | The GCP region identifier to ping (e.g., 'us-central1'). | *required* |
| `attempts` | `int, optional` | Number of ping attempts to make for calculating statistics. | `1` |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/hub/google/__init__.py#L83-L118"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
@staticmethod
def _ping_region(region: str, attempts: int = 1) -> tuple[str, float, float, float, float]:
    """Ping a specified GCP region and measure network latency statistics.
...
### Method `ultralytics.hub.google.GCPRegions.lowest_latency` {#ultralytics.hub.google.\_\_init\_\_.GCPRegions.lowest\_latency}
...
| Name | Type | Description | Default |
| --- | --- | --- | --- |
| `top` | `int, optional` | Number of top regions to return. | `1` |
| `verbose` | `bool, optional` | If True, prints detailed latency information for all tested regions. | `False` |
| `tier` | `int | None, optional` | Filter regions by tier (1 or 2). If None, all regions are tested. | `None` |
| `attempts` | `int, optional` | Number of ping attempts per region. | `1` |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/hub/google/__init__.py#L120-L168"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def lowest_latency(
    self,
    top: int = 1,
...
### Method `ultralytics.hub.google.GCPRegions.tier1` {#ultralytics.hub.google.\_\_init\_\_.GCPRegions.tier1}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/hub/google/__init__.py#L74-L76"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def tier1(self) -> list[str]:
    """Return a list of GCP regions classified as tier 1 based on predefined criteria."""
...
### Method `ultralytics.hub.google.GCPRegions.tier2` {#ultralytics.hub.google.\_\_init\_\_.GCPRegions.tier2}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/hub/google/__init__.py#L78-L80"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def tier2(self) -> list[str]:
    """Return a list of GCP regions classified as tier 2 based on predefined criteria."""
