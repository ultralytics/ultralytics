...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/split_dota.py#L20-L63">View on GitHub</a>
```python
def bbox_iof(polygon1: np.ndarray, bbox2: np.ndarray, eps: float = 1e-6) -> np.ndarray:
    """Calculate Intersection over Foreground (IoF) between polygons and bounding boxes.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/split_dota.py#L66-L98">View on GitHub</a>
```python
def load_yolo_dota(data_root: str, split: str = "train") -> list[dict[str, Any]]:
    """Load DOTA dataset annotations and image information.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/split_dota.py#L101-L150">View on GitHub</a>
```python
def get_windows(
    im_size: tuple[int, int],
    crop_sizes: tuple[int, ...] = (1024,),
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/split_dota.py#L153-L164">View on GitHub</a>
```python
def get_window_obj(anno: dict[str, Any], windows: np.ndarray, iof_thr: float = 0.7) -> list[np.ndarray]:
    """Get objects for each window based on IoF threshold."""
    h, w = anno["ori_size"]
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/split_dota.py#L167-L215">View on GitHub</a>
```python
def crop_and_save(
    anno: dict[str, Any],
    windows: np.ndarray,
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/split_dota.py#L218-L257">View on GitHub</a>
```python
def split_images_and_labels(
    data_root: str,
    save_dir: str,
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/split_dota.py#L260-L295">View on GitHub</a>
```python
def split_trainval(
    data_root: str, save_dir: str, crop_size: int = 1024, gap: int = 200, rates: tuple[float, ...] = (1.0,)
) -> None:
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/split_dota.py#L298-L339">View on GitHub</a>
```python
def split_test(
    data_root: str, save_dir: str, crop_size: int = 1024, gap: int = 200, rates: tuple[float, ...] = (1.0,)
) -> None:
