...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/modules/conv.py#L39-L89">View on GitHub</a>
```python
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/modules/conv.py#L69-L78">View on GitHub</a>
```python
def forward(self, x):
    """Apply convolution, batch normalization and activation to input tensor.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/modules/conv.py#L80-L89">View on GitHub</a>
```python
def forward_fuse(self, x):
    """Apply convolution and activation without batch normalization.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/modules/conv.py#L92-L147">View on GitHub</a>
```python
class Conv2(Conv):
    """Simplified RepConv module with Conv fusing.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/modules/conv.py#L118-L127">View on GitHub</a>
```python
def forward(self, x):
    """Apply convolution, batch normalization and activation to input tensor.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/modules/conv.py#L129-L138">View on GitHub</a>
```python
def forward_fuse(self, x):
    """Apply fused convolution, batch normalization and activation to input tensor.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/modules/conv.py#L140-L147">View on GitHub</a>
```python
def fuse_convs(self):
    """Fuse parallel convolutions."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/modules/conv.py#L150-L183">View on GitHub</a>
```python
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/modules/conv.py#L174-L183">View on GitHub</a>
```python
def forward(self, x):
    """Apply 2 convolutions to input tensor.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/modules/conv.py#L186-L200">View on GitHub</a>
```python
class DWConv(Conv):
    """Depth-wise convolution module."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/modules/conv.py#L203-L217">View on GitHub</a>
```python
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/modules/conv.py#L220-L269">View on GitHub</a>
```python
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/modules/conv.py#L249-L258">View on GitHub</a>
```python
def forward(self, x):
    """Apply transposed convolution, batch normalization and activation to input.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/modules/conv.py#L260-L269">View on GitHub</a>
```python
def forward_fuse(self, x):
    """Apply convolution transpose and activation to input.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/modules/conv.py#L272-L308">View on GitHub</a>
```python
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/modules/conv.py#L297-L308">View on GitHub</a>
```python
def forward(self, x):
    """Apply Focus operation and convolution to input tensor.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/modules/conv.py#L312-L351">View on GitHub</a>
```python
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/modules/conv.py#L341-L351">View on GitHub</a>
```python
def forward(self, x):
    """Apply Ghost Convolution to input tensor.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/modules/conv.py#L354-L510">View on GitHub</a>
```python
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/modules/conv.py#L448-L482">View on GitHub</a>
```python
def _fuse_bn_tensor(self, branch):
    """Fuse batch normalization with convolution weights.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/modules/conv.py#L434-L446">View on GitHub</a>
```python
@staticmethod
def _pad_1x1_to_3x3_tensor(kernel1x1):
    """Pad a 1x1 kernel to 3x3 size.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/modules/conv.py#L409-L419">View on GitHub</a>
```python
def forward(self, x):
    """Forward pass for training mode.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/modules/conv.py#L398-L407">View on GitHub</a>
```python
def forward_fuse(self, x):
    """Forward pass for deploy mode.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/modules/conv.py#L484-L510">View on GitHub</a>
```python
def fuse_convs(self):
    """Fuse convolutions for inference by creating a single equivalent convolution."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/modules/conv.py#L421-L431">View on GitHub</a>
```python
def get_equivalent_kernel_bias(self):
    """Calculate equivalent kernel and bias by fusing convolutions.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/modules/conv.py#L513-L547">View on GitHub</a>
```python
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/modules/conv.py#L538-L547">View on GitHub</a>
```python
def forward(self, x: torch.Tensor) -> torch.Tensor:
    """Apply channel attention to input tensor.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/modules/conv.py#L550-L581">View on GitHub</a>
```python
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/modules/conv.py#L572-L581">View on GitHub</a>
```python
def forward(self, x):
    """Apply spatial attention to input tensor.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/modules/conv.py#L584-L614">View on GitHub</a>
```python
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/modules/conv.py#L605-L614">View on GitHub</a>
```python
def forward(self, x):
    """Apply channel and spatial attention sequentially to input tensor.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/modules/conv.py#L617-L642">View on GitHub</a>
```python
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/modules/conv.py#L633-L642">View on GitHub</a>
```python
def forward(self, x: list[torch.Tensor]):
    """Concatenate input tensors along specified dimension.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/modules/conv.py#L645-L670">View on GitHub</a>
```python
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/modules/conv.py#L661-L670">View on GitHub</a>
```python
def forward(self, x: list[torch.Tensor]):
    """Select and return a particular index from input.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/modules/conv.py#L30-L36">View on GitHub</a>
```python
