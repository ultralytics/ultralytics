...
| `trt_quant_algo` | `str`            | `'ENTROPY_CALIBRATION_2'` | TensorRT `INT8` quantization algorithm; choices are LEGACY_CALIBRATION, ENTROPY_CALIBRATION, ENTROPY_CALIBRATION_2, MINMAX_CALIBRATION.                          |
