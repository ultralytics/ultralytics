...
!!! abstract "Summary"
    ...
    === "<span class="doc-kind doc-kind-class">Classes</span>"
        ...
        - [`Attention`](#ultralytics.models.sam.sam3.vitdet.Attention)
        - [`Block`](#ultralytics.models.sam.sam3.vitdet.Block)
        - [`ViT`](#ultralytics.models.sam.sam3.vitdet.ViT)

    === "<span class="doc-kind doc-kind-method">Methods</span>"

        - [`Attention._setup_rel_pos`](#ultralytics.models.sam.sam3.vitdet.Attention._setup_rel_pos)
        - [`Attention._setup_rope_freqs`](#ultralytics.models.sam.sam3.vitdet.Attention._setup_rope_freqs)
        - [`Attention._apply_rope`](#ultralytics.models.sam.sam3.vitdet.Attention._apply_rope)
        - [`Attention.forward`](#ultralytics.models.sam.sam3.vitdet.Attention.forward)
        - [`Block.forward`](#ultralytics.models.sam.sam3.vitdet.Block.forward)
        - [`ViT._init_weights`](#ultralytics.models.sam.sam3.vitdet.ViT._init_weights)
        - [`ViT.forward`](#ultralytics.models.sam.sam3.vitdet.ViT.forward)
        - [`ViT.set_imgsz`](#ultralytics.models.sam.sam3.vitdet.ViT.set_imgsz)


## Class `ultralytics.models.sam.sam3.vitdet.Attention` {#ultralytics.models.sam.sam3.vitdet.Attention}
...
| Name | Description |
| --- | --- |
| [`_apply_rope`](#ultralytics.models.sam.sam3.vitdet.Attention._apply_rope) | Apply 2d-rope to q and k. |
| [`_setup_rel_pos`](#ultralytics.models.sam.sam3.vitdet.Attention._setup_rel_pos) | Setup relative positional embeddings. |
| [`_setup_rope_freqs`](#ultralytics.models.sam.sam3.vitdet.Attention._setup_rope_freqs) | Setup 2d-rope frequencies. |
| [`forward`](#ultralytics.models.sam.sam3.vitdet.Attention.forward) | Forward pass of attention block. |

<details>
<summary>Source code in <code>ultralytics/models/sam/sam3/vitdet.py</code></summary>

<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/sam3/vitdet.py#L41-L213"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
...
### Method `ultralytics.models.sam.sam3.vitdet.Attention._apply_rope` {#ultralytics.models.sam.sam3.vitdet.Attention.\_apply\_rope}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/sam3/vitdet.py#L159-L165"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def _apply_rope(self, q, k) -> tuple[Tensor, Tensor]:
    """Apply 2d-rope to q and k."""
...
### Method `ultralytics.models.sam.sam3.vitdet.Attention._setup_rel_pos` {#ultralytics.models.sam.sam3.vitdet.Attention.\_setup\_rel\_pos}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/sam3/vitdet.py#L96-L118"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def _setup_rel_pos(self, rel_pos_zero_init: bool = True, input_size: tuple[int, int] | None = None) -> None:
    """Setup relative positional embeddings."""
...
### Method `ultralytics.models.sam.sam3.vitdet.Attention._setup_rope_freqs` {#ultralytics.models.sam.sam3.vitdet.Attention.\_setup\_rope\_freqs}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/sam3/vitdet.py#L120-L157"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def _setup_rope_freqs(self, input_size: tuple[int, int] | None = None) -> None:
    """Setup 2d-rope frequencies."""
    if not self.use_rope:
...
### Method `ultralytics.models.sam.sam3.vitdet.Attention.forward` {#ultralytics.models.sam.sam3.vitdet.Attention.forward}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/sam3/vitdet.py#L167-L213"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def forward(self, x: Tensor) -> Tensor:
    """Forward pass of attention block."""
...
## Class `ultralytics.models.sam.sam3.vitdet.Block` {#ultralytics.models.sam.sam3.vitdet.Block}
...
| Name | Description |
| --- | --- |
| [`forward`](#ultralytics.models.sam.sam3.vitdet.Block.forward) | Forward pass of the transformer block. |

<details>
<summary>Source code in <code>ultralytics/models/sam/sam3/vitdet.py</code></summary>

<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/sam3/vitdet.py#L216-L311"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
...
### Method `ultralytics.models.sam.sam3.vitdet.Block.forward` {#ultralytics.models.sam.sam3.vitdet.Block.forward}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/sam3/vitdet.py#L294-L311"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def forward(self, x: Tensor) -> Tensor:
    """Forward pass of the transformer block."""
    shortcut = x
...
## Class `ultralytics.models.sam.sam3.vitdet.ViT` {#ultralytics.models.sam.sam3.vitdet.ViT}
...
| Name | Description |
| --- | --- |
| [`_init_weights`](#ultralytics.models.sam.sam3.vitdet.ViT._init_weights) | Initialize the weights. |
| [`forward`](#ultralytics.models.sam.sam3.vitdet.ViT.forward) | Vit forward path and get feature maps. |
| [`set_imgsz`](#ultralytics.models.sam.sam3.vitdet.ViT.set_imgsz) | Setup rel pos embeddings and rope freqs for a new input image size. |

<details>
<summary>Source code in <code>ultralytics/models/sam/sam3/vitdet.py</code></summary>

<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/sam3/vitdet.py#L314-L549"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
class ViT(nn.Module):
    """This module implements Vision Transformer (ViT) backbone in :paper:`vitdet`. "Exploring Plain Vision Transformer
    Backbones for Object Detection", https://arxiv.org/abs/2203.16527.
...
### Method `ultralytics.models.sam.sam3.vitdet.ViT._init_weights` {#ultralytics.models.sam.sam3.vitdet.ViT.\_init\_weights}
...
| Name | Type | Description | Default |
| --- | --- | --- | --- |
| `m` | `nn.Module` |  | *required* |

<details>
<summary>Source code in <code>ultralytics/models/sam/sam3/vitdet.py</code></summary>

<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/sam3/vitdet.py#L488-L496"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
@staticmethod
def _init_weights(m: nn.Module) -> None:
    """Initialize the weights."""
...
### Method `ultralytics.models.sam.sam3.vitdet.ViT.forward` {#ultralytics.models.sam.sam3.vitdet.ViT.forward}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/sam3/vitdet.py#L498-L541"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def forward(self, x: torch.Tensor) -> list[torch.Tensor]:
    """Vit forward path and get feature maps."""
...
### Method `ultralytics.models.sam.sam3.vitdet.ViT.set_imgsz` {#ultralytics.models.sam.sam3.vitdet.ViT.set\_imgsz}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/sam3/vitdet.py#L543-L549"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def set_imgsz(self, imgsz: list[int] = [1008, 1008]):
    """Setup rel pos embeddings and rope freqs for a new input image size."""
