...
Each image is annotated in the [Ultralytics YOLO format](../../detect#ultralytics-yolo-format) ensuring compatibility with state-of-the-art [object detection](../../tasks/detect.md) and [tracking](../../modes/track.md) pipelines.
