...
| --- | --- | --- | --- |
| `torch_model` | `torch.nn.Module` | The PyTorch model to export. | *required* |
| `im` | `torch.Tensor` | Example input tensor for the model. | *required* |
| `onnx_file` | `str` | Path to save the exported ONNX file. | *required* |
| `opset` | `int` | ONNX opset version to use for export. | `14` |
| `input_names` | `list[str]` | List of input tensor names. | `["images"]` |
| `output_names` | `list[str]` | List of output tensor names. | `["output0"]` |
| `dynamic` | `bool | dict, optional` | Whether to enable dynamic axes. | `False` |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/export/engine.py#L14-L49"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def torch2onnx(
    torch_model: torch.nn.Module,
    im: torch.Tensor,
...
| `engine_file` | `str | None` | Path to save the generated TensorRT engine file. | `None` |
| `workspace` | `int | None` | Workspace size in GB for TensorRT. | `None` |
| `half` | `bool, optional` | Enable FP16 precision. | `False` |
| `int8` | `bool, optional` | Enable INT8 precision. | `False` |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/export/engine.py#L52-L246"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def onnx2engine(
    onnx_file: str,
    engine_file: str | None = None,
