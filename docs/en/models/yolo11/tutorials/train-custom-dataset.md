---
comments: true
description: Learn how to train Ultralytics YOLO11 on your own custom dataset. Step-by-step guide covering dataset preparation, YAML config, training commands, and results analysis.
