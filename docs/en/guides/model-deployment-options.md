...
| Core AI           | Optimized for Apple silicon                     | iOS 27 and macOS 27; export needs macOS 26+    | Apple framework; opt-in in iOS/Flutter SDKs   | On-device ML on next-gen Apple platforms    | Tied to Apple OS releases; currently beta      | On-device inference keeps data local              | Apple Neural Engine, GPU, and CPU   |
