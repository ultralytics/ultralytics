...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/solutions/analytics.py#L15-L264"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/solutions/analytics.py#L95-L137"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def process(self, im0: np.ndarray, frame_number: int) -> SolutionResults:
    """Process image data and run object tracking to update analytics charts.
...
| `count_dict` | `dict[str, int], optional` | Dictionary with class names as keys and counts as values for multiple<br>    classes. If None, updates a single line graph. | `None` |
