...
<p align="center">
  <img width="100%" src="https://cdn.ul.run/i/11dc46f6702048f937a7b6f39f53f05a.avif" alt="ExecuTorch pipeline diagram showing an Ultralytics YOLO model exported to .pte format for on-device inference">
</p>
