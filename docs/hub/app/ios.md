---
comments: true
description: Detect objects in real-time with the Ultralytics iOS app. Leverage Apple Neural Engine performance and optimize with FP16/INT8 quantization.
---
