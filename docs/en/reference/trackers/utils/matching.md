...
| `use_lap` | `bool` | Use lap.lapjv for the assignment. If False, ops.linear_sum_assignment is used. | `True` |

**Returns**

| Type | Description |
| --- | --- |
| `matched_indices (list[list[int]] \| np.ndarray)` | Matched indices of shape (K, 2), where K is the number of matches. |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/trackers/utils/matching.py#L18-L59">View on GitHub</a>
```python
def linear_assignment(cost_matrix: np.ndarray, thresh: float, use_lap: bool = True):
    """Perform linear assignment using either lap.lapjv or the built-in NumPy solver.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/trackers/utils/matching.py#L62-L98">View on GitHub</a>
```python
def iou_distance(atracks: list, btracks: list) -> np.ndarray:
    """Compute cost based on Intersection over Union (IoU) between tracks.
...
| Type | Description |
| --- | --- |
| `np.ndarray` | Cost matrix computed based on embeddings with shape (N, M), where N is the number of tracks and M is the number of detections. |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/trackers/utils/matching.py#L101-L142">View on GitHub</a>
```python
def embedding_distance(tracks: list, detections: list) -> np.ndarray:
    """Compute cosine distance between tracks and detections based on embeddings.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/trackers/utils/matching.py#L145-L167">View on GitHub</a>
```python
def fuse_score(cost_matrix: np.ndarray, detections: list) -> np.ndarray:
    """Fuse cost matrix with detection scores to produce a single cost matrix.
