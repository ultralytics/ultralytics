...
!!! abstract "Summary"
    ...
    === "<span class="doc-kind doc-kind-method">Methods</span>"
        ...
        - [`Tuner._json_default`](#ultralytics.engine.tuner.Tuner._json_default)
        - [`Tuner._result_record`](#ultralytics.engine.tuner.Tuner._result_record)
        - [`Tuner._save_to_mongodb`](#ultralytics.engine.tuner.Tuner._save_to_mongodb)
        - [`Tuner._sync_mongodb_to_file`](#ultralytics.engine.tuner.Tuner._sync_mongodb_to_file)
        - [`Tuner._load_local_results`](#ultralytics.engine.tuner.Tuner._load_local_results)
        - [`Tuner._local_results_to_array`](#ultralytics.engine.tuner.Tuner._local_results_to_array)
        - [`Tuner._save_local_result`](#ultralytics.engine.tuner.Tuner._save_local_result)
        - [`Tuner._best_metrics`](#ultralytics.engine.tuner.Tuner._best_metrics)
        - [`Tuner._has_training_metrics`](#ultralytics.engine.tuner.Tuner._has_training_metrics)
        - [`Tuner._best_result_index`](#ultralytics.engine.tuner.Tuner._best_result_index)
        - [`Tuner._dataset_names`](#ultralytics.engine.tuner.Tuner._dataset_names)
...
| [`_best_metrics`](#ultralytics.engine.tuner.Tuner._best_metrics) | Summarize best-result metrics for logging. |
| [`_best_result_index`](#ultralytics.engine.tuner.Tuner._best_result_index) | Return the best result index, preferring rows with training metrics. |
...
| [`_dataset_names`](#ultralytics.engine.tuner.Tuner._dataset_names) | Create stable unique dataset names for logging and per-run directories. |
...
| [`_has_training_metrics`](#ultralytics.engine.tuner.Tuner._has_training_metrics) | Return whether a tuning result contains training metrics. |
| [`_init_mongodb`](#ultralytics.engine.tuner.Tuner._init_mongodb) | Initialize MongoDB connection for distributed tuning. |
| [`_json_default`](#ultralytics.engine.tuner.Tuner._json_default) | Convert tensor-like values for JSON serialization. |
| [`_load_local_results`](#ultralytics.engine.tuner.Tuner._load_local_results) | Load local tuning results from the NDJSON log. |
| [`_local_results_to_array`](#ultralytics.engine.tuner.Tuner._local_results_to_array) | Convert local NDJSON records to a fitness-plus-hyperparameters numpy array. |
...
| [`_result_record`](#ultralytics.engine.tuner.Tuner._result_record) | Build one local tuning result record. |
| [`_save_local_result`](#ultralytics.engine.tuner.Tuner._save_local_result) | Append one tuning result to the local NDJSON log. |
| [`_save_to_mongodb`](#ultralytics.engine.tuner.Tuner._save_to_mongodb) | Save results to MongoDB with proper type conversion. |
| [`_sync_mongodb_to_file`](#ultralytics.engine.tuner.Tuner._sync_mongodb_to_file) | Sync MongoDB results to the local NDJSON tuning log. |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/tuner.py#L39-L617">View on GitHub</a>
```python
class Tuner:
    """A class for hyperparameter tuning of YOLO models.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/tuner.py#L450-L617">View on GitHub</a>
```python
def __call__(self, iterations: int = 10, cleanup: bool = True):
    """Execute the hyperparameter evolution process when the Tuner instance is called.
...
### Method `ultralytics.engine.tuner.Tuner._best_metrics` {#ultralytics.engine.tuner.Tuner.\_best\_metrics}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/tuner.py#L336-L343">View on GitHub</a>
```python
@staticmethod
def _best_metrics(result: dict) -> dict | None:
    """Summarize best-result metrics for logging."""
...
### Method `ultralytics.engine.tuner.Tuner._best_result_index` {#ultralytics.engine.tuner.Tuner.\_best\_result\_index}
...
| `fitness` | `np.ndarray` |  | *required* |

<details>
<summary>Source code in <code>ultralytics/engine/tuner.py</code></summary>

<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/tuner.py#L352-L355">View on GitHub</a>
```python
@classmethod
def _best_result_index(cls, results: list[dict], fitness: np.ndarray) -> int:
    """Return the best result index, preferring rows with training metrics."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/tuner.py#L146-L184">View on GitHub</a>
```python
def _connect(self, uri: str = "", max_retries: int = 3):
    """Create MongoDB client with exponential backoff retry on connection failures.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/tuner.py#L369-L382">View on GitHub</a>
```python
@staticmethod
def _crossover(x: np.ndarray, alpha: float = 0.2, k: int = 9) -> np.ndarray:
    """BLX-α crossover from up to top-k parents (x[:,0]=fitness, rest=genes)."""
...
### Method `ultralytics.engine.tuner.Tuner._dataset_names` {#ultralytics.engine.tuner.Tuner.\_dataset\_names}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/tuner.py#L358-L366">View on GitHub</a>
```python
@staticmethod
def _dataset_names(data: list) -> list[str]:
    """Create stable unique dataset names for logging and per-run directories."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/tuner.py#L207-L219">View on GitHub</a>
```python
def _get_mongodb_results(self, n: int = 5) -> list:
    """Get top N results from MongoDB sorted by fitness.
...
### Method `ultralytics.engine.tuner.Tuner._has_training_metrics` {#ultralytics.engine.tuner.Tuner.\_has\_training\_metrics}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/tuner.py#L346-L349">View on GitHub</a>
```python
@staticmethod
def _has_training_metrics(result: dict, require_all: bool = False) -> bool:
    """Return whether a tuning result contains training metrics."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/tuner.py#L186-L205">View on GitHub</a>
```python
def _init_mongodb(self, mongodb_uri="", mongodb_db="", mongodb_collection=""):
    """Initialize MongoDB connection for distributed tuning.
...
### Method `ultralytics.engine.tuner.Tuner._json_default` {#ultralytics.engine.tuner.Tuner.\_json\_default}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/tuner.py#L222-L224">View on GitHub</a>
```python
@staticmethod
def _json_default(x):
    """Convert tensor-like values for JSON serialization."""
...
### Method `ultralytics.engine.tuner.Tuner._load_local_results` {#ultralytics.engine.tuner.Tuner.\_load\_local\_results}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/tuner.py#L306-L311">View on GitHub</a>
```python
def _load_local_results(self) -> list[dict]:
    """Load local tuning results from the NDJSON log."""
...
### Method `ultralytics.engine.tuner.Tuner._local_results_to_array` {#ultralytics.engine.tuner.Tuner.\_local\_results\_to\_array}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/tuner.py#L313-L328">View on GitHub</a>
```python
def _local_results_to_array(self, results: list[dict], n: int | None = None) -> np.ndarray | None:
    """Convert local NDJSON records to a fitness-plus-hyperparameters numpy array."""
    if not results:
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/tuner.py#L384-L448">View on GitHub</a>
```python
def _mutate(
    self,
    n: int = 9,
...
### Method `ultralytics.engine.tuner.Tuner._result_record` {#ultralytics.engine.tuner.Tuner.\_result\_record}
...
| `hyperparameters` | `dict[str, float]` |  | *required* |
| `datasets` | `dict[str, dict]` |  | *required* |
| `save_dirs` | `dict[str, str] \| None` |  | `None` |

<details>
<summary>Source code in <code>ultralytics/engine/tuner.py</code></summary>

<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/tuner.py#L226-L243">View on GitHub</a>
```python
def _result_record(
    self,
    iteration: int,
...
### Method `ultralytics.engine.tuner.Tuner._save_local_result` {#ultralytics.engine.tuner.Tuner.\_save\_local\_result}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/tuner.py#L330-L333">View on GitHub</a>
```python
def _save_local_result(self, result: dict):
    """Append one tuning result to the local NDJSON log."""
...
| `datasets` | `dict[str, dict]` | Per-dataset metrics for the iteration. | *required* |
| `iteration` | `int` | Current iteration number. | *required* |

<details>
<summary>Source code in <code>ultralytics/engine/tuner.py</code></summary>

<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/tuner.py#L245-L274">View on GitHub</a>
```python
def _save_to_mongodb(
    self,
    fitness: float,
...
### Method `ultralytics.engine.tuner.Tuner._sync_mongodb_to_file` {#ultralytics.engine.tuner.Tuner.\_sync\_mongodb\_to\_file}
...
Downloads all results from MongoDB and writes them to the local NDJSON file in chronological order. This keeps resume, mutation, and plotting on the same local source of truth when using distributed tuning.

<details>
<summary>Source code in <code>ultralytics/engine/tuner.py</code></summary>

<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/tuner.py#L276-L304">View on GitHub</a>
```python
def _sync_mongodb_to_file(self):
    """Sync MongoDB results to the local NDJSON tuning log.
