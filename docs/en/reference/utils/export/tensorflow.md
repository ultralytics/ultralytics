...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/export/tensorflow.py#L25-L35">View on GitHub</a>
```python
def tf_wrapper(model: torch.nn.Module) -> torch.nn.Module:
    """A wrapper for TensorFlow export compatibility (TF-specific handling is now in head modules)."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/export/tensorflow.py#L38-L49">View on GitHub</a>
```python
def _tf_decode_boxes(self, x: dict[str, torch.Tensor]) -> torch.Tensor:
    """Decode bounding boxes for TensorFlow export."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/export/tensorflow.py#L52-L64">View on GitHub</a>
```python
def _tf_kpts_decode(self, kpts: torch.Tensor, is_pose26: bool = False) -> torch.Tensor:
    """Decode keypoints for TensorFlow export."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/export/tensorflow.py#L67-L203">View on GitHub</a>
```python
def onnx2saved_model(
    onnx_file: str,
    output_dir: Path | str,
...
| `output_file` | `Path \| str` | Output file path (suffix will be changed to .pb). | *required* |
| `prefix` | `str, optional` | Logging prefix. Defaults to "". | `""` |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/export/tensorflow.py#L206-L232">View on GitHub</a>
```python
def keras2pb(keras_model, output_file: Path | str, prefix: str = "") -> str:
    """Convert a Keras model to TensorFlow GraphDef (.pb) format.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/export/tensorflow.py#L235-L290">View on GitHub</a>
```python
def tflite2edgetpu(tflite_file: str | Path, output_dir: str | Path, prefix: str = "") -> str:
    """Convert a TensorFlow Lite model to Edge TPU format using the Edge TPU compiler.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/export/tensorflow.py#L293-L299">View on GitHub</a>
```python
def gd_outputs(gd):
    """Return TensorFlow GraphDef model output node names."""
