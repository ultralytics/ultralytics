...
!!! abstract "Summary"
    ...
    === "<span class="doc-kind doc-kind-method">Methods</span>"
        ...
        - [`SAM2VideoPredictor.setup_source`](#ultralytics.models.sam.predict.SAM2VideoPredictor.setup_source)
...
```python
Predictor(cfg=DEFAULT_CFG, overrides=None, _callbacks: dict | None = None)
```
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L45-L691">View on GitHub</a>
```python
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L241-L279">View on GitHub</a>
```python
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L281-L330">View on GitHub</a>
```python
def _prepare_prompts(self, dst_shape, src_shape, bboxes=None, points=None, labels=None, masks=None):
    """Prepare and transform the input prompts for processing based on the destination shape.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L332-L441">View on GitHub</a>
```python
def generate(
    self,
    im,
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L580-L582">View on GitHub</a>
```python
def get_im_features(self, im):
    """Extract image features using the SAM model's image encoder for subsequent mask prediction."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L480-L484">View on GitHub</a>
```python
def get_model(self):
    """Retrieve or build the Segment Anything Model (SAM) for image segmentation tasks."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L172-L208">View on GitHub</a>
```python
def inference(self, im, bboxes=None, points=None, labels=None, masks=None, multimask_output=False, *args, **kwargs):
    """Perform image segmentation inference based on the given input cues, using the currently loaded image.
...
| --- | --- |
| `pred_masks (torch.Tensor)` | The output masks in shape (C, H, W), where C is the number of generated masks. |
| `pred_bboxes (torch.Tensor)` | Bounding boxes for each mask with shape (N, 6), where N is the number of boxes. Each box is in xyxy format with additional columns for score and class. |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L646-L691">View on GitHub</a>
```python
...
| Type | Description |
| --- | --- |
| `list[Results]` | List of Results objects containing detection masks, bounding boxes, and other metadata for each processed image. |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L486-L536">View on GitHub</a>
```python
def postprocess(self, preds, img, orig_imgs):
    """Post-process SAM's inference outputs to generate object detection masks and bounding boxes.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L145-L170">View on GitHub</a>
```python
def pre_transform(self, im):
    """Perform initial transformations on the input image for preprocessing.
...
| Name | Type | Description | Default |
| --- | --- | --- | --- |
| `im` | `torch.Tensor \| list[np.ndarray]` | Input image(s) in BCHW tensor format or a list of HWC NumPy arrays. NumPy arrays are expected to be in BGR order (as returned by OpenCV) and will be converted to RGB. | *required* |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L111-L143">View on GitHub</a>
```python
def preprocess(self, im):
    """Preprocess the input image for model inference.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L210-L239">View on GitHub</a>
```python
def prompt_inference(self, im, bboxes=None, points=None, labels=None, masks=None, multimask_output=False):
    """Perform image segmentation inference based on input cues using SAM's specialized architecture.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L594-L643">View on GitHub</a>
```python
@staticmethod
def remove_small_regions(masks, min_area=0, nms_thresh=0.7):
    """Remove small disconnected regions and holes from segmentation masks.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L588-L591">View on GitHub</a>
```python
def reset_image(self):
    """Reset the current image and its features, clearing them for subsequent inference."""
    self.im = None
...
| Name | Type | Description | Default |
| --- | --- | --- | --- |
| `image` | `str \| np.ndarray` | Path to the image file as a string, or a numpy array representing an image read by cv2 (BGR channel order). | *required* |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L538-L568">View on GitHub</a>
```python
def set_image(self, image):
    """Preprocess and set a single image for inference.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L584-L586">View on GitHub</a>
```python
def set_prompts(self, prompts):
    """Set prompts for subsequent inference operations."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L444-L478">View on GitHub</a>
```python
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L570-L578">View on GitHub</a>
```python
def setup_source(self, source):
    """Set up the data source for SAM inference."""
...
```python
SAM2Predictor(cfg=DEFAULT_CFG, overrides=None, _callbacks: dict | None = None)
```
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L694-L833">View on GitHub</a>
```python
...
| Name | Type | Description | Default |
| --- | --- | --- | --- |
| `features` | `torch.Tensor \| dict[str, Any]` | Extracted image features with shape (B, C, H, W) from the SAM2 model image encoder. Can also be a dict with 'image_embed' (torch.Tensor) of shape (B, C, H, W) and 'high_res_feats' (list[torch.Tensor]) high-resolution feature maps from the backbone. | *required* |
| `points` | `np.ndarray \| list[list[float]] \| None` | Object location points with shape (N, 2), in pixels. | `None` |
| `labels` | `np.ndarray \| list[int] \| None` | Point prompt labels with shape (N,). 1 = foreground, 0 = background. | `None` |
| `masks` | `list[np.ndarray] \| np.ndarray \| None` | Masks for the objects, where each mask is a 2D array. | `None` |
| `multimask_output` | `bool` | Flag to return multiple masks for ambiguous prompts. | `False` |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L785-L833">View on GitHub</a>
```python
def _inference_features(
    self,
    features,
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L735-L767">View on GitHub</a>
```python
def _prepare_prompts(self, dst_shape, src_shape, bboxes=None, points=None, labels=None, masks=None):
    """Prepare and transform the input prompts for processing based on the destination shape.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L774-L783">View on GitHub</a>
```python
def get_im_features(self, im):
    """Extract image features from the SAM image encoder for subsequent processing."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L729-L733">View on GitHub</a>
```python
def get_model(self):
    """Retrieve and initialize the Segment Anything Model 2 (SAM2) for image segmentation tasks."""
    from .build import build_sam  # slow import
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L769-L772">View on GitHub</a>
```python
def setup_source(self, source):
    """Set up the data source and image size for SAM2 inference."""
...
```python
SAM2VideoPredictor(cfg=DEFAULT_CFG, overrides=None, _callbacks: dict | None = None)
```
...
This class extends the functionality of SAM2Predictor to support video processing and maintains the state of inference operations. It includes configurations for managing non-overlapping masks and clearing memory for non-conditional inputs.
...
| [`setup_source`](#ultralytics.models.sam.predict.SAM2VideoPredictor.setup_source) | Set up the source and build the video inference state before any prediction callback runs. |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L836-L1865">View on GitHub</a>
```python
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L1629-L1662">View on GitHub</a>
```python
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L1664-L1684">View on GitHub</a>
```python
def _clear_non_cond_mem_around_input(self, frame_idx, inference_state: dict[str, Any] | None = None):
    """Remove the non-conditioning memory around the input frame.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L1443-L1552">View on GitHub</a>
```python
def _consolidate_temp_output_across_obj(
    self,
    frame_idx,
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L1554-L1585">View on GitHub</a>
```python
def _get_empty_mask_ptr(self, frame_idx, inference_state: dict[str, Any] | None = None):
    """Get a dummy object pointer based on an empty mask on the current frame.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L1402-L1441">View on GitHub</a>
```python
def _get_maskmem_pos_enc(self, out_maskmem_pos_enc, inference_state: dict[str, Any] | None = None):
    """Cache and manage the positional encoding for mask memory across frames and objects.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L1206-L1245">View on GitHub</a>
```python
@staticmethod
def _init_state(num_frames):
    """Initialize an inference state.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L1270-L1322">View on GitHub</a>
```python
def _obj_id_to_idx(self, obj_id, inference_state: dict[str, Any] | None = None):
    """Map client-side object id to model-side object index.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L1848-L1865">View on GitHub</a>
```python
def _prune_non_cond_memory(self, frame_idx, inference_state=None):
    """Prune old non-conditioning frames to bound memory usage."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L1828-L1846">View on GitHub</a>
```python
@staticmethod
def _reset_tracking_results(inference_state):
    """Reset all tracking inputs and results across the videos."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L1587-L1627">View on GitHub</a>
```python
def _run_memory_encoder(
    self,
    batch_size,
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L1324-L1400">View on GitHub</a>
```python
def _run_single_frame_inference(
    self,
    output_dict,
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L1005-L1111">View on GitHub</a>
```python
@smart_inference_mode()
def add_new_prompts(
    self,
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L1766-L1812">View on GitHub</a>
```python
@smart_inference_mode()
def clear_all_points_in_frame(self, inference_state, frame_idx, obj_id):
    """Remove all input points or mask in a specific frame for a given object."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L1815-L1825">View on GitHub</a>
```python
@smart_inference_mode()
def clear_all_points_in_video(self, inference_state):
    """Remove all input points or mask in all frames throughout the video."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L1247-L1268">View on GitHub</a>
```python
def get_im_features(self, im, batch=1):
    """Extract and process image features using SAM2's image encoder for subsequent segmentation tasks.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L895-L903">View on GitHub</a>
```python
def get_model(self):
    """Retrieve and configure the model with binarization enabled.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L905-L976">View on GitHub</a>
```python
def inference(self, im, bboxes=None, points=None, labels=None, masks=None):
    """Perform image segmentation inference based on the given input cues, using the currently loaded image. This
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L1189-L1203">View on GitHub</a>
```python
@staticmethod
def init_state(predictor):
    """Initialize an inference state for the predictor.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L978-L1002">View on GitHub</a>
```python
def postprocess(self, preds, img, orig_imgs):
    """Post-process the predictions to apply non-overlapping constraints if required.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L1114-L1186">View on GitHub</a>
```python
@smart_inference_mode()
def propagate_in_video_preflight(self, inference_state: dict[str, Any] | None = None):
    """Prepare inference_state and consolidate temporary outputs before tracking.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L1687-L1763">View on GitHub</a>
```python
@smart_inference_mode()
def remove_object(self, inference_state, obj_id, strict=False):
    """Remove an object id from the tracking state. If strict is True, we check whether the object id actually
...
### Method `ultralytics.models.sam.predict.SAM2VideoPredictor.setup_source` {#ultralytics.models.sam.predict.SAM2VideoPredictor.setup\_source}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L889-L893">View on GitHub</a>
```python
def setup_source(self, source):
    """Set up the source and build the video inference state before any prediction callback runs."""
    super().setup_source(source)
...
| `max_obj_num` | `int` | Maximum number of objects to track. Default is 3. This is set to keep fixed feature size for the model. | `3` |
| `_callbacks` | `dict \| None` | Dictionary of callback functions to customize behavior. | `None` |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L1868-L2197">View on GitHub</a>
```python
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L2137-L2146">View on GitHub</a>
```python
def _obj_id_to_idx(self, obj_id: int) -> int | None:
    """Map client-side object id to model-side object index.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L2089-L2122">View on GitHub</a>
```python
def _prepare_memory_conditioned_features(self, obj_idx: int | None) -> torch.Tensor:
    """Prepare memory-conditioned features for the current image state.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L1992-L2006">View on GitHub</a>
```python
def get_im_features(self, img: torch.Tensor | np.ndarray) -> None:
    """Initialize the image state by processing the input image and extracting features.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L2124-L2135">View on GitHub</a>
```python
def get_maskmem_enc(self) -> tuple[torch.Tensor, torch.Tensor]:
    """Get memory and positional encoding from memory, which is used to condition the current image features."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L1926-L1990">View on GitHub</a>
```python
@smart_inference_mode()
def inference(
    self,
...
| `label` | `torch.Tensor \| None` | The labels corresponding to the points where 1 means positive clicks, 0 means negative clicks. | `None` |
...
| Type | Description |
| --- | --- |
| `current_out (dict[str, Any])` | A dictionary containing the current output with mask predictions and object pointers. Keys include 'point_inputs', 'mask_inputs', 'pred_masks', 'pred_masks_high_res', 'obj_ptr', 'object_score_logits'. |

<details>
<summary>Source code in <code>ultralytics/models/sam/predict.py</code></summary>

<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L2148-L2197">View on GitHub</a>
```python
def track_step(
    self,
    obj_idx: int | None = None,
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L2009-L2087">View on GitHub</a>
```python
@smart_inference_mode()
def update_memory(
    self,
...
```python
SAM3Predictor(cfg=DEFAULT_CFG, overrides=None, _callbacks: dict | None = None)
```
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L2200-L2221">View on GitHub</a>
```python
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L2217-L2221">View on GitHub</a>
```python
def get_model(self):
    """Retrieve and initialize the Segment Anything Model 3 (SAM3) for image segmentation tasks."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L2210-L2215">View on GitHub</a>
```python
def setup_model(self, model=None, verbose=True):
    """Setup the SAM3 model with appropriate mean and standard deviation for preprocessing."""
...
```python
SAM3SemanticPredictor(cfg=DEFAULT_CFG, overrides=None, _callbacks: dict | None = None)
```
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L2224-L2435">View on GitHub</a>
```python
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L2426-L2435">View on GitHub</a>
```python
def _get_dummy_prompt(self, num_prompts=1):
    """Get a dummy geometric prompt with zero boxes."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L2285-L2303">View on GitHub</a>
```python
def _inference_features(self, features, bboxes=None, labels=None, text: list[str] | None = None):
    """Run inference on the extracted features with optional bounding boxes and labels."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L2265-L2283">View on GitHub</a>
```python
def _prepare_geometric_prompts(self, src_shape, bboxes=None, labels=None):
    """Prepare prompts by normalizing bounding boxes and points to the destination shape."""
    if bboxes is not None:
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L2234-L2236">View on GitHub</a>
```python
@smart_inference_mode()
def get_im_features(self, im):
    """Extract image features using the model's backbone."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L2227-L2231">View on GitHub</a>
```python
def get_model(self):
    """Retrieve and initialize the Segment Anything Model 3 (SAM3) for image segmentation tasks."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L2348-L2355">View on GitHub</a>
```python
def inference(self, im, bboxes=None, labels=None, text: list[str] | None = None, *args, **kwargs):
    """Perform inference on a single image with optional prompts."""
    bboxes = self.prompts.pop("bboxes", bboxes)
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L2358-L2419">View on GitHub</a>
```python
@smart_inference_mode()
def inference_features(
    self,
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L2305-L2346">View on GitHub</a>
```python
def postprocess(self, preds, img, orig_imgs):
    """Post-process the predictions to apply non-overlapping constraints if required."""
    import torchvision
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L2238-L2263">View on GitHub</a>
```python
def pre_transform(self, im):
    """Perform initial transformations on the input image for preprocessing.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L2421-L2424">View on GitHub</a>
```python
def reset_prompts(self):
    """Reset the prompts for the predictor."""
    self.prompts = {}
...
```python
SAM3VideoPredictor(cfg=DEFAULT_CFG, overrides=None, _callbacks: dict | None = None)
```
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L2438-L2489">View on GitHub</a>
```python
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L2441-L2489">View on GitHub</a>
```python
def propagate_in_video(self, inference_state, frame_idx):
    """Perform image segmentation inference based on the given input cues, using the currently loaded image. This
    method leverages SAM's (Segment Anything Model) architecture consisting of image encoder, prompt
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L2492-L3975">View on GitHub</a>
```python
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L2793-L2807">View on GitHub</a>
```python
def _apply_object_wise_non_overlapping_constraints(self, pred_masks, obj_scores, background_value=-10.0):
    """Applies non-overlapping constraints object wise (i.e. only one object can claim the overlapping region)."""
...
| `unmatched_trk_obj_ids` | array of existing masklet object IDs that are not matched to any detections on this frame (for unmatched, we only count masklets with >0 area) |
| `det_to_matched_trk_obj_ids` | dict[int, np.ndarray]: mapping from detector's detection indices to the list of matched tracklet object IDs |
| `empty_trk_obj_ids` | array of existing masklet object IDs with zero area in SAM2 prediction |

<details>
<summary>Source code in <code>ultralytics/models/sam/predict.py</code></summary>

<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L3502-L3633">View on GitHub</a>
```python
def _associate_det_trk(
    self,
    det_masks: torch.Tensor,
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L2965-L2980">View on GitHub</a>
```python
def _cache_backbone_features(self, sam3_image_out):
    """Build and cache SAM2 backbone features."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L2809-L2914">View on GitHub</a>
```python
def _det_track_one_frame(
    self,
    im: torch.Tensor,
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L3962-L3975">View on GitHub</a>
```python
@staticmethod
def _drop_new_det_with_obj_limit(new_det_fa_inds, det_scores_np, num_to_keep):
    """Drop a few new detections based on the maximum number of objects. We drop new objects based on their
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L2942-L2963">View on GitHub</a>
```python
def _extract_detection_outputs(self, sam3_image_out, allow_new_detections):
    """Extract and filter detection outputs."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L3866-L3900">View on GitHub</a>
```python
def _initialize_metadata(self):
    """Initialize metadata for the masklets."""
    tracker_metadata = {
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L3635-L3744">View on GitHub</a>
```python
def _process_hotstart(
    self,
    frame_idx: int,
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L3474-L3500">View on GitHub</a>
```python
def _propogate_tracker_one_frame_local_gpu(self, inference_states: list[Any], frame_idx: int):
    """Inference_states: list of inference states, each state corresponds to a different set of objects."""
    obj_ids_local = []
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L3004-L3044">View on GitHub</a>
```python
def _recondition_masklets(
    self,
    frame_idx,
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L2699-L2751">View on GitHub</a>
```python
def _run_single_frame_inference(self, frame_idx, reverse=False, inference_state=None):
    """Perform inference on a single frame and get its inference results."""
    inference_state = inference_state or self.inference_state
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L2917-L2928">View on GitHub</a>
```python
@staticmethod
def _suppress_detections_close_to_boundary(boxes, margin=0.025):
    """Suppress detections too close to image edges (for normalized boxes).
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L3261-L3329">View on GitHub</a>
```python
def _suppress_overlapping_based_on_recent_occlusion(
    self,
    frame_idx: int,
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L3804-L3846">View on GitHub</a>
```python
def _tracker_add_new_objects(
    self,
    frame_idx: int,
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L3848-L3864">View on GitHub</a>
```python
def _tracker_remove_objects(self, tracker_states_local: list[Any], obj_ids: list[int]):
    """Remove an object from SAM2 inference states. This would remove the object from all frames in the video."""
    if not obj_ids:
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L3746-L3802">View on GitHub</a>
```python
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L2754-L2791">View on GitHub</a>
```python
@smart_inference_mode()
def add_prompt(
    self,
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L3368-L3404">View on GitHub</a>
```python
@staticmethod
def build_outputs(
    det_out: dict[str, torch.Tensor],
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L2642-L2648">View on GitHub</a>
```python
def inference(self, im, bboxes=None, labels=None, text: list[str] | None = None, *args, **kwargs):
    """Perform inference on a video sequence with optional prompts."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L2618-L2640">View on GitHub</a>
```python
@staticmethod
def init_state(predictor):
    """Initialize an inference state for the predictor.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L2650-L2697">View on GitHub</a>
```python
def postprocess(self, preds, img, orig_imgs):
    """Post-process the predictions to apply non-overlapping constraints if required."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L2930-L2940">View on GitHub</a>
```python
def run_backbone_and_detection(
    self, im: torch.Tensor, text_ids: torch.Tensor, geometric_prompt: Prompt, allow_new_detections: bool
):
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L2982-L3002">View on GitHub</a>
```python
def run_tracker_propagation(
    self, frame_idx: int, tracker_states_local: list[Any], tracker_metadata_prev: dict[str, np.ndarray]
):
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L3331-L3365">View on GitHub</a>
```python
def run_tracker_update_execution_phase(
    self,
    frame_idx: int,
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L3046-L3259">View on GitHub</a>
```python
def run_tracker_update_planning_phase(
    self,
    frame_idx: int,
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L2598-L2605">View on GitHub</a>
```python
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L2607-L2615">View on GitHub</a>
```python
def setup_source(self, source):
    """Setup the source for the SAM3VideoSemanticPredictor model."""
    super().setup_source(source)
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L3902-L3948">View on GitHub</a>
```python
def update_masklet_confirmation_status(
    self,
    metadata: dict[str, Any],
