...
LANES = {
    "lane-a": (
        ...
        "ffnattn2",  # bridge, the arm carried by every session so ratios cross sessions
        {
            ...
            "tokenmlp-stagematch-deep": ("yolo26{s}-ultravit-290726-stagematch-deep.yaml", "l"),
            "tokenmlp-stagematch-p4deep": ("yolo26{s}-ultravit-290726-stagematch-p4deep.yaml", "l"),
