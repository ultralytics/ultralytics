...
!!! abstract "Summary"
    ...
    === "<span class="doc-kind doc-kind-class">Classes</span>"
        ...
        - [`Inference`](#ultralytics.solutions.streamlit_inference.Inference)

    === "<span class="doc-kind doc-kind-method">Methods</span>"

        - [`Inference.web_ui`](#ultralytics.solutions.streamlit_inference.Inference.web_ui)
        - [`Inference.sidebar`](#ultralytics.solutions.streamlit_inference.Inference.sidebar)
        - [`Inference.source_upload`](#ultralytics.solutions.streamlit_inference.Inference.source_upload)
        - [`Inference.configure`](#ultralytics.solutions.streamlit_inference.Inference.configure)
        - [`Inference.image_inference`](#ultralytics.solutions.streamlit_inference.Inference.image_inference)
        - [`Inference.inference`](#ultralytics.solutions.streamlit_inference.Inference.inference)


## Class `ultralytics.solutions.streamlit_inference.Inference` {#ultralytics.solutions.streamlit\_inference.Inference}
...
| Name | Description |
| --- | --- |
| [`configure`](#ultralytics.solutions.streamlit_inference.Inference.configure) | Configure the model and load selected classes for inference. |
| [`image_inference`](#ultralytics.solutions.streamlit_inference.Inference.image_inference) | Perform inference on uploaded images. |
| [`inference`](#ultralytics.solutions.streamlit_inference.Inference.inference) | Perform real-time object detection inference on video or webcam feed. |
| [`sidebar`](#ultralytics.solutions.streamlit_inference.Inference.sidebar) | Configure the Streamlit sidebar for model and inference settings. |
| [`source_upload`](#ultralytics.solutions.streamlit_inference.Inference.source_upload) | Handle video file uploads through the Streamlit interface. |
| [`web_ui`](#ultralytics.solutions.streamlit_inference.Inference.web_ui) | Set up the Streamlit web interface with custom HTML elements. |
...
<details>
<summary>Source code in <code>ultralytics/solutions/streamlit_inference.py</code></summary>

<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/solutions/streamlit_inference.py#L18-L250"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
class Inference:
    """A class to perform object detection, image classification, image segmentation and pose estimation inference.
...
### Method `ultralytics.solutions.streamlit_inference.Inference.configure` {#ultralytics.solutions.streamlit\_inference.Inference.configure}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/solutions/streamlit_inference.py#L150-L182"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def configure(self) -> None:
    """Configure the model and load selected classes for inference."""
...
### Method `ultralytics.solutions.streamlit_inference.Inference.image_inference` {#ultralytics.solutions.streamlit\_inference.Inference.image\_inference}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/solutions/streamlit_inference.py#L184-L203"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def image_inference(self) -> None:
    """Perform inference on uploaded images."""
...
### Method `ultralytics.solutions.streamlit_inference.Inference.inference` {#ultralytics.solutions.streamlit\_inference.Inference.inference}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/solutions/streamlit_inference.py#L205-L250"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def inference(self) -> None:
    """Perform real-time object detection inference on video or webcam feed."""
...
### Method `ultralytics.solutions.streamlit_inference.Inference.sidebar` {#ultralytics.solutions.streamlit\_inference.Inference.sidebar}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/solutions/streamlit_inference.py#L102-L123"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def sidebar(self) -> None:
    """Configure the Streamlit sidebar for model and inference settings."""
...
### Method `ultralytics.solutions.streamlit_inference.Inference.source_upload` {#ultralytics.solutions.streamlit\_inference.Inference.source\_upload}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/solutions/streamlit_inference.py#L125-L148"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def source_upload(self) -> None:
    """Handle video file uploads through the Streamlit interface."""
...
### Method `ultralytics.solutions.streamlit_inference.Inference.web_ui` {#ultralytics.solutions.streamlit\_inference.Inference.web\_ui}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/solutions/streamlit_inference.py#L83-L100"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def web_ui(self) -> None:
    """Set up the Streamlit web interface with custom HTML elements."""
