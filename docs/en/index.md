...
Every `yolo` command follows one grammar, `yolo [TASK] MODE ARGS`, where Task is optional, and these docs are organized around the same three parts, plus one shortcut:
