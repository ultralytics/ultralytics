...
| Core AI           | Optimized for Apple silicon                     | iOS 27 and macOS 27; export needs macOS 26+    | Apple's new framework; no Ultralytics SDK yet | On-device ML on next-gen Apple platforms    | Follows Apple OS releases                      | On-device inference keeps data local              | Apple Neural Engine, GPU, and CPU   |
