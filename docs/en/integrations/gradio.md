...
<p align="center">
   <img width="800" alt="Gradio interface for YOLO object detection showing image upload and detection results" src="https://cdn.jsdelivr.net/gh/ultralytics/assets@main/docs/gradio-example-screenshot.avif">
</p>
