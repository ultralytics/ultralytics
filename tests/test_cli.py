...
def test_predict_detect():
    ...
    run(f"yolo predict detect model={MODEL}.pt source=https://ultralytics.com/assets/decelera_landscape_min.mov imgsz=32")
    run(f"yolo predict detect model={MODEL}.pt source=https://ultralytics.com/assets/decelera_portrait_min.mov imgsz=32")
