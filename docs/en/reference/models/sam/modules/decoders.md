...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/modules/decoders.py#L11-L163">View on GitHub</a>
```python
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/modules/decoders.py#L82-L124">View on GitHub</a>
```python
def forward(
    self,
    image_embeddings: torch.Tensor,
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/modules/decoders.py#L126-L163">View on GitHub</a>
```python
def predict_masks(
    self,
    image_embeddings: torch.Tensor,
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/modules/decoders.py#L166-L495">View on GitHub</a>
```python
...
| Name | Type | Description | Default |
| --- | --- | --- | --- |
| `all_mask_logits` | `torch.Tensor` | Logits for all predicted masks, shape (B, N, H, W) where B is batch size, N is number of masks (typically 4), and H, W are mask dimensions. | *required* |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/modules/decoders.py#L443-L495">View on GitHub</a>
```python
def _dynamic_multimask_via_stability(self, all_mask_logits, all_iou_scores):
    """Dynamically select the most stable mask output based on stability scores and IoU predictions.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/modules/decoders.py#L436-L441">View on GitHub</a>
```python
def _get_stability_scores(self, mask_logits):
    """Compute mask stability scores based on IoU between upper and lower thresholds."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/modules/decoders.py#L297-L363">View on GitHub</a>
```python
def forward(
    self,
    image_embeddings: torch.Tensor,
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/modules/decoders.py#L365-L434">View on GitHub</a>
```python
def predict_masks(
    self,
    image_embeddings: torch.Tensor,
