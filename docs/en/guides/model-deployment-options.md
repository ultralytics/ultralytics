...
| Core AI           | Optimized for Apple silicon                     | iOS 27 and macOS 27; export needs macOS 26+    | Apple framework; iOS/Flutter SDKs on iOS 27+  | On-device ML on next-gen Apple platforms    | Tied to Apple OS releases; currently beta      | On-device inference keeps data local              | Apple Neural Engine, GPU, and CPU   |
