...
for c1, c2, c3, c4 in zip(cam1_ids, cam2_ids, cam3_ids, cam4_ids):
    assert manitou.imgs[c1]['frame_name'] == manitou.imgs[c2]['frame_name'] == manitou.imgs[c3]['frame_name'] == manitou.imgs[c4]['frame_name'], "Frame names do not match across cameras"
