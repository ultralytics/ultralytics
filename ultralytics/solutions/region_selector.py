...
class RegionSelector:
    ...
    def draw_polygon(self):
        ...
        for i, point in enumerate(self.points):
            ...
            cv2.putText(self.image, str(i + 1), (point[0] + 10, point[1] - 10),
    ...
    def select_region(self):
        ...
        if not check_imshow(warn=True):
            raise RuntimeError(
                "Region selection requires a display. "
                "Run in a GUI environment or provide region coordinates directly."
            )
