...
class BiFPN(nn.Module):
    ...
    Menerima 3 input (P3, P4, P5 dari backbone) dan mengembalikan 3 output (P3_out, P4_out, P5_out). Menggunakan
    BiFPN_Add untuk fusi berbobot dan C3 untuk pemrosesan pasca-fusi.
    """
