...
- [Image Property Analysis](analysis.md): Augment YOLO dataset labels in place with 27 per-image properties covering brightness, blurriness, object-size buckets, and crowdedness, using no model and no predictions.
