...
| `freez_bn`        | `False`  | Whether to freeze the statistics of BatchNorm in frozen layers to prevent the outputs of frozen layers definitely unchanged. Useful for fine-tuning or transfer learning.                                           |
