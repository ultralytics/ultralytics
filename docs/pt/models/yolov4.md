...
Observe que as etapas específicas podem variar dependendo do seu caso de uso específico e do estado actual do repositório YOLOv4. Portanto, é altamente recomendável consultar diretamente as instruções fornecidas no repositório YOLOv4 do GitHub.
