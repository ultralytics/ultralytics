...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/loaders.py#L28-L51">View on GitHub</a>
```python
@dataclass
class SourceTypes:
    """Class to represent various types of input sources for predictions.
...
```python
LoadStreams(sources: str = "file.streams", vid_stride: int = 1, buffer: bool = False, channels: int = 3)
```
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/loaders.py#L54-L229">View on GitHub</a>
```python
class LoadStreams:
    """Stream Loader for various types of video streams.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/loaders.py#L195-L198">View on GitHub</a>
```python
def __iter__(self):
    """Return an iterator object and reset the frame counter."""
    self.count = -1
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/loaders.py#L227-L229">View on GitHub</a>
```python
def __len__(self) -> int:
    """Return the number of video streams in the LoadStreams object."""
    return self.bs
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/loaders.py#L200-L225">View on GitHub</a>
```python
def __next__(self) -> tuple[list[str], list[np.ndarray], list[str]]:
    """Return the next batch of frames from multiple video streams for processing."""
    self.count += 1
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/loaders.py#L181-L193">View on GitHub</a>
```python
def close(self):
    """Terminate stream loader, stop threads, and release video capture resources."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/loaders.py#L159-L179">View on GitHub</a>
```python
def update(self, i: int, cap: cv2.VideoCapture, stream: str):
    """Read stream frames in daemon thread and update image buffer."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/loaders.py#L232-L306">View on GitHub</a>
```python
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/loaders.py#L295-L297">View on GitHub</a>
```python
def __iter__(self):
    """Return an iterator object for the screenshot capture."""
    return self
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/loaders.py#L299-L306">View on GitHub</a>
```python
def __next__(self) -> tuple[list[str], list[np.ndarray], list[str]]:
    """Capture and return the next screenshot as a numpy array using the mss library."""
...
```python
LoadImagesAndVideos(path: str | Path | list, batch: int = 1, vid_stride: int = 1, channels: int = 3)
```
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/loaders.py#L309-L474">View on GitHub</a>
```python
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/loaders.py#L401-L404">View on GitHub</a>
```python
def __iter__(self):
    """Iterate through image/video files, yielding source paths, images, and metadata."""
    self.count = 0
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/loaders.py#L472-L474">View on GitHub</a>
```python
def __len__(self) -> int:
    """Return the number of batches in the dataset."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/loaders.py#L406-L461">View on GitHub</a>
```python
def __next__(self) -> tuple[list[str], list[np.ndarray], list[str]]:
    """Return the next batch of images or video frames with their paths and metadata."""
    paths, imgs, info = [], [], []
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/loaders.py#L463-L470">View on GitHub</a>
```python
def _new_video(self, path: str):
    """Create a new video capture object for the given path and initialize video-related attributes."""
    self.frame = 0
...
```python
LoadPilAndNumpy(im0: Image.Image | np.ndarray | list, channels: int = 3)
```
...
| [`_single_check`](#ultralytics.data.loaders.LoadPilAndNumpy._single_check) | Validate an image and normalize its channel count. |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/loaders.py#L477-L568">View on GitHub</a>
```python
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/loaders.py#L565-L568">View on GitHub</a>
```python
def __iter__(self):
    """Iterate through PIL/numpy images, yielding paths, raw images, and metadata for processing."""
    self.count = 0
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/loaders.py#L554-L556">View on GitHub</a>
```python
def __len__(self) -> int:
    """Return the length of the 'im0' attribute, representing the number of loaded images."""
    return len(self.im0)
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/loaders.py#L558-L563">View on GitHub</a>
```python
def __next__(self) -> tuple[list[str], list[np.ndarray], list[str]]:
    """Return the next batch of images, paths, and metadata for processing."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/loaders.py#L522-L552">View on GitHub</a>
```python
@staticmethod
def _single_check(im: Image.Image | np.ndarray, channels: int = 3) -> np.ndarray:
    """Validate an image and normalize its channel count.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/loaders.py#L571-L642">View on GitHub</a>
```python
class LoadTensor:
    """A class for loading and processing tensor data for object detection tasks.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/loaders.py#L628-L631">View on GitHub</a>
```python
def __iter__(self):
    """Yield an iterator object for iterating through tensor image data."""
    self.count = 0
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/loaders.py#L640-L642">View on GitHub</a>
```python
def __len__(self) -> int:
    """Return the batch size of the tensor input."""
    return self.bs
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/loaders.py#L633-L638">View on GitHub</a>
```python
def __next__(self) -> tuple[list[str], torch.Tensor, list[str]]:
    """Yield the next batch of tensor images and metadata for processing."""
    if self.count == 1:
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/loaders.py#L607-L626">View on GitHub</a>
```python
@staticmethod
def _single_check(im: torch.Tensor, stride: int = 32) -> torch.Tensor:
    """Validate and format a single image tensor, ensuring correct shape and normalization."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/loaders.py#L645-L667">View on GitHub</a>
```python
def autocast_list(source: list[Any]) -> list[Image.Image | np.ndarray]:
    """Convert a list of sources into a list of numpy arrays or PIL images for Ultralytics prediction."""
    files = []
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/loaders.py#L670-L718">View on GitHub</a>
```python
def get_best_youtube_url(url: str, method: str = "pytube") -> str | None:
    """Retrieve the URL of the best quality MP4 video stream from a given YouTube video.
