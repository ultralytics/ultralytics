...
{%- set default_params = {
    ...
    "show_fps": ["bool", "False", "Displays frames per second (FPS) overlay on video/ stream output. Provides real-time performance metrics for processing speed analysis."],
