...
!!! abstract "Summary"
    ...
    === "<span class="doc-kind doc-kind-method">Methods</span>"
        ...
        - [`VisualAISearch._normalize`](#ultralytics.solutions.similarity_search.VisualAISearch._normalize)
...
| [`_normalize`](#ultralytics.solutions.similarity_search.VisualAISearch._normalize) | L2-normalize each row of `x` so inner products equal cosine similarity. |
...
| [`load_or_build_index`](#ultralytics.solutions.similarity_search.VisualAISearch.load_or_build_index) | Load existing image embeddings or build them from the image directory. |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/solutions/similarity_search.py#L20-L166">View on GitHub</a>
```python
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/solutions/similarity_search.py#L164-L166">View on GitHub</a>
```python
def __call__(self, query: str) -> list[str]:
    """Direct call interface for the search function."""
...
### Method `ultralytics.solutions.similarity_search.VisualAISearch._normalize` {#ultralytics.solutions.similarity\_search.VisualAISearch.\_normalize}
...
| Name | Type | Description | Default |
| --- | --- | --- | --- |
| `x` | `np.ndarray` | Feature array of shape (N, D). | *required* |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/solutions/similarity_search.py#L84-L93">View on GitHub</a>
```python
@staticmethod
def _normalize(x: np.ndarray) -> np.ndarray:
    """L2-normalize each row of `x` so inner products equal cosine similarity.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/solutions/similarity_search.py#L75-L77">View on GitHub</a>
```python
def extract_image_feature(self, path: Path) -> np.ndarray:
    """Extract CLIP image embedding from the given image path."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/solutions/similarity_search.py#L79-L81">View on GitHub</a>
```python
def extract_text_feature(self, text: str) -> np.ndarray:
    """Extract CLIP text embedding from the given text query."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/solutions/similarity_search.py#L95-L134">View on GitHub</a>
```python
def load_or_build_index(self) -> None:
    """Load existing image embeddings or build them from the image directory.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/solutions/similarity_search.py#L136-L162">View on GitHub</a>
```python
def search(self, query: str, k: int = 30, similarity_thresh: float = 0.1) -> list[str]:
    """Return top-k semantically similar images to the given query.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/solutions/similarity_search.py#L169-L222">View on GitHub</a>
```python
class SearchApp:
    """A Flask-based web interface for semantic image search with natural language queries.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/solutions/similarity_search.py#L212-L218">View on GitHub</a>
```python
def index(self) -> str:
    """Process user query and display search results in the web interface."""
    results = []
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/solutions/similarity_search.py#L220-L222">View on GitHub</a>
```python
def run(self, debug: bool = False) -> None:
    """Start the Flask web application server."""
