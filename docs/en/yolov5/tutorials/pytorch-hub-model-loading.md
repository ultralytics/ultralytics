...
PyTorch Hub supports inference on most YOLOv5 export formats, including custom-trained models. See [ONNX, CoreML, TensorRT Export tutorial](./model-export.md) for details on exporting models.
