...
```python
Bboxes(bboxes: np.ndarray, format: str = "xyxy")
```
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/instance.py#L36-L180">View on GitHub</a>
```python
class Bboxes:
    """A class for handling bounding boxes in multiple formats.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/instance.py#L163-L180">View on GitHub</a>
```python
def __getitem__(self, index: int | np.ndarray | slice) -> Bboxes:
    """Retrieve a specific bounding box or a set of bounding boxes using indexing.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/instance.py#L136-L138">View on GitHub</a>
```python
def __len__(self) -> int:
    """Return the number of bounding boxes."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/instance.py#L120-L134">View on GitHub</a>
```python
def add(self, offset: int | tuple | list) -> None:
    """Add offset to bounding box coordinates.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/instance.py#L96-L102">View on GitHub</a>
```python
def areas(self) -> np.ndarray:
    """Calculate the area of bounding boxes."""
    return (
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/instance.py#L141-L161">View on GitHub</a>
```python
@classmethod
def concatenate(cls, boxes_list: list[Bboxes], axis: int = 0) -> Bboxes:
    """Concatenate a list of Bboxes objects into a single Bboxes object.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/instance.py#L78-L94">View on GitHub</a>
```python
def convert(self, format: str) -> None:
    """Convert bounding box format from one type to another.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/instance.py#L104-L118">View on GitHub</a>
```python
def mul(self, scale: int | tuple | list) -> None:
    """Multiply bounding box coordinates by scale factor(s).
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/instance.py#L183-L530">View on GitHub</a>
```python
class Instances:
    """Container for bounding boxes, segments, and keypoints of detected objects in an image.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/instance.py#L249-L251">View on GitHub</a>
```python
@property
def bbox_areas(self) -> np.ndarray:
    """Calculate the area of bounding boxes."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/instance.py#L515-L517">View on GitHub</a>
```python
@property
def bboxes(self) -> np.ndarray:
    """Return bounding boxes."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/instance.py#L319-L342">View on GitHub</a>
```python
def __getitem__(self, index: int | np.ndarray | slice) -> Instances:
    """Retrieve a specific instance or a set of instances using indexing.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/instance.py#L464-L466">View on GitHub</a>
```python
def __len__(self) -> int:
    """Return the number of instances."""
    return len(self.bboxes)
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/instance.py#L519-L530">View on GitHub</a>
```python
def __repr__(self) -> str:
    """Return a string representation of the Instances object."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/instance.py#L304-L317">View on GitHub</a>
```python
def add_padding(self, padw: int, padh: int) -> None:
    """Add padding to coordinates.
...
| `preserve_obb` | `bool` | Preserve oriented-box direction while clipping segments. | `False` |

<details>
<summary>Source code in <code>ultralytics/utils/instance.py</code></summary>

<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/instance.py#L378-L433">View on GitHub</a>
```python
def clip(self, w: int, h: int, preserve_obb: bool = False) -> None:
    """Clip coordinates to stay within image boundaries.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/instance.py#L469-L512">View on GitHub</a>
```python
@classmethod
def concatenate(cls, instances_list: list[Instances], axis=0) -> Instances:
    """Concatenate a list of Instances objects into a single Instances object.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/instance.py#L240-L246">View on GitHub</a>
```python
def convert_bbox(self, format: str) -> None:
    """Convert bounding box format.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/instance.py#L270-L285">View on GitHub</a>
```python
def denormalize(self, w: int, h: int) -> None:
    """Convert normalized coordinates to absolute coordinates.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/instance.py#L361-L376">View on GitHub</a>
```python
def fliplr(self, w: int) -> None:
    """Flip coordinates horizontally.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/instance.py#L344-L359">View on GitHub</a>
```python
def flipud(self, h: int) -> None:
    """Flip coordinates vertically.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/instance.py#L287-L302">View on GitHub</a>
```python
def normalize(self, w: int, h: int) -> None:
    """Convert absolute coordinates to normalized coordinates.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/instance.py#L435-L448">View on GitHub</a>
```python
def remove_zero_area_boxes(self) -> np.ndarray:
    """Remove zero-area boxes, i.e. after clipping some boxes may have zero width or height.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/instance.py#L253-L268">View on GitHub</a>
```python
def scale(self, scale_w: float, scale_h: float, bbox_only: bool = False):
    """Scale coordinates by given factors.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/instance.py#L450-L462">View on GitHub</a>
```python
def update(self, bboxes: np.ndarray, segments: np.ndarray = None, keypoints: np.ndarray = None):
    """Update instance variables.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/instance.py#L15-L22">View on GitHub</a>
```python
def _ntuple(n):
    """Create a function that converts input to n-tuple by repeating singleton values."""
