...
!!! abstract "Summary"
    ...
    === "<span class="doc-kind doc-kind-class">Classes</span>"
        ...
        - [`HUBDatasetStats`](#ultralytics.data.utils.HUBDatasetStats)

    === "<span class="doc-kind doc-kind-method">Methods</span>"

        - [`HUBDatasetStats._unzip`](#ultralytics.data.utils.HUBDatasetStats._unzip)
        - [`HUBDatasetStats._hub_ops`](#ultralytics.data.utils.HUBDatasetStats._hub_ops)
        - [`HUBDatasetStats.get_json`](#ultralytics.data.utils.HUBDatasetStats.get_json)
        - [`HUBDatasetStats.process_images`](#ultralytics.data.utils.HUBDatasetStats.process_images)

    === "<span class="doc-kind doc-kind-function">Functions</span>"

        - [`img2label_paths`](#ultralytics.data.utils.img2label_paths)
        - [`check_file_speeds`](#ultralytics.data.utils.check_file_speeds)
        - [`get_hash`](#ultralytics.data.utils.get_hash)
        - [`exif_size`](#ultralytics.data.utils.exif_size)
        - [`verify_image`](#ultralytics.data.utils.verify_image)
        - [`verify_image_label`](#ultralytics.data.utils.verify_image_label)
        - [`visualize_image_annotations`](#ultralytics.data.utils.visualize_image_annotations)
        - [`polygon2mask`](#ultralytics.data.utils.polygon2mask)
        - [`polygons2masks`](#ultralytics.data.utils.polygons2masks)
        - [`polygons2masks_overlap`](#ultralytics.data.utils.polygons2masks_overlap)
        - [`find_dataset_yaml`](#ultralytics.data.utils.find_dataset_yaml)
        - [`check_det_dataset`](#ultralytics.data.utils.check_det_dataset)
        - [`check_cls_dataset`](#ultralytics.data.utils.check_cls_dataset)
        - [`compress_one_image`](#ultralytics.data.utils.compress_one_image)
        - [`load_dataset_cache_file`](#ultralytics.data.utils.load_dataset_cache_file)
        - [`save_dataset_cache_file`](#ultralytics.data.utils.save_dataset_cache_file)


## Class `ultralytics.data.utils.HUBDatasetStats` {#ultralytics.data.utils.HUBDatasetStats}
...
| --- | --- | --- | --- |
| `path` | `str` | Path to data.yaml or data.zip (with data.yaml inside data.zip). | `"coco8.yaml"` |
| `task` | `str` | Dataset task. Options are 'detect', 'segment', 'pose', 'classify', 'obb'. | `"detect"` |
| `autodownload` | `bool` | Attempt to download dataset if not found locally. | `False` |
...
| Name | Description |
| --- | --- |
| [`_hub_ops`](#ultralytics.data.utils.HUBDatasetStats._hub_ops) | Save a compressed image for HUB previews. |
| [`_unzip`](#ultralytics.data.utils.HUBDatasetStats._unzip) | Unzip data.zip. |
| [`get_json`](#ultralytics.data.utils.HUBDatasetStats.get_json) | Return dataset JSON for Ultralytics HUB. |
| [`process_images`](#ultralytics.data.utils.HUBDatasetStats.process_images) | Compress images for Ultralytics HUB. |
...
<details>
<summary>Source code in <code>ultralytics/data/utils.py</code></summary>

<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/utils.py#L576-L739"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
...
### Method `ultralytics.data.utils.HUBDatasetStats._hub_ops` {#ultralytics.data.utils.HUBDatasetStats.\_hub\_ops}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/utils.py#L648-L650"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def _hub_ops(self, f: str):
    """Save a compressed image for HUB previews."""
...
### Method `ultralytics.data.utils.HUBDatasetStats._unzip` {#ultralytics.data.utils.HUBDatasetStats.\_unzip}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/utils.py#L638-L646"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
@staticmethod
def _unzip(path: Path) -> tuple[bool, str, Path]:
    """Unzip data.zip."""
...
### Method `ultralytics.data.utils.HUBDatasetStats.get_json` {#ultralytics.data.utils.HUBDatasetStats.get\_json}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/utils.py#L652-L724"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def get_json(self, save: bool = False, verbose: bool = False) -> dict:
    """Return dataset JSON for Ultralytics HUB."""
...
### Method `ultralytics.data.utils.HUBDatasetStats.process_images` {#ultralytics.data.utils.HUBDatasetStats.process\_images}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/utils.py#L726-L739"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def process_images(self) -> Path:
    """Compress images for Ultralytics HUB."""
...
## Function `ultralytics.data.utils.img2label_paths` {#ultralytics.data.utils.img2label\_paths}
...
| Name | Type | Description | Default |
| --- | --- | --- | --- |
| `img_paths` | `list[str]` |  | *required* |

<details>
<summary>Source code in <code>ultralytics/data/utils.py</code></summary>

<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/utils.py#L45-L48"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def img2label_paths(img_paths: list[str]) -> list[str]:
    """Convert image paths to label paths by replacing 'images' with 'labels' and extension with '.txt'."""
...
## Function `ultralytics.data.utils.check_file_speeds` {#ultralytics.data.utils.check\_file\_speeds}
...
| Name | Type | Description | Default |
| --- | --- | --- | --- |
| `files` | `list[str]` | List of file paths to check for access speed. | *required* |
| `threshold_ms` | `float, optional` | Threshold in milliseconds for ping time warnings. | `10` |
| `threshold_mb` | `float, optional` | Threshold in megabytes per second for read speed warnings. | `50` |
| `max_files` | `int, optional` | The maximum number of files to check. | `5` |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/utils.py#L51-L125"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def check_file_speeds(
    files: list[str], threshold_ms: float = 10, threshold_mb: float = 50, max_files: int = 5, prefix: str = ""
):
...
## Function `ultralytics.data.utils.get_hash` {#ultralytics.data.utils.get\_hash}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/utils.py#L128-L138"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def get_hash(paths: list[str]) -> str:
    """Return a single hash value of a list of paths (files or dirs)."""
    size = 0
...
## Function `ultralytics.data.utils.exif_size` {#ultralytics.data.utils.exif\_size}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/utils.py#L141-L152"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def exif_size(img: Image.Image) -> tuple[int, int]:
    """Return exif-corrected PIL size."""
...
## Function `ultralytics.data.utils.verify_image` {#ultralytics.data.utils.verify\_image}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/utils.py#L155-L177"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def verify_image(args: tuple) -> tuple:
    """Verify one image."""
...
## Function `ultralytics.data.utils.verify_image_label` {#ultralytics.data.utils.verify\_image\_label}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/utils.py#L180-L249"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def verify_image_label(args: tuple) -> list:
    """Verify one image-label pair."""
...
## Function `ultralytics.data.utils.visualize_image_annotations` {#ultralytics.data.utils.visualize\_image\_annotations}
...
| Name | Type | Description | Default |
| --- | --- | --- | --- |
| `image_path` | `str` | Path to the image file to annotate. The file must be readable by PIL. | *required* |
| `txt_path` | `str` | Path to the annotation file in YOLO format, which should contain one line per object. | *required* |
| `label_map` | `dict[int, str]` | A dictionary that maps class IDs (integers) to class labels (strings). | *required* |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/utils.py#L252-L292"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def visualize_image_annotations(image_path: str, txt_path: str, label_map: dict[int, str]):
    """Visualize YOLO annotations (bounding boxes and class labels) on an image.
...
## Function `ultralytics.data.utils.polygon2mask` {#ultralytics.data.utils.polygon2mask}
...
| Name | Type | Description | Default |
| --- | --- | --- | --- |
| `imgsz` | `tuple[int, int]` | The size of the image as (height, width). | *required* |
| `polygons` | `list[np.ndarray]` | A list of polygons. Each polygon is a 1D array of coordinates with length M, where<br>    M % 2 = 0 (alternating x, y values). | *required* |
| `color` | `int, optional` | The color value to fill in the polygons on the mask. | `1` |
| `downsample_ratio` | `int, optional` | Factor by which to downsample the mask. | `1` |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/utils.py#L295-L316"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def polygon2mask(
    imgsz: tuple[int, int], polygons: list[np.ndarray], color: int = 1, downsample_ratio: int = 1
) -> np.ndarray:
...
## Function `ultralytics.data.utils.polygons2masks` {#ultralytics.data.utils.polygons2masks}
...
| --- | --- | --- | --- |
| `imgsz` | `tuple[int, int]` | The size of the image as (height, width). | *required* |
| `polygons` | `list[np.ndarray]` | A list of polygons. Each polygon is an array of coordinates that can be reshaped to<br>    (-1, 2) as (x, y) point pairs. | *required* |
| `color` | `int` | The color value to fill in the polygons on the masks. | *required* |
| `downsample_ratio` | `int, optional` | Factor by which to downsample each mask. | `1` |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/utils.py#L319-L334"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def polygons2masks(
    imgsz: tuple[int, int], polygons: list[np.ndarray], color: int, downsample_ratio: int = 1
) -> np.ndarray:
...
## Function `ultralytics.data.utils.polygons2masks_overlap` {#ultralytics.data.utils.polygons2masks\_overlap}
...
| `segments` | `list[np.ndarray]` |  | *required* |
| `downsample_ratio` | `int` |  | `1` |

<details>
<summary>Source code in <code>ultralytics/data/utils.py</code></summary>

<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/utils.py#L337-L363"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def polygons2masks_overlap(
    imgsz: tuple[int, int], segments: list[np.ndarray], downsample_ratio: int = 1
) -> tuple[np.ndarray, np.ndarray]:
...
## Function `ultralytics.data.utils.find_dataset_yaml` {#ultralytics.data.utils.find\_dataset\_yaml}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/utils.py#L366-L383"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def find_dataset_yaml(path: Path) -> Path:
    """Find and return the YAML file associated with a Detect, Segment or Pose dataset.
...
## Function `ultralytics.data.utils.check_det_dataset` {#ultralytics.data.utils.check\_det\_dataset}
...
| `autodownload` | `bool, optional` | Whether to automatically download the dataset if not found. | `True` |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/utils.py#L386-L477"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def check_det_dataset(dataset: str, autodownload: bool = True) -> dict[str, Any]:
    """Download, verify, and/or unzip a dataset if not found locally.
...
## Function `ultralytics.data.utils.check_cls_dataset` {#ultralytics.data.utils.check\_cls\_dataset}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/utils.py#L480-L573"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def check_cls_dataset(dataset: str | Path, split: str = "") -> dict[str, Any]:
    """Check a classification dataset such as Imagenet.
...
## Function `ultralytics.data.utils.compress_one_image` {#ultralytics.data.utils.compress\_one\_image}
...
| `f_new` | `str, optional` | The path to the output image file. If not specified, the input file will be overwritten. | `None` |
| `max_dim` | `int, optional` | The maximum dimension (width or height) of the output image. | `1920` |
| `quality` | `int, optional` | The image compression quality as a percentage. | `50` |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/utils.py#L742-L775"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def compress_one_image(f: str, f_new: str | None = None, max_dim: int = 1920, quality: int = 50):
    """Compress a single image file to reduced size while preserving its aspect ratio and quality using either the
...
## Function `ultralytics.data.utils.load_dataset_cache_file` {#ultralytics.data.utils.load\_dataset\_cache\_file}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/utils.py#L778-L785"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def load_dataset_cache_file(path: Path) -> dict:
    """Load an Ultralytics *.cache dictionary from path."""
    import gc
...
## Function `ultralytics.data.utils.save_dataset_cache_file` {#ultralytics.data.utils.save\_dataset\_cache\_file}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/utils.py#L788-L798"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def save_dataset_cache_file(prefix: str, path: Path, x: dict, version: str):
    """Save an Ultralytics dataset *.cache dictionary x to path."""
