...
class Mosaic(BaseMixTransform):
    ...
    def _mosaic3(self, labels: Dict[str, Any]) -> Dict[str, Any]:
        ...
        for i in range(3):
            ...
            # Place img in img3
            if i == 0:  # center
                img3 = np.full((s * 3, s * 3, img.shape[2]), 114, dtype=self.dtype)  # base image with 3 tiles
                h0, w0 = h, w
    ...
    def _mosaic4(self, labels: Dict[str, Any]) -> Dict[str, Any]:
        ...
        for i in range(4):
            ...
            # Place img in img4
            if i == 0:  # top left
                img4 = np.full((s * 2, s * 2, img.shape[2]), 114, dtype=self.dtype)  # base image with 4 tiles
    ...
    def _mosaic9(self, labels: Dict[str, Any]) -> Dict[str, Any]:
        ...
        for i in range(9):
            ...
            # Place img in img9
            if i == 0:  # center
                img9 = np.full((s * 3, s * 3, img.shape[2]), 114, dtype=self.dtype)  # base image with 4 tiles
                h0, w0 = h, w
                c = s, s, s + w, s + h  # xmin, ymin, xmax, ymax (base) coordinates
            elif i == 1:  # top
                c = s, s - h, s + w, s
