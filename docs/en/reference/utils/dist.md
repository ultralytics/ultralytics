...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/dist.py#L18-L46">View on GitHub</a>
```python
def find_free_network_port() -> int:
    """Find a free port on localhost.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/dist.py#L49-L106">View on GitHub</a>
```python
def generate_ddp_file(trainer: BaseTrainer) -> str:
    """Generate a DDP (Distributed Data Parallel) file for multi-GPU training.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/dist.py#L109-L136">View on GitHub</a>
```python
def generate_ddp_command(trainer: BaseTrainer) -> tuple[list[str], str]:
    """Generate command for distributed training.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/dist.py#L139-L155">View on GitHub</a>
```python
def ddp_cleanup(trainer: BaseTrainer, file: str) -> None:
    """Delete temporary file if created during distributed data parallel (DDP) training.
