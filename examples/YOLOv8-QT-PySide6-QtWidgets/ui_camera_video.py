...
class Ui_camera_video(object):
    ...
    def retranslateUi(self, camera_video):
        camera_video.setWindowTitle(QCoreApplication.translate("camera_video", "Yolov* Camera Video", None))
        self.label.setText("")
        self.model.setText(QCoreApplication.translate("camera_video", "model", None))
        self.lineEdit.setText(QCoreApplication.translate("camera_video", "yolov8n.pt", None))
