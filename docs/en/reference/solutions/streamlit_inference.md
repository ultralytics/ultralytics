...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/solutions/streamlit_inference.py#L18-L250">View on GitHub</a>
```python
class Inference:
    """A class to perform object detection, image classification, image segmentation and pose estimation inference.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/solutions/streamlit_inference.py#L151-L180">View on GitHub</a>
```python
def configure(self) -> None:
    """Configure the model and load selected classes for inference."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/solutions/streamlit_inference.py#L182-L201">View on GitHub</a>
```python
def image_inference(self) -> None:
    """Perform inference on uploaded images."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/solutions/streamlit_inference.py#L203-L250">View on GitHub</a>
```python
def inference(self) -> None:
    """Perform real-time object detection inference on video or webcam feed."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/solutions/streamlit_inference.py#L103-L124">View on GitHub</a>
```python
def sidebar(self) -> None:
    """Configure the Streamlit sidebar for model and inference settings."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/solutions/streamlit_inference.py#L126-L149">View on GitHub</a>
```python
def source_upload(self) -> None:
    """Handle video file uploads through the Streamlit interface."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/solutions/streamlit_inference.py#L84-L101">View on GitHub</a>
```python
def web_ui(self) -> None:
    """Set up the Streamlit web interface with custom HTML elements."""
