...
```python
PoseTrainer(cfg=DEFAULT_CFG, overrides: dict[str, Any] | None = None, _callbacks: dict | None = None)
```
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/yolo/pose/train.py#L14-L116">View on GitHub</a>
```python
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/yolo/pose/train.py#L104-L116">View on GitHub</a>
```python
def get_dataset(self) -> dict[str, Any]:
    """Retrieve the dataset and ensure it contains the required `kpt_shape` key.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/yolo/pose/train.py#L57-L85">View on GitHub</a>
```python
def get_model(
    self,
    cfg: str | Path | dict[str, Any] | None = None,
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/yolo/pose/train.py#L98-L102">View on GitHub</a>
```python
def get_validator(self):
    """Return an instance of the PoseValidator class for validation."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/yolo/pose/train.py#L87-L96">View on GitHub</a>
```python
def set_model_attributes(self):
    """Set keypoints shape attribute of PoseModel."""
