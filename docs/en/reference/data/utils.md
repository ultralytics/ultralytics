...
!!! abstract "Summary"
    ...
    === "<span class="doc-kind doc-kind-function">Functions</span>"
        ...
        - [`check_image`](#ultralytics.data.utils.check_image)
        - [`verify_image`](#ultralytics.data.utils.verify_image)
        - [`verify_image_depth`](#ultralytics.data.utils.verify_image_depth)
        - [`verify_image_mask`](#ultralytics.data.utils.verify_image_mask)
        ...
        - [`convert_ndjson_to_yolo_if_needed`](#ultralytics.data.utils.convert_ndjson_to_yolo_if_needed)
        ...
        - [`add_polygon_background`](#ultralytics.data.utils.add_polygon_background)
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/utils.py#L55-L58">View on GitHub</a>
```python
def img2label_paths(img_paths: list[str], label_dir: str = "labels", suffix: str = ".txt") -> list[str]:
    """Convert image paths to label paths by replacing 'images' with 'labels' and extension with '.txt'."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/utils.py#L61-L136">View on GitHub</a>
```python
def check_file_speeds(
    files: list[str], threshold_ms: float = 10, threshold_mb: float = 50, max_files: int = 5, prefix: str = ""
):
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/utils.py#L139-L149">View on GitHub</a>
```python
def get_hash(paths: list[str]) -> str:
    """Return a single hash value of a list of paths (files or dirs)."""
    size = 0
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/utils.py#L152-L163">View on GitHub</a>
```python
def exif_size(img: Image.Image) -> tuple[int, int]:
    """Return exif-corrected PIL size."""
...
## Function `ultralytics.data.utils.check_image` {#ultralytics.data.utils.check\_image}
...
| Name | Type | Description | Default |
| --- | --- | --- | --- |
| `im_file` | `str` | Path to the image file to check. | *required* |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/utils.py#L166-L192">View on GitHub</a>
```python
def check_image(im_file: str) -> tuple[str, tuple[int, int]]:
    """Verify an image file for integrity and correct corrupt JPEGs if found.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/utils.py#L195-L207">View on GitHub</a>
```python
def verify_image(args: tuple) -> tuple:
    """Verify one image."""
...
## Function `ultralytics.data.utils.verify_image_depth` {#ultralytics.data.utils.verify\_image\_depth}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/utils.py#L210-L229">View on GitHub</a>
```python
def verify_image_depth(args: tuple) -> tuple:
    """Verify that an image and its paired depth .npy map exist and are readable."""
...
## Function `ultralytics.data.utils.verify_image_mask` {#ultralytics.data.utils.verify\_image\_mask}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/utils.py#L232-L263">View on GitHub</a>
```python
def verify_image_mask(args: tuple) -> tuple:
    """Verify that an image and its semantic mask exist, are readable, and have matching shapes."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/utils.py#L266-L326">View on GitHub</a>
```python
def verify_image_label(args: tuple) -> list:
    """Verify one image-label pair."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/utils.py#L329-L369">View on GitHub</a>
```python
def visualize_image_annotations(image_path: str, txt_path: str, label_map: dict[int, str]):
    """Visualize YOLO annotations (bounding boxes and class labels) on an image.
...
| `polygons` | `list[np.ndarray]` | A list of polygons. Each polygon is a 1D array of coordinates with length M, where M % 2 = 0 (alternating x, y values). | *required* |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/utils.py#L372-L393">View on GitHub</a>
```python
def polygon2mask(
    imgsz: tuple[int, int], polygons: list[np.ndarray], color: int = 1, downsample_ratio: int = 1
) -> np.ndarray:
...
| --- | --- | --- | --- |
| `imgsz` | `tuple[int, int]` | The size of the image as (height, width). | *required* |
| `polygons` | `list[np.ndarray]` | A list of polygons. Each polygon is an array of coordinates that can be reshaped to (-1, 2) as (x, y) point pairs. | *required* |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/utils.py#L396-L411">View on GitHub</a>
```python
def polygons2masks(
    imgsz: tuple[int, int], polygons: list[np.ndarray], color: int, downsample_ratio: int = 1
) -> np.ndarray:
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/utils.py#L414-L439">View on GitHub</a>
```python
def polygons2masks_overlap(
    imgsz: tuple[int, int], segments: list[np.ndarray], downsample_ratio: int = 1
) -> tuple[np.ndarray, np.ndarray]:
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/utils.py#L442-L459">View on GitHub</a>
```python
def find_dataset_yaml(path: Path) -> Path:
    """Find and return the YAML file associated with a Detect, Segment or Pose dataset.
...
## Function `ultralytics.data.utils.convert_ndjson_to_yolo_if_needed` {#ultralytics.data.utils.convert\_ndjson\_to\_yolo\_if\_needed}
...
| Name | Type | Description | Default |
| --- | --- | --- | --- |
| `data` | `str \| Path` |  | *required* |

<details>
<summary>Source code in <code>ultralytics/data/utils.py</code></summary>

<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/utils.py#L462-L472">View on GitHub</a>
```python
def convert_ndjson_to_yolo_if_needed(data: str | Path) -> str | Path:
    """Convert an NDJSON dataset or Platform dataset URI to YOLO format."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/utils.py#L475-L585">View on GitHub</a>
```python
def check_det_dataset(dataset: str, autodownload: bool = True, split: str = "") -> dict[str, Any]:
    """Download, verify, and/or unzip a dataset if not found locally.
...
| Type | Description |
| --- | --- |
| `dict[str, Any]` | A dictionary containing the following keys:<br><br>- 'train' (Path): The directory path containing the training set of the dataset.<br>- 'val' (Path): The directory path containing the validation set of the dataset.<br>- 'test' (Path): The directory path containing the test set of the dataset.<br>- 'nc' (int): The number of classes in the dataset.<br>- 'names' (dict[int, str]): A dictionary of class names in the dataset. |

<details>
<summary>Source code in <code>ultralytics/data/utils.py</code></summary>

<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/utils.py#L588-L687">View on GitHub</a>
```python
def check_cls_dataset(dataset: str | Path, split: str = "") -> dict[str, Any]:
    """Check a classification dataset such as Imagenet.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/utils.py#L690-L723">View on GitHub</a>
```python
def compress_one_image(f: str, f_new: str | None = None, max_dim: int = 1920, quality: int = 50):
    """Compress a single image file to reduced size while preserving its aspect ratio and quality using either the
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/utils.py#L726-L733">View on GitHub</a>
```python
def load_dataset_cache_file(path: Path) -> dict:
    """Load an Ultralytics *.cache dictionary from path."""
    import gc
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/utils.py#L736-L750">View on GitHub</a>
```python
def save_dataset_cache_file(prefix: str, path: Path, x: dict, version: str):
    """Save an Ultralytics dataset *.cache dictionary x to path."""
...
## Function `ultralytics.data.utils.add_polygon_background` {#ultralytics.data.utils.add\_polygon\_background}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/data/utils.py#L753-L773">View on GitHub</a>
```python
def add_polygon_background(data: dict) -> dict:
    """Set up the background class for polygon-based semantic datasets without 'masks_dir'.
