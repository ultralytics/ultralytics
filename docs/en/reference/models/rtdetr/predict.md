...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/rtdetr/predict.py#L11-L83">View on GitHub</a>
```python
...
| --- | --- | --- | --- |
| `preds` | `list \| tuple` | List of [predictions, extra] from the model, where predictions have shape (bs, num_queries, 6) with format [cx, cy, w, h, score, class]. | *required* |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/rtdetr/predict.py#L35-L69">View on GitHub</a>
```python
def postprocess(self, preds, img, orig_imgs):
    """Postprocess the raw predictions from the model to generate bounding boxes and confidence scores.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/rtdetr/predict.py#L71-L83">View on GitHub</a>
```python
def pre_transform(self, im):
    """Pre-transform input images before feeding them into the model for inference.
