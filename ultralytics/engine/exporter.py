...
class Exporter:
    ...
    def __call__(self, model=None):
        ...
        # Input
        im = torch.zeros(self.args.batch, self.ch, *self.imgsz).to(self.device)
        file = Path(
    ...
    def export_ncnn(self, prefix=colorstr('ncnn:')):
        ...
        cmd = [
            ...
            *pnnx_args,
            ...
            f'inputshape="{[self.args.batch, self.ch, *self.imgsz]}"', ]
    ...
    def _pipeline_coreml(self, model, weights_dir=None, prefix=colorstr('CoreML Pipeline:')):
        ...
        pipeline = ct.models.pipeline.Pipeline(input_features=[('image', ct.models.datatypes.Array(self.ch, ny, nx)),
