...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/modules/transformer.py#L32-L168">View on GitHub</a>
```python
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/modules/transformer.py#L148-L168">View on GitHub</a>
```python
def forward(
    self,
    src: torch.Tensor,
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/modules/transformer.py#L96-L120">View on GitHub</a>
```python
def forward_post(
    self,
    src: torch.Tensor,
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/modules/transformer.py#L122-L146">View on GitHub</a>
```python
def forward_pre(
    self,
    src: torch.Tensor,
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/modules/transformer.py#L92-L94">View on GitHub</a>
```python
@staticmethod
def with_pos_embed(tensor: torch.Tensor, pos: torch.Tensor | None = None) -> torch.Tensor:
    """Add position embeddings to the tensor if provided."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/modules/transformer.py#L171-L244">View on GitHub</a>
```python
...
| `device` | `torch.device, optional` | Device on which to build the embedding grids. | `None` |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/modules/transformer.py#L215-L244">View on GitHub</a>
```python
@staticmethod
def build_2d_sincos_position_embedding(
    w: int, h: int, embed_dim: int = 256, temperature: float = 10000.0, device=None
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/modules/transformer.py#L199-L212">View on GitHub</a>
```python
def forward(self, x: torch.Tensor) -> torch.Tensor:
    """Forward pass for the AIFI transformer layer.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/modules/transformer.py#L247-L275">View on GitHub</a>
```python
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/modules/transformer.py#L265-L275">View on GitHub</a>
```python
def forward(self, x: torch.Tensor) -> torch.Tensor:
    """Apply a transformer block to the input x and return the output.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/modules/transformer.py#L278-L321">View on GitHub</a>
```python
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/modules/transformer.py#L308-L321">View on GitHub</a>
```python
def forward(self, x: torch.Tensor) -> torch.Tensor:
    """Forward propagate the input through the transformer block.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/modules/transformer.py#L324-L349">View on GitHub</a>
```python
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/modules/transformer.py#L340-L349">View on GitHub</a>
```python
def forward(self, x: torch.Tensor) -> torch.Tensor:
    """Forward pass for the MLPBlock.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/modules/transformer.py#L352-L416">View on GitHub</a>
```python
class MLP(nn.Module):
    """A simple multi-layer perceptron (also called FFN).
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/modules/transformer.py#L401-L416">View on GitHub</a>
```python
def forward(self, x: torch.Tensor) -> torch.Tensor:
    """Forward pass for the entire MLP.
...
```python
LayerNorm2d(num_channels: int, eps: float = 1e-6)
```
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/modules/transformer.py#L419-L459">View on GitHub</a>
```python
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/modules/transformer.py#L447-L459">View on GitHub</a>
```python
def forward(self, x: torch.Tensor) -> torch.Tensor:
    """Perform forward pass for 2D layer normalization.
...
```python
MSDeformAttn(d_model: int = 256, n_levels: int = 4, n_heads: int = 8, n_points: int = 4)
```
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/modules/transformer.py#L462-L585">View on GitHub</a>
```python
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/modules/transformer.py#L513-L532">View on GitHub</a>
```python
def _reset_parameters(self):
    """Reset module parameters."""
...
| `refer_bbox` | `torch.Tensor` | Reference bounding boxes with shape [bs, query_length, 1, 2 or 4], range in [0, 1], top-left (0,0), bottom-right (1, 1). The size-1 axis broadcasts across n_levels. | *required* |
...
| `value_mask` | `torch.Tensor, optional` | Mask tensor with shape [bs, value_length], True for padding elements, False for non-padding elements. | `None` |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/modules/transformer.py#L534-L585">View on GitHub</a>
```python
def forward(
    self,
    query: torch.Tensor,
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/modules/transformer.py#L588-L712">View on GitHub</a>
```python
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/modules/transformer.py#L672-L712">View on GitHub</a>
```python
def forward(
    self,
    embed: torch.Tensor,
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/modules/transformer.py#L659-L670">View on GitHub</a>
```python
def forward_ffn(self, tgt: torch.Tensor) -> torch.Tensor:
    """Perform forward pass through the Feed-Forward Network part of the layer.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/modules/transformer.py#L655-L657">View on GitHub</a>
```python
@staticmethod
def with_pos_embed(tensor: torch.Tensor, pos: torch.Tensor | None) -> torch.Tensor:
    """Add positional embeddings to the input tensor, if provided."""
...
```python
DeformableTransformerDecoder(hidden_dim: int, decoder_layer: nn.Module, num_layers: int, eval_idx: int = -1)
```
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/modules/transformer.py#L715-L800">View on GitHub</a>
```python
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/modules/transformer.py#L746-L800">View on GitHub</a>
```python
def forward(
    self,
    embed: torch.Tensor,  # decoder embeddings
