...
class BasePredictor:
    ...
    def stream_inference(self, source=None, model=None):
        ...
        self.seen, self.windows, dt_list, self.batch = 0, [], (ops.Profile(), ops.Profile(), ops.Profile()), None
        ...
        for batch in self.dataset:
            ...
            for i in range(n):
                self.results[i].speed = {
                    'preprocess': dt_list[0].dt * 1E3 / n,
                    'inference': dt_list[1].dt * 1E3 / n,
                    'postprocess': dt_list[2].dt * 1E3 / n}
            ...
            if self.args.verbose:
                LOGGER.info(f'{s}{dt_list[1].dt * 1E3:.1f}ms')
        ...
        if self.args.verbose and self.seen:
            t = tuple(x.t / self.seen * 1E3 for x in dt_list)  # speeds per image
