...
- **速度** 指标是在 [Amazon EC2 P4d](https://aws.amazon.com/ec2/instance-types/p4/) 实例上对 Cityscapes 验证集图像进行平均测量的。<br>使用 `yolo semseg val data=cityscapes.yaml batch=1 device=0|cpu imgsz=2048` 复现结果。
