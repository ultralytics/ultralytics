...
class TestClassBalancing:
    ...
    def test_weighted_random_sampler(self):
        ...
        dataloader = build_dataloader(
            mock_dataset, batch=2, workers=0, shuffle=False, use_weighted_sampler=True, cls_weights=cls_weights
        )
...
""")
    ...
    def test_malformed_sample_handling(self):
        ...
        mock_dataset.__getitem__ = Mock(
            side_effect=[{"cls": torch.tensor([0])}, {"no_cls": "invalid"}, {"cls": torch.tensor([1])}]
        )
