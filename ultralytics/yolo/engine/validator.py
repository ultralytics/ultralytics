...
from ultralytics.yolo.utils import LOGGER, TQDM_BAR_FORMAT, RANK
...
class BaseValidator:
    ...
    def __init__(self, dataloader=None, save_dir=None, pbar=None, logger=None, args=None):
        ...
        self.save_dir = save_dir or increment_path(Path(project) / name, exist_ok=self.args.exist_ok if RANK == -1 else True)
