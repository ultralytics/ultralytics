...
```python
OBBTrainer(cfg=DEFAULT_CFG, overrides: dict | None = None, _callbacks: dict | None = None)
```
...
| `_callbacks` | `dict, optional` | Dictionary of callback functions to be invoked during training. | `None` |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/yolo/obb/train.py#L13-L78">View on GitHub</a>
```python
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/yolo/obb/train.py#L48-L72">View on GitHub</a>
```python
def get_model(
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/yolo/obb/train.py#L74-L78">View on GitHub</a>
```python
def get_validator(self):
    """Return an instance of OBBValidator for validation of YOLO model."""
