...
```python
InstanceSegmentation(**kwargs: Any)
```
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/solutions/instance_segmentation.py#L9-L86">View on GitHub</a>
```python
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/solutions/instance_segmentation.py#L51-L86">View on GitHub</a>
```python
def process(self, im0) -> SolutionResults:
    """Perform instance segmentation on the input image and annotate the results.
