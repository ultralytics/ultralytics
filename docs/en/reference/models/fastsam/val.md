...
```python
FastSAMValidator(dataloader=None, save_dir=None, args=None, _callbacks: dict | None = None)
```
...
| `_callbacks` | `dict, optional` | Dictionary of callback functions to be invoked during validation. | `None` |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/fastsam/val.py#L8-L40">View on GitHub</a>
```python
