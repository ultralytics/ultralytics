...
| `mem_cache_limit` | `0.7`    | Limit of memory cache in byte. For values `0.0~1.0`, the fraction of available memory will be used. Only applicable when `cache` is `True`/`ram`.                                                                    |
