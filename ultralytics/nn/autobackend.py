...
class AutoBackend(nn.Module):
    ...
    def __init__(self,
        ...
        pt, jit, onnx, xml, engine, mlmodel, mlprogram, saved_model, pb, tflite, edgetpu, tfjs, paddle, triton = self._model_type(
            w)
        fp16 &= pt or jit or onnx or engine or nn_module  # FP16
        nhwc = mlmodel or mlprogram or saved_model or pb or tflite or edgetpu  # BHWC formats (vs torch BCWH)
        ...
        elif mlmodel or mlprogram:  # CoreML
    ...
    def forward(self, im, augment=False, visualize=False):
        ...
        elif self.mlmodel or self.mlprogram:  # CoreML
            im = im[0].cpu().numpy()
