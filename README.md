...
- **Speed** metrics are averaged over Cityscapes val images using an [Amazon EC2 P4d](https://aws.amazon.com/ec2/instance-types/p4/) instance. <br>Reproduce with `yolo semseg val data=cityscapes.yaml batch=1 device=0|cpu imgsz=2048`
