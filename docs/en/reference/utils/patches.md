...
!!! abstract "Summary"
    ...
    === "<span class="doc-kind doc-kind-function">Functions</span>"
        ...
        - [`image_open`](#ultralytics.utils.patches.image_open)
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/patches.py#L21-L50">View on GitHub</a>
```python
def imread(filename: str, flags: int = cv2.IMREAD_COLOR) -> np.ndarray | None:
    """Read an image from a file with multilanguage filename support.
...
## Function `ultralytics.utils.patches.image_open` {#ultralytics.utils.patches.image\_open}
...
| Name | Type | Description | Default |
| --- | --- | --- | --- |
| `filename` | `str` | Path to the image file. | *required* |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/patches.py#L58-L86">View on GitHub</a>
```python
def image_open(filename, *args, **kwargs):
    """Open an image with PIL, lazily registering the HEIF plugin on first failure.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/patches.py#L92-L108">View on GitHub</a>
```python
def _imread_pil(filename: str, flags: int = cv2.IMREAD_COLOR) -> np.ndarray | None:
    """Read an image using PIL as fallback for formats not supported by OpenCV.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/patches.py#L111-L133">View on GitHub</a>
```python
def imwrite(filename: str, img: np.ndarray, params: list[int] | None = None) -> bool:
    """Write an image to a file with multilanguage filename support.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/patches.py#L136-L153">View on GitHub</a>
```python
def imshow(winname: str, mat: np.ndarray) -> None:
    """Display an image in the specified window with multilanguage window name support.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/patches.py#L160-L181">View on GitHub</a>
```python
def torch_load(*args, **kwargs):
    """Load a PyTorch model with updated arguments to avoid warnings.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/patches.py#L184-L204">View on GitHub</a>
```python
def torch_save(*args, **kwargs):
    """Save PyTorch objects with retry mechanism for robustness.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/patches.py#L208-L224">View on GitHub</a>
```python
@contextmanager
def arange_patch(dynamic: bool = False, quantize: int | str | None = None, fmt: str = ""):
    """Workaround for ONNX torch.arange incompatibility with FP16.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/patches.py#L228-L243">View on GitHub</a>
```python
@contextmanager
def onnx_export_patch():
    """Workaround for ONNX export issues in PyTorch 2.9+ with Dynamo enabled."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/patches.py#L247-L266">View on GitHub</a>
```python
@contextmanager
def override_configs(args, overrides: dict[str, Any] | None = None):
    """Context manager to temporarily override configurations in args.
