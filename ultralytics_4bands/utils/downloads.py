...
from ultralytics_4bands.utils import LOGGER, TQDM, checks, clean_url, emojis, is_online, url2file

# Define Ultralytics GitHub assets maintained at https://github.com/ultralytics/assets
GITHUB_ASSETS_REPO = "ultralytics_4bands/assets"
GITHUB_ASSETS_NAMES = (
...
def delete_dsstore(path, files_to_delete=(".DS_Store", "__MACOSX")):
    ...
    Example:
        ```python
        from ultralytics_4bands.utils.downloads import delete_dsstore
...
def unzip_file(file, path=None, exclude=(".DS_Store", "__MACOSX"), exist_ok=False, progress=True):
    ...
    Example:
        ```python
        from ultralytics_4bands.utils.downloads import unzip_file
...
def safe_download(
    ...
    Example:
        ```python
        from ultralytics_4bands.utils.downloads import safe_download
...
def get_github_assets(repo="ultralytics_4bands/assets", version="latest", retry=False):
    """
    Retrieve the specified version's tag and assets from a GitHub repository. If the version is not specified, the
    function fetches the latest release assets.

    Args:
        repo (str, optional): The GitHub repository in the format 'owner/repo'. Defaults to 'ultralytics_4bands/assets'.
    ...
    Example:
        ```python
        tag, assets = get_github_assets(repo='ultralytics_4bands/assets', version='latest')
        ```
    """
...
def attempt_download_asset(file, repo="ultralytics_4bands/assets", release="v8.1.0", **kwargs):
    """
    ...
    Example:
        ```python
        file_path = attempt_download_asset('yolov5s.pt', repo='ultralytics_4bands/assets', release='latest')
        ```
    """
    from ultralytics_4bands.utils import SETTINGS  # scoped for circular import
