...
!!! abstract "Summary"
    ...
    === "<span class="doc-kind doc-kind-class">Classes</span>"
        ...
        - [`AutoBackend`](#ultralytics.nn.autobackend.AutoBackend)

    === "<span class="doc-kind doc-kind-method">Methods</span>"

        - [`AutoBackend.__getattr__`](#ultralytics.nn.autobackend.AutoBackend.__getattr__)
        - [`AutoBackend.forward`](#ultralytics.nn.autobackend.AutoBackend.forward)
        - [`AutoBackend.from_numpy`](#ultralytics.nn.autobackend.AutoBackend.from_numpy)
        - [`AutoBackend.warmup`](#ultralytics.nn.autobackend.AutoBackend.warmup)
        - [`AutoBackend._model_type`](#ultralytics.nn.autobackend.AutoBackend._model_type)
        - [`AutoBackend.eval`](#ultralytics.nn.autobackend.AutoBackend.eval)
        - [`AutoBackend._apply`](#ultralytics.nn.autobackend.AutoBackend._apply)

    === "<span class="doc-kind doc-kind-function">Functions</span>"

        - [`check_class_names`](#ultralytics.nn.autobackend.check_class_names)
        - [`default_class_names`](#ultralytics.nn.autobackend.default_class_names)


## Class `ultralytics.nn.autobackend.AutoBackend` {#ultralytics.nn.autobackend.AutoBackend}
...
| Name | Description |
| --- | --- |
| [`__getattr__`](#ultralytics.nn.autobackend.AutoBackend.__getattr__) | Delegate attribute access to the backend. |
| [`_apply`](#ultralytics.nn.autobackend.AutoBackend._apply) | Apply a function to backend.model parameters, buffers, and tensors. |
| [`_model_type`](#ultralytics.nn.autobackend.AutoBackend._model_type) | Take a path to a model file and return the model format string. |
| [`eval`](#ultralytics.nn.autobackend.AutoBackend.eval) | Set the backend model to evaluation mode if supported. |
| [`forward`](#ultralytics.nn.autobackend.AutoBackend.forward) | Run inference on an AutoBackend model. |
| [`from_numpy`](#ultralytics.nn.autobackend.AutoBackend.from_numpy) | Normalize a backend output to the model device when possible. |
| [`warmup`](#ultralytics.nn.autobackend.AutoBackend.warmup) | Warm up the model by running forward pass(es). |
...
<details>
<summary>Source code in <code>ultralytics/nn/autobackend.py</code></summary>

<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/autobackend.py#L92-L396">View on GitHub</a>
```python
...
### Method `ultralytics.nn.autobackend.AutoBackend.__getattr__` {#ultralytics.nn.autobackend.AutoBackend.\_\_getattr\_\_}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/autobackend.py#L238-L255">View on GitHub</a>
```python
def __getattr__(self, name: str) -> Any:
    """Delegate attribute access to the backend.
...
### Method `ultralytics.nn.autobackend.AutoBackend._apply` {#ultralytics.nn.autobackend.AutoBackend.\_apply}
...
This method extends the functionality of the parent class's _apply method by additionally applying the function to the backend model and updating the backend device. It's typically used for operations like moving the model to a different device or changing its precision.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/autobackend.py#L378-L396">View on GitHub</a>
```python
def _apply(self, fn) -> AutoBackend:
    """Apply a function to backend.model parameters, buffers, and tensors.
...
### Method `ultralytics.nn.autobackend.AutoBackend._model_type` {#ultralytics.nn.autobackend.AutoBackend.\_model\_type}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/autobackend.py#L333-L370">View on GitHub</a>
```python
@staticmethod
def _model_type(p: str = "path/to/model.pt", dnn: bool = False) -> str:
    """Take a path to a model file and return the model format string.
...
### Method `ultralytics.nn.autobackend.AutoBackend.eval` {#ultralytics.nn.autobackend.AutoBackend.eval}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/autobackend.py#L372-L376">View on GitHub</a>
```python
def eval(self) -> AutoBackend:
    """Set the backend model to evaluation mode if supported."""
...
### Method `ultralytics.nn.autobackend.AutoBackend.forward` {#ultralytics.nn.autobackend.AutoBackend.forward}

```python
def forward(self, im: torch.Tensor, augment: bool = False, embed: list | None = None, **kwargs: Any) -> Any
```
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/autobackend.py#L257-L293">View on GitHub</a>
```python
def forward(
    self,
    im: torch.Tensor,
...
### Method `ultralytics.nn.autobackend.AutoBackend.from_numpy` {#ultralytics.nn.autobackend.AutoBackend.from\_numpy}
...
| Name | Type | Description | Default |
| --- | --- | --- | --- |
| `x` | `Any` | Backend output to normalize. | *required* |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/autobackend.py#L295-L305">View on GitHub</a>
```python
def from_numpy(self, x: Any) -> Any:
    """Normalize a backend output to the model device when possible.
...
### Method `ultralytics.nn.autobackend.AutoBackend.warmup` {#ultralytics.nn.autobackend.AutoBackend.warmup}
...
| `im` | `torch.Tensor, optional` | Input tensor to reuse instead of allocating a dummy. | `None` |

<details>
<summary>Source code in <code>ultralytics/nn/autobackend.py</code></summary>

<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/autobackend.py#L307-L330">View on GitHub</a>
```python
def warmup(self, imgsz: tuple[int, int, int, int] = (1, 3, 640, 640), im: torch.Tensor | None = None) -> None:
    """Warm up the model by running forward pass(es).
...
## Function `ultralytics.nn.autobackend.check_class_names` {#ultralytics.nn.autobackend.check\_class\_names}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/autobackend.py#L39-L69">View on GitHub</a>
```python
def check_class_names(names: list | dict) -> dict[int, str]:
    """Check class names and convert to dict format if needed.
...
## Function `ultralytics.nn.autobackend.default_class_names` {#ultralytics.nn.autobackend.default\_class\_names}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/autobackend.py#L72-L89">View on GitHub</a>
```python
def default_class_names(data: str | Path | None = None) -> dict[int, str]:
    """Load class names from a YAML file or return numerical class names.
