...
!!! abstract "Summary"
    ...
    === "<span class="doc-kind doc-kind-function">Functions</span>"
        ...
        - [`is_url`](#ultralytics.utils.downloads.is_url)
        - [`delete_dsstore`](#ultralytics.utils.downloads.delete_dsstore)
        - [`zip_directory`](#ultralytics.utils.downloads.zip_directory)
        - [`unzip_file`](#ultralytics.utils.downloads.unzip_file)
        - [`check_disk_space`](#ultralytics.utils.downloads.check_disk_space)
        - [`get_google_drive_file_info`](#ultralytics.utils.downloads.get_google_drive_file_info)
        - [`safe_download`](#ultralytics.utils.downloads.safe_download)
        - [`get_github_assets`](#ultralytics.utils.downloads.get_github_assets)
        - [`attempt_download_asset`](#ultralytics.utils.downloads.attempt_download_asset)
        - [`download`](#ultralytics.utils.downloads.download)


## Function `ultralytics.utils.downloads.is_url` {#ultralytics.utils.downloads.is\_url}
...
<details>
<summary>Source code in <code>ultralytics/utils/downloads.py</code></summary>

<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/downloads.py#L47-L71"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def is_url(url: str | Path, check: bool = False) -> bool:
    """Validate if the given string is a URL and optionally check if the URL exists online.
...
## Function `ultralytics.utils.downloads.delete_dsstore` {#ultralytics.utils.downloads.delete\_dsstore}
...
| `files_to_delete` | `tuple[str, ...]` | The files to be deleted. | `(".DS_Store", "__MACOSX")` |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/downloads.py#L74-L93"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def delete_dsstore(path: str | Path, files_to_delete: tuple[str, ...] = (".DS_Store", "__MACOSX")) -> None:
    """Delete all specified system files in a directory.
...
## Function `ultralytics.utils.downloads.zip_directory` {#ultralytics.utils.downloads.zip\_directory}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/downloads.py#L96-L134"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def zip_directory(
    directory: str | Path,
    compress: bool = True,
...
## Function `ultralytics.utils.downloads.unzip_file` {#ultralytics.utils.downloads.unzip\_file}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/downloads.py#L137-L202"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def unzip_file(
    file: str | Path,
    path: str | Path | None = None,
...
## Function `ultralytics.utils.downloads.check_disk_space` {#ultralytics.utils.downloads.check\_disk\_space}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/downloads.py#L205-L234"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
...
## Function `ultralytics.utils.downloads.get_google_drive_file_info` {#ultralytics.utils.downloads.get\_google\_drive\_file\_info}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/downloads.py#L237-L273"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def get_google_drive_file_info(link: str) -> tuple[str, str | None]:
    """Retrieve the direct download link and filename for a shareable Google Drive file link.
...
## Function `ultralytics.utils.downloads.safe_download` {#ultralytics.utils.downloads.safe\_download}
...
| Name | Type | Description | Default |
| --- | --- | --- | --- |
| `url` | `str | Path` | The URL of the file to be downloaded. | *required* |
| `file` | `str | Path, optional` | The filename of the downloaded file. If not provided, the file will be saved with<br>    the same name as the URL. | `None` |
| `dir` | `str | Path, optional` | The directory to save the downloaded file. If not provided, the file will be saved<br>    in the current working directory. | `None` |
...
| `min_bytes` | `float, optional` | The minimum number of bytes that the downloaded file should have, to be considered<br>    a successful download. | `1e0` |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/downloads.py#L276-L387"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def safe_download(
    url: str | Path,
    file: str | Path | None = None,
...
## Function `ultralytics.utils.downloads.get_github_assets` {#ultralytics.utils.downloads.get\_github\_assets}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/downloads.py#L390-L423"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def get_github_assets(
    repo: str = "ultralytics/assets",
    version: str = "latest",
...
## Function `ultralytics.utils.downloads.attempt_download_asset` {#ultralytics.utils.downloads.attempt\_download\_asset}

```python
def attempt_download_asset(file: str | Path, repo: str = "ultralytics/assets", release: str = "v8.4.0", **kwargs) -> str
```
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/downloads.py#L426-L478"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
...
## Function `ultralytics.utils.downloads.download` {#ultralytics.utils.downloads.download}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/downloads.py#L481-L531"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def download(
    url: str | list[str] | Path,
    dir: Path = Path.cwd(),
