---
comments: true
description: Learn how to set up image classification tasks in torchvision's default folder format for your custom dataset and explore supported datasets.
---
