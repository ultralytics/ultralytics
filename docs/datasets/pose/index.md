---
comments: true
description: Learn how to format and define datasets for pose estimation in Ultralytics YOLO, and see how to port or convert label formats in this guide.
---
