...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/callbacks/comet.py#L44-L56">View on GitHub</a>
```python
def _get_comet_mode() -> str:
    """Return the Comet mode from environment variables, defaulting to 'online'."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/callbacks/comet.py#L59-L61">View on GitHub</a>
```python
def _get_comet_model_name() -> str:
    """Return the Comet model name from environment variable or default to 'Ultralytics'."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/callbacks/comet.py#L64-L66">View on GitHub</a>
```python
def _get_eval_batch_logging_interval() -> int:
    """Get the evaluation batch logging interval from environment variable or use default value 1."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/callbacks/comet.py#L69-L71">View on GitHub</a>
```python
def _get_max_image_predictions_to_log() -> int:
    """Get the maximum number of image predictions to log from environment variables."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/callbacks/comet.py#L74-L77">View on GitHub</a>
```python
def _scale_confidence_score(score: float) -> float:
    """Scale the confidence score by a factor specified in environment variable."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/callbacks/comet.py#L80-L82">View on GitHub</a>
```python
def _should_log_confusion_matrix() -> bool:
    """Determine if the confusion matrix should be logged based on environment variable settings."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/callbacks/comet.py#L85-L87">View on GitHub</a>
```python
def _should_log_image_predictions() -> bool:
    """Determine whether to log image predictions based on environment variable."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/callbacks/comet.py#L90-L122">View on GitHub</a>
```python
def _resume_or_create_experiment(args: SimpleNamespace) -> None:
    """Resume CometML experiment or create a new experiment based on args.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/callbacks/comet.py#L125-L145">View on GitHub</a>
```python
def _fetch_trainer_metadata(trainer) -> dict:
    """Return metadata for YOLO training including epoch and asset saving status.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/callbacks/comet.py#L148-L177">View on GitHub</a>
```python
def _scale_bounding_box_to_original_image_shape(
    box, resized_image_shape, original_image_shape, ratio_pad
) -> list[float]:
...
| Type | Description |
| --- | --- |
| `dict \| None` | Formatted ground truth annotations with keys 'name' and 'data', where 'data' is a list of annotation dicts each containing 'boxes', 'label', and 'score' keys. Returns None if no bounding boxes are found for the image. |

<details>
<summary>Source code in <code>ultralytics/utils/callbacks/comet.py</code></summary>

<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/callbacks/comet.py#L180-L229">View on GitHub</a>
```python
def _format_ground_truth_annotations_for_detection(img_idx, image_path, batch, class_name_map=None) -> dict | None:
    """Format ground truth annotations for object detection.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/callbacks/comet.py#L232-L281">View on GitHub</a>
```python
def _format_prediction_annotations(image_path, metadata, class_label_map=None, class_map=None) -> dict | None:
    """Format YOLO predictions for object detection visualization.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/callbacks/comet.py#L284-L301">View on GitHub</a>
```python
def _extract_segmentation_annotation(segmentation_raw: str, decode: Callable) -> list[list[Any]] | None:
    """Extract segmentation annotation from compressed segmentations as list of polygons.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/callbacks/comet.py#L304-L328">View on GitHub</a>
```python
def _fetch_annotations(img_idx, image_path, batch, prediction_metadata_map, class_label_map, class_map) -> list | None:
    """Join the ground truth and prediction annotations if they exist.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/callbacks/comet.py#L331-L338">View on GitHub</a>
```python
def _create_prediction_metadata_map(model_predictions) -> dict:
    """Create metadata map for model predictions by grouping them based on image ID."""
    pred_metadata_map = {}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/callbacks/comet.py#L341-L347">View on GitHub</a>
```python
def _log_confusion_matrix(experiment, trainer, curr_step, curr_epoch) -> None:
    """Log the confusion matrix to Comet experiment."""
...
| `annotations` | `list[list[dict]], optional` | Nested list of annotation dictionaries for each image. Each annotation contains visualization data like bounding boxes, labels, and confidence scores. | `None` |

<details>
<summary>Source code in <code>ultralytics/utils/callbacks/comet.py</code></summary>

<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/callbacks/comet.py#L350-L369">View on GitHub</a>
```python
def _log_images(experiment, image_paths, curr_step: int | None, annotations=None) -> None:
    """Log images to the experiment with optional annotations.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/callbacks/comet.py#L372-L430">View on GitHub</a>
```python
def _log_image_predictions(experiment, validator, curr_step) -> None:
    """Log image predictions to a Comet ML experiment during model validation.
...
| `trainer` | `ultralytics.engine.trainer.BaseTrainer` | The trainer object containing validation metrics and save directory information. | *required* |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/callbacks/comet.py#L433-L477">View on GitHub</a>
```python
def _log_plots(experiment, trainer) -> None:
    """Log evaluation plots and label plots for the experiment.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/callbacks/comet.py#L480-L483">View on GitHub</a>
```python
def _log_model(experiment, trainer) -> None:
    """Log the best-trained model to Comet.ml."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/callbacks/comet.py#L486-L489">View on GitHub</a>
```python
def _log_image_batches(experiment, trainer, curr_step: int) -> None:
    """Log samples of image batches for train and validation."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/callbacks/comet.py#L492-L502">View on GitHub</a>
```python
def _log_asset(experiment, asset_path) -> None:
    """Logs a specific asset file to the given experiment.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/callbacks/comet.py#L505-L514">View on GitHub</a>
```python
def _log_table(experiment, table_path) -> None:
    """Logs a table to the provided experiment.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/callbacks/comet.py#L517-L519">View on GitHub</a>
```python
def on_pretrain_routine_start(trainer) -> None:
    """Create or resume a CometML experiment at the start of a YOLO pre-training routine."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/callbacks/comet.py#L522-L532">View on GitHub</a>
```python
def on_train_epoch_end(trainer) -> None:
    """Log metrics and save batch images at the end of training epochs."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/callbacks/comet.py#L535-L576">View on GitHub</a>
```python
def on_fit_epoch_end(trainer) -> None:
    """Log model assets at the end of each epoch during training.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/callbacks/comet.py#L579-L610">View on GitHub</a>
```python
def on_train_end(trainer) -> None:
    """Perform operations at the end of training."""
    experiment = comet_ml.get_running_experiment()
