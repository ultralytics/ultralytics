...
| [Neuron](https://awsdocs-neuron.readthedocs-hosted.com)            | `neuron`          | `yolov8n-pose.neuron`          | ✅        | `imgsz`, `half`, `dynamic`                                           |
| [Neuronx](https://awsdocs-neuron.readthedocs-hosted.com)           | `neuronx`         | `yolov8n-pose.neuronx`         | ✅        | `imgsz`, `half`, `dynamic`                                           |
