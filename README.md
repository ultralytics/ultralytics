...
```bash
yolo predict model=yolov8n.pt source='https://ultralytics.com/images/bus.jpg' classes=[0,1,2,3,...] # list of classes required for inference
```
...
results = model("https://ultralytics.com/images/bus.jpg", classes=[0,1,2,..])  # predict on an image # classes->list of class IDs
