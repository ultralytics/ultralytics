...
class JSONDict(dict):
    """A base class for dictionary-like objects that persist data to a JSON file."""

    def __init__(self, file_path: Union[str, Path] = "dict.json"):
        """Initialize JSONDict from file_path JSON location."""
        super().__init__()
