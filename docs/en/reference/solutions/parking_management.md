...
!!! abstract "Summary"
    ...
    === "<span class="doc-kind doc-kind-class">Classes</span>"
        ...
        - [`ParkingPtsSelection`](#ultralytics.solutions.parking_management.ParkingPtsSelection)
        - [`ParkingManagement`](#ultralytics.solutions.parking_management.ParkingManagement)

    === "<span class="doc-kind doc-kind-method">Methods</span>"

        - [`ParkingPtsSelection.initialize_properties`](#ultralytics.solutions.parking_management.ParkingPtsSelection.initialize_properties)
        - [`ParkingPtsSelection.upload_image`](#ultralytics.solutions.parking_management.ParkingPtsSelection.upload_image)
        - [`ParkingPtsSelection.on_canvas_click`](#ultralytics.solutions.parking_management.ParkingPtsSelection.on_canvas_click)
        - [`ParkingPtsSelection.draw_box`](#ultralytics.solutions.parking_management.ParkingPtsSelection.draw_box)
        - [`ParkingPtsSelection.remove_last_bounding_box`](#ultralytics.solutions.parking_management.ParkingPtsSelection.remove_last_bounding_box)
        - [`ParkingPtsSelection.redraw_canvas`](#ultralytics.solutions.parking_management.ParkingPtsSelection.redraw_canvas)
        - [`ParkingPtsSelection.save_to_json`](#ultralytics.solutions.parking_management.ParkingPtsSelection.save_to_json)
        - [`ParkingManagement.process`](#ultralytics.solutions.parking_management.ParkingManagement.process)


## Class `ultralytics.solutions.parking_management.ParkingPtsSelection` {#ultralytics.solutions.parking\_management.ParkingPtsSelection}
...
| Name | Description |
| --- | --- |
| [`draw_box`](#ultralytics.solutions.parking_management.ParkingPtsSelection.draw_box) | Draw a bounding box on the canvas using the provided coordinates. |
| [`initialize_properties`](#ultralytics.solutions.parking_management.ParkingPtsSelection.initialize_properties) | Initialize properties for image, canvas, bounding boxes, and dimensions. |
| [`on_canvas_click`](#ultralytics.solutions.parking_management.ParkingPtsSelection.on_canvas_click) | Handle mouse clicks to add points for bounding boxes on the canvas. |
| [`redraw_canvas`](#ultralytics.solutions.parking_management.ParkingPtsSelection.redraw_canvas) | Redraw the canvas with the image and all bounding boxes. |
| [`remove_last_bounding_box`](#ultralytics.solutions.parking_management.ParkingPtsSelection.remove_last_bounding_box) | Remove the last bounding box from the list and redraw the canvas. |
| [`save_to_json`](#ultralytics.solutions.parking_management.ParkingPtsSelection.save_to_json) | Save the selected parking zone points to a JSON file with scaled coordinates. |
| [`upload_image`](#ultralytics.solutions.parking_management.ParkingPtsSelection.upload_image) | Upload and display an image on the canvas, resizing it to fit within specified dimensions. |
...
<details>
<summary>Source code in <code>ultralytics/solutions/parking_management.py</code></summary>

<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/solutions/parking_management.py#L16-L176"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
...
### Method `ultralytics.solutions.parking_management.ParkingPtsSelection.draw_box` {#ultralytics.solutions.parking\_management.ParkingPtsSelection.draw\_box}
...
| --- | --- | --- | --- |
| `box` | `list[tuple[int, int]]` |  | *required* |

<details>
<summary>Source code in <code>ultralytics/solutions/parking_management.py</code></summary>

<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/solutions/parking_management.py#L145-L148"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def draw_box(self, box: list[tuple[int, int]]) -> None:
    """Draw a bounding box on the canvas using the provided coordinates."""
    for i in range(4):
...
### Method `ultralytics.solutions.parking_management.ParkingPtsSelection.initialize_properties` {#ultralytics.solutions.parking\_management.ParkingPtsSelection.initialize\_properties}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/solutions/parking_management.py#L103-L108"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def initialize_properties(self) -> None:
    """Initialize properties for image, canvas, bounding boxes, and dimensions."""
...
### Method `ultralytics.solutions.parking_management.ParkingPtsSelection.on_canvas_click` {#ultralytics.solutions.parking\_management.ParkingPtsSelection.on\_canvas\_click}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/solutions/parking_management.py#L136-L143"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def on_canvas_click(self, event) -> None:
    """Handle mouse clicks to add points for bounding boxes on the canvas."""
...
### Method `ultralytics.solutions.parking_management.ParkingPtsSelection.redraw_canvas` {#ultralytics.solutions.parking\_management.ParkingPtsSelection.redraw\_canvas}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/solutions/parking_management.py#L158-L163"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def redraw_canvas(self) -> None:
    """Redraw the canvas with the image and all bounding boxes."""
...
### Method `ultralytics.solutions.parking_management.ParkingPtsSelection.remove_last_bounding_box` {#ultralytics.solutions.parking\_management.ParkingPtsSelection.remove\_last\_bounding\_box}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/solutions/parking_management.py#L150-L156"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def remove_last_bounding_box(self) -> None:
    """Remove the last bounding box from the list and redraw the canvas."""
    if not self.rg_data:
...
### Method `ultralytics.solutions.parking_management.ParkingPtsSelection.save_to_json` {#ultralytics.solutions.parking\_management.ParkingPtsSelection.save\_to\_json}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/solutions/parking_management.py#L165-L176"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def save_to_json(self) -> None:
    """Save the selected parking zone points to a JSON file with scaled coordinates."""
...
### Method `ultralytics.solutions.parking_management.ParkingPtsSelection.upload_image` {#ultralytics.solutions.parking\_management.ParkingPtsSelection.upload\_image}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/solutions/parking_management.py#L110-L134"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def upload_image(self) -> None:
    """Upload and display an image on the canvas, resizing it to fit within specified dimensions."""
...
## Class `ultralytics.solutions.parking_management.ParkingManagement` {#ultralytics.solutions.parking\_management.ParkingManagement}

```python
ParkingManagement(self, **kwargs: Any) -> None
```
...
| Name | Description |
| --- | --- |
| [`process`](#ultralytics.solutions.parking_management.ParkingManagement.process) | Process the input image for parking lot management and visualization. |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/solutions/parking_management.py#L179-L280"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
...
### Method `ultralytics.solutions.parking_management.ParkingManagement.process` {#ultralytics.solutions.parking\_management.ParkingManagement.process}
...
| Name | Type | Description | Default |
| --- | --- | --- | --- |
| `im0` | `np.ndarray` | The input inference image. | *required* |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/solutions/parking_management.py#L221-L280"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def process(self, im0: np.ndarray) -> SolutionResults:
    """Process the input image for parking lot management and visualization.
