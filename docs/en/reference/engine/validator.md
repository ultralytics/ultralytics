...
```python
BaseValidator(dataloader=None, save_dir=None, args=None, _callbacks: dict | None = None)
```
...
| `speed` | `dict` | Dictionary with keys 'preprocess', 'inference', 'loss', 'postprocess' and their respective batch processing times in milliseconds. |
...
| [`on_plot`](#ultralytics.engine.validator.BaseValidator.on_plot) | Register a plot by its unique path for visualization and logging. |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/validator.py#L58-L423">View on GitHub</a>
```python
class BaseValidator:
    """A base class for creating validators.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/validator.py#L405-L407">View on GitHub</a>
```python
@property
def metric_keys(self):
    """Return the metric keys used in YOLO training/validation."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/validator.py#L146-L316">View on GitHub</a>
```python
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/validator.py#L357-L359">View on GitHub</a>
```python
def add_callback(self, event: str, callback):
    """Append the given callback to the specified event."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/validator.py#L370-L372">View on GitHub</a>
```python
def build_dataset(self, img_path):
    """Build dataset from image path."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/validator.py#L422-L423">View on GitHub</a>
```python
def eval_json(self, stats):
    """Evaluate and return JSON format of prediction statistics."""
```
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/validator.py#L388-L389">View on GitHub</a>
```python
def finalize_metrics(self):
    """Finalize and return all metrics."""
```
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/validator.py#L395-L396">View on GitHub</a>
```python
def gather_stats(self):
    """Gather statistics from all the GPUs during DDP training to GPU 0."""
```
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/validator.py#L366-L368">View on GitHub</a>
```python
def get_dataloader(self, dataset_path, batch_size):
    """Get data loader from dataset path and batch size."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/validator.py#L401-L402">View on GitHub</a>
```python
def get_desc(self):
    """Get description of the YOLO model."""
```
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/validator.py#L391-L393">View on GitHub</a>
```python
def get_stats(self):
    """Return statistics about the model's performance."""
    return {}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/validator.py#L382-L383">View on GitHub</a>
```python
def init_metrics(self, model):
    """Initialize performance metrics for the YOLO model."""
```
...
| `use_scipy` | `bool, optional` | Whether to use Hungarian one-to-one matching (more precise). | `False` |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/validator.py#L318-L355">View on GitHub</a>
```python
def match_predictions(
    self, pred_classes: torch.Tensor, true_classes: torch.Tensor, iou: torch.Tensor, use_scipy: bool = False
) -> torch.Tensor:
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/validator.py#L409-L411">View on GitHub</a>
```python
def on_plot(self, name, data=None):
    """Register a plot by its unique path for visualization and logging."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/validator.py#L416-L417">View on GitHub</a>
```python
def plot_predictions(self, batch, preds, ni):
    """Plot YOLO model predictions on batch images."""
```
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/validator.py#L413-L414">View on GitHub</a>
```python
def plot_val_samples(self, batch, ni):
    """Plot validation samples during training."""
```
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/validator.py#L378-L380">View on GitHub</a>
```python
def postprocess(self, preds):
    """Postprocess the predictions."""
    return preds
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/validator.py#L419-L420">View on GitHub</a>
```python
def pred_to_json(self, preds, batch):
    """Convert predictions to JSON format."""
```
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/validator.py#L374-L376">View on GitHub</a>
```python
def preprocess(self, batch):
    """Preprocess an input batch."""
    return batch
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/validator.py#L398-L399">View on GitHub</a>
```python
def print_results(self):
    """Print the results of the model's predictions."""
```
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/validator.py#L361-L364">View on GitHub</a>
```python
def run_callbacks(self, event: str):
    """Run all callbacks associated with a specified event."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/validator.py#L385-L386">View on GitHub</a>
```python
def update_metrics(self, preds, batch):
    """Update metrics based on predictions and batch."""
```
