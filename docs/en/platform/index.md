...
| **Annotate** | Manual tools for all 6 drawable task types, plus [Smart Annotation](data/annotation.md#smart-annotation) with SAM and YOLO models for detect, segment, semantic, and OBB (see [supported task types](data/annotation.md#supported-task-types)) |
...
- **Visualize** annotations with interactive overlays for all 6 drawable YOLO task types (see [supported task types](data/annotation.md#supported-task-types))
...
- **[Annotation Editor](https://www.ultralytics.com/annotate)**: Manual annotation for all 6 drawable YOLO task types (detect, segment, semantic, classify, pose, OBB; see [supported task types](data/annotation.md#supported-task-types))
