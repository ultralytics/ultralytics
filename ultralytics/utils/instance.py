...
class Instances:
    ...
    Attributes:
        ...
        attributes (np.ndarray): Human attributes with shape (N, 5) in format (weight, height, gender, age, ethnicity).
    ...
    def __init__(
        ...
        """Initialize the Instances object with bounding boxes, segments, keypoints and human attributes.
    ...
    def update(
        ...
        Args:
            ...
            attributes (np.ndarray, optional): New human attributes.
        """
