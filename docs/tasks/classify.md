...
| [Neuron](https://awsdocs-neuron.readthedocs-hosted.com)            | `neuron`          | `yolov8n-cls.neuron`          | ✅        | `imgsz`, `half`, `dynamic`                                           |
| [Neuronx](https://awsdocs-neuron.readthedocs-hosted.com)           | `neuronx`         | `yolov8n-cls.neuronx`         | ✅        | `imgsz`, `half`, `dynamic`                                           |
