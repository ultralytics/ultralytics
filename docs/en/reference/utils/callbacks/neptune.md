...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/callbacks/neptune.py#L20-L33">View on GitHub</a>
```python
def _log_scalars(scalars: dict, step: int = 0) -> None:
    """Log scalars to the NeptuneAI experiment logger.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/callbacks/neptune.py#L36-L52">View on GitHub</a>
```python
def _log_images(imgs_dict: dict, group: str = "") -> None:
    """Log images to the NeptuneAI experiment logger.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/callbacks/neptune.py#L55-L64">View on GitHub</a>
```python
def _log_plot(title: str, plot_path: str) -> None:
    """Log plots to the NeptuneAI experiment logger."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/callbacks/neptune.py#L67-L78">View on GitHub</a>
```python
def on_pretrain_routine_start(trainer) -> None:
    """Initialize NeptuneAI run and log hyperparameters before training starts."""
    try:
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/callbacks/neptune.py#L81-L86">View on GitHub</a>
```python
def on_train_epoch_end(trainer) -> None:
    """Log training metrics and learning rate at the end of each training epoch."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/callbacks/neptune.py#L89-L95">View on GitHub</a>
```python
def on_fit_epoch_end(trainer) -> None:
    """Log model info and validation metrics at the end of each fit epoch."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/callbacks/neptune.py#L98-L102">View on GitHub</a>
```python
def on_val_end(validator) -> None:
    """Log validation images at the end of validation."""
    if run:
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/callbacks/neptune.py#L105-L113">View on GitHub</a>
```python
def on_train_end(trainer) -> None:
    """Log final results, plots, and model weights at the end of training."""
    if run:
