...
- [COCO12-Formats](coco12-formats.md): A test dataset with 12 images covering 12 image format extensions (AVIF, BMP, DNG, HEIC, JP2, JPEG, JPG, MPO, PNG, TIF, TIFF, WebP) for validating image loading pipelines.
