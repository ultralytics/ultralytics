...
def test_yolov10():
    ...
    # train/val/predict
    model.train(data="coco8.yaml", epochs=1, imgsz=32, close_mosaic=1, cache="disk", end2end=False)
    model.val(data="coco8.yaml", imgsz=32, end2end=False)
    model(SOURCE, end2end=False)
