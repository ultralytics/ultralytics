...
- Multi-Task Capabilities: Perform object detection, instance segmentation, classification, pose estimation, and [anomaly detection](../models/yoloa.md) with a unified framework.
