...
def main():
    ...
    if proximity_events:
        ...
        if 'closest_parts' in event:
            print(f"✓ Event now includes 'closest_parts' information:")
        ...
        if 'heading_analysis' in event:
            print(f"✓ Event now includes 'heading_analysis':")
        ...
        if 'ttc_seconds' in event:
            ...
            if ttc is not None:
                ...
                print(f"✓ Event now includes 'ttc_seconds': N/A (objects separating)")
    ...
    if keyframe_dir.exists():
        ...
        print(f"  - Anchor points visualization")
        print(f"  - Closest parts highlighted")
        print(f"  - Distance and part names labeled")
        print(f"  - Risk level color-coded")
        
        if keyframes:
            print(f"\n✓ Keyframes saved in: {keyframe_dir}")
            print(f"  Example: {keyframes[0].name}")
    else:
        print(f"✗ No keyframes generated (check if events were detected)")
