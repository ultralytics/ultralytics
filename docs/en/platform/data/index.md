...
- **Annotate** with manual drawing tools and Smart annotation with SAM ([SAM 2.1](../../models/sam-2.md), [SAM 3](../../models/sam-3.md), or the default [SAM 3.1](../../models/sam-3.md#sam-31)), YOLO models, or hosted vision-language models (detection datasets with 1–100 classes)
...
| **Annotate** | Label data with manual tools, or use Smart annotation with SAM (detect, segment, semantic, and OBB), YOLO, or hosted vision-language models (detection datasets with 1–100 classes) |
