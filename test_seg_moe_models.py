...
def main():
    ...
    models_to_test = [
        {
            'yaml': 'ultralytics/cfg/models/v8/yolov8-seg-p23456-moe.yaml',
            'name': 'yolov8-seg-p23456-moe'
        },
        {
            'yaml': 'ultralytics/cfg/models/v8/yolov8-seg-p23456-neck-moe.yaml',
            'name': 'yolov8-seg-p23456-neck-moe'
        }
    ]
