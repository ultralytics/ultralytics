...
from ultralytics_MB.utils.checks import check_file, check_font, is_ascii
from ultralytics_MB.utils.downloads import download, safe_download, unzip_file
from ultralytics_MB.utils.ops import segments2boxes
    ...
    def get_json(self, save=False, verbose=False):
        ...
        for split in "train", "val", "test":
            ...
            if self.task == "classify":
                ...
                from ultralytics_MB.data import YOLODataset
...
def autosplit(path=DATASETS_DIR / "coco8/images", weights=(0.9, 0.1, 0.0), annotated_only=False):
    ...
    Example:
        ```python
        from ultralytics_MB.data.utils import autosplit
