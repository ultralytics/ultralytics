...
# class ModelMeta:
    ...
    def __init_subclass__(cls, **kwargs) -> None:
        ...
        full_arg_spec = inspect.getfullargspec(ModelMeta.predict)
        cls.predict.__signature__ = inspect.signature(ModelMeta.predict)
        # cls.predict.__kwdefaults__ = inspect.signature(ModelMeta.predict).parameters
        cls.predict.__annotations__ = full_arg_spec.annotations
        cls.predict.__doc__ = ModelMeta.predict.__doc__
        cls.train.__signature__ = inspect.signature(ModelMeta.train)


class Model(nn.Module, ModelMeta):
    """
