...
!!! abstract "Summary"
    ...
    === "<span class="doc-kind doc-kind-function">Functions</span>"
        ...
        - [`_get_clones`](#ultralytics.nn.modules.utils._get_clones)
        - [`bias_init_with_prob`](#ultralytics.nn.modules.utils.bias_init_with_prob)
        - [`linear_init`](#ultralytics.nn.modules.utils.linear_init)
...
## Function `ultralytics.nn.modules.utils._get_clones` {#ultralytics.nn.modules.utils.\_get\_clones}
...
| --- | --- | --- | --- |
| `module` | `nn.Module` | The module to be cloned. | *required* |
| `n` | `int` | Number of clones to create. | *required* |
...
<details>
<summary>Source code in <code>ultralytics/nn/modules/utils.py</code></summary>

<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/modules/utils.py#L15-L32"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def _get_clones(module, n):
    """Create a list of cloned modules from the given module.
...
## Function `ultralytics.nn.modules.utils.bias_init_with_prob` {#ultralytics.nn.modules.utils.bias\_init\_with\_prob}
...
This function calculates the bias initialization value based on a prior probability using the inverse sigmoid (logit) function. It's commonly used in object detection models to initialize classification layers with a specific positive prediction probability.

**Args**

| Name | Type | Description | Default |
| --- | --- | --- | --- |
| `prior_prob` | `float, optional` | Prior probability for bias initialization. | `0.01` |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/modules/utils.py#L35-L54"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def bias_init_with_prob(prior_prob=0.01):
    """Initialize conv/fc bias value according to a given probability value.
...
## Function `ultralytics.nn.modules.utils.linear_init` {#ultralytics.nn.modules.utils.linear\_init}
...
This function initializes the weights of a linear module using a uniform distribution within bounds calculated from the output dimension. If the module has a bias, it is also initialized.

**Args**

| Name | Type | Description | Default |
| --- | --- | --- | --- |
| `module` | `nn.Module` | Linear module to initialize. | *required* |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/modules/utils.py#L57-L74"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def linear_init(module):
    """Initialize the weights and biases of a linear module.
...
## Function `ultralytics.nn.modules.utils.inverse_sigmoid` {#ultralytics.nn.modules.utils.inverse\_sigmoid}
...
| Name | Type | Description | Default |
| --- | --- | --- | --- |
| `x` | `torch.Tensor` | Input tensor with values in range [0, 1]. | *required* |
| `eps` | `float, optional` | Small epsilon value to prevent numerical instability. | `1e-5` |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/modules/utils.py#L77-L98"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def inverse_sigmoid(x, eps=1e-5):
    """Calculate the inverse sigmoid function for a tensor.
...
## Function `ultralytics.nn.modules.utils.multi_scale_deformable_attn_pytorch` {#ultralytics.nn.modules.utils.multi\_scale\_deformable\_attn\_pytorch}
...
| Name | Type | Description | Default |
| --- | --- | --- | --- |
| `value` | `torch.Tensor` | The value tensor with shape (bs, num_keys, num_heads, embed_dims). | *required* |
| `value_spatial_shapes` | `torch.Tensor` | Spatial shapes of the value tensor with shape (num_levels, 2). | *required* |
| `sampling_locations` | `torch.Tensor` | The sampling locations with shape (bs, num_queries, num_heads, num_levels,<br>    num_points, 2). | *required* |
| `attention_weights` | `torch.Tensor` | The attention weights with shape (bs, num_queries, num_heads, num_levels,<br>    num_points). | *required* |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/modules/utils.py#L101-L157"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def multi_scale_deformable_attn_pytorch(
    value: torch.Tensor,
    value_spatial_shapes: torch.Tensor,
