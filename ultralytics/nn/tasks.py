...
def parse_model(d, ch, verbose=True):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d["backbone"] + d["head"]):  # from, number, module, args
        ...
        if m in {BiFPN_Add, BiFPN_Add3}:
            ...
            c1 = ch[
                f
            ]  # Input channel dari layer sebelumnya (akan diabaikan oleh BiFPN_Add/Add3, tapi perlu untuk parse_model)
            ...
            # Jika f adalah list (multiple inputs), make in_channels_list harus dihitung dari ch[x]
            ...
            c2 = args[-1]  # out_channels adalah argument terakhir di YAML
