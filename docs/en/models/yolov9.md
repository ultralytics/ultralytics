...
!!! tip "Performance"
    ...
    === "Detection (COCO)"
        ...
        | Model                                                                                 | size<br><sup>(pixels)</sup> | mAP<sup>val<br>50-95 | mAP<sup>val<br>50 | params<br><sup>(M)</sup> | FLOPs<br><sup>(B)</sup> |
        |---------------------------------------------------------------------------------------|-----------------------|----------------------|-------------------|--------------------|-------------------|
    ...
    === "Segmentation (COCO)"
        ...
        | Model                                                                                         | size<br><sup>(pixels)</sup> | mAP<sup>box<br>50-95 | mAP<sup>mask<br>50-95 | params<br><sup>(M)</sup> | FLOPs<br><sup>(B)</sup> |
        |-----------------------------------------------------------------------------------------------|-----------------------|----------------------|-----------------------|--------------------|-------------------|
