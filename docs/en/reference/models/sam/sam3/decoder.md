...
!!! abstract "Summary"
    ...
    === "<span class="doc-kind doc-kind-class">Classes</span>"
        ...
        - [`TransformerDecoderLayer`](#ultralytics.models.sam.sam3.decoder.TransformerDecoderLayer)
        - [`TransformerDecoder`](#ultralytics.models.sam.sam3.decoder.TransformerDecoder)

    === "<span class="doc-kind doc-kind-method">Methods</span>"

        - [`TransformerDecoderLayer.with_pos_embed`](#ultralytics.models.sam.sam3.decoder.TransformerDecoderLayer.with_pos_embed)
        - [`TransformerDecoderLayer.forward_ffn`](#ultralytics.models.sam.sam3.decoder.TransformerDecoderLayer.forward_ffn)
        - [`TransformerDecoderLayer.forward`](#ultralytics.models.sam.sam3.decoder.TransformerDecoderLayer.forward)
        - [`TransformerDecoderLayer._apply_self_attention`](#ultralytics.models.sam.sam3.decoder.TransformerDecoderLayer._apply_self_attention)
        - [`TransformerDecoder._get_coords`](#ultralytics.models.sam.sam3.decoder.TransformerDecoder._get_coords)
        - [`TransformerDecoder._get_rpb_matrix`](#ultralytics.models.sam.sam3.decoder.TransformerDecoder._get_rpb_matrix)
        - [`TransformerDecoder.forward`](#ultralytics.models.sam.sam3.decoder.TransformerDecoder.forward)


## Class `ultralytics.models.sam.sam3.decoder.TransformerDecoderLayer` {#ultralytics.models.sam.sam3.decoder.TransformerDecoderLayer}
...
| `dim_feedforward` | `int` |  | *required* |
| `dropout` | `float` |  | *required* |
| `cross_attention` | `nn.Module` |  | *required* |
...
| Name | Description |
| --- | --- |
| [`_apply_self_attention`](#ultralytics.models.sam.sam3.decoder.TransformerDecoderLayer._apply_self_attention) | Apply self-attention with optional DAC splitting. |
| [`forward`](#ultralytics.models.sam.sam3.decoder.TransformerDecoderLayer.forward) | Forward pass of the TransformerDecoderLayer. |
| [`forward_ffn`](#ultralytics.models.sam.sam3.decoder.TransformerDecoderLayer.forward_ffn) | Feedforward network forward pass. |
| [`with_pos_embed`](#ultralytics.models.sam.sam3.decoder.TransformerDecoderLayer.with_pos_embed) | Add positional embedding to the tensor. |

<details>
<summary>Source code in <code>ultralytics/models/sam/sam3/decoder.py</code></summary>

<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/sam3/decoder.py#L23-L178"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
...
### Method `ultralytics.models.sam.sam3.decoder.TransformerDecoderLayer._apply_self_attention` {#ultralytics.models.sam.sam3.decoder.TransformerDecoderLayer.\_apply\_self\_attention}
...
| --- | --- | --- | --- |
| `tgt` |  |  | *required* |
| `tgt_query_pos` |  |  | *required* |
| `dac` |  |  | *required* |
| `dac_use_selfatt_ln` |  |  | *required* |
| `presence_token` |  |  | *required* |
| `self_attn_mask` |  |  | *required* |

<details>
<summary>Source code in <code>ultralytics/models/sam/sam3/decoder.py</code></summary>

<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/sam3/decoder.py#L138-L178"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def _apply_self_attention(self, tgt, tgt_query_pos, dac, dac_use_selfatt_ln, presence_token, self_attn_mask):
    """Apply self-attention with optional DAC splitting."""
...
### Method `ultralytics.models.sam.sam3.decoder.TransformerDecoderLayer.forward` {#ultralytics.models.sam.sam3.decoder.TransformerDecoderLayer.forward}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/sam3/decoder.py#L74-L136"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def forward(
    self,
    # for tgt
...
### Method `ultralytics.models.sam.sam3.decoder.TransformerDecoderLayer.forward_ffn` {#ultralytics.models.sam.sam3.decoder.TransformerDecoderLayer.forward\_ffn}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/sam3/decoder.py#L67-L72"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def forward_ffn(self, tgt):
    """Feedforward network forward pass."""
...
### Method `ultralytics.models.sam.sam3.decoder.TransformerDecoderLayer.with_pos_embed` {#ultralytics.models.sam.sam3.decoder.TransformerDecoderLayer.with\_pos\_embed}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/sam3/decoder.py#L63-L65"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
@staticmethod
def with_pos_embed(tensor, pos):
    """Add positional embedding to the tensor."""
...
## Class `ultralytics.models.sam.sam3.decoder.TransformerDecoder` {#ultralytics.models.sam.sam3.decoder.TransformerDecoder}
...
| `interaction_layer` |  |  | *required* |
| `layer` |  |  | *required* |
| `num_layers` | `int` |  | *required* |
| `num_queries` | `int` |  | *required* |
| `return_intermediate` | `bool` |  | *required* |
| `box_refine` | `bool` |  | `False` |
| `num_o2m_queries` | `int` |  | `0` |
| `dac` | `bool` |  | `False` |
| `boxRPB` | `str` |  | `"none"` |
...
| Name | Description |
| --- | --- |
| [`_get_coords`](#ultralytics.models.sam.sam3.decoder.TransformerDecoder._get_coords) | Get normalized coordinates for height and width. |
| [`_get_rpb_matrix`](#ultralytics.models.sam.sam3.decoder.TransformerDecoder._get_rpb_matrix) | Get the relative position bias (RPB) matrix for box-relative position bias. |
| [`forward`](#ultralytics.models.sam.sam3.decoder.TransformerDecoder.forward) | Forward pass of the TransformerDecoder. |

<details>
<summary>Source code in <code>ultralytics/models/sam/sam3/decoder.py</code></summary>

<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/sam3/decoder.py#L181-L546"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
...
### Method `ultralytics.models.sam.sam3.decoder.TransformerDecoder._get_coords` {#ultralytics.models.sam.sam3.decoder.TransformerDecoder.\_get\_coords}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/sam3/decoder.py#L308-L312"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
@staticmethod
def _get_coords(H, W, device, dtype):
    """Get normalized coordinates for height and width."""
...
### Method `ultralytics.models.sam.sam3.decoder.TransformerDecoder._get_rpb_matrix` {#ultralytics.models.sam.sam3.decoder.TransformerDecoder.\_get\_rpb\_matrix}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/sam3/decoder.py#L314-L374"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def _get_rpb_matrix(self, reference_boxes, feat_size):
    """Get the relative position bias (RPB) matrix for box-relative position bias."""
    H, W = feat_size
...
### Method `ultralytics.models.sam.sam3.decoder.TransformerDecoder.forward` {#ultralytics.models.sam.sam3.decoder.TransformerDecoder.forward}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/sam3/decoder.py#L376-L546"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def forward(
    self,
    tgt,
