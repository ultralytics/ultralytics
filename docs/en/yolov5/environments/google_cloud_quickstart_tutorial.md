...
1.  Navigate to the [GCP marketplace](https://console.cloud.google.com/marketplace/details/click-to-deploy-images/deeplearning?inv=1&invt=AbywUw) and select the **Deep Learning VM**.
