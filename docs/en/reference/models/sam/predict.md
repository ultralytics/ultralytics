...
!!! abstract "Summary"
    ...
    === "<span class="doc-kind doc-kind-class">Classes</span>"
        ...
        - [`Predictor`](#ultralytics.models.sam.predict.Predictor)
        - [`SAM2Predictor`](#ultralytics.models.sam.predict.SAM2Predictor)
        - [`SAM2VideoPredictor`](#ultralytics.models.sam.predict.SAM2VideoPredictor)
        - [`SAM2DynamicInteractivePredictor`](#ultralytics.models.sam.predict.SAM2DynamicInteractivePredictor)
        - [`SAM3Predictor`](#ultralytics.models.sam.predict.SAM3Predictor)
        - [`SAM3SemanticPredictor`](#ultralytics.models.sam.predict.SAM3SemanticPredictor)
        - [`SAM3VideoPredictor`](#ultralytics.models.sam.predict.SAM3VideoPredictor)
        - [`SAM3VideoSemanticPredictor`](#ultralytics.models.sam.predict.SAM3VideoSemanticPredictor)

    === "<span class="doc-kind doc-kind-method">Methods</span>"

        - [`Predictor.preprocess`](#ultralytics.models.sam.predict.Predictor.preprocess)
        - [`Predictor.pre_transform`](#ultralytics.models.sam.predict.Predictor.pre_transform)
        - [`Predictor.inference`](#ultralytics.models.sam.predict.Predictor.inference)
        - [`Predictor.prompt_inference`](#ultralytics.models.sam.predict.Predictor.prompt_inference)
        - [`Predictor._inference_features`](#ultralytics.models.sam.predict.Predictor._inference_features)
        - [`Predictor._prepare_prompts`](#ultralytics.models.sam.predict.Predictor._prepare_prompts)
        - [`Predictor.generate`](#ultralytics.models.sam.predict.Predictor.generate)
        - [`Predictor.setup_model`](#ultralytics.models.sam.predict.Predictor.setup_model)
        - [`Predictor.get_model`](#ultralytics.models.sam.predict.Predictor.get_model)
        - [`Predictor.postprocess`](#ultralytics.models.sam.predict.Predictor.postprocess)
        - [`Predictor.set_image`](#ultralytics.models.sam.predict.Predictor.set_image)
        - [`Predictor.setup_source`](#ultralytics.models.sam.predict.Predictor.setup_source)
        - [`Predictor.get_im_features`](#ultralytics.models.sam.predict.Predictor.get_im_features)
        - [`Predictor.set_prompts`](#ultralytics.models.sam.predict.Predictor.set_prompts)
        - [`Predictor.reset_image`](#ultralytics.models.sam.predict.Predictor.reset_image)
        - [`Predictor.remove_small_regions`](#ultralytics.models.sam.predict.Predictor.remove_small_regions)
        - [`Predictor.inference_features`](#ultralytics.models.sam.predict.Predictor.inference_features)
        - [`SAM2Predictor.get_model`](#ultralytics.models.sam.predict.SAM2Predictor.get_model)
        - [`SAM2Predictor._prepare_prompts`](#ultralytics.models.sam.predict.SAM2Predictor._prepare_prompts)
        - [`SAM2Predictor.setup_source`](#ultralytics.models.sam.predict.SAM2Predictor.setup_source)
        - [`SAM2Predictor.get_im_features`](#ultralytics.models.sam.predict.SAM2Predictor.get_im_features)
        - [`SAM2Predictor._inference_features`](#ultralytics.models.sam.predict.SAM2Predictor._inference_features)
        - [`SAM2VideoPredictor.get_model`](#ultralytics.models.sam.predict.SAM2VideoPredictor.get_model)
        - [`SAM2VideoPredictor.inference`](#ultralytics.models.sam.predict.SAM2VideoPredictor.inference)
        - [`SAM2VideoPredictor.postprocess`](#ultralytics.models.sam.predict.SAM2VideoPredictor.postprocess)
        - [`SAM2VideoPredictor.add_new_prompts`](#ultralytics.models.sam.predict.SAM2VideoPredictor.add_new_prompts)
        - [`SAM2VideoPredictor.propagate_in_video_preflight`](#ultralytics.models.sam.predict.SAM2VideoPredictor.propagate_in_video_preflight)
        - [`SAM2VideoPredictor.init_state`](#ultralytics.models.sam.predict.SAM2VideoPredictor.init_state)
        - [`SAM2VideoPredictor._init_state`](#ultralytics.models.sam.predict.SAM2VideoPredictor._init_state)
        - [`SAM2VideoPredictor.get_im_features`](#ultralytics.models.sam.predict.SAM2VideoPredictor.get_im_features)
        - [`SAM2VideoPredictor._obj_id_to_idx`](#ultralytics.models.sam.predict.SAM2VideoPredictor._obj_id_to_idx)
        - [`SAM2VideoPredictor._run_single_frame_inference`](#ultralytics.models.sam.predict.SAM2VideoPredictor._run_single_frame_inference)
        - [`SAM2VideoPredictor._get_maskmem_pos_enc`](#ultralytics.models.sam.predict.SAM2VideoPredictor._get_maskmem_pos_enc)
        - [`SAM2VideoPredictor._consolidate_temp_output_across_obj`](#ultralytics.models.sam.predict.SAM2VideoPredictor._consolidate_temp_output_across_obj)
        - [`SAM2VideoPredictor._get_empty_mask_ptr`](#ultralytics.models.sam.predict.SAM2VideoPredictor._get_empty_mask_ptr)
        - [`SAM2VideoPredictor._run_memory_encoder`](#ultralytics.models.sam.predict.SAM2VideoPredictor._run_memory_encoder)
        - [`SAM2VideoPredictor._add_output_per_object`](#ultralytics.models.sam.predict.SAM2VideoPredictor._add_output_per_object)
        - [`SAM2VideoPredictor._clear_non_cond_mem_around_input`](#ultralytics.models.sam.predict.SAM2VideoPredictor._clear_non_cond_mem_around_input)
        - [`SAM2VideoPredictor.remove_object`](#ultralytics.models.sam.predict.SAM2VideoPredictor.remove_object)
        - [`SAM2VideoPredictor.clear_all_points_in_frame`](#ultralytics.models.sam.predict.SAM2VideoPredictor.clear_all_points_in_frame)
        - [`SAM2VideoPredictor.clear_all_points_in_video`](#ultralytics.models.sam.predict.SAM2VideoPredictor.clear_all_points_in_video)
        - [`SAM2VideoPredictor._reset_tracking_results`](#ultralytics.models.sam.predict.SAM2VideoPredictor._reset_tracking_results)
        - [`SAM2VideoPredictor._prune_non_cond_memory`](#ultralytics.models.sam.predict.SAM2VideoPredictor._prune_non_cond_memory)
        - [`SAM2DynamicInteractivePredictor.inference`](#ultralytics.models.sam.predict.SAM2DynamicInteractivePredictor.inference)
        - [`SAM2DynamicInteractivePredictor.get_im_features`](#ultralytics.models.sam.predict.SAM2DynamicInteractivePredictor.get_im_features)
        - [`SAM2DynamicInteractivePredictor.update_memory`](#ultralytics.models.sam.predict.SAM2DynamicInteractivePredictor.update_memory)
        - [`SAM2DynamicInteractivePredictor._prepare_memory_conditioned_features`](#ultralytics.models.sam.predict.SAM2DynamicInteractivePredictor._prepare_memory_conditioned_features)
        - [`SAM2DynamicInteractivePredictor.get_maskmem_enc`](#ultralytics.models.sam.predict.SAM2DynamicInteractivePredictor.get_maskmem_enc)
        - [`SAM2DynamicInteractivePredictor._obj_id_to_idx`](#ultralytics.models.sam.predict.SAM2DynamicInteractivePredictor._obj_id_to_idx)
        - [`SAM2DynamicInteractivePredictor.track_step`](#ultralytics.models.sam.predict.SAM2DynamicInteractivePredictor.track_step)
        - [`SAM3Predictor.setup_model`](#ultralytics.models.sam.predict.SAM3Predictor.setup_model)
        - [`SAM3Predictor.get_model`](#ultralytics.models.sam.predict.SAM3Predictor.get_model)
        - [`SAM3SemanticPredictor.get_model`](#ultralytics.models.sam.predict.SAM3SemanticPredictor.get_model)
        - [`SAM3SemanticPredictor.get_im_features`](#ultralytics.models.sam.predict.SAM3SemanticPredictor.get_im_features)
        - [`SAM3SemanticPredictor.pre_transform`](#ultralytics.models.sam.predict.SAM3SemanticPredictor.pre_transform)
        - [`SAM3SemanticPredictor._prepare_geometric_prompts`](#ultralytics.models.sam.predict.SAM3SemanticPredictor._prepare_geometric_prompts)
        - [`SAM3SemanticPredictor._inference_features`](#ultralytics.models.sam.predict.SAM3SemanticPredictor._inference_features)
        - [`SAM3SemanticPredictor.postprocess`](#ultralytics.models.sam.predict.SAM3SemanticPredictor.postprocess)
        - [`SAM3SemanticPredictor.inference`](#ultralytics.models.sam.predict.SAM3SemanticPredictor.inference)
        - [`SAM3SemanticPredictor.inference_features`](#ultralytics.models.sam.predict.SAM3SemanticPredictor.inference_features)
        - [`SAM3SemanticPredictor.reset_prompts`](#ultralytics.models.sam.predict.SAM3SemanticPredictor.reset_prompts)
        - [`SAM3SemanticPredictor._get_dummy_prompt`](#ultralytics.models.sam.predict.SAM3SemanticPredictor._get_dummy_prompt)
        - [`SAM3VideoPredictor.propagate_in_video`](#ultralytics.models.sam.predict.SAM3VideoPredictor.propagate_in_video)
        - [`SAM3VideoSemanticPredictor.setup_model`](#ultralytics.models.sam.predict.SAM3VideoSemanticPredictor.setup_model)
        - [`SAM3VideoSemanticPredictor.setup_source`](#ultralytics.models.sam.predict.SAM3VideoSemanticPredictor.setup_source)
        - [`SAM3VideoSemanticPredictor.init_state`](#ultralytics.models.sam.predict.SAM3VideoSemanticPredictor.init_state)
        - [`SAM3VideoSemanticPredictor.inference`](#ultralytics.models.sam.predict.SAM3VideoSemanticPredictor.inference)
        - [`SAM3VideoSemanticPredictor.postprocess`](#ultralytics.models.sam.predict.SAM3VideoSemanticPredictor.postprocess)
        - [`SAM3VideoSemanticPredictor._run_single_frame_inference`](#ultralytics.models.sam.predict.SAM3VideoSemanticPredictor._run_single_frame_inference)
        - [`SAM3VideoSemanticPredictor.add_prompt`](#ultralytics.models.sam.predict.SAM3VideoSemanticPredictor.add_prompt)
        - [`SAM3VideoSemanticPredictor._apply_object_wise_non_overlapping_constraints`](#ultralytics.models.sam.predict.SAM3VideoSemanticPredictor._apply_object_wise_non_overlapping_constraints)
        - [`SAM3VideoSemanticPredictor._det_track_one_frame`](#ultralytics.models.sam.predict.SAM3VideoSemanticPredictor._det_track_one_frame)
        - [`SAM3VideoSemanticPredictor._suppress_detections_close_to_boundary`](#ultralytics.models.sam.predict.SAM3VideoSemanticPredictor._suppress_detections_close_to_boundary)
        - [`SAM3VideoSemanticPredictor.run_backbone_and_detection`](#ultralytics.models.sam.predict.SAM3VideoSemanticPredictor.run_backbone_and_detection)
        - [`SAM3VideoSemanticPredictor._extract_detection_outputs`](#ultralytics.models.sam.predict.SAM3VideoSemanticPredictor._extract_detection_outputs)
        - [`SAM3VideoSemanticPredictor._cache_backbone_features`](#ultralytics.models.sam.predict.SAM3VideoSemanticPredictor._cache_backbone_features)
        - [`SAM3VideoSemanticPredictor.run_tracker_propagation`](#ultralytics.models.sam.predict.SAM3VideoSemanticPredictor.run_tracker_propagation)
        - [`SAM3VideoSemanticPredictor._recondition_masklets`](#ultralytics.models.sam.predict.SAM3VideoSemanticPredictor._recondition_masklets)
        - [`SAM3VideoSemanticPredictor.run_tracker_update_planning_phase`](#ultralytics.models.sam.predict.SAM3VideoSemanticPredictor.run_tracker_update_planning_phase)
        - [`SAM3VideoSemanticPredictor._suppress_overlapping_based_on_recent_occlusion`](#ultralytics.models.sam.predict.SAM3VideoSemanticPredictor._suppress_overlapping_based_on_recent_occlusion)
        - [`SAM3VideoSemanticPredictor.run_tracker_update_execution_phase`](#ultralytics.models.sam.predict.SAM3VideoSemanticPredictor.run_tracker_update_execution_phase)
        - [`SAM3VideoSemanticPredictor.build_outputs`](#ultralytics.models.sam.predict.SAM3VideoSemanticPredictor.build_outputs)
        - [`SAM3VideoSemanticPredictor._propogate_tracker_one_frame_local_gpu`](#ultralytics.models.sam.predict.SAM3VideoSemanticPredictor._propogate_tracker_one_frame_local_gpu)
        - [`SAM3VideoSemanticPredictor._associate_det_trk`](#ultralytics.models.sam.predict.SAM3VideoSemanticPredictor._associate_det_trk)
        - [`SAM3VideoSemanticPredictor._process_hotstart`](#ultralytics.models.sam.predict.SAM3VideoSemanticPredictor._process_hotstart)
        - [`SAM3VideoSemanticPredictor._tracker_update_memories`](#ultralytics.models.sam.predict.SAM3VideoSemanticPredictor._tracker_update_memories)
        - [`SAM3VideoSemanticPredictor._tracker_add_new_objects`](#ultralytics.models.sam.predict.SAM3VideoSemanticPredictor._tracker_add_new_objects)
        - [`SAM3VideoSemanticPredictor._tracker_remove_objects`](#ultralytics.models.sam.predict.SAM3VideoSemanticPredictor._tracker_remove_objects)
        - [`SAM3VideoSemanticPredictor._initialize_metadata`](#ultralytics.models.sam.predict.SAM3VideoSemanticPredictor._initialize_metadata)
        - [`SAM3VideoSemanticPredictor.update_masklet_confirmation_status`](#ultralytics.models.sam.predict.SAM3VideoSemanticPredictor.update_masklet_confirmation_status)
        - [`SAM3VideoSemanticPredictor._drop_new_det_with_obj_limit`](#ultralytics.models.sam.predict.SAM3VideoSemanticPredictor._drop_new_det_with_obj_limit)
...
| Name | Description |
| --- | --- |
| [`_inference_features`](#ultralytics.models.sam.predict.Predictor._inference_features) | Perform inference on image features using the SAM model. |
| [`_prepare_prompts`](#ultralytics.models.sam.predict.Predictor._prepare_prompts) | Prepare and transform the input prompts for processing based on the destination shape. |
| [`generate`](#ultralytics.models.sam.predict.Predictor.generate) | Perform image segmentation using the Segment Anything Model (SAM). |
| [`get_im_features`](#ultralytics.models.sam.predict.Predictor.get_im_features) | Extract image features using the SAM model's image encoder for subsequent mask prediction. |
| [`get_model`](#ultralytics.models.sam.predict.Predictor.get_model) | Retrieve or build the Segment Anything Model (SAM) for image segmentation tasks. |
| [`inference`](#ultralytics.models.sam.predict.Predictor.inference) | Perform image segmentation inference based on the given input cues, using the currently loaded image. |
| [`inference_features`](#ultralytics.models.sam.predict.Predictor.inference_features) | Perform prompts preprocessing and inference on provided image features using the SAM model. |
| [`postprocess`](#ultralytics.models.sam.predict.Predictor.postprocess) | Post-process SAM's inference outputs to generate object detection masks and bounding boxes. |
| [`pre_transform`](#ultralytics.models.sam.predict.Predictor.pre_transform) | Perform initial transformations on the input image for preprocessing. |
| [`preprocess`](#ultralytics.models.sam.predict.Predictor.preprocess) | Preprocess the input image for model inference. |
| [`prompt_inference`](#ultralytics.models.sam.predict.Predictor.prompt_inference) | Perform image segmentation inference based on input cues using SAM's specialized architecture. |
| [`remove_small_regions`](#ultralytics.models.sam.predict.Predictor.remove_small_regions) | Remove small disconnected regions and holes from segmentation masks. |
| [`reset_image`](#ultralytics.models.sam.predict.Predictor.reset_image) | Reset the current image and its features, clearing them for subsequent inference. |
| [`set_image`](#ultralytics.models.sam.predict.Predictor.set_image) | Preprocess and set a single image for inference. |
| [`set_prompts`](#ultralytics.models.sam.predict.Predictor.set_prompts) | Set prompts for subsequent inference operations. |
| [`setup_model`](#ultralytics.models.sam.predict.Predictor.setup_model) | Initialize the Segment Anything Model (SAM) for inference. |
| [`setup_source`](#ultralytics.models.sam.predict.Predictor.setup_source) | Set up the data source for SAM inference. |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L43-L682"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
...
### Method `ultralytics.models.sam.predict.Predictor._inference_features` {#ultralytics.models.sam.predict.Predictor.\_inference\_features}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L238-L276"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def _inference_features(
    self,
    features,
...
### Method `ultralytics.models.sam.predict.Predictor._prepare_prompts` {#ultralytics.models.sam.predict.Predictor.\_prepare\_prompts}
...
| `points` | `np.ndarray | list | None` | Points indicating object locations with shape (N, 2) or (N, num_points,<br>    2), in pixels. | `None` |
| `labels` | `np.ndarray | list | None` | Point prompt labels with shape (N) or (N, num_points). 1 for foreground,<br>    0 for background. | `None` |
| `masks` | `list[np.ndarray] | np.ndarray | None` | Masks for the objects, where each mask is a 2D array with<br>    shape (H, W). | `None` |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L278-L327"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def _prepare_prompts(self, dst_shape, src_shape, bboxes=None, points=None, labels=None, masks=None):
    """Prepare and transform the input prompts for processing based on the destination shape.
...
### Method `ultralytics.models.sam.predict.Predictor.generate` {#ultralytics.models.sam.predict.Predictor.generate}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L329-L438"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def generate(
    self,
    im,
...
### Method `ultralytics.models.sam.predict.Predictor.get_im_features` {#ultralytics.models.sam.predict.Predictor.get\_im\_features}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L572-L574"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def get_im_features(self, im):
    """Extract image features using the SAM model's image encoder for subsequent mask prediction."""
...
### Method `ultralytics.models.sam.predict.Predictor.get_model` {#ultralytics.models.sam.predict.Predictor.get\_model}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L472-L476"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def get_model(self):
    """Retrieve or build the Segment Anything Model (SAM) for image segmentation tasks."""
...
### Method `ultralytics.models.sam.predict.Predictor.inference` {#ultralytics.models.sam.predict.Predictor.inference}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L169-L205"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def inference(self, im, bboxes=None, points=None, labels=None, masks=None, multimask_output=False, *args, **kwargs):
    """Perform image segmentation inference based on the given input cues, using the currently loaded image.
...
### Method `ultralytics.models.sam.predict.Predictor.inference_features` {#ultralytics.models.sam.predict.Predictor.inference\_features}
...
| `src_shape` | `tuple[int, int]` | The source shape (height, width) of the input image. | *required* |
| `dst_shape` | `tuple[int, int] | None` | The target shape (height, width) for the prompts. If None, defaults to<br>    (imgsz, imgsz). | `None` |
| `bboxes` | `np.ndarray | list[list[float]] | None` | Bounding boxes in xyxy format with shape (N, 4). | `None` |
| `points` | `np.ndarray | list[list[float]] | None` | Points indicating object locations with shape (N, 2), in<br>    pixels. | `None` |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L637-L682"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
...
### Method `ultralytics.models.sam.predict.Predictor.postprocess` {#ultralytics.models.sam.predict.Predictor.postprocess}
...
| Name | Type | Description | Default |
| --- | --- | --- | --- |
| `preds` | `tuple` | The output from SAM model inference, containing:<br>    - pred_masks (torch.Tensor): Predicted masks with shape (N, 1, H, W).<br>    - pred_scores (torch.Tensor): Confidence scores for each mask with shape (N, 1).<br>    - pred_bboxes (torch.Tensor, optional): Predicted bounding boxes if segment_all is True. | *required* |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L478-L528"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def postprocess(self, preds, img, orig_imgs):
    """Post-process SAM's inference outputs to generate object detection masks and bounding boxes.
...
### Method `ultralytics.models.sam.predict.Predictor.pre_transform` {#ultralytics.models.sam.predict.Predictor.pre\_transform}
...
| Name | Type | Description | Default |
| --- | --- | --- | --- |
| `im` | `list[np.ndarray]` | List containing a single image in HWC numpy array format. | *required* |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L143-L167"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def pre_transform(self, im):
    """Perform initial transformations on the input image for preprocessing.
...
### Method `ultralytics.models.sam.predict.Predictor.preprocess` {#ultralytics.models.sam.predict.Predictor.preprocess}
...
| Name | Type | Description | Default |
| --- | --- | --- | --- |
| `im` | `torch.Tensor | list[np.ndarray]` | Input image(s) in BCHW tensor format or a list of HWC NumPy arrays.<br>    NumPy arrays are expected to be in BGR order (as returned by OpenCV) and will be converted to RGB. | *required* |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L109-L141"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def preprocess(self, im):
    """Preprocess the input image for model inference.
...
### Method `ultralytics.models.sam.predict.Predictor.prompt_inference` {#ultralytics.models.sam.predict.Predictor.prompt\_inference}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L207-L236"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def prompt_inference(self, im, bboxes=None, points=None, labels=None, masks=None, multimask_output=False):
    """Perform image segmentation inference based on input cues using SAM's specialized architecture.
...
### Method `ultralytics.models.sam.predict.Predictor.remove_small_regions` {#ultralytics.models.sam.predict.Predictor.remove\_small\_regions}
...
| Name | Type | Description | Default |
| --- | --- | --- | --- |
| `masks` | `torch.Tensor` | Segmentation masks to be processed, with shape (N, H, W) where N is the number of<br>    masks, H is height, and W is width. | *required* |
| `min_area` | `int` | Minimum area threshold for removing disconnected regions and holes. Regions smaller than<br>    this will be removed. | `0` |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L586-L634"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
@staticmethod
def remove_small_regions(masks, min_area=0, nms_thresh=0.7):
    """Remove small disconnected regions and holes from segmentation masks.
...
### Method `ultralytics.models.sam.predict.Predictor.reset_image` {#ultralytics.models.sam.predict.Predictor.reset\_image}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L580-L583"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def reset_image(self):
    """Reset the current image and its features, clearing them for subsequent inference."""
    self.im = None
...
### Method `ultralytics.models.sam.predict.Predictor.set_image` {#ultralytics.models.sam.predict.Predictor.set\_image}
...
| Name | Type | Description | Default |
| --- | --- | --- | --- |
| `image` | `str | np.ndarray` | Path to the image file as a string, or a numpy array representing an image read by<br>    cv2 (BGR channel order). | *required* |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L530-L560"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def set_image(self, image):
    """Preprocess and set a single image for inference.
...
### Method `ultralytics.models.sam.predict.Predictor.set_prompts` {#ultralytics.models.sam.predict.Predictor.set\_prompts}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L576-L578"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def set_prompts(self, prompts):
    """Set prompts for subsequent inference operations."""
...
### Method `ultralytics.models.sam.predict.Predictor.setup_model` {#ultralytics.models.sam.predict.Predictor.setup\_model}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L440-L470"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def setup_model(self, model=None, verbose=True):
    """Initialize the Segment Anything Model (SAM) for inference.
...
### Method `ultralytics.models.sam.predict.Predictor.setup_source` {#ultralytics.models.sam.predict.Predictor.setup\_source}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L562-L570"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def setup_source(self, source):
    """Set up the data source for SAM inference."""
...
## Class `ultralytics.models.sam.predict.SAM2Predictor` {#ultralytics.models.sam.predict.SAM2Predictor}
...
| Name | Description |
| --- | --- |
| [`_inference_features`](#ultralytics.models.sam.predict.SAM2Predictor._inference_features) | Perform inference on image features using the SAM2 model. |
| [`_prepare_prompts`](#ultralytics.models.sam.predict.SAM2Predictor._prepare_prompts) | Prepare and transform the input prompts for processing based on the destination shape. |
| [`get_im_features`](#ultralytics.models.sam.predict.SAM2Predictor.get_im_features) | Extract image features from the SAM image encoder for subsequent processing. |
| [`get_model`](#ultralytics.models.sam.predict.SAM2Predictor.get_model) | Retrieve and initialize the Segment Anything Model 2 (SAM2) for image segmentation tasks. |
| [`setup_source`](#ultralytics.models.sam.predict.SAM2Predictor.setup_source) | Set up the data source and image size for SAM2 inference. |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L685-L825"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
...
### Method `ultralytics.models.sam.predict.SAM2Predictor._inference_features` {#ultralytics.models.sam.predict.SAM2Predictor.\_inference\_features}
...
| Name | Type | Description | Default |
| --- | --- | --- | --- |
| `features` | `torch.Tensor | dict[str, Any]` | Extracted image features with shape (B, C, H, W) from the SAM2 | *required* |
...
| `masks` | `list[np.ndarray] | np.ndarray | None` | Masks for the objects, where each mask is a 2D array. | `None` |
| `multimask_output` | `bool` | Flag to return multiple masks for ambiguous prompts. | `False` |
| `img_idx` | `int` | Index of the image in the batch to process. | `-1` |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L776-L825"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def _inference_features(
    self,
    features,
...
### Method `ultralytics.models.sam.predict.SAM2Predictor._prepare_prompts` {#ultralytics.models.sam.predict.SAM2Predictor.\_prepare\_prompts}
...
| `points` | `np.ndarray | list | None` | Points indicating object locations with shape (N, 2) or (N, num_points,<br>    2), in pixels. | `None` |
| `labels` | `np.ndarray | list | None` | Point prompt labels with shape (N,) or (N, num_points). 1 for foreground,<br>    0 for background. | `None` |
| `masks` | `list | np.ndarray | None` | Masks for the objects, where each mask is a 2D array. | `None` |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L726-L758"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def _prepare_prompts(self, dst_shape, src_shape, bboxes=None, points=None, labels=None, masks=None):
    """Prepare and transform the input prompts for processing based on the destination shape.
...
### Method `ultralytics.models.sam.predict.SAM2Predictor.get_im_features` {#ultralytics.models.sam.predict.SAM2Predictor.get\_im\_features}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L765-L774"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def get_im_features(self, im):
    """Extract image features from the SAM image encoder for subsequent processing."""
...
### Method `ultralytics.models.sam.predict.SAM2Predictor.get_model` {#ultralytics.models.sam.predict.SAM2Predictor.get\_model}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L720-L724"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def get_model(self):
    """Retrieve and initialize the Segment Anything Model 2 (SAM2) for image segmentation tasks."""
    from .build import build_sam  # slow import
...
### Method `ultralytics.models.sam.predict.SAM2Predictor.setup_source` {#ultralytics.models.sam.predict.SAM2Predictor.setup\_source}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L760-L763"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def setup_source(self, source):
    """Set up the data source and image size for SAM2 inference."""
...
| `clear_non_cond_mem_for_multi_obj` | `bool` | A flag to control clearing non-conditional memory for multi-object<br>    scenarios. |
...
| Name | Description |
| --- | --- |
| [`_add_output_per_object`](#ultralytics.models.sam.predict.SAM2VideoPredictor._add_output_per_object) | Split a multi-object output into per-object output slices and add them into Output_Dict_Per_Obj. |
| [`_clear_non_cond_mem_around_input`](#ultralytics.models.sam.predict.SAM2VideoPredictor._clear_non_cond_mem_around_input) | Remove the non-conditioning memory around the input frame. |
| [`_consolidate_temp_output_across_obj`](#ultralytics.models.sam.predict.SAM2VideoPredictor._consolidate_temp_output_across_obj) | Consolidate per-object temporary outputs into a single output for all objects. |
| [`_get_empty_mask_ptr`](#ultralytics.models.sam.predict.SAM2VideoPredictor._get_empty_mask_ptr) | Get a dummy object pointer based on an empty mask on the current frame. |
| [`_get_maskmem_pos_enc`](#ultralytics.models.sam.predict.SAM2VideoPredictor._get_maskmem_pos_enc) | Cache and manage the positional encoding for mask memory across frames and objects. |
| [`_init_state`](#ultralytics.models.sam.predict.SAM2VideoPredictor._init_state) | Initialize an inference state. |
| [`_obj_id_to_idx`](#ultralytics.models.sam.predict.SAM2VideoPredictor._obj_id_to_idx) | Map client-side object id to model-side object index. |
| [`_prune_non_cond_memory`](#ultralytics.models.sam.predict.SAM2VideoPredictor._prune_non_cond_memory) | Prune old non-conditioning frames to bound memory usage. |
| [`_reset_tracking_results`](#ultralytics.models.sam.predict.SAM2VideoPredictor._reset_tracking_results) | Reset all tracking inputs and results across the videos. |
| [`_run_memory_encoder`](#ultralytics.models.sam.predict.SAM2VideoPredictor._run_memory_encoder) | Run the memory encoder on masks. |
| [`_run_single_frame_inference`](#ultralytics.models.sam.predict.SAM2VideoPredictor._run_single_frame_inference) | Run tracking on a single frame based on current inputs and previous memory. |
| [`add_new_prompts`](#ultralytics.models.sam.predict.SAM2VideoPredictor.add_new_prompts) | Add new points or masks to a specific frame for a given object ID. |
| [`clear_all_points_in_frame`](#ultralytics.models.sam.predict.SAM2VideoPredictor.clear_all_points_in_frame) | Remove all input points or mask in a specific frame for a given object. |
| [`clear_all_points_in_video`](#ultralytics.models.sam.predict.SAM2VideoPredictor.clear_all_points_in_video) | Remove all input points or mask in all frames throughout the video. |
| [`get_im_features`](#ultralytics.models.sam.predict.SAM2VideoPredictor.get_im_features) | Extract and process image features using SAM2's image encoder for subsequent segmentation tasks. |
| [`get_model`](#ultralytics.models.sam.predict.SAM2VideoPredictor.get_model) | Retrieve and configure the model with binarization enabled. |
| [`inference`](#ultralytics.models.sam.predict.SAM2VideoPredictor.inference) | Perform image segmentation inference based on the given input cues, using the currently loaded image. This |
| [`init_state`](#ultralytics.models.sam.predict.SAM2VideoPredictor.init_state) | Initialize an inference state for the predictor. |
| [`postprocess`](#ultralytics.models.sam.predict.SAM2VideoPredictor.postprocess) | Post-process the predictions to apply non-overlapping constraints if required. |
| [`propagate_in_video_preflight`](#ultralytics.models.sam.predict.SAM2VideoPredictor.propagate_in_video_preflight) | Prepare inference_state and consolidate temporary outputs before tracking. |
| [`remove_object`](#ultralytics.models.sam.predict.SAM2VideoPredictor.remove_object) | Remove an object id from the tracking state. If strict is True, we check whether the object id actually |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L828-L1853"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
...
### Method `ultralytics.models.sam.predict.SAM2VideoPredictor._add_output_per_object` {#ultralytics.models.sam.predict.SAM2VideoPredictor.\_add\_output\_per\_object}
...
| `inference_state` | `dict[str, Any], optional` | The current inference state. If None, uses the instance's<br>    inference state. | `None` |
...
### Method `ultralytics.models.sam.predict.SAM2VideoPredictor._clear_non_cond_mem_around_input` {#ultralytics.models.sam.predict.SAM2VideoPredictor.\_clear\_non\_cond\_mem\_around\_input}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L1652-L1672"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def _clear_non_cond_mem_around_input(self, frame_idx, inference_state: dict[str, Any] | None = None):
    """Remove the non-conditioning memory around the input frame.
...
### Method `ultralytics.models.sam.predict.SAM2VideoPredictor._consolidate_temp_output_across_obj` {#ultralytics.models.sam.predict.SAM2VideoPredictor.\_consolidate\_temp\_output\_across\_obj}
...
| `run_mem_encoder` | `bool, optional` | Specifies whether to run the memory encoder after consolidating the<br>    outputs. | `False` |
| `inference_state` | `dict[str, Any], optional` | The current inference state. If None, uses the instance's<br>    inference state. | `None` |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L1431-L1540"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def _consolidate_temp_output_across_obj(
    self,
    frame_idx,
...
### Method `ultralytics.models.sam.predict.SAM2VideoPredictor._get_empty_mask_ptr` {#ultralytics.models.sam.predict.SAM2VideoPredictor.\_get\_empty\_mask\_ptr}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L1542-L1573"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def _get_empty_mask_ptr(self, frame_idx, inference_state: dict[str, Any] | None = None):
    """Get a dummy object pointer based on an empty mask on the current frame.
...
### Method `ultralytics.models.sam.predict.SAM2VideoPredictor._get_maskmem_pos_enc` {#ultralytics.models.sam.predict.SAM2VideoPredictor.\_get\_maskmem\_pos\_enc}
...
| Name | Type | Description | Default |
| --- | --- | --- | --- |
| `out_maskmem_pos_enc` | `list[torch.Tensor] | None` | The positional encoding for mask memory. Should be a list<br>    of tensors or None. | *required* |
| `inference_state` | `dict[str, Any], optional` | The current inference state. If None, uses the instance's<br>    inference state. | `None` |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L1390-L1429"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def _get_maskmem_pos_enc(self, out_maskmem_pos_enc, inference_state: dict[str, Any] | None = None):
    """Cache and manage the positional encoding for mask memory across frames and objects.
...
### Method `ultralytics.models.sam.predict.SAM2VideoPredictor._init_state` {#ultralytics.models.sam.predict.SAM2VideoPredictor.\_init\_state}
...
| Name | Type | Description | Default |
| --- | --- | --- | --- |
| `num_frames` | `int` | The number of frames in the video. | *required* |

<details>
<summary>Source code in <code>ultralytics/models/sam/predict.py</code></summary>

<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L1194-L1233"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
@staticmethod
def _init_state(num_frames):
    """Initialize an inference state.
...
### Method `ultralytics.models.sam.predict.SAM2VideoPredictor._obj_id_to_idx` {#ultralytics.models.sam.predict.SAM2VideoPredictor.\_obj\_id\_to\_idx}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L1258-L1310"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def _obj_id_to_idx(self, obj_id, inference_state: dict[str, Any] | None = None):
    """Map client-side object id to model-side object index.
...
### Method `ultralytics.models.sam.predict.SAM2VideoPredictor._prune_non_cond_memory` {#ultralytics.models.sam.predict.SAM2VideoPredictor.\_prune\_non\_cond\_memory}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L1836-L1853"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def _prune_non_cond_memory(self, frame_idx, inference_state=None):
    """Prune old non-conditioning frames to bound memory usage."""
...
### Method `ultralytics.models.sam.predict.SAM2VideoPredictor._reset_tracking_results` {#ultralytics.models.sam.predict.SAM2VideoPredictor.\_reset\_tracking\_results}
...
| Name | Type | Description | Default |
| --- | --- | --- | --- |
| `inference_state` |  |  | *required* |

<details>
<summary>Source code in <code>ultralytics/models/sam/predict.py</code></summary>

<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L1816-L1834"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
@staticmethod
def _reset_tracking_results(inference_state):
    """Reset all tracking inputs and results across the videos."""
...
### Method `ultralytics.models.sam.predict.SAM2VideoPredictor._run_memory_encoder` {#ultralytics.models.sam.predict.SAM2VideoPredictor.\_run\_memory\_encoder}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L1575-L1615"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def _run_memory_encoder(
    self,
    batch_size,
...
### Method `ultralytics.models.sam.predict.SAM2VideoPredictor._run_single_frame_inference` {#ultralytics.models.sam.predict.SAM2VideoPredictor.\_run\_single\_frame\_inference}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L1312-L1388"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def _run_single_frame_inference(
    self,
    output_dict,
...
### Method `ultralytics.models.sam.predict.SAM2VideoPredictor.add_new_prompts` {#ultralytics.models.sam.predict.SAM2VideoPredictor.add\_new\_prompts}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L993-L1099"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
@smart_inference_mode()
def add_new_prompts(
    self,
...
### Method `ultralytics.models.sam.predict.SAM2VideoPredictor.clear_all_points_in_frame` {#ultralytics.models.sam.predict.SAM2VideoPredictor.clear\_all\_points\_in\_frame}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L1754-L1800"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
@smart_inference_mode()
def clear_all_points_in_frame(self, inference_state, frame_idx, obj_id):
    """Remove all input points or mask in a specific frame for a given object."""
...
### Method `ultralytics.models.sam.predict.SAM2VideoPredictor.clear_all_points_in_video` {#ultralytics.models.sam.predict.SAM2VideoPredictor.clear\_all\_points\_in\_video}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L1803-L1813"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
@smart_inference_mode()
def clear_all_points_in_video(self, inference_state):
    """Remove all input points or mask in all frames throughout the video."""
...
### Method `ultralytics.models.sam.predict.SAM2VideoPredictor.get_im_features` {#ultralytics.models.sam.predict.SAM2VideoPredictor.get\_im\_features}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L1235-L1256"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def get_im_features(self, im, batch=1):
    """Extract and process image features using SAM2's image encoder for subsequent segmentation tasks.
...
### Method `ultralytics.models.sam.predict.SAM2VideoPredictor.get_model` {#ultralytics.models.sam.predict.SAM2VideoPredictor.get\_model}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L883-L891"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def get_model(self):
    """Retrieve and configure the model with binarization enabled.
...
### Method `ultralytics.models.sam.predict.SAM2VideoPredictor.inference` {#ultralytics.models.sam.predict.SAM2VideoPredictor.inference}
...
| `masks` | `np.ndarray, optional` | Low-resolution masks from previous predictions shape (N,H,W). For SAM H=W=256. | `None` |
...
### Method `ultralytics.models.sam.predict.SAM2VideoPredictor.init_state` {#ultralytics.models.sam.predict.SAM2VideoPredictor.init\_state}
...
| Name | Type | Description | Default |
| --- | --- | --- | --- |
| `predictor` | `SAM2VideoPredictor` | The predictor object for which to initialize the state. | *required* |

<details>
<summary>Source code in <code>ultralytics/models/sam/predict.py</code></summary>

<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L1177-L1191"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
@staticmethod
def init_state(predictor):
    """Initialize an inference state for the predictor.
...
### Method `ultralytics.models.sam.predict.SAM2VideoPredictor.postprocess` {#ultralytics.models.sam.predict.SAM2VideoPredictor.postprocess}
...
| Name | Type | Description | Default |
| --- | --- | --- | --- |
| `preds` | `tuple[torch.Tensor, torch.Tensor]` | The predicted masks and scores from the model. | *required* |
| `img` | `torch.Tensor` | The processed image tensor. | *required* |
| `orig_imgs` | `list[np.ndarray]` | The original images before processing. | *required* |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L966-L990"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def postprocess(self, preds, img, orig_imgs):
    """Post-process the predictions to apply non-overlapping constraints if required.
...
### Method `ultralytics.models.sam.predict.SAM2VideoPredictor.propagate_in_video_preflight` {#ultralytics.models.sam.predict.SAM2VideoPredictor.propagate\_in\_video\_preflight}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L1102-L1174"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
@smart_inference_mode()
def propagate_in_video_preflight(self, inference_state: dict[str, Any] | None = None):
    """Prepare inference_state and consolidate temporary outputs before tracking.
...
### Method `ultralytics.models.sam.predict.SAM2VideoPredictor.remove_object` {#ultralytics.models.sam.predict.SAM2VideoPredictor.remove\_object}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L1675-L1751"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
@smart_inference_mode()
def remove_object(self, inference_state, obj_id, strict=False):
    """Remove an object id from the tracking state. If strict is True, we check whether the object id actually
...
## Class `ultralytics.models.sam.predict.SAM2DynamicInteractivePredictor` {#ultralytics.models.sam.predict.SAM2DynamicInteractivePredictor}
...
| Name | Type | Description | Default |
| --- | --- | --- | --- |
| `cfg` | `Any` | Configuration dictionary containing default settings. | `DEFAULT_CFG` |
| `overrides` | `dict[str, Any] | None` | Dictionary of values to override default configuration. | `None` |
| `max_obj_num` | `int` | Maximum number of objects to track. Default is 3. This is set to keep fixed feature size<br>    for the model. | `3` |
| `_callbacks` | `dict[str, Any] | None` | Dictionary of callback functions to customize behavior. | `None` |
...
| Name | Description |
| --- | --- |
| [`_obj_id_to_idx`](#ultralytics.models.sam.predict.SAM2DynamicInteractivePredictor._obj_id_to_idx) | Map client-side object id to model-side object index. |
| [`_prepare_memory_conditioned_features`](#ultralytics.models.sam.predict.SAM2DynamicInteractivePredictor._prepare_memory_conditioned_features) | Prepare memory-conditioned features for the current image state. |
| [`get_im_features`](#ultralytics.models.sam.predict.SAM2DynamicInteractivePredictor.get_im_features) | Initialize the image state by processing the input image and extracting features. |
| [`get_maskmem_enc`](#ultralytics.models.sam.predict.SAM2DynamicInteractivePredictor.get_maskmem_enc) | Get memory and positional encoding from memory, which is used to condition the current image features. |
| [`inference`](#ultralytics.models.sam.predict.SAM2DynamicInteractivePredictor.inference) | Perform inference on a single image with optional bounding boxes, masks, points and object IDs. It has two |
| [`track_step`](#ultralytics.models.sam.predict.SAM2DynamicInteractivePredictor.track_step) | Tracking step for the current image state to predict masks. |
| [`update_memory`](#ultralytics.models.sam.predict.SAM2DynamicInteractivePredictor.update_memory) | Append the imgState to the memory_bank and update the memory for the model. |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L1856-L2185"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
...
### Method `ultralytics.models.sam.predict.SAM2DynamicInteractivePredictor._obj_id_to_idx` {#ultralytics.models.sam.predict.SAM2DynamicInteractivePredictor.\_obj\_id\_to\_idx}
...
| Name | Type | Description | Default |
| --- | --- | --- | --- |
| `obj_id` | `int` | The client-side object ID. | *required* |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L2125-L2134"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def _obj_id_to_idx(self, obj_id: int) -> int | None:
    """Map client-side object id to model-side object index.
...
### Method `ultralytics.models.sam.predict.SAM2DynamicInteractivePredictor._prepare_memory_conditioned_features` {#ultralytics.models.sam.predict.SAM2DynamicInteractivePredictor.\_prepare\_memory\_conditioned\_features}
...
| Name | Type | Description | Default |
| --- | --- | --- | --- |
| `obj_idx` | `int | None` | The index of the object for which to prepare the features. | *required* |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L2077-L2110"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def _prepare_memory_conditioned_features(self, obj_idx: int | None) -> torch.Tensor:
    """Prepare memory-conditioned features for the current image state.
...
### Method `ultralytics.models.sam.predict.SAM2DynamicInteractivePredictor.get_im_features` {#ultralytics.models.sam.predict.SAM2DynamicInteractivePredictor.get\_im\_features}
...
| Name | Type | Description | Default |
| --- | --- | --- | --- |
| `img` | `torch.Tensor | np.ndarray` | The input image tensor or numpy array. | *required* |

<details>
<summary>Source code in <code>ultralytics/models/sam/predict.py</code></summary>

<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L1980-L1994"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def get_im_features(self, img: torch.Tensor | np.ndarray) -> None:
    """Initialize the image state by processing the input image and extracting features.
...
### Method `ultralytics.models.sam.predict.SAM2DynamicInteractivePredictor.get_maskmem_enc` {#ultralytics.models.sam.predict.SAM2DynamicInteractivePredictor.get\_maskmem\_enc}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L2112-L2123"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def get_maskmem_enc(self) -> tuple[torch.Tensor, torch.Tensor]:
    """Get memory and positional encoding from memory, which is used to condition the current image features."""
...
### Method `ultralytics.models.sam.predict.SAM2DynamicInteractivePredictor.inference` {#ultralytics.models.sam.predict.SAM2DynamicInteractivePredictor.inference}
...
| Name | Type | Description | Default |
| --- | --- | --- | --- |
| `im` | `torch.Tensor | np.ndarray` | The input image tensor or numpy array. | *required* |
| `bboxes` | `list[list[float]] | None` | Optional list of bounding boxes to update the memory. | `None` |
| `masks` | `torch.Tensor | np.ndarray | None` | Optional masks to update the memory. | `None` |
| `points` | `list[list[float]] | None` | Optional list of points to update the memory, each point is [x, y]. | `None` |
| `labels` | `list[int] | None` | Optional list of labels for point prompts (>0 for positive, 0 for negative). | `None` |
| `obj_ids` | `list[int] | None` | Optional list of object IDs corresponding to the prompts. | `None` |
| `update_memory` | `bool` | Flag to indicate whether to update the memory with new objects. | `False` |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L1914-L1978"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
@smart_inference_mode()
def inference(
    self,
...
### Method `ultralytics.models.sam.predict.SAM2DynamicInteractivePredictor.track_step` {#ultralytics.models.sam.predict.SAM2DynamicInteractivePredictor.track\_step}
...
| Name | Type | Description | Default |
| --- | --- | --- | --- |
| `obj_idx` | `int | None` | The index of the object for which to predict masks. If None, it processes all objects. | `None` |
| `point` | `torch.Tensor | None` | The coordinates of the points of interest with shape (N, 2). | `None` |
| `label` | `torch.Tensor | None` | The labels corresponding to the points where 1 means positive clicks, 0 means<br>    negative clicks. | `None` |
| `mask` | `torch.Tensor | None` | The mask input for the object with shape (H, W). | `None` |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L2136-L2185"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def track_step(
    self,
    obj_idx: int | None = None,
...
### Method `ultralytics.models.sam.predict.SAM2DynamicInteractivePredictor.update_memory` {#ultralytics.models.sam.predict.SAM2DynamicInteractivePredictor.update\_memory}
...
| Name | Type | Description | Default |
| --- | --- | --- | --- |
| `obj_ids` | `list[int]` | List of object IDs corresponding to the prompts. | `None` |
| `points` | `torch.Tensor | None` | Tensor of shape (B, N, 2) representing the input points for N objects. | `None` |
| `labels` | `torch.Tensor | None` | Tensor of shape (B, N) representing the labels for the input points. | `None` |
| `masks` | `torch.Tensor | None` | Optional tensor of shape (N, H, W) representing the input masks for N objects. | `None` |

<details>
<summary>Source code in <code>ultralytics/models/sam/predict.py</code></summary>

<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L1997-L2075"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
@smart_inference_mode()
def update_memory(
    self,
...
## Class `ultralytics.models.sam.predict.SAM3Predictor` {#ultralytics.models.sam.predict.SAM3Predictor}
...
| Name | Description |
| --- | --- |
| [`get_model`](#ultralytics.models.sam.predict.SAM3Predictor.get_model) | Retrieve and initialize the Segment Anything Model 3 (SAM3) for image segmentation tasks. |
| [`setup_model`](#ultralytics.models.sam.predict.SAM3Predictor.setup_model) | Setup the SAM3 model with appropriate mean and standard deviation for preprocessing. |

<details>
<summary>Source code in <code>ultralytics/models/sam/predict.py</code></summary>

<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L2188-L2209"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
...
### Method `ultralytics.models.sam.predict.SAM3Predictor.get_model` {#ultralytics.models.sam.predict.SAM3Predictor.get\_model}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L2205-L2209"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def get_model(self):
    """Retrieve and initialize the Segment Anything Model 3 (SAM3) for image segmentation tasks."""
...
### Method `ultralytics.models.sam.predict.SAM3Predictor.setup_model` {#ultralytics.models.sam.predict.SAM3Predictor.setup\_model}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L2198-L2203"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def setup_model(self, model=None, verbose=True):
    """Setup the SAM3 model with appropriate mean and standard deviation for preprocessing."""
...
## Class `ultralytics.models.sam.predict.SAM3SemanticPredictor` {#ultralytics.models.sam.predict.SAM3SemanticPredictor}
...
| Name | Description |
| --- | --- |
| [`_get_dummy_prompt`](#ultralytics.models.sam.predict.SAM3SemanticPredictor._get_dummy_prompt) | Get a dummy geometric prompt with zero boxes. |
| [`_inference_features`](#ultralytics.models.sam.predict.SAM3SemanticPredictor._inference_features) | Run inference on the extracted features with optional bounding boxes and labels. |
| [`_prepare_geometric_prompts`](#ultralytics.models.sam.predict.SAM3SemanticPredictor._prepare_geometric_prompts) | Prepare prompts by normalizing bounding boxes and points to the destination shape. |
| [`get_im_features`](#ultralytics.models.sam.predict.SAM3SemanticPredictor.get_im_features) | Extract image features using the model's backbone. |
| [`get_model`](#ultralytics.models.sam.predict.SAM3SemanticPredictor.get_model) | Retrieve and initialize the Segment Anything Model 3 (SAM3) for image segmentation tasks. |
| [`inference`](#ultralytics.models.sam.predict.SAM3SemanticPredictor.inference) | Perform inference on a single image with optional prompts. |
| [`inference_features`](#ultralytics.models.sam.predict.SAM3SemanticPredictor.inference_features) | Perform prompts preprocessing and inference on provided image features using the SAM model. |
| [`postprocess`](#ultralytics.models.sam.predict.SAM3SemanticPredictor.postprocess) | Post-process the predictions to apply non-overlapping constraints if required. |
| [`pre_transform`](#ultralytics.models.sam.predict.SAM3SemanticPredictor.pre_transform) | Perform initial transformations on the input image for preprocessing. |
| [`reset_prompts`](#ultralytics.models.sam.predict.SAM3SemanticPredictor.reset_prompts) | Reset the prompts for the predictor. |

<details>
<summary>Source code in <code>ultralytics/models/sam/predict.py</code></summary>

<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L2212-L2401"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
...
### Method `ultralytics.models.sam.predict.SAM3SemanticPredictor._get_dummy_prompt` {#ultralytics.models.sam.predict.SAM3SemanticPredictor.\_get\_dummy\_prompt}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L2395-L2401"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def _get_dummy_prompt(self, num_prompts=1):
    """Get a dummy geometric prompt with zero boxes."""
...
### Method `ultralytics.models.sam.predict.SAM3SemanticPredictor._inference_features` {#ultralytics.models.sam.predict.SAM3SemanticPredictor.\_inference\_features}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L2272-L2289"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def _inference_features(self, features, bboxes=None, labels=None, text: list[str] | None = None):
    """Run inference on the extracted features with optional bounding boxes and labels."""
...
### Method `ultralytics.models.sam.predict.SAM3SemanticPredictor._prepare_geometric_prompts` {#ultralytics.models.sam.predict.SAM3SemanticPredictor.\_prepare\_geometric\_prompts}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L2252-L2270"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def _prepare_geometric_prompts(self, src_shape, bboxes=None, labels=None):
    """Prepare prompts by normalizing bounding boxes and points to the destination shape."""
    if bboxes is not None:
...
### Method `ultralytics.models.sam.predict.SAM3SemanticPredictor.get_im_features` {#ultralytics.models.sam.predict.SAM3SemanticPredictor.get\_im\_features}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L2222-L2224"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
@smart_inference_mode()
def get_im_features(self, im):
    """Extract image features using the model's backbone."""
...
### Method `ultralytics.models.sam.predict.SAM3SemanticPredictor.get_model` {#ultralytics.models.sam.predict.SAM3SemanticPredictor.get\_model}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L2215-L2219"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def get_model(self):
    """Retrieve and initialize the Segment Anything Model 3 (SAM3) for image segmentation tasks."""
...
### Method `ultralytics.models.sam.predict.SAM3SemanticPredictor.inference` {#ultralytics.models.sam.predict.SAM3SemanticPredictor.inference}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L2325-L2332"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def inference(self, im, bboxes=None, labels=None, text: list[str] | None = None, *args, **kwargs):
    """Perform inference on a single image with optional prompts."""
    bboxes = self.prompts.pop("bboxes", bboxes)
...
### Method `ultralytics.models.sam.predict.SAM3SemanticPredictor.inference_features` {#ultralytics.models.sam.predict.SAM3SemanticPredictor.inference\_features}
...
| Name | Type | Description | Default |
| --- | --- | --- | --- |
| `features` | `dict[str, Any]` | Extracted image features from the SAM3 model image encoder. | *required* |
| `src_shape` | `tuple[int, int]` | The source shape (height, width) of the input image. | *required* |
| `bboxes` | `np.ndarray | list[list[float]] | None` | Bounding boxes in xyxy format with shape (N, 4). pixels. | `None` |
| `labels` | `np.ndarray | list[int] | None` | Point prompt labels with shape (N, ). | `None` |
| `text` | `list[str] | None` | List of text prompts corresponding to the classes. | `None` |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L2335-L2388"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
@smart_inference_mode()
def inference_features(
    self,
...
### Method `ultralytics.models.sam.predict.SAM3SemanticPredictor.postprocess` {#ultralytics.models.sam.predict.SAM3SemanticPredictor.postprocess}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L2291-L2323"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def postprocess(self, preds, img, orig_imgs):
    """Post-process the predictions to apply non-overlapping constraints if required."""
    pred_boxes = preds["pred_boxes"]  # (nc, num_query, 4)
...
### Method `ultralytics.models.sam.predict.SAM3SemanticPredictor.pre_transform` {#ultralytics.models.sam.predict.SAM3SemanticPredictor.pre\_transform}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L2226-L2250"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def pre_transform(self, im):
    """Perform initial transformations on the input image for preprocessing.
...
### Method `ultralytics.models.sam.predict.SAM3SemanticPredictor.reset_prompts` {#ultralytics.models.sam.predict.SAM3SemanticPredictor.reset\_prompts}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L2390-L2393"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def reset_prompts(self):
    """Reset the prompts for the predictor."""
    self.prompts = {}
...
## Class `ultralytics.models.sam.predict.SAM3VideoPredictor` {#ultralytics.models.sam.predict.SAM3VideoPredictor}
...
| Name | Description |
| --- | --- |
| [`propagate_in_video`](#ultralytics.models.sam.predict.SAM3VideoPredictor.propagate_in_video) | Perform image segmentation inference based on the given input cues, using the currently loaded image. This |

<details>
<summary>Source code in <code>ultralytics/models/sam/predict.py</code></summary>

<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L2404-L2455"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
...
### Method `ultralytics.models.sam.predict.SAM3VideoPredictor.propagate_in_video` {#ultralytics.models.sam.predict.SAM3VideoPredictor.propagate\_in\_video}
...
| Name | Type | Description | Default |
| --- | --- | --- | --- |
| `inference_state` | `dict` | The current state of inference, including input cues and previous outputs. | *required* |
| `frame_idx` | `int` | The index of the current frame in the video sequence. | *required* |
...
## Class `ultralytics.models.sam.predict.SAM3VideoSemanticPredictor` {#ultralytics.models.sam.predict.SAM3VideoSemanticPredictor}
...
| Name | Description |
| --- | --- |
| [`_apply_object_wise_non_overlapping_constraints`](#ultralytics.models.sam.predict.SAM3VideoSemanticPredictor._apply_object_wise_non_overlapping_constraints) | Applies non-overlapping constraints object wise (i.e. only one object can claim the overlapping region). |
| [`_associate_det_trk`](#ultralytics.models.sam.predict.SAM3VideoSemanticPredictor._associate_det_trk) | Match detections on the current frame with the existing masklets. |
| [`_cache_backbone_features`](#ultralytics.models.sam.predict.SAM3VideoSemanticPredictor._cache_backbone_features) | Build and cache SAM2 backbone features. |
| [`_det_track_one_frame`](#ultralytics.models.sam.predict.SAM3VideoSemanticPredictor._det_track_one_frame) | This function handles one-step inference for the DenseTracking model in an SPMD manner. At a high-level, all |
| [`_drop_new_det_with_obj_limit`](#ultralytics.models.sam.predict.SAM3VideoSemanticPredictor._drop_new_det_with_obj_limit) | Drop a few new detections based on the maximum number of objects. We drop new objects based on their |
| [`_extract_detection_outputs`](#ultralytics.models.sam.predict.SAM3VideoSemanticPredictor._extract_detection_outputs) | Extract and filter detection outputs. |
| [`_initialize_metadata`](#ultralytics.models.sam.predict.SAM3VideoSemanticPredictor._initialize_metadata) | Initialize metadata for the masklets. |
| [`_process_hotstart`](#ultralytics.models.sam.predict.SAM3VideoSemanticPredictor._process_hotstart) | Handle hotstart heuristics to remove unmatched or duplicated objects. |
| [`_propogate_tracker_one_frame_local_gpu`](#ultralytics.models.sam.predict.SAM3VideoSemanticPredictor._propogate_tracker_one_frame_local_gpu) | Inference_states: list of inference states, each state corresponds to a different set of objects. |
| [`_recondition_masklets`](#ultralytics.models.sam.predict.SAM3VideoSemanticPredictor._recondition_masklets) | Recondition masklets based on new high-confidence detections. |
| [`_run_single_frame_inference`](#ultralytics.models.sam.predict.SAM3VideoSemanticPredictor._run_single_frame_inference) | Perform inference on a single frame and get its inference results. |
| [`_suppress_detections_close_to_boundary`](#ultralytics.models.sam.predict.SAM3VideoSemanticPredictor._suppress_detections_close_to_boundary) | Suppress detections too close to image edges (for normalized boxes). |
| [`_suppress_overlapping_based_on_recent_occlusion`](#ultralytics.models.sam.predict.SAM3VideoSemanticPredictor._suppress_overlapping_based_on_recent_occlusion) | Suppress overlapping masks based on the most recent occlusion information. If an object is removed by |
| [`_tracker_add_new_objects`](#ultralytics.models.sam.predict.SAM3VideoSemanticPredictor._tracker_add_new_objects) | Add a new object to SAM2 inference states. |
| [`_tracker_remove_objects`](#ultralytics.models.sam.predict.SAM3VideoSemanticPredictor._tracker_remove_objects) | Remove an object from SAM2 inference states. This would remove the object from all frames in the video. |
| [`_tracker_update_memories`](#ultralytics.models.sam.predict.SAM3VideoSemanticPredictor._tracker_update_memories) | Run Sam2 memory encoder, enforcing non-overlapping constraints globally. |
| [`add_prompt`](#ultralytics.models.sam.predict.SAM3VideoSemanticPredictor.add_prompt) | Add text, point or box prompts on a single frame. This method returns the inference outputs only on the |
| [`build_outputs`](#ultralytics.models.sam.predict.SAM3VideoSemanticPredictor.build_outputs) | Build the output masks for the current frame. |
| [`inference`](#ultralytics.models.sam.predict.SAM3VideoSemanticPredictor.inference) | Perform inference on a video sequence with optional prompts. |
| [`init_state`](#ultralytics.models.sam.predict.SAM3VideoSemanticPredictor.init_state) | Initialize an inference state for the predictor. |
| [`postprocess`](#ultralytics.models.sam.predict.SAM3VideoSemanticPredictor.postprocess) | Post-process the predictions to apply non-overlapping constraints if required. |
| [`run_backbone_and_detection`](#ultralytics.models.sam.predict.SAM3VideoSemanticPredictor.run_backbone_and_detection) | Run backbone and detection for a single frame. |
| [`run_tracker_propagation`](#ultralytics.models.sam.predict.SAM3VideoSemanticPredictor.run_tracker_propagation) | Run the tracker propagation phase for a single frame in an SPMD manner. |
| [`run_tracker_update_execution_phase`](#ultralytics.models.sam.predict.SAM3VideoSemanticPredictor.run_tracker_update_execution_phase) | Execute the tracker update plan for a single frame in an SPMD manner. |
| [`run_tracker_update_planning_phase`](#ultralytics.models.sam.predict.SAM3VideoSemanticPredictor.run_tracker_update_planning_phase) | Run the tracker update planning phase for a single frame in an SPMD manner. |
| [`setup_model`](#ultralytics.models.sam.predict.SAM3VideoSemanticPredictor.setup_model) | Setup the SAM3VideoSemanticPredictor model. |
| [`setup_source`](#ultralytics.models.sam.predict.SAM3VideoSemanticPredictor.setup_source) | Setup the source for the SAM3VideoSemanticPredictor model. |
| [`update_masklet_confirmation_status`](#ultralytics.models.sam.predict.SAM3VideoSemanticPredictor.update_masklet_confirmation_status) | Update the confirmation status of masklets based on the current frame's detection results. |

<details>
<summary>Source code in <code>ultralytics/models/sam/predict.py</code></summary>

<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L2458-L3940"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
...
### Method `ultralytics.models.sam.predict.SAM3VideoSemanticPredictor._apply_object_wise_non_overlapping_constraints` {#ultralytics.models.sam.predict.SAM3VideoSemanticPredictor.\_apply\_object\_wise\_non\_overlapping\_constraints}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L2761-L2775"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def _apply_object_wise_non_overlapping_constraints(self, pred_masks, obj_scores, background_value=-10.0):
    """Applies non-overlapping constraints object wise (i.e. only one object can claim the overlapping region)."""
...
### Method `ultralytics.models.sam.predict.SAM3VideoSemanticPredictor._associate_det_trk` {#ultralytics.models.sam.predict.SAM3VideoSemanticPredictor.\_associate\_det\_trk}
...
| Name | Type | Description | Default |
| --- | --- | --- | --- |
| `det_masks` | `torch.Tensor` | (N, H, W) tensor of predicted masks | *required* |
| `det_scores_np` | `np.ndarray` | (N,) array of detection scores | *required* |
| `trk_masks` | `torch.Tensor` | (M, H, W) tensor of track masks | *required* |
| `trk_obj_ids` | `np.ndarray` | (M,) array of object IDs corresponding to trk_masks | *required* |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L3467-L3598"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def _associate_det_trk(
    self,
    det_masks: torch.Tensor,
...
### Method `ultralytics.models.sam.predict.SAM3VideoSemanticPredictor._cache_backbone_features` {#ultralytics.models.sam.predict.SAM3VideoSemanticPredictor.\_cache\_backbone\_features}
...
| Name | Type | Description | Default |
| --- | --- | --- | --- |
| `sam3_image_out` |  |  | *required* |

<details>
<summary>Source code in <code>ultralytics/models/sam/predict.py</code></summary>

<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L2933-L2948"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def _cache_backbone_features(self, sam3_image_out):
    """Build and cache SAM2 backbone features."""
...
### Method `ultralytics.models.sam.predict.SAM3VideoSemanticPredictor._det_track_one_frame` {#ultralytics.models.sam.predict.SAM3VideoSemanticPredictor.\_det\_track\_one\_frame}
...
| `frame_idx` | `int` |  | *required* |
| `num_frames` | `int` |  | *required* |
| `reverse` | `bool` |  | *required* |
| `geometric_prompt` | `Prompt` |  | *required* |
| `tracker_states_local` | `list[Any]` |  | *required* |
| `tracker_metadata_prev` | `dict[str, Any]` |  | *required* |
| `allow_new_detections` | `bool` |  | `True` |

<details>
<summary>Source code in <code>ultralytics/models/sam/predict.py</code></summary>

<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L2777-L2882"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def _det_track_one_frame(
    self,
    im: torch.Tensor,
...
### Method `ultralytics.models.sam.predict.SAM3VideoSemanticPredictor._drop_new_det_with_obj_limit` {#ultralytics.models.sam.predict.SAM3VideoSemanticPredictor.\_drop\_new\_det\_with\_obj\_limit}
...
| Name | Type | Description | Default |
| --- | --- | --- | --- |
| `new_det_fa_inds` |  |  | *required* |
| `det_scores_np` |  |  | *required* |
| `num_to_keep` |  |  | *required* |

<details>
<summary>Source code in <code>ultralytics/models/sam/predict.py</code></summary>

<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L3927-L3940"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
@staticmethod
def _drop_new_det_with_obj_limit(new_det_fa_inds, det_scores_np, num_to_keep):
    """Drop a few new detections based on the maximum number of objects. We drop new objects based on their
...
### Method `ultralytics.models.sam.predict.SAM3VideoSemanticPredictor._extract_detection_outputs` {#ultralytics.models.sam.predict.SAM3VideoSemanticPredictor.\_extract\_detection\_outputs}
...
| --- | --- | --- | --- |
| `sam3_image_out` |  |  | *required* |
| `allow_new_detections` |  |  | *required* |

<details>
<summary>Source code in <code>ultralytics/models/sam/predict.py</code></summary>

<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L2910-L2931"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def _extract_detection_outputs(self, sam3_image_out, allow_new_detections):
    """Extract and filter detection outputs."""
...
### Method `ultralytics.models.sam.predict.SAM3VideoSemanticPredictor._initialize_metadata` {#ultralytics.models.sam.predict.SAM3VideoSemanticPredictor.\_initialize\_metadata}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L3831-L3865"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def _initialize_metadata(self):
    """Initialize metadata for the masklets."""
    tracker_metadata = {
...
### Method `ultralytics.models.sam.predict.SAM3VideoSemanticPredictor._process_hotstart` {#ultralytics.models.sam.predict.SAM3VideoSemanticPredictor.\_process\_hotstart}
...
| `frame_idx` | `int` |  | *required* |
| `reverse` | `bool` |  | *required* |
| `det_to_matched_trk_obj_ids` | `dict[int, np.ndarray]` |  | *required* |
| `new_det_obj_ids` | `np.ndarray` |  | *required* |
| `empty_trk_obj_ids` | `np.ndarray` |  | *required* |
| `unmatched_trk_obj_ids` | `np.ndarray` |  | *required* |
| `metadata` | `dict[str, Any]` |  | *required* |

<details>
<summary>Source code in <code>ultralytics/models/sam/predict.py</code></summary>

<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L3600-L3709"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def _process_hotstart(
    self,
    frame_idx: int,
...
### Method `ultralytics.models.sam.predict.SAM3VideoSemanticPredictor._propogate_tracker_one_frame_local_gpu` {#ultralytics.models.sam.predict.SAM3VideoSemanticPredictor.\_propogate\_tracker\_one\_frame\_local\_gpu}
...
| Name | Type | Description | Default |
| --- | --- | --- | --- |
| `inference_states` | `list[Any]` |  | *required* |
| `frame_idx` | `int` |  | *required* |

<details>
<summary>Source code in <code>ultralytics/models/sam/predict.py</code></summary>

<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L3439-L3465"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def _propogate_tracker_one_frame_local_gpu(self, inference_states: list[Any], frame_idx: int):
    """Inference_states: list of inference states, each state corresponds to a different set of objects."""
    obj_ids_local = []
...
### Method `ultralytics.models.sam.predict.SAM3VideoSemanticPredictor._recondition_masklets` {#ultralytics.models.sam.predict.SAM3VideoSemanticPredictor.\_recondition\_masklets}
...
| --- | --- | --- | --- |
| `frame_idx` |  |  | *required* |
| `det_out` | `dict[str, torch.Tensor]` |  | *required* |
| `trk_id_to_max_iou_high_conf_det` | `list[int]` |  | *required* |
| `tracker_states_local` | `list[Any]` |  | *required* |
| `tracker_metadata` | `dict[str, np.ndarray]` |  | *required* |
| `tracker_obj_scores_global` | `torch.Tensor` |  | *required* |

<details>
<summary>Source code in <code>ultralytics/models/sam/predict.py</code></summary>

<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L2972-L3012"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def _recondition_masklets(
    self,
    frame_idx,
...
### Method `ultralytics.models.sam.predict.SAM3VideoSemanticPredictor._run_single_frame_inference` {#ultralytics.models.sam.predict.SAM3VideoSemanticPredictor.\_run\_single\_frame\_inference}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L2667-L2719"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def _run_single_frame_inference(self, frame_idx, reverse=False, inference_state=None):
    """Perform inference on a single frame and get its inference results."""
    inference_state = inference_state or self.inference_state
...
### Method `ultralytics.models.sam.predict.SAM3VideoSemanticPredictor._suppress_detections_close_to_boundary` {#ultralytics.models.sam.predict.SAM3VideoSemanticPredictor.\_suppress\_detections\_close\_to\_boundary}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L2885-L2896"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
@staticmethod
def _suppress_detections_close_to_boundary(boxes, margin=0.025):
    """Suppress detections too close to image edges (for normalized boxes).
...
### Method `ultralytics.models.sam.predict.SAM3VideoSemanticPredictor._suppress_overlapping_based_on_recent_occlusion` {#ultralytics.models.sam.predict.SAM3VideoSemanticPredictor.\_suppress\_overlapping\_based\_on\_recent\_occlusion}
...
| Name | Type | Description | Default |
| --- | --- | --- | --- |
| `frame_idx` | `int` | The current frame index. | *required* |
| `tracker_low_res_masks_global` | `torch.Tensor` | The low-resolution masks for the current frame. | *required* |
| `tracker_metadata_prev` | `dict[str, Any]` | The metadata from the previous frame. | *required* |
| `tracker_metadata_new` | `dict[str, Any]` | The metadata for the current frame. | *required* |
| `obj_ids_newly_removed` | `set[int]` | The object IDs that have been removed. | *required* |
| `reverse` | `bool` | Whether the tracking is in reverse order. | `False` |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L3226-L3294"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def _suppress_overlapping_based_on_recent_occlusion(
    self,
    frame_idx: int,
...
### Method `ultralytics.models.sam.predict.SAM3VideoSemanticPredictor._tracker_add_new_objects` {#ultralytics.models.sam.predict.SAM3VideoSemanticPredictor.\_tracker\_add\_new\_objects}
...
| `frame_idx` | `int` |  | *required* |
| `num_frames` | `int` |  | *required* |
| `new_obj_ids` | `list[int]` |  | *required* |
| `new_obj_masks` | `torch.Tensor` |  | *required* |
| `tracker_states_local` | `list[Any]` |  | *required* |

<details>
<summary>Source code in <code>ultralytics/models/sam/predict.py</code></summary>

<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L3769-L3811"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def _tracker_add_new_objects(
    self,
    frame_idx: int,
...
### Method `ultralytics.models.sam.predict.SAM3VideoSemanticPredictor._tracker_remove_objects` {#ultralytics.models.sam.predict.SAM3VideoSemanticPredictor.\_tracker\_remove\_objects}
...
| --- | --- | --- | --- |
| `tracker_states_local` | `list[Any]` |  | *required* |
| `obj_ids` | `list[int]` |  | *required* |

<details>
<summary>Source code in <code>ultralytics/models/sam/predict.py</code></summary>

<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L3813-L3829"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def _tracker_remove_objects(self, tracker_states_local: list[Any], obj_ids: list[int]):
    """Remove an object from SAM2 inference states. This would remove the object from all frames in the video."""
    if not obj_ids:
...
### Method `ultralytics.models.sam.predict.SAM3VideoSemanticPredictor._tracker_update_memories` {#ultralytics.models.sam.predict.SAM3VideoSemanticPredictor.\_tracker\_update\_memories}
...
| Name | Type | Description | Default |
| --- | --- | --- | --- |
| `tracker_inference_states` | `list[Any]` |  | *required* |
| `frame_idx` | `int` |  | *required* |
| `low_res_masks` | `torch.Tensor` |  | *required* |
...
### Method `ultralytics.models.sam.predict.SAM3VideoSemanticPredictor.add_prompt` {#ultralytics.models.sam.predict.SAM3VideoSemanticPredictor.add\_prompt}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L2722-L2759"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
@smart_inference_mode()
def add_prompt(
    self,
...
### Method `ultralytics.models.sam.predict.SAM3VideoSemanticPredictor.build_outputs` {#ultralytics.models.sam.predict.SAM3VideoSemanticPredictor.build\_outputs}
...
| --- | --- | --- | --- |
| `det_out` | `dict[str, torch.Tensor]` |  | *required* |
| `tracker_low_res_masks_global` | `torch.Tensor` |  | *required* |
| `tracker_metadata_prev` | `dict[str, np.ndarray]` |  | *required* |
| `tracker_update_plan` | `dict[str, np.ndarray]` |  | *required* |
| `reconditioned_obj_ids` | `set | None` |  | `None` |

<details>
<summary>Source code in <code>ultralytics/models/sam/predict.py</code></summary>

<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L3333-L3369"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
@staticmethod
def build_outputs(
    det_out: dict[str, torch.Tensor],
...
### Method `ultralytics.models.sam.predict.SAM3VideoSemanticPredictor.inference` {#ultralytics.models.sam.predict.SAM3VideoSemanticPredictor.inference}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L2606-L2612"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def inference(self, im, bboxes=None, labels=None, text: list[str] | None = None, *args, **kwargs):
    """Perform inference on a video sequence with optional prompts."""
...
### Method `ultralytics.models.sam.predict.SAM3VideoSemanticPredictor.init_state` {#ultralytics.models.sam.predict.SAM3VideoSemanticPredictor.init\_state}
...
| Name | Type | Description | Default |
| --- | --- | --- | --- |
| `predictor` | `SAM3VideoSemanticPredictor` | The predictor object for which to initialize the state. | *required* |

<details>
<summary>Source code in <code>ultralytics/models/sam/predict.py</code></summary>

<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L2582-L2604"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
@staticmethod
def init_state(predictor):
    """Initialize an inference state for the predictor.
...
### Method `ultralytics.models.sam.predict.SAM3VideoSemanticPredictor.postprocess` {#ultralytics.models.sam.predict.SAM3VideoSemanticPredictor.postprocess}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L2614-L2665"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def postprocess(self, preds, img, orig_imgs):
    """Post-process the predictions to apply non-overlapping constraints if required."""
...
### Method `ultralytics.models.sam.predict.SAM3VideoSemanticPredictor.run_backbone_and_detection` {#ultralytics.models.sam.predict.SAM3VideoSemanticPredictor.run\_backbone\_and\_detection}
...
| `text_ids` | `torch.Tensor` |  | *required* |
| `geometric_prompt` | `Prompt` |  | *required* |
| `allow_new_detections` | `bool` |  | *required* |

<details>
<summary>Source code in <code>ultralytics/models/sam/predict.py</code></summary>

<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L2898-L2908"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def run_backbone_and_detection(
    self, im: torch.Tensor, text_ids: torch.Tensor, geometric_prompt: Prompt, allow_new_detections: bool
):
...
### Method `ultralytics.models.sam.predict.SAM3VideoSemanticPredictor.run_tracker_propagation` {#ultralytics.models.sam.predict.SAM3VideoSemanticPredictor.run\_tracker\_propagation}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L2950-L2970"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def run_tracker_propagation(
    self, frame_idx: int, tracker_states_local: list[Any], tracker_metadata_prev: dict[str, np.ndarray]
):
...
### Method `ultralytics.models.sam.predict.SAM3VideoSemanticPredictor.run_tracker_update_execution_phase` {#ultralytics.models.sam.predict.SAM3VideoSemanticPredictor.run\_tracker\_update\_execution\_phase}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L3296-L3330"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def run_tracker_update_execution_phase(
    self,
    frame_idx: int,
...
### Method `ultralytics.models.sam.predict.SAM3VideoSemanticPredictor.run_tracker_update_planning_phase` {#ultralytics.models.sam.predict.SAM3VideoSemanticPredictor.run\_tracker\_update\_planning\_phase}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L3014-L3224"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def run_tracker_update_planning_phase(
    self,
    frame_idx: int,
...
### Method `ultralytics.models.sam.predict.SAM3VideoSemanticPredictor.setup_model` {#ultralytics.models.sam.predict.SAM3VideoSemanticPredictor.setup\_model}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L2564-L2571"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def setup_model(self, model=None, verbose=True):
    """Setup the SAM3VideoSemanticPredictor model."""
    super().setup_model(model, verbose)
...
### Method `ultralytics.models.sam.predict.SAM3VideoSemanticPredictor.setup_source` {#ultralytics.models.sam.predict.SAM3VideoSemanticPredictor.setup\_source}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L2573-L2579"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def setup_source(self, source):
    """Setup the source for the SAM3VideoSemanticPredictor model."""
    super().setup_source(source)
...
### Method `ultralytics.models.sam.predict.SAM3VideoSemanticPredictor.update_masklet_confirmation_status` {#ultralytics.models.sam.predict.SAM3VideoSemanticPredictor.update\_masklet\_confirmation\_status}
...
| --- | --- | --- | --- |
| `metadata` | `dict[str, Any]` |  | *required* |
| `obj_ids_all_gpu_prev` | `np.ndarray` |  | *required* |
| `obj_ids_all_gpu_updated` | `np.ndarray` |  | *required* |
| `det_to_matched_trk_obj_ids` | `dict[int, np.ndarray]` |  | *required* |
| `new_det_obj_ids` | `np.ndarray` |  | *required* |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/predict.py#L3867-L3913"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def update_masklet_confirmation_status(
    self,
    metadata: dict[str, Any],
