...
def main():
    ...
    print("   Step 3: 用中心点距离快速筛选接近事件")
    print("   Step 3.6: 仅对关键帧执行多锚点分析（大幅降低计算量）")
    print("   可视化: keyframe中显示锚点距离（绿/红圈标记最近碰撞部分）")
    ...
    print("\n✅ 管道执行完成！")
    print("   检查 results/ 目录中的最新输出")
    print("   关键帧在 3_key_frames/ 文件夹中")
    print("   图像中的可视化元素:")
    print("     - 小圆点(ID:): 物体中心")
    print("     - 大圆圈(绿/红): 多锚点最近碰撞部分")
    print("     - 紫色线: 最近碰撞点之间的连线")
    print("     - 文本: 碰撞部分、风险等级、TTC")
