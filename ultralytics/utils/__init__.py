...
def yaml_load(file="data.yaml", append_filename=False) -> dict:
    """
    Load YAML data from a file.

    Args:
        file (str, optional): YAML file name to load.
        append_filename (bool): Whether to add the YAML filename to the YAML dictionary.
