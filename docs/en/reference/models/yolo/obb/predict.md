...
```python
OBBPredictor(cfg=DEFAULT_CFG, overrides=None, _callbacks: dict | None = None)
```
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/yolo/obb/predict.py#L12-L58">View on GitHub</a>
```python
...
| Name | Type | Description | Default |
| --- | --- | --- | --- |
| `pred` | `torch.Tensor` | The predicted bounding boxes, scores, and rotation angles with shape (N, 7) where the last dimension contains [x, y, w, h, confidence, class_id, angle]. | *required* |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/yolo/obb/predict.py#L41-L58">View on GitHub</a>
```python
def construct_result(self, pred, img, orig_img, img_path):
    """Construct the result object from the prediction.
