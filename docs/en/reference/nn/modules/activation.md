...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/modules/activation.py#L8-L54">View on GitHub</a>
```python
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/nn/modules/activation.py#L41-L54">View on GitHub</a>
```python
def forward(self, x: torch.Tensor) -> torch.Tensor:
    """Apply the Adaptive Gated Linear Unit (AGLU) activation function.
