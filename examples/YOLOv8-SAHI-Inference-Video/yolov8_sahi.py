...
# Taken from yolov5 implementation
...
def run(
    ...
    yolov8_model_path = "models/{}".format(weights)
    ...
    while(videocapture.isOpened()):
        ...
        if success==True:
            ...
            #inference with sahi
            results = get_sliced_prediction(frame,detection_model,slice_height=512,slice_width=512,
                                        overlap_height_ratio=0.2,overlap_width_ratio=0.2)
            
            object_prediction_list = results.object_prediction_list

            #store all bbox data in list
            boxes_list = []
            clss_list = []
