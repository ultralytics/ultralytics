...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/solutions/object_counter.py#L12-L190"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/solutions/object_counter.py#L54-L115"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def count_objects(
    self,
    current_centroid: tuple[float, float],
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/solutions/object_counter.py#L117-L135"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def display_counts(self, plot_im) -> None:
    """Display object counts on the input image or frame.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/solutions/object_counter.py#L137-L190"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def process(self, im0) -> SolutionResults:
    """Process input data (frames or object tracks) and update object counts.
