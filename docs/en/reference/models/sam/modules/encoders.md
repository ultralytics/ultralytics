...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/modules/encoders.py#L23-L147">View on GitHub</a>
```python
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/modules/encoders.py#L135-L147">View on GitHub</a>
```python
def forward(self, x: torch.Tensor) -> torch.Tensor:
    """Process input through patch embedding, positional embedding, transformer blocks, and neck module."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/modules/encoders.py#L150-L331">View on GitHub</a>
```python
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/modules/encoders.py#L254-L261">View on GitHub</a>
```python
def _embed_boxes(self, boxes: torch.Tensor) -> torch.Tensor:
    """Embed box prompts by applying positional encoding and adding corner embeddings."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/modules/encoders.py#L263-L265">View on GitHub</a>
```python
def _embed_masks(self, masks: torch.Tensor) -> torch.Tensor:
    """Embed mask inputs by downscaling and processing through convolutional layers."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/modules/encoders.py#L237-L252">View on GitHub</a>
```python
def _embed_points(self, points: torch.Tensor, labels: torch.Tensor, pad: bool) -> torch.Tensor:
    """Embed point prompts by applying positional encoding and label-specific embeddings."""
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/modules/encoders.py#L268-L281">View on GitHub</a>
```python
@staticmethod
def _get_batch_size(
    points: tuple[torch.Tensor, torch.Tensor] | None,
...
| Name | Type | Description | Default |
| --- | --- | --- | --- |
| `points` | `tuple[torch.Tensor, torch.Tensor] \| None` | Point coordinates and labels to embed. The first tensor contains coordinates of shape (B, N, 2), and the second tensor contains labels of shape (B, N). | *required* |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/modules/encoders.py#L283-L331">View on GitHub</a>
```python
def forward(
    self,
    points: tuple[torch.Tensor, torch.Tensor] | None,
...
| Type | Description |
| --- | --- |
| `torch.Tensor` | Positional encoding tensor with shape (1, embed_dim, H, W), where H and W are the height and width of the image embedding size, respectively. |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/modules/encoders.py#L219-L235">View on GitHub</a>
```python
def get_dense_pe(self) -> torch.Tensor:
    """Return the dense positional encoding used for encoding point prompts.
...
```python
MemoryEncoder(out_dim, in_dim=256, interpol_size: tuple[int, int] | None = None)
```
...
| `interpol_size` | `tuple[int, int] \| None` | Size to interpolate masks to. If None, uses the size of pixel features. | `None` |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/modules/encoders.py#L334-L409">View on GitHub</a>
```python
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/modules/encoders.py#L388-L409">View on GitHub</a>
```python
def forward(
    self,
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/modules/encoders.py#L412-L472">View on GitHub</a>
```python
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/modules/encoders.py#L460-L472">View on GitHub</a>
```python
def forward(self, sample: torch.Tensor):
    """Encode input through trunk and neck networks, returning multiscale features and positional encodings."""
...
This FPN variant removes the output convolution and uses configurable interpolation (default bilinear) for feature resizing, similar to ViT positional embedding interpolation.
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/modules/encoders.py#L475-L607">View on GitHub</a>
```python
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/modules/encoders.py#L558-L607">View on GitHub</a>
```python
def forward(self, xs: list[torch.Tensor]):
    """Perform forward pass through the Feature Pyramid Network (FPN) neck.
...
| `window_pos_embed_bkg_spatial_size` | `tuple[int, int]` | Spatial size for window positional embedding background. | `(14, 14)` |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/modules/encoders.py#L610-L794">View on GitHub</a>
```python
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/modules/encoders.py#L753-L760">View on GitHub</a>
```python
def _get_pos_embed(self, hw: tuple[int, int]) -> torch.Tensor:
    """Generate positional embeddings by interpolating and combining window and background embeddings."""
    h, w = hw
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/sam/modules/encoders.py#L762-L794">View on GitHub</a>
```python
def forward(self, x: torch.Tensor) -> list[torch.Tensor]:
    """Perform forward pass through Hiera model, extracting multiscale features from input images.
