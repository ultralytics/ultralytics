...
![Google Colab runtime settings menu for selecting GPU or TPU hardware acceleration](https://cdn.jsdelivr.net/gh/ultralytics/assets@main/docs/runtime-settings.avif)
