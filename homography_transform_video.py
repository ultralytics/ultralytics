...
def transform_first_frame_verify(video_path, homography_path, output_size):
    ...
    M, _world_bounds = compute_transformation_matrix(H, world_points, output_size)
    ...
    print("[VERIFY] First frame transformed:")
...
def transform_video(video_path, homography_path, output_path, output_size=(180, 1200)):
    ...
    print("[INFO] Computing transformation matrix")
    M, _world_bounds = compute_transformation_matrix(H, world_points, output_size)
    ...
    print("[OK] Video transformation complete")
...
def main():
    ...
    parser.add_argument(
        "--output-dir", "-d", default="results/warped_videos", help="Output directory (default: results/warped_videos)"
    )
