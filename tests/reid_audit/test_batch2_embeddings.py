...
def test_reid_predictor_write_results_clone_removed():
    """ReidPredictor must NOT define its own write_results (was a 30-line clone of BasePredictor)."""
    from ultralytics.models.yolo.reid.predict import ReidPredictor
    from ultralytics.engine.predictor import BasePredictor

    assert ReidPredictor.write_results is BasePredictor.write_results, (
        "ReidPredictor.write_results should be inherited from BasePredictor, not overridden"
    )
